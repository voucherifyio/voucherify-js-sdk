...
class CustomerRedeemable {
     ...
     * @return {module:model/CustomerRedeemable} The populated <code>CustomerRedeemable</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerRedeemable</code>.
     */
...
/**
 * Role of the holder.
 * @member {module:model/CustomerRedeemable.HolderRoleEnum} holder_role
 * @default 'OWNER'
 */
 ...
 * @member {module:model/CustomerRedeemable.CampaignTypeEnum} campaign_type
 ...
 * @member {module:model/CustomerRedeemable.VoucherTypeEnum} voucher_type
 * @default 'DISCOUNT_VOUCHER'
 */
CustomerRedeemable.prototype['voucher_type'] = 'DISCOUNT_VOUCHER';

/**
 * @member {module:model/CustomerRedeemableRedeemable} redeemable
 */

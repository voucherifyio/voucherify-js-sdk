...
class RewardsUpdateRequestBodyParametersProduct {
     ...
     * @return {module:model/RewardsUpdateRequestBodyParametersProduct} The populated <code>RewardsUpdateRequestBodyParametersProduct</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsUpdateRequestBodyParametersProduct</code>.
     */

...
class ClientValidationsValidateRequestBodyOptions {
     ...
     * @return {module:model/ClientValidationsValidateRequestBodyOptions} The populated <code>ClientValidationsValidateRequestBodyOptions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateRequestBodyOptions</code>.
     */
 ...
 * @member {Array.<module:model/ClientValidationsValidateRequestBodyOptions.ExpandEnum>} expand
 */

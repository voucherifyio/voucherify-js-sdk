...
class CampaignsVouchersCreateCombinedResponseBodyRedemption {
    ...
    constructor() { 
        ...
        CampaignsVouchersCreateCombinedResponseBodyRedemption.initialize(this);
    }
     ...
     * @return {module:model/CampaignsVouchersCreateCombinedResponseBodyRedemption} The populated <code>CampaignsVouchersCreateCombinedResponseBodyRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsVouchersCreateCombinedResponseBodyRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateCombinedResponseBodyRedemption</code>.
     */
...
export default CampaignsVouchersCreateCombinedResponseBodyRedemption;

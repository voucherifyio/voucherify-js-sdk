...
class LoyaltiesMembersTiersListResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesMembersTiersListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersTiersListResponseBody} The populated <code>LoyaltiesMembersTiersListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersTiersListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTiersListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersTiersListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesMembersTiersListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
...
export default LoyaltiesMembersTiersListResponseBody;

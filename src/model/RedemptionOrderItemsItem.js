...
class RedemptionOrderItemsItem {
     ...
     * @alias module:model/RedemptionOrderItemsItem
     ...
     * @param {module:model/RedemptionOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/RedemptionOrderItemsItem} The populated <code>RedemptionOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionOrderItemsItem</code>.
     */
 ...
 * @member {module:model/RedemptionOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/RedemptionOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

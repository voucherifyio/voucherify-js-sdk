...
class RedemptionOrderItemsItem {
    /**
     * Constructs a new <code>RedemptionOrderItemsItem</code>.
     * @alias RedemptionOrderItemsItem
     * @implements OrderCalculatedItem
     */
    constructor() { 
        OrderCalculatedItem.initialize(this);
        RedemptionOrderItemsItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionOrderItemsItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<RedemptionOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionOrderItemsItem} [obj] Optional instance to populate.
     * @returns {RedemptionOrderItemsItem} The populated <code>RedemptionOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionOrderItemsItem();
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionOrderItemsItem</code>.
     * @param {Partial<RedemptionOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionOrderItemsItem</code>.
     */
...
/**
    ...
    */
RedemptionOrderItemsItem.prototype['id'] = undefined;

/**
    * Unique identifier of the SKU. It is assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionOrderItemsItem.prototype['sku_id'] = undefined;

/**
    * Unique identifier of the product. It is assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionOrderItemsItem.prototype['product_id'] = undefined;

/**
    * Used along with the source_id property, can be set to either sku or product.
    * @type {(keyof typeof RedemptionOrderItemsItem.RelatedObjectEnum) | undefined}
    */
RedemptionOrderItemsItem.prototype['related_object'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
RedemptionOrderItemsItem.prototype['source_id'] = undefined;

/**
    * The quantity of the particular item in the cart.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['quantity'] = undefined;

/**
    * Number of dicounted items.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['initial_quantity'] = undefined;

/**
    * The total amount of the order item (price * quantity).
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['amount'] = undefined;

/**
    * Sum of all order-item-level discounts applied to the order.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['discount_amount'] = undefined;

/**
    * This field shows the order-level discount applied.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['applied_discount_amount'] = undefined;

/**
    * Number of the discounted items applied in the transaction.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['applied_discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['applied_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['applied_quantity_amount'] = undefined;

/**
    * A positive integer in the smallest currency unit (e.g. 100 cents for $1.00) representing the total amount of the order. This is the sum of the order items' amounts.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['initial_amount'] = undefined;

/**
    * Unit price of an item. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['price'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrderItemsItem.prototype['subtotal_amount'] = undefined;

/**
    * @type {OrderCalculatedItemProduct | undefined}
    */
RedemptionOrderItemsItem.prototype['product'] = undefined;

/**
    * @type {OrderCalculatedItemSku | undefined}
    */
RedemptionOrderItemsItem.prototype['sku'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof RedemptionOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */
RedemptionOrderItemsItem.prototype['object'] = 'order_item';
...
/**
    ...
    */
RedemptionOrderItemsItem.prototype['metadata'] = undefined;
...
/**
    ...
    */
RedemptionOrderItemsItem.prototype['application_details'] = undefined;
...
OrderCalculatedItem.prototype['metadata'] = undefined;
     ...
     * @readonly
     */
    RedemptionOrderItemsItem['RelatedObjectEnum'] = {
     ...
     * @readonly
     */
    RedemptionOrderItemsItem['ObjectEnum'] = {
...
export default RedemptionOrderItemsItem;

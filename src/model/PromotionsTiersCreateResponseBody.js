...
import PromotionsTiersCreateResponseBodyAction from './PromotionsTiersCreateResponseBodyAction';
import PromotionsTiersCreateResponseBodyCampaign from './PromotionsTiersCreateResponseBodyCampaign';
import PromotionsTiersCreateResponseBodySummary from './PromotionsTiersCreateResponseBodySummary';
...
class PromotionsTiersCreateResponseBody {
    ...
    constructor() { 
        ...
        PromotionsTiersCreateResponseBody.initialize(this);
    }
     ...
     * @return {module:model/PromotionsTiersCreateResponseBody} The populated <code>PromotionsTiersCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersCreateResponseBody();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = PromotionsTiersCreateResponseBodyAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = PromotionsTiersCreateResponseBodyCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = PromotionsTiersCreateResponseBodySummary.constructFromObject(data['summary']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersCreateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          PromotionsTiersCreateResponseBodyAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['campaign']) { // data not null
          PromotionsTiersCreateResponseBodyCampaign.validateJSON(data['campaign']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          PromotionsTiersCreateResponseBodySummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/PromotionsTiersCreateResponseBodyAction} action
 */
...
/**
 * @member {module:model/PromotionsTiersCreateResponseBodyCampaign} campaign
 */
 ...
 * @member {Array.<module:model/PromotionsTiersCreateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/PromotionsTiersCreateResponseBodySummary} summary
 */
 ...
 * @readonly
 */
PromotionsTiersCreateResponseBody['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersCreateResponseBody;

...
class TemplatesCampaignsTierSetupCreateRequestBody {
     ...
     * @alias module:model/TemplatesCampaignsTierSetupCreateRequestBody
     */
    constructor() { 
     ...
     * @param {module:model/TemplatesCampaignsTierSetupCreateRequestBody} obj Optional instance to populate.
     * @return {module:model/TemplatesCampaignsTierSetupCreateRequestBody} The populated <code>TemplatesCampaignsTierSetupCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsTierSetupCreateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/TemplatesCampaignsTierSetupCreateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */

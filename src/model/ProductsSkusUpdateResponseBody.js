...
class ProductsSkusUpdateResponseBody {
     ...
     * @alias module:model/ProductsSkusUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ProductsSkusUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/ProductsSkusUpdateResponseBody} The populated <code>ProductsSkusUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsSkusUpdateResponseBody</code>.
     */
 ...
 * @member {module:model/ProductsSkusUpdateResponseBody.ObjectEnum} object
 * @default 'sku'
 */

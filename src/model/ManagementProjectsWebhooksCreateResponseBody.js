...
class ManagementProjectsWebhooksCreateResponseBody {
     ...
     * @alias module:model/ManagementProjectsWebhooksCreateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ManagementProjectsWebhooksCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/ManagementProjectsWebhooksCreateResponseBody} The populated <code>ManagementProjectsWebhooksCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhooksCreateResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsWebhooksCreateResponseBody.ObjectEnum} object
 * @default 'webhook'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhooksCreateResponseBody.EventsEnum>} events
 */

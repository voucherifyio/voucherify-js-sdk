...
class SkusListForProduct {
     ...
     * @return {module:model/SkusListForProduct} The populated <code>SkusListForProduct</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SkusListForProduct</code>.
     */
 ...
 * @member {Array.<module:model/Sku>} data
 */

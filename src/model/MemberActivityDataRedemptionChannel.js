...
class MemberActivityDataRedemptionChannel {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionChannel.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionChannel} The populated <code>MemberActivityDataRedemptionChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionChannel();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionChannel</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionChannel.ChannelTypeEnum} channel_type
 */
...
export default MemberActivityDataRedemptionChannel;

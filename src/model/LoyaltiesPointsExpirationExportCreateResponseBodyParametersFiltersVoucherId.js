...
class LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId {
    ...
    constructor() { 
        ...
        LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId} The populated <code>LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId();

            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions.constructFromObject(data['conditions']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId</code>.
     */
    static validateJSON(data) {
        // validate the optional field `conditions`
        if (data['conditions']) { // data not null
          LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions.validateJSON(data['conditions']);
        }
...
/**
 * @member {module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions} conditions
 */
...
export default LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherId;

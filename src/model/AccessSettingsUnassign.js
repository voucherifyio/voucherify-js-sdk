...
class AccessSettingsUnassign {
    ...
    constructor() { 
        ...
        AccessSettingsUnassign.initialize(this);
    }
     ...
     * @return {module:model/AccessSettingsUnassign} The populated <code>AccessSettingsUnassign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessSettingsUnassign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessSettingsUnassign</code>.
     */
...
export default AccessSettingsUnassign;

...
import ValidationsValidateResponseBodyRedeemablesItemOrderCustomer from './ValidationsValidateResponseBodyRedeemablesItemOrderCustomer';
import ValidationsValidateResponseBodyRedeemablesItemOrderReferrer from './ValidationsValidateResponseBodyRedeemablesItemOrderReferrer';
/**
...
class ValidationsValidateResponseBodyRedeemablesItemOrder {
    /**
     * Constructs a new <code>ValidationsValidateResponseBodyRedeemablesItemOrder</code>.
     * @alias ValidationsValidateResponseBodyRedeemablesItemOrder
     */
    constructor() { 
        
        ValidationsValidateResponseBodyRedeemablesItemOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidationsValidateResponseBodyRedeemablesItemOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<ValidationsValidateResponseBodyRedeemablesItemOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationsValidateResponseBodyRedeemablesItemOrder} [obj] Optional instance to populate.
     * @returns {ValidationsValidateResponseBodyRedeemablesItemOrder} The populated <code>ValidationsValidateResponseBodyRedeemablesItemOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationsValidateResponseBodyRedeemablesItemOrder();
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = ValidationsValidateResponseBodyRedeemablesItemOrderCustomer.constructFromObject(data['customer']);
            }
            if (data.hasOwnProperty('referrer')) {
                obj['referrer'] = ValidationsValidateResponseBodyRedeemablesItemOrderReferrer.constructFromObject(data['referrer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ValidationsValidateResponseBodyRedeemablesItemOrder</code>.
     * @param {Partial<ValidationsValidateResponseBodyRedeemablesItemOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyRedeemablesItemOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['customer']) { // data not null
          ValidationsValidateResponseBodyRedeemablesItemOrderCustomer.validateJSON(data['customer']);
        }
        // validate the optional field `referrer`
        if (data['referrer']) { // data not null
          ValidationsValidateResponseBodyRedeemablesItemOrderReferrer.validateJSON(data['referrer']);
        }
...
/**
    ...
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['id'] = undefined;

/**
    * Unique source ID of an existing order that will be linked to the redemption of this request.
    * @type {String | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['source_id'] = undefined;

/**
    * The order status.
    * @type {(keyof typeof ValidationsValidateResponseBodyRedeemablesItemOrder.StatusEnum) | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['status'] = undefined;
...
/**
    ...
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['initial_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['items_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['total_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['total_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['items_applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['total_applied_discount_amount'] = undefined;
...
/**
    ...
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['metadata'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof ValidationsValidateResponseBodyRedeemablesItemOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['object'] = 'order';

/**
    * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
    * @type {String | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['customer_id'] = undefined;

/**
    * Unique referrer ID.
    * @type {String | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['referrer_id'] = undefined;

/**
    * @type {ValidationsValidateResponseBodyRedeemablesItemOrderCustomer | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['customer'] = undefined;

/**
    * @type {ValidationsValidateResponseBodyRedeemablesItemOrderReferrer | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['referrer'] = undefined;

/**
    * @type {Object.<String, OrderRedemptionsEntry> | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['redemptions'] = undefined;

/**
    * Array of items applied to the order. It can include up to 500 items.
    * @type {Array.<OrderCalculatedItem> | undefined}
    */
ValidationsValidateResponseBodyRedeemablesItemOrder.prototype['items'] = undefined;
     ...
     * @readonly
     */
    ValidationsValidateResponseBodyRedeemablesItemOrder['StatusEnum'] = {
     ...
     * @readonly
     */
    ValidationsValidateResponseBodyRedeemablesItemOrder['ObjectEnum'] = {
...
export default ValidationsValidateResponseBodyRedeemablesItemOrder;

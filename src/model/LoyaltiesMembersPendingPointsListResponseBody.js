...
class LoyaltiesMembersPendingPointsListResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesMembersPendingPointsListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersPendingPointsListResponseBody} The populated <code>LoyaltiesMembersPendingPointsListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersPendingPointsListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPendingPointsListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/LoyaltyPendingPoints>} data
 */
...
export default LoyaltiesMembersPendingPointsListResponseBody;

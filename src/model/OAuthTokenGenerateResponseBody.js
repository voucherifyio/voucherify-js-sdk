...
class OAuthTokenGenerateResponseBody {
    ...
    constructor() { 
        ...
        OAuthTokenGenerateResponseBody.initialize(this);
    }
     ...
     * @return {module:model/OAuthTokenGenerateResponseBody} The populated <code>OAuthTokenGenerateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OAuthTokenGenerateResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OAuthTokenGenerateResponseBody</code>.
     */
 ...
 * @member {module:model/OAuthTokenGenerateResponseBody.TokenTypeEnum} token_type
 * @default 'Bearer'
 */
...
export default OAuthTokenGenerateResponseBody;

...
class PromotionsTiersDisableResponseBodyCampaign {
     ...
     * @alias module:model/PromotionsTiersDisableResponseBodyCampaign
     */
    constructor() { 
     ...
     * @param {module:model/PromotionsTiersDisableResponseBodyCampaign} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersDisableResponseBodyCampaign} The populated <code>PromotionsTiersDisableResponseBodyCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersDisableResponseBodyCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersDisableResponseBodyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

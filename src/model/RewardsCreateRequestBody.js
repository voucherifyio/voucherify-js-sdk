...
class RewardsCreateRequestBody {
     ...
     * @return {module:model/RewardsCreateRequestBody} The populated <code>RewardsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/RewardsCreateRequestBodyParameters} parameters
 */
...
/**
 * @member {module:model/RewardsCreateRequestBodyAttributes} attributes
 */

...
class LoyaltiesRewardsGetResponseBody {
     ...
     * @return {module:model/LoyaltiesRewardsGetResponseBody} The populated <code>LoyaltiesRewardsGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardsGetResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesRewardsGetResponseBody.ObjectEnum} object
 ...
 * @member {module:model/LoyaltiesRewardsGetResponseBody.RelatedObjectTypeEnum} related_object_type
 * @default 'campaign'
 */
LoyaltiesRewardsGetResponseBody.prototype['related_object_type'] = 'campaign';

/**
 * @member {module:model/LoyaltiesRewardsGetResponseBodyParameters} parameters
 */

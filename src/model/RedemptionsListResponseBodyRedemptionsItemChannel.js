...
class RedemptionsListResponseBodyRedemptionsItemChannel {
    ...
    constructor() { 
        ...
        RedemptionsListResponseBodyRedemptionsItemChannel.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsListResponseBodyRedemptionsItemChannel} The populated <code>RedemptionsListResponseBodyRedemptionsItemChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsListResponseBodyRedemptionsItemChannel();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBodyRedemptionsItemChannel</code>.
     */
...
/**
 * @member {module:model/RedemptionsListResponseBodyRedemptionsItemChannel.ChannelTypeEnum} channel_type
 */
...
export default RedemptionsListResponseBodyRedemptionsItemChannel;

...
class ManagementProjectsCustomEventSchemasCreateRequestBody {
     ...
     * @return {module:model/ManagementProjectsCustomEventSchemasCreateRequestBody} The populated <code>ManagementProjectsCustomEventSchemasCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchemasCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/ManagementProjectsCustomEventSchemasCreateRequestBodySchema} schema
 */

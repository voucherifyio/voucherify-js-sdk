...
import PromotionsTiersGetResponseBodyAction from './PromotionsTiersGetResponseBodyAction';
import PromotionsTiersGetResponseBodyCampaign from './PromotionsTiersGetResponseBodyCampaign';
import PromotionsTiersGetResponseBodySummary from './PromotionsTiersGetResponseBodySummary';
...
class PromotionsTiersGetResponseBody {
    /**
     * Constructs a new <code>PromotionsTiersGetResponseBody</code>.
     * Response body schema for **GET** &#x60;v1/promotions/tiers/{promotionTierId}&#x60;.
     * @alias module:model/PromotionsTiersGetResponseBody
     */
    constructor() { 
        
        PromotionsTiersGetResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionsTiersGetResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsTiersGetResponseBody} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersGetResponseBody} The populated <code>PromotionsTiersGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersGetResponseBody();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = PromotionsTiersGetResponseBodyAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = PromotionsTiersGetResponseBodyCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = PromotionsTiersGetResponseBodySummary.constructFromObject(data['summary']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsTiersGetResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersGetResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          PromotionsTiersGetResponseBodyAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['campaign']) { // data not null
          PromotionsTiersGetResponseBodyCampaign.validateJSON(data['campaign']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          PromotionsTiersGetResponseBodySummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
PromotionsTiersGetResponseBody.prototype['id'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['created_at'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['updated_at'] = undefined;

/**
 * Name of the promotion tier.
 * @member {String} name
 */
PromotionsTiersGetResponseBody.prototype['name'] = undefined;

/**
 * Text to be displayed to your customers on your website.
 * @member {String} banner
 */
PromotionsTiersGetResponseBody.prototype['banner'] = undefined;

/**
 * @member {module:model/PromotionsTiersGetResponseBodyAction} action
 */
PromotionsTiersGetResponseBody.prototype['action'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['metadata'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['hierarchy'] = undefined;

/**
 * Promotion unique ID.
 * @member {String} promotion_id
 */
PromotionsTiersGetResponseBody.prototype['promotion_id'] = undefined;

/**
 * @member {module:model/PromotionsTiersGetResponseBodyCampaign} campaign
 */
PromotionsTiersGetResponseBody.prototype['campaign'] = undefined;

/**
 * Promotion tier's parent campaign's unique ID.
 * @member {String} campaign_id
 */
PromotionsTiersGetResponseBody.prototype['campaign_id'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['active'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['start_date'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
PromotionsTiersGetResponseBody.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/PromotionsTiersGetResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
PromotionsTiersGetResponseBody.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
PromotionsTiersGetResponseBody.prototype['validity_hours'] = undefined;

/**
 * @member {module:model/PromotionsTiersGetResponseBodySummary} summary
 */
PromotionsTiersGetResponseBody.prototype['summary'] = undefined;
 ...
 */
PromotionsTiersGetResponseBody.prototype['object'] = 'promotion_tier';

/**
 * @member {module:model/ValidationRuleAssignmentsList} validation_rule_assignments
 */
PromotionsTiersGetResponseBody.prototype['validation_rule_assignments'] = undefined;

/**
 * Promotion tier category ID.
 * @member {String} category_id
 */
PromotionsTiersGetResponseBody.prototype['category_id'] = undefined;

/**
 * @member {Array.<module:model/Category>} categories
 */
PromotionsTiersGetResponseBody.prototype['categories'] = undefined;
 ...
 * @readonly
 */
PromotionsTiersGetResponseBody['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersGetResponseBody;

...
class PromotionsTiersGetResponseBody {
     ...
     * @alias PromotionsTiersGetResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<PromotionsTiersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionsTiersGetResponseBody} [obj] Optional instance to populate.
     * @returns {PromotionsTiersGetResponseBody} The populated <code>PromotionsTiersGetResponseBody</code> instance.
     */
     ...
     * @param {Partial<PromotionsTiersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersGetResponseBody</code>.
     */
...
/**
    * @type {PromotionsTiersGetResponseBodyAction | undefined}
    */
...
/**
    * @type {PromotionsTiersGetResponseBodyCampaign | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof PromotionsTiersGetResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {PromotionsTiersGetResponseBodySummary | undefined}
    */

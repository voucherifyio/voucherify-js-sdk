...
class VouchersCreateRequestBody {
     ...
     * @return {module:model/VouchersCreateRequestBody} The populated <code>VouchersCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersCreateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/VouchersCreateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @member {Array.<String>} validation_rules
 */
VouchersCreateRequestBody.prototype['validation_rules'] = undefined;

/**
 * @member {module:model/VouchersCreateRequestBodyRedemption} redemption
 */
VouchersCreateRequestBody.prototype['redemption'] = undefined;

/**
 * @member {module:model/VouchersCreateRequestBody.TypeEnum} type
 */
VouchersCreateRequestBody.prototype['type'] = undefined;

/**
 * @member {module:model/SimpleLoyaltyCard} loyalty_card
 */

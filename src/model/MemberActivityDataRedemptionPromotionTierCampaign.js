...
class MemberActivityDataRedemptionPromotionTierCampaign {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionPromotionTierCampaign.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionPromotionTierCampaign} The populated <code>MemberActivityDataRedemptionPromotionTierCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionPromotionTierCampaign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionPromotionTierCampaign</code>.
     */
 ...
 * @member {Array.<module:model/MemberActivityDataRedemptionPromotionTierCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @readonly
 */
MemberActivityDataRedemptionPromotionTierCampaign['ValidityDayOfWeekEnum'] = {
...
export default MemberActivityDataRedemptionPromotionTierCampaign;

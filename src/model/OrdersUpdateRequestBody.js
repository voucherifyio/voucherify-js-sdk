...
class OrdersUpdateRequestBody {
     ...
     * @alias module:model/OrdersUpdateRequestBody
     */
    constructor() { 
     ...
     * @param {module:model/OrdersUpdateRequestBody} obj Optional instance to populate.
     * @return {module:model/OrdersUpdateRequestBody} The populated <code>OrdersUpdateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersUpdateRequestBody</code>.
     */
...
/**
 * The order status.
 * @member {module:model/OrdersUpdateRequestBody.StatusEnum} status
 */
...
/**
 * @member {module:model/Referrer} referrer
 */

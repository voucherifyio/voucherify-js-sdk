...
class RewardsAssignmentsListResponseBody {
     ...
     * @return {module:model/RewardsAssignmentsListResponseBody} The populated <code>RewardsAssignmentsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsAssignmentsListResponseBody</code>.
     */

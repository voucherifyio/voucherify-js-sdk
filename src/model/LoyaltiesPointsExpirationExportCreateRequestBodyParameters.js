...
class LoyaltiesPointsExpirationExportCreateRequestBodyParameters {
    ...
    constructor() { 
        ...
        LoyaltiesPointsExpirationExportCreateRequestBodyParameters.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParameters} The populated <code>LoyaltiesPointsExpirationExportCreateRequestBodyParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesPointsExpirationExportCreateRequestBodyParameters();
            ...
            if (data.hasOwnProperty('filters')) {
                obj['filters'] = LoyaltiesPointsExpirationExportCreateRequestBodyParametersFilters.constructFromObject(data['filters']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPointsExpirationExportCreateRequestBodyParameters</code>.
     */
    static validateJSON(data) {
        ...
        if (data['filters']) { // data not null
          LoyaltiesPointsExpirationExportCreateRequestBodyParametersFilters.validateJSON(data['filters']);
        }
 ...
 * @member {module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParameters.FieldsEnum>} fields
 */
LoyaltiesPointsExpirationExportCreateRequestBodyParameters.prototype['fields'] = undefined;

/**
 * @member {module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParametersFilters} filters
 */
 ...
 * @readonly
 */
LoyaltiesPointsExpirationExportCreateRequestBodyParameters['FieldsEnum'] = {
...
export default LoyaltiesPointsExpirationExportCreateRequestBodyParameters;

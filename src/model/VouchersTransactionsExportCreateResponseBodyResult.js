...
class VouchersTransactionsExportCreateResponseBodyResult {
    ...
    constructor() { 
        ...
        VouchersTransactionsExportCreateResponseBodyResult.initialize(this);
    }
     ...
     * @return {module:model/VouchersTransactionsExportCreateResponseBodyResult} The populated <code>VouchersTransactionsExportCreateResponseBodyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersTransactionsExportCreateResponseBodyResult();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersTransactionsExportCreateResponseBodyResult</code>.
     */
...
export default VouchersTransactionsExportCreateResponseBodyResult;

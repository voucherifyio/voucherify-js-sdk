...
class RewardTypeCampaign {
     ...
     * @return {module:model/RewardTypeCampaign} The populated <code>RewardTypeCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardTypeCampaign</code>.
     */
...
/**
 * Campaign type.
 * @member {module:model/RewardTypeCampaign.TypeEnum} type
 */

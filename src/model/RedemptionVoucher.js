...
import RedemptionVoucherGift from './RedemptionVoucherGift';
import RedemptionVoucherLoyaltyCard from './RedemptionVoucherLoyaltyCard';
import RedemptionVoucherPublish from './RedemptionVoucherPublish';
import RedemptionVoucherRedemption from './RedemptionVoucherRedemption';
...
class RedemptionVoucher {
     ...
     * @param {Partial<RedemptionVoucher>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionVoucher} [obj] Optional instance to populate.
     * @returns {RedemptionVoucher} The populated <code>RedemptionVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = RedemptionVoucherGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = RedemptionVoucherLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = RedemptionVoucherPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = RedemptionVoucherRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionVoucher</code>.
     * @param {Partial<RedemptionVoucher>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionVoucher</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          RedemptionVoucherGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          RedemptionVoucherLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          RedemptionVoucherPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          RedemptionVoucherRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
RedemptionVoucher.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
RedemptionVoucher.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
RedemptionVoucher.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
    * @type {String | undefined}
    */
RedemptionVoucher.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionVoucher.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof RedemptionVoucher.TypeEnum) | undefined}
    */
RedemptionVoucher.prototype['type'] = undefined;

/**
    * @type {Discount | undefined}
    */
RedemptionVoucher.prototype['discount'] = undefined;

/**
    * @type {RedemptionVoucherGift | undefined}
    */
RedemptionVoucher.prototype['gift'] = undefined;

/**
    * @type {RedemptionVoucherLoyaltyCard | undefined}
    */
RedemptionVoucher.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
RedemptionVoucher.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
RedemptionVoucher.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
RedemptionVoucher.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof RedemptionVoucher.ValidityDayOfWeekEnum>) | undefined}
    */
RedemptionVoucher.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
RedemptionVoucher.prototype['validity_hours'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
RedemptionVoucher.prototype['object'] = 'voucher';

/**
    * @type {RedemptionVoucherPublish | undefined}
    */
RedemptionVoucher.prototype['publish'] = undefined;

/**
    * @type {RedemptionVoucherRedemption | undefined}
    */
RedemptionVoucher.prototype['redemption'] = undefined;

/**
    * Contains details about the category.
    * @type {Array.<CategoryWithStackingRulesType> | undefined}
    */
RedemptionVoucher.prototype['categories'] = undefined;

/**
    * @type {ValidationRulesAssignmentsList | undefined}
    */
RedemptionVoucher.prototype['validation_rules_assignments'] = undefined;

/**
    * @type {SimpleCustomer | undefined}
    */
RedemptionVoucher.prototype['holder'] = undefined;
 ...
 * @readonly
 */
RedemptionVoucher['ValidityDayOfWeekEnum'] = {

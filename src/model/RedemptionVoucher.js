...
class RedemptionVoucher {
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionVoucher</code>.
     */
 ...
 * @member {module:model/RedemptionVoucher.TypeEnum} type
 */
...
/**
 * @member {module:model/RedemptionVoucherGift} gift
 */
RedemptionVoucher.prototype['gift'] = undefined;

/**
 * @member {module:model/RedemptionVoucherLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/RedemptionVoucher.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/RedemptionVoucherPublish} publish
 */
RedemptionVoucher.prototype['publish'] = undefined;

/**
 * @member {module:model/RedemptionVoucherRedemption} redemption
 */

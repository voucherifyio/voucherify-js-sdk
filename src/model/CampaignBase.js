...
class CampaignBase {
     ...
     * @return {module:model/CampaignBase} The populated <code>CampaignBase</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignBase</code>.
     */
...
/**
 * Type of campaign.
 * @member {module:model/CampaignBase.CampaignTypeEnum} campaign_type
 */
 ...
 * @member {module:model/CampaignBase.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/CampaignBase.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @member {module:model/CampaignBase.CreationStatusEnum} creation_status
 */
CampaignBase.prototype['creation_status'] = undefined;

/**
 * Indicates the status of the campaign's voucher generation.
 * @member {module:model/CampaignBase.VouchersGenerationStatusEnum} vouchers_generation_status
 */

...
class RedemptionsRollbacksCreateResponseBodyOrder {
     ...
     * @alias RedemptionsRollbacksCreateResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<RedemptionsRollbacksCreateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionsRollbacksCreateResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {RedemptionsRollbacksCreateResponseBodyOrder} The populated <code>RedemptionsRollbacksCreateResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<RedemptionsRollbacksCreateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRollbacksCreateResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof RedemptionsRollbacksCreateResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof RedemptionsRollbacksCreateResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */

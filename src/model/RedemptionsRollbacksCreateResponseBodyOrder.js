...
class RedemptionsRollbacksCreateResponseBodyOrder {
    /**
     * Constructs a new <code>RedemptionsRollbacksCreateResponseBodyOrder</code>.
     * @alias module:model/RedemptionsRollbacksCreateResponseBodyOrder
     */
    constructor() { 
        
        RedemptionsRollbacksCreateResponseBodyOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionsRollbacksCreateResponseBodyOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedemptionsRollbacksCreateResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionsRollbacksCreateResponseBodyOrder} The populated <code>RedemptionsRollbacksCreateResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsRollbacksCreateResponseBodyOrder();
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionsRollbacksCreateResponseBodyOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRollbacksCreateResponseBodyOrder</code>.
     */
 ...
 * @member {String} id
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/RedemptionsRollbacksCreateResponseBodyOrder.StatusEnum} status
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['status'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['initial_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['total_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/RedemptionsRollbacksCreateResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
RedemptionsRollbacksCreateResponseBodyOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
RedemptionsRollbacksCreateResponseBodyOrder['StatusEnum'] = {
 ...
 * @readonly
 */
RedemptionsRollbacksCreateResponseBodyOrder['ObjectEnum'] = {
...
export default RedemptionsRollbacksCreateResponseBodyOrder;

...
class CampaignsCreateRequestBody {
     ...
     * @return {module:model/CampaignsCreateRequestBody} The populated <code>CampaignsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsCreateRequestBody</code>.
     */
 ...
 * @member {module:model/CampaignsCreateRequestBody.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/CampaignsCreateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/CampaignsCreateRequestBody.CampaignTypeEnum} campaign_type
 */
CampaignsCreateRequestBody.prototype['campaign_type'] = undefined;

/**
 * @member {module:model/CampaignsCreateRequestBodyVoucher} voucher
 */
...
/**
 * @member {module:model/CampaignsCreateRequestBodyPromotion} promotion
 */

...
class LocationsListResponseBody {
    ...
    constructor() { 
        ...
        LocationsListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LocationsListResponseBody} The populated <code>LocationsListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationsListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationsListResponseBody</code>.
     */
...
export default LocationsListResponseBody;

...
class CampaignLoyaltyCardExpirationRules {
     ...
     * @return {module:model/CampaignLoyaltyCardExpirationRules} The populated <code>CampaignLoyaltyCardExpirationRules</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignLoyaltyCardExpirationRules</code>.
     */
 ...
 * @member {module:model/CampaignLoyaltyCardExpirationRules.PeriodTypeEnum} period_type
 */
 ...
 * @member {module:model/CampaignLoyaltyCardExpirationRules.RoundingTypeEnum} rounding_type
 */

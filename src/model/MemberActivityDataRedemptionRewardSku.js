...
class MemberActivityDataRedemptionRewardSku {
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardSku} The populated <code>MemberActivityDataRedemptionRewardSku</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardSku</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionRewardSku.ObjectEnum} object
 * @default 'sku'
 */

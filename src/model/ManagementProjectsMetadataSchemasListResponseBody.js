...
class ManagementProjectsMetadataSchemasListResponseBody {
     ...
     * @return {module:model/ManagementProjectsMetadataSchemasListResponseBody} The populated <code>ManagementProjectsMetadataSchemasListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsMetadataSchemasListResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsMetadataSchemasListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsMetadataSchemasListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsMetadataSchema>} data
 */

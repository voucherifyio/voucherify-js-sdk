...
class RedemptionEntryPromotionTierCampaign {
     ...
     * @alias module:model/RedemptionEntryPromotionTierCampaign
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionEntryPromotionTierCampaign} obj Optional instance to populate.
     * @return {module:model/RedemptionEntryPromotionTierCampaign} The populated <code>RedemptionEntryPromotionTierCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryPromotionTierCampaign</code>.
     */
 ...
 * @member {Array.<module:model/RedemptionEntryPromotionTierCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

...
class PromotionsTiersGetResponseBodyCampaign {
    /**
     * Constructs a new <code>PromotionsTiersGetResponseBodyCampaign</code>.
     * Contains details about promotion tier&#39;s parent campaign.
     * @alias PromotionsTiersGetResponseBodyCampaign
     */
    constructor() { 
        
        PromotionsTiersGetResponseBodyCampaign.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionsTiersGetResponseBodyCampaign</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<PromotionsTiersGetResponseBodyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionsTiersGetResponseBodyCampaign} [obj] Optional instance to populate.
     * @returns {PromotionsTiersGetResponseBodyCampaign} The populated <code>PromotionsTiersGetResponseBodyCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersGetResponseBodyCampaign();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsTiersGetResponseBodyCampaign</code>.
     * @param {Partial<PromotionsTiersGetResponseBodyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersGetResponseBodyCampaign</code>.
     */
...
/**
    ...
    */
PromotionsTiersGetResponseBodyCampaign.prototype['id'] = undefined;

/**
    * Activation timestamp defines when the campaign starts to be active in ISO 8601 format. Campaign is *inactive before* this date. 
    * @type {Date | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the campaign expires in ISO 8601 format.  Campaign is *inactive after* this date.
    * @type {Date | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof PromotionsTiersGetResponseBodyCampaign.ValidityDayOfWeekEnum>) | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
PromotionsTiersGetResponseBodyCampaign.prototype['active'] = undefined;

/**
    * Unique category ID that this campaign belongs to.
    * @type {String | undefined}
    */
PromotionsTiersGetResponseBodyCampaign.prototype['category_id'] = undefined;
...
/**
    ...
    * @default 'campaign'
    */
PromotionsTiersGetResponseBodyCampaign.prototype['object'] = 'campaign';
 ...
 * @readonly
 */
PromotionsTiersGetResponseBodyCampaign['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersGetResponseBodyCampaign;

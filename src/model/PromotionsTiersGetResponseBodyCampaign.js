...
class PromotionsTiersGetResponseBodyCampaign {
     ...
     * @alias module:model/PromotionsTiersGetResponseBodyCampaign
     */
    constructor() { 
     ...
     * @param {module:model/PromotionsTiersGetResponseBodyCampaign} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersGetResponseBodyCampaign} The populated <code>PromotionsTiersGetResponseBodyCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersGetResponseBodyCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersGetResponseBodyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

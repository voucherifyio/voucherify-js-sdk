...
class CustomersCreateResponseBodyAddress {
     ...
     * @return {module:model/CustomersCreateResponseBodyAddress} The populated <code>CustomersCreateResponseBodyAddress</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersCreateResponseBodyAddress</code>.
     */

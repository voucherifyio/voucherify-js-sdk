...
class CampaignsGetResponseBody {
     ...
     * @alias CampaignsGetResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<CampaignsGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {CampaignsGetResponseBody} [obj] Optional instance to populate.
     * @returns {CampaignsGetResponseBody} The populated <code>CampaignsGetResponseBody</code> instance.
     */
     ...
     * @param {Partial<CampaignsGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsGetResponseBody</code>.
     */
...
/**
    * Type of campaign.
    * @type {(keyof typeof CampaignsGetResponseBody.CampaignTypeEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof CampaignsGetResponseBody.TypeEnum) | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof CampaignsGetResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof CampaignsGetResponseBody.CreationStatusEnum) | undefined}
    */
CampaignsGetResponseBody.prototype['creation_status'] = undefined;

/**
    * Indicates the status of the campaign's voucher generation.
    * @type {(keyof typeof CampaignsGetResponseBody.VouchersGenerationStatusEnum) | undefined}
    */

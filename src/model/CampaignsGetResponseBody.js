...
/**
 * The CampaignsGetResponseBody model module.
 * @module model/CampaignsGetResponseBody
 * @version v2018-08-01
 */
class CampaignsGetResponseBody {
    /**
     * Constructs a new <code>CampaignsGetResponseBody</code>.
     * Response body schema for **GET** &#x60;v1/campaigns/{campaignId}&#x60;.
     * @alias module:model/CampaignsGetResponseBody
     */
    constructor() { 
        
        CampaignsGetResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignsGetResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignsGetResponseBody} obj Optional instance to populate.
     * @return {module:model/CampaignsGetResponseBody} The populated <code>CampaignsGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsGetResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignsGetResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsGetResponseBody</code>.
     */
 ...
 * @member {String} id
 */
CampaignsGetResponseBody.prototype['id'] = undefined;

/**
 * Campaign name.
 * @member {String} name
 */
CampaignsGetResponseBody.prototype['name'] = undefined;

/**
 * An optional field to keep any extra textual information about the campaign such as a campaign description and details.
 * @member {String} description
 */
CampaignsGetResponseBody.prototype['description'] = undefined;

/**
 * Type of campaign.
 * @member {module:model/CampaignsGetResponseBody.CampaignTypeEnum} campaign_type
 */
CampaignsGetResponseBody.prototype['campaign_type'] = undefined;
 ...
 * @member {module:model/CampaignsGetResponseBody.TypeEnum} type
 */
CampaignsGetResponseBody.prototype['type'] = undefined;

/**
 * @member {module:model/CampaignVoucher} voucher
 */
CampaignsGetResponseBody.prototype['voucher'] = undefined;

/**
 * Indicates whether customers will be able to auto-join a loyalty campaign if any earning rule is fulfilled.
 * @member {Boolean} auto_join
 */
CampaignsGetResponseBody.prototype['auto_join'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['join_once'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['use_voucher_metadata_schema'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
CampaignsGetResponseBody.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/CampaignsGetResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
CampaignsGetResponseBody.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
CampaignsGetResponseBody.prototype['validity_hours'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['activity_duration_after_publishing'] = undefined;

/**
 * Total number of unique vouchers in campaign.
 * @member {Number} vouchers_count
 */
CampaignsGetResponseBody.prototype['vouchers_count'] = undefined;

/**
 * Activation timestamp defines when the campaign starts to be active in ISO 8601 format. Campaign is *inactive before* this date. 
 * @member {Date} start_date
 */
CampaignsGetResponseBody.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the campaign expires in ISO 8601 format.  Campaign is *inactive after* this date.
 * @member {Date} expiration_date
 */
CampaignsGetResponseBody.prototype['expiration_date'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['active'] = undefined;

/**
 * The metadata object stores all custom attributes assigned to the campaign. A set of key/value pairs that you can attach to a campaign object. It can be useful for storing additional information about the campaign in a structured format.
 * @member {Object} metadata
 */
CampaignsGetResponseBody.prototype['metadata'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
CampaignsGetResponseBody.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
CampaignsGetResponseBody.prototype['updated_at'] = undefined;

/**
 * Unique category name.
 * @member {String} category
 */
CampaignsGetResponseBody.prototype['category'] = undefined;

/**
 * Indicates the status of the campaign creation.
 * @member {module:model/CampaignsGetResponseBody.CreationStatusEnum} creation_status
 */
CampaignsGetResponseBody.prototype['creation_status'] = undefined;

/**
 * Indicates the status of the campaign's voucher generation.
 * @member {module:model/CampaignsGetResponseBody.VouchersGenerationStatusEnum} vouchers_generation_status
 */
CampaignsGetResponseBody.prototype['vouchers_generation_status'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['readonly'] = undefined;

/**
 * Indicates whether the resource can be deleted.
 * @member {Boolean} protected
 */
CampaignsGetResponseBody.prototype['protected'] = undefined;

/**
 * Unique category ID that this campaign belongs to.
 * @member {String} category_id
 */
CampaignsGetResponseBody.prototype['category_id'] = undefined;
 ...
 */
CampaignsGetResponseBody.prototype['categories'] = undefined;
 ...
 * @default 'campaign'
 */
CampaignsGetResponseBody.prototype['object'] = 'campaign';

/**
 * @member {module:model/ReferralProgram} referral_program
 */
CampaignsGetResponseBody.prototype['referral_program'] = undefined;

/**
 * @member {module:model/LoyaltyTiersExpirationAll} loyalty_tiers_expiration
 */
CampaignsGetResponseBody.prototype['loyalty_tiers_expiration'] = undefined;

/**
 * @member {module:model/AccessSettingsCampaignAssignmentsList} access_settings_assignments
 */
CampaignsGetResponseBody.prototype['access_settings_assignments'] = undefined;

/**
 * @member {module:model/PromotionTiersList} promotion
 */
CampaignsGetResponseBody.prototype['promotion'] = undefined;

/**
 * @member {module:model/ValidationRulesAssignmentsList} validation_rules_assignments
 */
CampaignsGetResponseBody.prototype['validation_rules_assignments'] = undefined;
 ...
 * @readonly
 */
CampaignsGetResponseBody['CampaignTypeEnum'] = {
 ...
 * @readonly
 */
CampaignsGetResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
CampaignsGetResponseBody['ValidityDayOfWeekEnum'] = {
 ...
 * @readonly
 */
CampaignsGetResponseBody['CreationStatusEnum'] = {
 ...
 * @readonly
 */
CampaignsGetResponseBody['VouchersGenerationStatusEnum'] = {
...
export default CampaignsGetResponseBody;

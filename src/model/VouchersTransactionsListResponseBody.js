...
class VouchersTransactionsListResponseBody {
    ...
    constructor() { 
        ...
        VouchersTransactionsListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/VouchersTransactionsListResponseBody} The populated <code>VouchersTransactionsListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersTransactionsListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersTransactionsListResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersTransactionsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/VouchersTransactionsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
...
export default VouchersTransactionsListResponseBody;

...
class TemplatesCampaignsCampaignSetupCreateRequestBody {
     ...
     * @return {module:model/TemplatesCampaignsCampaignSetupCreateRequestBody} The populated <code>TemplatesCampaignsCampaignSetupCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsCampaignSetupCreateRequestBody</code>.
     */
 ...
 * @member {module:model/TemplatesCampaignsCampaignSetupCreateRequestBody.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/TemplatesCampaignsCampaignSetupCreateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/TemplatesCampaignsCampaignSetupCreateRequestBodyVoucher} voucher
 */

...
class PromotionTierAction {
     ...
     * @return {module:model/PromotionTierAction} The populated <code>PromotionTierAction</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTierAction</code>.
     */

...
class FieldConditions {
     ...
     * @return {module:model/FieldConditions} The populated <code>FieldConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldConditions</code>.
     */
...
/**
 * @member {module:model/FiltersCondition} conditions
 */

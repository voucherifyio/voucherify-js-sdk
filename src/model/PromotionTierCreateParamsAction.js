...
class PromotionTierCreateParamsAction {
     ...
     * @return {module:model/PromotionTierCreateParamsAction} The populated <code>PromotionTierCreateParamsAction</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTierCreateParamsAction</code>.
     */

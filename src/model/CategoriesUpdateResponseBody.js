...
class CategoriesUpdateResponseBody {
     ...
     * @return {module:model/CategoriesUpdateResponseBody} The populated <code>CategoriesUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesUpdateResponseBody</code>.
     */
...
/**
 * @member {module:model/CategoriesUpdateResponseBody.ObjectEnum} object
 * @default 'category'
 */

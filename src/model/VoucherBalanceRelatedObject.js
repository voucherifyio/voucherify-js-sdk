...
class VoucherBalanceRelatedObject {
    ...
    constructor() { 
        ...
        VoucherBalanceRelatedObject.initialize(this);
    }
     ...
     * @return {module:model/VoucherBalanceRelatedObject} The populated <code>VoucherBalanceRelatedObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherBalanceRelatedObject();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherBalanceRelatedObject</code>.
     */
 ...
 * @member {module:model/VoucherBalanceRelatedObject.TypeEnum} type
 * @default 'voucher'
 */
...
export default VoucherBalanceRelatedObject;

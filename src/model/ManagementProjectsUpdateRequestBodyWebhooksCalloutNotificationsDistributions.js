...
class ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions {
    ...
    constructor() { 
        ...
        ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions} The populated <code>ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions</code>.
     */
...
export default ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions;

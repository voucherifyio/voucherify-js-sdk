...
class EarningRuleSegment {
    ...
    constructor() { 
        ...
        EarningRuleSegment.initialize(this);
    }
     ...
     * @return {module:model/EarningRuleSegment} The populated <code>EarningRuleSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRuleSegment();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleSegment</code>.
     */
...
export default EarningRuleSegment;

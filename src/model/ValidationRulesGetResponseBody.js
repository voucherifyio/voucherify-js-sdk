...
class ValidationRulesGetResponseBody {
    ...
    constructor() { 
        ...
        ValidationRulesGetResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ValidationRulesGetResponseBody} The populated <code>ValidationRulesGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationRulesGetResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesGetResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['applicable_to']) { // data not null
          ValidationRulesGetResponseBodyApplicableTo.validateJSON(data['applicable_to']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ValidationRulesGetResponseBodyError} error
 */
ValidationRulesGetResponseBody.prototype['error'] = undefined;

/**
 * @member {module:model/ValidationRulesGetResponseBodyApplicableTo} applicable_to
 */
ValidationRulesGetResponseBody.prototype['applicable_to'] = undefined;

/**
 * Type of validation rule.
 * @member {module:model/ValidationRulesGetResponseBody.TypeEnum} type
 * @default 'expression'
 */
 ...
 * @member {module:model/ValidationRulesGetResponseBody.ContextTypeEnum} context_type
 * @default 'global'
 */
...
export default ValidationRulesGetResponseBody;

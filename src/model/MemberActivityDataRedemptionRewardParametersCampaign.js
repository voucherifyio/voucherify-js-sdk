...
class MemberActivityDataRedemptionRewardParametersCampaign {
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardParametersCampaign} The populated <code>MemberActivityDataRedemptionRewardParametersCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardParametersCampaign</code>.
     */

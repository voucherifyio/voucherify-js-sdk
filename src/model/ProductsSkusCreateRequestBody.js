...
class ProductsSkusCreateRequestBody {
     ...
     * @return {module:model/ProductsSkusCreateRequestBody} The populated <code>ProductsSkusCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsSkusCreateRequestBody</code>.
     */

...
class VouchersUpdateRequestBody {
     ...
     * @return {module:model/VouchersUpdateRequestBody} The populated <code>VouchersUpdateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersUpdateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/VouchersUpdateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @member {module:model/VouchersUpdateRequestBody.TypeEnum} type

...
class CreatePublicationCampaign {
     ...
     * @return {module:model/CreatePublicationCampaign} The populated <code>CreatePublicationCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePublicationCampaign</code>.
     */

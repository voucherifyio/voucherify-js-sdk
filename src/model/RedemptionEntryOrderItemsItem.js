...
class RedemptionEntryOrderItemsItem {
    ...
    constructor() { 
        ...
        RedemptionEntryOrderItemsItem.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntryOrderItemsItem} The populated <code>RedemptionEntryOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryOrderItemsItem();
            ...
            if (data.hasOwnProperty('product')) {
                obj['product'] = RedemptionEntryOrderItemsItemProduct.constructFromObject(data['product']);
            }
            if (data.hasOwnProperty('sku')) {
                obj['sku'] = RedemptionEntryOrderItemsItemSku.constructFromObject(data['sku']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryOrderItemsItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['product']) { // data not null
          RedemptionEntryOrderItemsItemProduct.validateJSON(data['product']);
        }
        // validate the optional field `sku`
        if (data['sku']) { // data not null
          RedemptionEntryOrderItemsItemSku.validateJSON(data['sku']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/RedemptionEntryOrderItemsItem.RelatedObjectEnum} related_object
 */
...
/**
 * @member {module:model/RedemptionEntryOrderItemsItemProduct} product
 */
RedemptionEntryOrderItemsItem.prototype['product'] = undefined;

/**
 * @member {module:model/RedemptionEntryOrderItemsItemSku} sku
 */
RedemptionEntryOrderItemsItem.prototype['sku'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/RedemptionEntryOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */
...
export default RedemptionEntryOrderItemsItem;

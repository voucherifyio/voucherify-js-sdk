...
class VouchersImportCreateItemRequestBody {
     ...
     * @return {module:model/VouchersImportCreateItemRequestBody} The populated <code>VouchersImportCreateItemRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersImportCreateItemRequestBody</code>.
     */
...
/**
 * @member {module:model/VouchersImportCreateItemRequestBodyRedemption} redemption
 */
 ...
 * @member {Array.<module:model/VouchersImportCreateItemRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersImportCreateItemRequestBody.TypeEnum} type
 */

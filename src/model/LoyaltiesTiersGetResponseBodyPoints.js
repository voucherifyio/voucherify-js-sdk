...
class LoyaltiesTiersGetResponseBodyPoints {
     ...
     * @return {module:model/LoyaltiesTiersGetResponseBodyPoints} The populated <code>LoyaltiesTiersGetResponseBodyPoints</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTiersGetResponseBodyPoints</code>.
     */

...
class ProductsSkusCreateResponseBody {
     ...
     * @return {module:model/ProductsSkusCreateResponseBody} The populated <code>ProductsSkusCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsSkusCreateResponseBody</code>.
     */
 ...
 * @member {module:model/ProductsSkusCreateResponseBody.ObjectEnum} object
 * @default 'sku'
 */

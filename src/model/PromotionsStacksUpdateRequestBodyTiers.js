...
class PromotionsStacksUpdateRequestBodyTiers {
     ...
     * @return {module:model/PromotionsStacksUpdateRequestBodyTiers} The populated <code>PromotionsStacksUpdateRequestBodyTiers</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsStacksUpdateRequestBodyTiers</code>.
     */
 ...
 * @member {module:model/PromotionsStacksUpdateRequestBodyTiers.HierarchyModeEnum} hierarchy_mode
 * @default 'MANUAL'
 */

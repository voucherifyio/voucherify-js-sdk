...
class ParameterFiltersListBinResourceType {
    ...
    constructor() { 
        ...
        ParameterFiltersListBinResourceType.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListBinResourceType} The populated <code>ParameterFiltersListBinResourceType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListBinResourceType();

            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ParameterFiltersListBinResourceTypeConditions.constructFromObject(data['conditions']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListBinResourceType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `conditions`
        if (data['conditions']) { // data not null
          ParameterFiltersListBinResourceTypeConditions.validateJSON(data['conditions']);
        }
...
/**
 * @member {module:model/ParameterFiltersListBinResourceTypeConditions} conditions
 */
...
export default ParameterFiltersListBinResourceType;

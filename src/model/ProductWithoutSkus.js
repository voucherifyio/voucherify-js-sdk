...
class ProductWithoutSkus {
     ...
     * @return {module:model/ProductWithoutSkus} The populated <code>ProductWithoutSkus</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductWithoutSkus</code>.
     */
 ...
 * @member {module:model/ProductWithoutSkus.ObjectEnum} object
 * @default 'product'
 */

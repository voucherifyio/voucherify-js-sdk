...
class LoyaltiesMembersPointsExpirationListResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesMembersPointsExpirationListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersPointsExpirationListResponseBody} The populated <code>LoyaltiesMembersPointsExpirationListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersPointsExpirationListResponseBody();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [LoyaltyPointsBucket]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPointsExpirationListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPointsExpirationListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesMembersPointsExpirationListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/LoyaltyPointsBucket>} data
 */
...
export default LoyaltiesMembersPointsExpirationListResponseBody;

...
class MemberActivityDataBalanceRelatedObject {
     ...
     * @return {module:model/MemberActivityDataBalanceRelatedObject} The populated <code>MemberActivityDataBalanceRelatedObject</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataBalanceRelatedObject</code>.
     */
 ...
 * @member {module:model/MemberActivityDataBalanceRelatedObject.TypeEnum} type
 * @default 'voucher'
 */

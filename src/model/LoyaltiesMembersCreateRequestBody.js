...
class LoyaltiesMembersCreateRequestBody {
     ...
     * @return {module:model/LoyaltiesMembersCreateRequestBody} The populated <code>LoyaltiesMembersCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersCreateRequestBody</code>.
     */

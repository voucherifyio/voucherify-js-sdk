...
class ValidationRulesUpdateRequestBodyApplicableTo {
     ...
     * @return {module:model/ValidationRulesUpdateRequestBodyApplicableTo} The populated <code>ValidationRulesUpdateRequestBodyApplicableTo</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesUpdateRequestBodyApplicableTo</code>.
     */

...
class RedemptionOrderReferrer {
    ...
    constructor() { 
        ...
        RedemptionOrderReferrer.initialize(this);
    }
     ...
     * @return {module:model/RedemptionOrderReferrer} The populated <code>RedemptionOrderReferrer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionOrderReferrer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionOrderReferrer</code>.
     */
 ...
 * @member {module:model/RedemptionOrderReferrer.ObjectEnum} object
 * @default 'customer'
 */
...
export default RedemptionOrderReferrer;

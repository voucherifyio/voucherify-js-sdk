...
class PromotionsTiersUpdateResponseBodyCampaign {
     ...
     * @alias module:model/PromotionsTiersUpdateResponseBodyCampaign
     */
    constructor() { 
     ...
     * @param {module:model/PromotionsTiersUpdateResponseBodyCampaign} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersUpdateResponseBodyCampaign} The populated <code>PromotionsTiersUpdateResponseBodyCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersUpdateResponseBodyCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersUpdateResponseBodyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

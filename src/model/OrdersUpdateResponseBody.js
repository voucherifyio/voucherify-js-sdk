...
class OrdersUpdateResponseBody {
     ...
     * @alias OrdersUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<OrdersUpdateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {OrdersUpdateResponseBody} [obj] Optional instance to populate.
     * @returns {OrdersUpdateResponseBody} The populated <code>OrdersUpdateResponseBody</code> instance.
     */
     ...
     * @param {Partial<OrdersUpdateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersUpdateResponseBody</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof OrdersUpdateResponseBody.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof OrdersUpdateResponseBody.ObjectEnum) | undefined}
    * @default 'order'
    */

...
class OrdersUpdateResponseBody {
    /**
     * Constructs a new <code>OrdersUpdateResponseBody</code>.
     * Response body schema for **PUT** &#x60;v1/orders/{orderId}&#x60;.
     * @alias module:model/OrdersUpdateResponseBody
     */
    constructor() { 
        
        OrdersUpdateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrdersUpdateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrdersUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/OrdersUpdateResponseBody} The populated <code>OrdersUpdateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersUpdateResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>OrdersUpdateResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersUpdateResponseBody</code>.
     */
 ...
 * @member {String} id
 */
OrdersUpdateResponseBody.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
OrdersUpdateResponseBody.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/OrdersUpdateResponseBody.StatusEnum} status
 */
OrdersUpdateResponseBody.prototype['status'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['initial_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['items_discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['total_discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['total_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['applied_discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
OrdersUpdateResponseBody.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/OrdersUpdateResponseBody.ObjectEnum} object
 * @default 'order'
 */
OrdersUpdateResponseBody.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
OrdersUpdateResponseBody.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
OrdersUpdateResponseBody.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
OrdersUpdateResponseBody.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
OrdersUpdateResponseBody.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
OrdersUpdateResponseBody.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
OrdersUpdateResponseBody.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
OrdersUpdateResponseBody.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
OrdersUpdateResponseBody.prototype['items'] = undefined;
 ...
 * @readonly
 */
OrdersUpdateResponseBody['StatusEnum'] = {
 ...
 * @readonly
 */
OrdersUpdateResponseBody['ObjectEnum'] = {
...
export default OrdersUpdateResponseBody;

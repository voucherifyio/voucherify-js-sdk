...
class LoyaltyCardTransaction {
     ...
     * @return {module:model/LoyaltyCardTransaction} The populated <code>LoyaltyCardTransaction</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCardTransaction</code>.
     */
...
/**
 * @member {module:model/LoyaltyCardTransactionDetails} details
 */
LoyaltyCardTransaction.prototype['details'] = undefined;

/**
 * @member {module:model/LoyaltyCardTransactionsType} type
 */

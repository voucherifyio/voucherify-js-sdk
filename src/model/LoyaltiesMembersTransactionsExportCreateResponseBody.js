...
class LoyaltiesMembersTransactionsExportCreateResponseBody {
     ...
     * @return {module:model/LoyaltiesMembersTransactionsExportCreateResponseBody} The populated <code>LoyaltiesMembersTransactionsExportCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransactionsExportCreateResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersTransactionsExportCreateResponseBody.ObjectEnum} object
 * @default 'export'
 */
 ...
 * @member {module:model/LoyaltiesMembersTransactionsExportCreateResponseBody.StatusEnum} status
 * @default 'SCHEDULED'
 */
 ...
 * @member {module:model/LoyaltiesMembersTransactionsExportCreateResponseBody.ExportedObjectEnum} exported_object
...
/**
 * @member {module:model/LoyaltiesMembersTransactionsExportCreateResponseBodyParameters} parameters
 */

...
class ProductsGetResponseBody {
     ...
     * @alias module:model/ProductsGetResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ProductsGetResponseBody} obj Optional instance to populate.
     * @return {module:model/ProductsGetResponseBody} The populated <code>ProductsGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsGetResponseBody</code>.
     */
 ...
 * @member {module:model/ProductsGetResponseBody.ObjectEnum} object
 * @default 'product'
 */
ProductsGetResponseBody.prototype['object'] = 'product';

/**
 * @member {module:model/SkusListForProduct} skus
 */

...
class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent} The populated <code>LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata.constructFromObject(data['metadata']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent</code>.
     */
    static validateJSON(data) {
        // validate the optional field `metadata`
        if (data['metadata']) { // data not null
          LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata.validateJSON(data['metadata']);
        }
...
/**
 * @member {module:model/LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata} metadata
 */
...
export default LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent;

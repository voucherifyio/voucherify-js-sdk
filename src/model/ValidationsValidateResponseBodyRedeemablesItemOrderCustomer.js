...
class ValidationsValidateResponseBodyRedeemablesItemOrderCustomer {
    ...
    constructor() { 
        ...
        ValidationsValidateResponseBodyRedeemablesItemOrderCustomer.initialize(this);
    }
     ...
     * @return {module:model/ValidationsValidateResponseBodyRedeemablesItemOrderCustomer} The populated <code>ValidationsValidateResponseBodyRedeemablesItemOrderCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationsValidateResponseBodyRedeemablesItemOrderCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyRedeemablesItemOrderCustomer</code>.
     */
 ...
 * @member {module:model/ValidationsValidateResponseBodyRedeemablesItemOrderCustomer.ObjectEnum} object
 * @default 'customer'
 */
...
export default ValidationsValidateResponseBodyRedeemablesItemOrderCustomer;

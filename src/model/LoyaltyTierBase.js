...
class LoyaltyTierBase {
     ...
     * @return {module:model/LoyaltyTierBase} The populated <code>LoyaltyTierBase</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTierBase</code>.
     */

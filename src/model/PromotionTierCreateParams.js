...
class PromotionTierCreateParams {
     ...
     * @alias module:model/PromotionTierCreateParams
     */
    constructor() { 
     ...
     * @param {module:model/PromotionTierCreateParams} obj Optional instance to populate.
     * @return {module:model/PromotionTierCreateParams} The populated <code>PromotionTierCreateParams</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTierCreateParams</code>.
     */
...
/**
 * @member {module:model/PromotionTierCreateParamsAction} action
 */
 ...
 * @member {Array.<module:model/PromotionTierCreateParams.ValidityDayOfWeekEnum>} validity_day_of_week
 */

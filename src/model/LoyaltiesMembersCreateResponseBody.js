...
class LoyaltiesMembersCreateResponseBody {
     ...
     * @alias module:model/LoyaltiesMembersCreateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/LoyaltiesMembersCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/LoyaltiesMembersCreateResponseBody} The populated <code>LoyaltiesMembersCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersCreateResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersCreateResponseBody.TypeEnum} type
...
/**
 * @member {module:model/LoyaltiesMembersCreateResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/LoyaltiesMembersCreateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/LoyaltiesMembersCreateResponseBodyPublish} publish
 */
LoyaltiesMembersCreateResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/LoyaltiesMembersCreateResponseBodyRedemption} redemption
 */

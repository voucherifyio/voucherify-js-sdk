...
import LoyaltiesMembersCreateResponseBodyLoyaltyCard from './LoyaltiesMembersCreateResponseBodyLoyaltyCard';
import LoyaltiesMembersCreateResponseBodyPublish from './LoyaltiesMembersCreateResponseBodyPublish';
import LoyaltiesMembersCreateResponseBodyRedemption from './LoyaltiesMembersCreateResponseBodyRedemption';
...
class LoyaltiesMembersCreateResponseBody {
    /**
     * Constructs a new <code>LoyaltiesMembersCreateResponseBody</code>.
     * Respone body schema for assigning a loyalty card to a customer using **POST** &#x60;/loyalties/{campaignId}/members&#x60;.
     * @alias LoyaltiesMembersCreateResponseBody
     */
    constructor() { 
        
        LoyaltiesMembersCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoyaltiesMembersCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<LoyaltiesMembersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {LoyaltiesMembersCreateResponseBody} [obj] Optional instance to populate.
     * @returns {LoyaltiesMembersCreateResponseBody} The populated <code>LoyaltiesMembersCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersCreateResponseBody();
            ...
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = LoyaltiesMembersCreateResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = LoyaltiesMembersCreateResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = LoyaltiesMembersCreateResponseBodyRedemption.constructFromObject(data['redemption']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoyaltiesMembersCreateResponseBody</code>.
     * @param {Partial<LoyaltiesMembersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersCreateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['loyalty_card']) { // data not null
          LoyaltiesMembersCreateResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          LoyaltiesMembersCreateResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          LoyaltiesMembersCreateResponseBodyRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
LoyaltiesMembersCreateResponseBody.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof LoyaltiesMembersCreateResponseBody.TypeEnum) | undefined}
    * @default 'LOYALTY_CARD'
    */
LoyaltiesMembersCreateResponseBody.prototype['type'] = 'LOYALTY_CARD';

/**
    * @type {Object | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['discount'] = undefined;

/**
    * @type {Object | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['gift'] = undefined;

/**
    * @type {LoyaltiesMembersCreateResponseBodyLoyaltyCard | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof LoyaltiesMembersCreateResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
LoyaltiesMembersCreateResponseBody.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['assets'] = undefined;

/**
    * This is always false for loyalty members.
    * @type {Boolean | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['updated_at'] = undefined;

/**
    * Unique identifier of the customer who owns the voucher.
    * @type {String | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['holder_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
LoyaltiesMembersCreateResponseBody.prototype['object'] = 'voucher';

/**
    * @type {LoyaltiesMembersCreateResponseBodyPublish | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['publish'] = undefined;

/**
    * @type {LoyaltiesMembersCreateResponseBodyRedemption | undefined}
    */
LoyaltiesMembersCreateResponseBody.prototype['redemption'] = undefined;
     ...
     * @readonly
     */
    LoyaltiesMembersCreateResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
LoyaltiesMembersCreateResponseBody['ValidityDayOfWeekEnum'] = {
...
export default LoyaltiesMembersCreateResponseBody;

...
class OrderCalculatedItem {
     ...
     * @return {module:model/OrderCalculatedItem} The populated <code>OrderCalculatedItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCalculatedItem</code>.
     */

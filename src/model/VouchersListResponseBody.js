...
class VouchersListResponseBody {
     ...
     * @return {module:model/VouchersListResponseBody} The populated <code>VouchersListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersListResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/VouchersListResponseBody.DataRefEnum} data_ref
 * @default 'vouchers'
 */
 ...
 * @member {Array.<module:model/VoucherWithCategories>} vouchers
 */

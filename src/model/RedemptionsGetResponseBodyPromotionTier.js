...
class RedemptionsGetResponseBodyPromotionTier {
     ...
     * @alias module:model/RedemptionsGetResponseBodyPromotionTier
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionsGetResponseBodyPromotionTier} obj Optional instance to populate.
     * @return {module:model/RedemptionsGetResponseBodyPromotionTier} The populated <code>RedemptionsGetResponseBodyPromotionTier</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyPromotionTier</code>.
     */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyPromotionTierAction} action
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyPromotionTierCampaign} campaign
 */
 ...
 * @member {Array.<module:model/RedemptionsGetResponseBodyPromotionTier.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyPromotionTierSummary} summary
 */

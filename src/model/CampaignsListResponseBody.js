...
class CampaignsListResponseBody {
     ...
     * @return {module:model/CampaignsListResponseBody} The populated <code>CampaignsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/CampaignBase>} campaigns
 */

...
class ProductCollectionsItem {
     ...
     * @return {module:model/ProductCollectionsItem} The populated <code>ProductCollectionsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsItem</code>.
     */
 ...
 * @member {module:model/ProductCollectionsItem.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/ProductCollectionsItemProductsItem>} products
 */
 ...
 * @member {module:model/ProductCollectionsItem.ObjectEnum} object

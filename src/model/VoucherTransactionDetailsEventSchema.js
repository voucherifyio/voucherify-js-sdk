...
class VoucherTransactionDetailsEventSchema {
     ...
     * @return {module:model/VoucherTransactionDetailsEventSchema} The populated <code>VoucherTransactionDetailsEventSchema</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionDetailsEventSchema</code>.
     */

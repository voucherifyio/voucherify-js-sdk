...
/**
 * The ManagementProjectsStackingRulesCreateResponseBody model module.
 * @module model/ManagementProjectsStackingRulesCreateResponseBody
 * @version v2018-08-01
 */
class ManagementProjectsStackingRulesCreateResponseBody {
    /**
     * Constructs a new <code>ManagementProjectsStackingRulesCreateResponseBody</code>.
     * Response body schema for **POST** &#x60;/management/v1/projects/{projectId}/stacking-rules&#x60;.
     * @alias module:model/ManagementProjectsStackingRulesCreateResponseBody
     */
    constructor() { 
        
        ManagementProjectsStackingRulesCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ManagementProjectsStackingRulesCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ManagementProjectsStackingRulesCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/ManagementProjectsStackingRulesCreateResponseBody} The populated <code>ManagementProjectsStackingRulesCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsStackingRulesCreateResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>ManagementProjectsStackingRulesCreateResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsStackingRulesCreateResponseBody</code>.
     */
 ...
 * @member {String} id
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['id'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['exclusive_categories'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['joint_categories'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_limit'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['applicable_redeemables_limit'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['applicable_redeemables_per_category_limit'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['applicable_redeemables_category_limits'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['applicable_exclusive_redeemables_limit'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['applicable_exclusive_redeemables_per_category_limit'] = undefined;

/**
 * Defines if the discounts are applied by taking into account the initial order amount or the discounted order amount.
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.DiscountCalculationModeEnum} discount_calculation_mode
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['discount_calculation_mode'] = undefined;

/**
 * Lists the IDs of the categories that apply a discount based on the initial amount.
 * @member {Array.<String>} initial_amount_mode_categories
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['initial_amount_mode_categories'] = undefined;

/**
 * Lists the IDs of the categories that apply a discount based on the discounted amount.
 * @member {Array.<String>} discounted_amount_mode_categories
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['discounted_amount_mode_categories'] = undefined;
 ...
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.RedeemablesApplicationModeEnum} redeemables_application_mode
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_application_mode'] = undefined;
 ...
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.RedeemablesSortingRuleEnum} redeemables_sorting_rule
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_sorting_rule'] = undefined;
 ...
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.RedeemablesProductsApplicationModeEnum} redeemables_products_application_mode
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_products_application_mode'] = undefined;
 ...
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.RedeemablesNoEffectRuleEnum} redeemables_no_effect_rule
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_no_effect_rule'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['no_effect_skip_categories'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['no_effect_redeem_anyway_categories'] = undefined;
 ...
 * @member {module:model/ManagementProjectsStackingRulesCreateResponseBody.RedeemablesRollbackOrderModeEnum} redeemables_rollback_order_mode
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['redeemables_rollback_order_mode'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['created_at'] = undefined;
 ...
 */
ManagementProjectsStackingRulesCreateResponseBody.prototype['updated_at'] = undefined;
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['DiscountCalculationModeEnum'] = {
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['RedeemablesApplicationModeEnum'] = {
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['RedeemablesSortingRuleEnum'] = {
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['RedeemablesProductsApplicationModeEnum'] = {
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['RedeemablesNoEffectRuleEnum'] = {
 ...
 * @readonly
 */
ManagementProjectsStackingRulesCreateResponseBody['RedeemablesRollbackOrderModeEnum'] = {
...
export default ManagementProjectsStackingRulesCreateResponseBody;

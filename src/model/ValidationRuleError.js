...
class ValidationRuleError {
     ...
     * @return {module:model/ValidationRuleError} The populated <code>ValidationRuleError</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRuleError</code>.
     */

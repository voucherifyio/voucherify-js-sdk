...
class QualificationsOptionFiltersHolderRole {
     ...
     * @return {module:model/QualificationsOptionFiltersHolderRole} The populated <code>QualificationsOptionFiltersHolderRole</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsOptionFiltersHolderRole</code>.
     */
...
/**
 * @member {module:model/QualificationsOptionFiltersHolderRoleConditions} conditions
 */

...
class ParameterFiltersListTemplatesName {
    ...
    constructor() { 
        ...
        ParameterFiltersListTemplatesName.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListTemplatesName} The populated <code>ParameterFiltersListTemplatesName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListTemplatesName();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListTemplatesName</code>.
     */
...
export default ParameterFiltersListTemplatesName;

...
class RedemptionVoucherRedemption {
    ...
    constructor() { 
        ...
        RedemptionVoucherRedemption.initialize(this);
    }
     ...
     * @return {module:model/RedemptionVoucherRedemption} The populated <code>RedemptionVoucherRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionVoucherRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionVoucherRedemption</code>.
     */
...
export default RedemptionVoucherRedemption;

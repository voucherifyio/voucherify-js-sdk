...
class SimpleRedemptionChannel {
     ...
     * @return {module:model/SimpleRedemptionChannel} The populated <code>SimpleRedemptionChannel</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleRedemptionChannel</code>.
     */
 ...
 * @member {module:model/SimpleRedemptionChannel.ChannelTypeEnum} channel_type
 */

...
class SimplePromotionTier {
     ...
     * @return {module:model/SimplePromotionTier} The populated <code>SimplePromotionTier</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePromotionTier</code>.
     */
...
/**
 * @member {module:model/SimplePromotionTierCampaign} campaign
 */

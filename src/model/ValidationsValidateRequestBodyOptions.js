...
class ValidationsValidateRequestBodyOptions {
     ...
     * @return {module:model/ValidationsValidateRequestBodyOptions} The populated <code>ValidationsValidateRequestBodyOptions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateRequestBodyOptions</code>.
     */
 ...
 * @member {Array.<module:model/ValidationsValidateRequestBodyOptions.ExpandEnum>} expand
 */

...
class LoyaltiesEarningRulesUpdateResponseBodyLoyalty {
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyalty} The populated <code>LoyaltiesEarningRulesUpdateResponseBodyLoyalty</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateResponseBodyLoyalty</code>.
     */
...
/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyalty.TypeEnum} type
 */
...
/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyalty.CalculationTypeEnum} calculation_type
 */
LoyaltiesEarningRulesUpdateResponseBodyLoyalty.prototype['calculation_type'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder} order
 */
LoyaltiesEarningRulesUpdateResponseBodyLoyalty.prototype['order'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems} order_items
 */
LoyaltiesEarningRulesUpdateResponseBodyLoyalty.prototype['order_items'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer} customer
 */
LoyaltiesEarningRulesUpdateResponseBodyLoyalty.prototype['customer'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent} custom_event
 */

...
class ManagementProjectsBrandingUpdateResponseBodyBrand {
    ...
    constructor() { 
        ...
        ManagementProjectsBrandingUpdateResponseBodyBrand.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsBrandingUpdateResponseBodyBrand} The populated <code>ManagementProjectsBrandingUpdateResponseBodyBrand</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsBrandingUpdateResponseBodyBrand();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsBrandingUpdateResponseBodyBrand</code>.
     */
...
export default ManagementProjectsBrandingUpdateResponseBodyBrand;

...
class ParameterFiltersListTemplatesCampaignTypeConditions {
    ...
    constructor() { 
        ...
        ParameterFiltersListTemplatesCampaignTypeConditions.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListTemplatesCampaignTypeConditions} The populated <code>ParameterFiltersListTemplatesCampaignTypeConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListTemplatesCampaignTypeConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListTemplatesCampaignTypeConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListTemplatesCampaignTypeConditions.InEnum>} $in
 */
ParameterFiltersListTemplatesCampaignTypeConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListTemplatesCampaignTypeConditions.NotInEnum>} $not_in
 */
ParameterFiltersListTemplatesCampaignTypeConditions.prototype['$not_in'] = undefined;

/**
 * Value is exactly this value (single value).
 * @member {module:model/ParameterFiltersListTemplatesCampaignTypeConditions.IsEnum} $is
 */
ParameterFiltersListTemplatesCampaignTypeConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListTemplatesCampaignTypeConditions.IsNotEnum} $is_not
 */
 ...
 * @readonly
 */
ParameterFiltersListTemplatesCampaignTypeConditions['InEnum'] = {
 ...
 * @readonly
 */
ParameterFiltersListTemplatesCampaignTypeConditions['NotInEnum'] = {
...
export default ParameterFiltersListTemplatesCampaignTypeConditions;

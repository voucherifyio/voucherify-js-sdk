...
class MemberActivityDataOrderItemsItemProduct {
    /**
     * Constructs a new <code>MemberActivityDataOrderItemsItemProduct</code>.
     * An object containing details of the related product.
     * @alias MemberActivityDataOrderItemsItemProduct
     */
    constructor() { 
        
        MemberActivityDataOrderItemsItemProduct.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MemberActivityDataOrderItemsItemProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<MemberActivityDataOrderItemsItemProduct>} data The plain JavaScript object bearing properties of interest.
     * @param {MemberActivityDataOrderItemsItemProduct} [obj] Optional instance to populate.
     * @returns {MemberActivityDataOrderItemsItemProduct} The populated <code>MemberActivityDataOrderItemsItemProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataOrderItemsItemProduct();
    ...
    /**
     * Validates the JSON data with respect to <code>MemberActivityDataOrderItemsItemProduct</code>.
     * @param {Partial<MemberActivityDataOrderItemsItemProduct>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataOrderItemsItemProduct</code>.
     */
...
/**
    ...
    */
MemberActivityDataOrderItemsItemProduct.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
MemberActivityDataOrderItemsItemProduct.prototype['source_id'] = undefined;
...
/**
    ...
    */
MemberActivityDataOrderItemsItemProduct.prototype['override'] = undefined;

/**
    * Product name.
    * @type {String | undefined}
    */
MemberActivityDataOrderItemsItemProduct.prototype['name'] = undefined;
...
/**
    ...
    */
MemberActivityDataOrderItemsItemProduct.prototype['metadata'] = undefined;

/**
    * Product price. A positive integer in the smallest currency unit (e.g. 100 cents for $1.00).
    * @type {Number | undefined}
    */
MemberActivityDataOrderItemsItemProduct.prototype['price'] = undefined;
...
export default MemberActivityDataOrderItemsItemProduct;

...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata} The populated <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata</code>.
     */
...
export default LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata;

...
class LoyaltiesEarningRulesCreateResponseBodySource {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesCreateResponseBodySource.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateResponseBodySource} The populated <code>LoyaltiesEarningRulesCreateResponseBodySource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesCreateResponseBodySource();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateResponseBodySource</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesCreateResponseBodySource.ObjectTypeEnum} object_type
 * @default 'campaign'
 */
...
export default LoyaltiesEarningRulesCreateResponseBodySource;

...
class OrderCalculatedItemSku {
     ...
     * @alias module:model/OrderCalculatedItemSku
     */
    constructor() { 
     ...
     * @param {module:model/OrderCalculatedItemSku} obj Optional instance to populate.
     * @returns {module:model/OrderCalculatedItemSku} The populated <code>OrderCalculatedItemSku</code> instance.
     */

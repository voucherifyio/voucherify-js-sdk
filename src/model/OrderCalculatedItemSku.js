...
/**
 * The OrderCalculatedItemSku model module.
 * @module model/OrderCalculatedItemSku
 * @version 3.0.2
 */
class OrderCalculatedItemSku {
    /**
     * Constructs a new <code>OrderCalculatedItemSku</code>.
     * An object containing details of the related SKU.
     * @alias OrderCalculatedItemSku
     */
    constructor() { 
        
        OrderCalculatedItemSku.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderCalculatedItemSku</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<OrderCalculatedItemSku>} data The plain JavaScript object bearing properties of interest.
     * @param {OrderCalculatedItemSku} [obj] Optional instance to populate.
     * @returns {OrderCalculatedItemSku} The populated <code>OrderCalculatedItemSku</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCalculatedItemSku();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCalculatedItemSku</code>.
     * @param {Partial<OrderCalculatedItemSku>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCalculatedItemSku</code>.
     */
...
/**
    ...
    */
OrderCalculatedItemSku.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
OrderCalculatedItemSku.prototype['source_id'] = undefined;
...
/**
    ...
    */
OrderCalculatedItemSku.prototype['override'] = undefined;

/**
    * The SKU name.
    * @type {String | undefined}
    */
OrderCalculatedItemSku.prototype['sku'] = undefined;

/**
    * SKU price. A positive integer in the smallest currency unit (e.g. 100 cents for $1.00).
    * @type {Number | undefined}
    */
OrderCalculatedItemSku.prototype['price'] = undefined;
...
/**
    ...
    */
OrderCalculatedItemSku.prototype['metadata'] = undefined;
...
export default OrderCalculatedItemSku;

...
class LoyaltiesLoyaltyTierReward {
     ...
     * @return {module:model/LoyaltiesLoyaltyTierReward} The populated <code>LoyaltiesLoyaltyTierReward</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesLoyaltyTierReward</code>.
     */
...
/**
 * @member {module:model/RewardAssignment} assignment
 */
 ...
 * @member {module:model/LoyaltiesLoyaltyTierReward.ObjectEnum} object

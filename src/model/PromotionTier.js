...
import PromotionTierAction from './PromotionTierAction';
import PromotionTierCampaign from './PromotionTierCampaign';
import PromotionTierSummary from './PromotionTierSummary';
...
class PromotionTier {
    /**
     * Constructs a new <code>PromotionTier</code>.
     ...
     * @alias module:model/PromotionTier
     */
    constructor() { 
        
        PromotionTier.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionTier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionTier} obj Optional instance to populate.
     * @return {module:model/PromotionTier} The populated <code>PromotionTier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionTier();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = PromotionTierAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = PromotionTierCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = PromotionTierSummary.constructFromObject(data['summary']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionTier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTier</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          PromotionTierAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['campaign']) { // data not null
          PromotionTierCampaign.validateJSON(data['campaign']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          PromotionTierSummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
PromotionTier.prototype['id'] = undefined;
 ...
 */
PromotionTier.prototype['created_at'] = undefined;
 ...
 */
PromotionTier.prototype['updated_at'] = undefined;

/**
 * Name of the promotion tier.
 * @member {String} name
 */
PromotionTier.prototype['name'] = undefined;

/**
 * Text to be displayed to your customers on your website.
 * @member {String} banner
 */
PromotionTier.prototype['banner'] = undefined;

/**
 * @member {module:model/PromotionTierAction} action
 */
PromotionTier.prototype['action'] = undefined;
 ...
 */
PromotionTier.prototype['metadata'] = undefined;
 ...
 */
PromotionTier.prototype['hierarchy'] = undefined;

/**
 * Promotion unique ID.
 * @member {String} promotion_id
 */
PromotionTier.prototype['promotion_id'] = undefined;

/**
 * @member {module:model/PromotionTierCampaign} campaign
 */
PromotionTier.prototype['campaign'] = undefined;

/**
 * Promotion tier's parent campaign's unique ID.
 * @member {String} campaign_id
 */
PromotionTier.prototype['campaign_id'] = undefined;
 ...
 */
PromotionTier.prototype['active'] = undefined;
 ...
 */
PromotionTier.prototype['start_date'] = undefined;
 ...
 */
PromotionTier.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
PromotionTier.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/PromotionTier.ValidityDayOfWeekEnum>} validity_day_of_week
 */
PromotionTier.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
PromotionTier.prototype['validity_hours'] = undefined;

/**
 * @member {module:model/PromotionTierSummary} summary
 */
PromotionTier.prototype['summary'] = undefined;
 ...
 */
PromotionTier.prototype['object'] = 'promotion_tier';

/**
 * @member {module:model/ValidationRuleAssignmentsList} validation_rule_assignments
 */
PromotionTier.prototype['validation_rule_assignments'] = undefined;

/**
 * Promotion tier category ID.
 * @member {String} category_id
 */
PromotionTier.prototype['category_id'] = undefined;

/**
 * @member {Array.<module:model/Category>} categories
 */
PromotionTier.prototype['categories'] = undefined;
 ...
 * @readonly
 */
PromotionTier['ValidityDayOfWeekEnum'] = {

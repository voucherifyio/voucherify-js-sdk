...
class PromotionTier {
     ...
     * @param {Partial<PromotionTier>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionTier} [obj] Optional instance to populate.
     * @returns {PromotionTier} The populated <code>PromotionTier</code> instance.
     */
     ...
     * @param {Partial<PromotionTier>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTier</code>.
     */
...
/**
    * @type {PromotionTierAction | undefined}
    */
...
/**
    * @type {PromotionTierCampaign | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof PromotionTier.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {PromotionTierSummary | undefined}
    */

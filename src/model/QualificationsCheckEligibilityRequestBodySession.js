...
class QualificationsCheckEligibilityRequestBodySession {
     ...
     * @return {module:model/QualificationsCheckEligibilityRequestBodySession} The populated <code>QualificationsCheckEligibilityRequestBodySession</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsCheckEligibilityRequestBodySession</code>.
     */
 ...
 * @member {module:model/QualificationsCheckEligibilityRequestBodySession.TypeEnum} type
 * @default 'LOCK'
 */

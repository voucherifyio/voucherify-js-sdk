...
class RedemptionsRedeemResponseBodyOrder {
     ...
     * @alias RedemptionsRedeemResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<RedemptionsRedeemResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionsRedeemResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {RedemptionsRedeemResponseBodyOrder} The populated <code>RedemptionsRedeemResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<RedemptionsRedeemResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRedeemResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof RedemptionsRedeemResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof RedemptionsRedeemResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
...
/**
    ...
    * @type {Array.<RedemptionsRedeemResponseBodyOrderItemsItem> | undefined}
    */

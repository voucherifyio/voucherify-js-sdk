...
import RedemptionsRedeemResponseBodyOrderItemsItem from './RedemptionsRedeemResponseBodyOrderItemsItem';
...
class RedemptionsRedeemResponseBodyOrder {
    /**
     * Constructs a new <code>RedemptionsRedeemResponseBodyOrder</code>.
     * Contains the order details associated with the redemption.
     * @alias module:model/RedemptionsRedeemResponseBodyOrder
     */
    constructor() { 
        
        RedemptionsRedeemResponseBodyOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionsRedeemResponseBodyOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedemptionsRedeemResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionsRedeemResponseBodyOrder} The populated <code>RedemptionsRedeemResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsRedeemResponseBodyOrder();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [RedemptionsRedeemResponseBodyOrderItemsItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionsRedeemResponseBodyOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRedeemResponseBodyOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                RedemptionsRedeemResponseBodyOrderItemsItem.validateJSON(item);
            };
        }
 ...
 * @member {String} id
 */
RedemptionsRedeemResponseBodyOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
RedemptionsRedeemResponseBodyOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/RedemptionsRedeemResponseBodyOrder.StatusEnum} status
 */
RedemptionsRedeemResponseBodyOrder.prototype['status'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['initial_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['total_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
RedemptionsRedeemResponseBodyOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/RedemptionsRedeemResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
RedemptionsRedeemResponseBodyOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
RedemptionsRedeemResponseBodyOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
RedemptionsRedeemResponseBodyOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
RedemptionsRedeemResponseBodyOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
RedemptionsRedeemResponseBodyOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
RedemptionsRedeemResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
RedemptionsRedeemResponseBodyOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
RedemptionsRedeemResponseBodyOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/RedemptionsRedeemResponseBodyOrderItemsItem>} items
 */
RedemptionsRedeemResponseBodyOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
RedemptionsRedeemResponseBodyOrder['StatusEnum'] = {
 ...
 * @readonly
 */
RedemptionsRedeemResponseBodyOrder['ObjectEnum'] = {
...
export default RedemptionsRedeemResponseBodyOrder;

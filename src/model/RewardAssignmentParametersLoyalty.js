...
class RewardAssignmentParametersLoyalty {
     ...
     * @return {module:model/RewardAssignmentParametersLoyalty} The populated <code>RewardAssignmentParametersLoyalty</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardAssignmentParametersLoyalty</code>.
     */

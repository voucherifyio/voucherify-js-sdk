...
class MemberActivityDataRedemptionRewardCustomer {
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardCustomer} The populated <code>MemberActivityDataRedemptionRewardCustomer</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardCustomer</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionRewardCustomer.ObjectEnum} object
 * @default 'customer'
 */

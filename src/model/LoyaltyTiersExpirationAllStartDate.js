...
class LoyaltyTiersExpirationAllStartDate {
     ...
     * @return {module:model/LoyaltyTiersExpirationAllStartDate} The populated <code>LoyaltyTiersExpirationAllStartDate</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTiersExpirationAllStartDate</code>.
     */
 ...
 * @member {module:model/LoyaltyTiersExpirationAllStartDate.TypeEnum} type
 */

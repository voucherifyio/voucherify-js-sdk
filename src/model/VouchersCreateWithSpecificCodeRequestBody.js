...
class VouchersCreateWithSpecificCodeRequestBody {
     ...
     * @return {module:model/VouchersCreateWithSpecificCodeRequestBody} The populated <code>VouchersCreateWithSpecificCodeRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersCreateWithSpecificCodeRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/VouchersCreateWithSpecificCodeRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersCreateWithSpecificCodeRequestBodyRedemption} redemption
 */
VouchersCreateWithSpecificCodeRequestBody.prototype['redemption'] = undefined;

/**
 * @member {module:model/VouchersCreateWithSpecificCodeRequestBody.TypeEnum} type
 */

...
class PromotionsStacksGetResponseBody {
     ...
     * @return {module:model/PromotionsStacksGetResponseBody} The populated <code>PromotionsStacksGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsStacksGetResponseBody</code>.
     */
...
/**
 * @member {module:model/PromotionsStacksGetResponseBodyTiers} tiers
 */
 ...
 * @member {module:model/PromotionsStacksGetResponseBody.ObjectEnum} object

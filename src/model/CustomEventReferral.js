...
class CustomEventReferral {
     ...
     * @return {module:model/CustomEventReferral} The populated <code>CustomEventReferral</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomEventReferral</code>.
     */

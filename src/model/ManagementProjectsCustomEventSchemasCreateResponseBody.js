...
class ManagementProjectsCustomEventSchemasCreateResponseBody {
    ...
    constructor() { 
        ...
        ManagementProjectsCustomEventSchemasCreateResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsCustomEventSchemasCreateResponseBody} The populated <code>ManagementProjectsCustomEventSchemasCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsCustomEventSchemasCreateResponseBody();
            ...
            if (data.hasOwnProperty('schema')) {
                obj['schema'] = ManagementProjectsCustomEventSchemasCreateResponseBodySchema.constructFromObject(data['schema']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchemasCreateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['schema']) { // data not null
          ManagementProjectsCustomEventSchemasCreateResponseBodySchema.validateJSON(data['schema']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ManagementProjectsCustomEventSchemasCreateResponseBodySchema} schema
 */
 ...
 * @member {module:model/ManagementProjectsCustomEventSchemasCreateResponseBody.ObjectEnum} object
...
export default ManagementProjectsCustomEventSchemasCreateResponseBody;

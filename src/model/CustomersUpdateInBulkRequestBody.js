...
class CustomersUpdateInBulkRequestBody {
    ...
    constructor() { 
        ...
        CustomersUpdateInBulkRequestBody.initialize(this);
    }
     ...
     * @return {module:model/CustomersUpdateInBulkRequestBody} The populated <code>CustomersUpdateInBulkRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomersUpdateInBulkRequestBody();
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = CustomersUpdateInBulkRequestBodyAddress.constructFromObject(data['address']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersUpdateInBulkRequestBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['address']) { // data not null
          CustomersUpdateInBulkRequestBodyAddress.validateJSON(data['address']);
        }
...
/**
 * @member {module:model/CustomersUpdateInBulkRequestBodyAddress} address
 */
...
export default CustomersUpdateInBulkRequestBody;

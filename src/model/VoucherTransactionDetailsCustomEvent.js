...
class VoucherTransactionDetailsCustomEvent {
    ...
    constructor() { 
        ...
        VoucherTransactionDetailsCustomEvent.initialize(this);
    }
     ...
     * @return {module:model/VoucherTransactionDetailsCustomEvent} The populated <code>VoucherTransactionDetailsCustomEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherTransactionDetailsCustomEvent();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionDetailsCustomEvent</code>.
     */
...
export default VoucherTransactionDetailsCustomEvent;

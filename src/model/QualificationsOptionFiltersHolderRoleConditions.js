...
class QualificationsOptionFiltersHolderRoleConditions {
     ...
     * @return {module:model/QualificationsOptionFiltersHolderRoleConditions} The populated <code>QualificationsOptionFiltersHolderRoleConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsOptionFiltersHolderRoleConditions</code>.
     */
 ...
 * @member {Array.<module:model/QualificationsOptionFiltersHolderRoleConditions.IsEnum>} $is
 */
QualificationsOptionFiltersHolderRoleConditions.prototype['$is'] = undefined;

/**
 * Will return records only for the first value in the array.
 * @member {Array.<module:model/QualificationsOptionFiltersHolderRoleConditions.IsNotEnum>} $is_not
 */
 ...
 * @member {Array.<module:model/QualificationsOptionFiltersHolderRoleConditions.InEnum>} $in
 */
QualificationsOptionFiltersHolderRoleConditions.prototype['$in'] = undefined;

/**
 * Will return records for the values in the array.
 * @member {Array.<module:model/QualificationsOptionFiltersHolderRoleConditions.NotInEnum>} $not_in
 */

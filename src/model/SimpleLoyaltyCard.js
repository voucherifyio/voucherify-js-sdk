...
class SimpleLoyaltyCard {
    ...
    constructor() { 
        ...
        SimpleLoyaltyCard.initialize(this);
    }
     ...
     * @return {module:model/SimpleLoyaltyCard} The populated <code>SimpleLoyaltyCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleLoyaltyCard();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleLoyaltyCard</code>.
     */

...
class SimpleProductDiscountUnit {
     ...
     * @return {module:model/SimpleProductDiscountUnit} The populated <code>SimpleProductDiscountUnit</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleProductDiscountUnit</code>.
     */

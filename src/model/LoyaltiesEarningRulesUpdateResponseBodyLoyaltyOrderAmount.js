...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount} The populated <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount</code>.
     */
...
export default LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount;

...
class TemplatesCampaignsListResponseBody {
     ...
     * @return {module:model/TemplatesCampaignsListResponseBody} The populated <code>TemplatesCampaignsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsListResponseBody</code>.
     */
 ...
 * @member {module:model/TemplatesCampaignsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/TemplatesCampaignsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */

...
class LoyaltiesTransactionsExportCreateRequestBody {
     ...
     * @return {module:model/LoyaltiesTransactionsExportCreateRequestBody} The populated <code>LoyaltiesTransactionsExportCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTransactionsExportCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesTransactionsExportCreateRequestBodyParameters} parameters
 */

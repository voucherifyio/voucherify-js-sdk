...
class EarningRuleLoyaltyCustomerMetadata {
    ...
    constructor() { 
        ...
        EarningRuleLoyaltyCustomerMetadata.initialize(this);
    }
     ...
     * @return {module:model/EarningRuleLoyaltyCustomerMetadata} The populated <code>EarningRuleLoyaltyCustomerMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRuleLoyaltyCustomerMetadata();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleLoyaltyCustomerMetadata</code>.
     */
...
export default EarningRuleLoyaltyCustomerMetadata;

...
class ProductCollectionsProductsListResponseBody {
     ...
     * @return {module:model/ProductCollectionsProductsListResponseBody} The populated <code>ProductCollectionsProductsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsProductsListResponseBody</code>.
     */
...
/**
 * @member {Array.<module:model/ProductCollectionsProductsListResponseBodyDataItem>} data
 */

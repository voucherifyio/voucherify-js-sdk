...
import MemberActivityDataRedemptionOrderCustomer from './MemberActivityDataRedemptionOrderCustomer';
import MemberActivityDataRedemptionOrderItemsItem from './MemberActivityDataRedemptionOrderItemsItem';
import MemberActivityDataRedemptionOrderReferrer from './MemberActivityDataRedemptionOrderReferrer';
...
class MemberActivityDataRedemptionOrder {
    /**
     * Constructs a new <code>MemberActivityDataRedemptionOrder</code>.
     * @alias MemberActivityDataRedemptionOrder
     */
    constructor() { 
        
        MemberActivityDataRedemptionOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MemberActivityDataRedemptionOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<MemberActivityDataRedemptionOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {MemberActivityDataRedemptionOrder} [obj] Optional instance to populate.
     * @returns {MemberActivityDataRedemptionOrder} The populated <code>MemberActivityDataRedemptionOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionOrder();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [MemberActivityDataRedemptionOrderItemsItem]);
            }
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = MemberActivityDataRedemptionOrderCustomer.constructFromObject(data['customer']);
            }
            if (data.hasOwnProperty('referrer')) {
                obj['referrer'] = MemberActivityDataRedemptionOrderReferrer.constructFromObject(data['referrer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MemberActivityDataRedemptionOrder</code>.
     * @param {Partial<MemberActivityDataRedemptionOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                MemberActivityDataRedemptionOrderItemsItem.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['customer']) { // data not null
          MemberActivityDataRedemptionOrderCustomer.validateJSON(data['customer']);
        }
        // validate the optional field `referrer`
        if (data['referrer']) { // data not null
          MemberActivityDataRedemptionOrderReferrer.validateJSON(data['referrer']);
        }
...
/**
    ...
    */
MemberActivityDataRedemptionOrder.prototype['id'] = undefined;

/**
    * @type {String | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['source_id'] = undefined;

/**
    * The order status.
    * @type {(keyof typeof MemberActivityDataRedemptionOrder.StatusEnum) | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['status'] = undefined;

/**
    * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
    * @type {String | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['customer_id'] = undefined;

/**
    * @type {String | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['referrer_id'] = undefined;
...
/**
    ...
    */
MemberActivityDataRedemptionOrder.prototype['amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['items_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['items_applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['total_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['total_applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['total_amount'] = undefined;

/**
    * Array of items applied to the order. It can include up to 500 items.
    * @type {Array.<MemberActivityDataRedemptionOrderItemsItem> | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['items'] = undefined;
...
/**
    ...
    */
MemberActivityDataRedemptionOrder.prototype['metadata'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof MemberActivityDataRedemptionOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
MemberActivityDataRedemptionOrder.prototype['object'] = 'order';
...
/**
    ...
    * @type {Number | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['initial_amount'] = undefined;

/**
    * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['updated_at'] = undefined;

/**
    * @type {MemberActivityDataRedemptionOrderCustomer | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['customer'] = undefined;

/**
    * @type {MemberActivityDataRedemptionOrderReferrer | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['referrer'] = undefined;

/**
    * @type {Object.<String, OrderRedemptionsEntry> | undefined}
    */
MemberActivityDataRedemptionOrder.prototype['redemptions'] = undefined;
     ...
     * @readonly
     */
    MemberActivityDataRedemptionOrder['StatusEnum'] = {
     ...
     * @readonly
     */
    MemberActivityDataRedemptionOrder['ObjectEnum'] = {
...
export default MemberActivityDataRedemptionOrder;

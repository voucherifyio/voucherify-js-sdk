...
class MemberActivityDataRedemptionOrder {
     ...
     * @alias module:model/MemberActivityDataRedemptionOrder
     */
    constructor() { 
     ...
     * @param {module:model/MemberActivityDataRedemptionOrder} obj Optional instance to populate.
     * @return {module:model/MemberActivityDataRedemptionOrder} The populated <code>MemberActivityDataRedemptionOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/MemberActivityDataRedemptionOrder.StatusEnum} status
 */
 ...
 * @member {Array.<module:model/MemberActivityDataRedemptionOrderItemsItem>} items
 */
 ...
 * @member {module:model/MemberActivityDataRedemptionOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionOrderCustomer} customer
 */
MemberActivityDataRedemptionOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/MemberActivityDataRedemptionOrderReferrer} referrer
 */

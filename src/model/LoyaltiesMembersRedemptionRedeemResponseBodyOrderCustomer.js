...
class LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer {
    ...
    constructor() { 
        ...
        LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer.ObjectEnum} object
 * @default 'customer'
 */
...
export default LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer;

...
class MemberActivityDataRedemptionRewardParametersCoin {
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardParametersCoin} The populated <code>MemberActivityDataRedemptionRewardParametersCoin</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardParametersCoin</code>.
     */

...
class MemberActivityDataRedemptionPromotionTierSummaryOrders {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionPromotionTierSummaryOrders.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionPromotionTierSummaryOrders} The populated <code>MemberActivityDataRedemptionPromotionTierSummaryOrders</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionPromotionTierSummaryOrders();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionPromotionTierSummaryOrders</code>.
     */
...
export default MemberActivityDataRedemptionPromotionTierSummaryOrders;

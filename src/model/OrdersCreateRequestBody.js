...
class OrdersCreateRequestBody {
    ...
    constructor() { 
        ...
        OrdersCreateRequestBody.initialize(this);
    }
     ...
     * @return {module:model/OrdersCreateRequestBody} The populated <code>OrdersCreateRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersCreateRequestBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersCreateRequestBody</code>.
     */
...
/**
 * The order status.
 * @member {module:model/OrdersCreateRequestBody.StatusEnum} status
 */
...
export default OrdersCreateRequestBody;

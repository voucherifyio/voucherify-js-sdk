...
class RedeemableHolder {
     ...
     * @return {module:model/RedeemableHolder} The populated <code>RedeemableHolder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedeemableHolder</code>.
     */
...
/**
 * Role of the holder.
 * @member {module:model/RedeemableHolder.HolderRoleEnum} holder_role
 */
 ...
 * @member {module:model/RedeemableHolder.CampaignTypeEnum} campaign_type
 ...
 * @member {module:model/RedeemableHolder.VoucherTypeEnum} voucher_type
 */
 ...
 * @member {module:model/RedeemableHolder.ObjectEnum} object

...
class LoyaltiesEarningRulesDisableResponseBodySource {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesDisableResponseBodySource.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesDisableResponseBodySource} The populated <code>LoyaltiesEarningRulesDisableResponseBodySource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesDisableResponseBodySource();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesDisableResponseBodySource</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesDisableResponseBodySource.ObjectTypeEnum} object_type
 * @default 'campaign'
 */
...
export default LoyaltiesEarningRulesDisableResponseBodySource;

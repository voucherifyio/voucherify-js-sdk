...
class CampaignsVouchersCreateRequestBodyRedemption {
     ...
     * @return {module:model/CampaignsVouchersCreateRequestBodyRedemption} The populated <code>CampaignsVouchersCreateRequestBodyRedemption</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateRequestBodyRedemption</code>.
     */

...
class LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject {
     ...
     * @return {module:model/LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject} The populated <code>LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject.TypeEnum} type
 * @default 'voucher'
 */

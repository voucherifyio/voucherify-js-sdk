...
class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity {
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity} The populated <code>LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity.ObjectEnum} object
 */
 ...
 * @member {Array.<module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantityApplicableToItem>} applicable_to
 */

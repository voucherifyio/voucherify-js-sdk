...
class SimpleReferralTier {
     ...
     * @return {module:model/SimpleReferralTier} The populated <code>SimpleReferralTier</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleReferralTier</code>.
     */

...
class ReferralsMembersHoldersCreateInBulkResponseBody {
     ...
     * @return {module:model/ReferralsMembersHoldersCreateInBulkResponseBody} The populated <code>ReferralsMembersHoldersCreateInBulkResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReferralsMembersHoldersCreateInBulkResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/RedeemableHolder>} holders
 */

...
class VoucherAssetsBarcode {
     ...
     * @return {module:model/VoucherAssetsBarcode} The populated <code>VoucherAssetsBarcode</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherAssetsBarcode</code>.
     */

...
class LoyaltyPendingPoints {
     ...
     * @return {module:model/LoyaltyPendingPoints} The populated <code>LoyaltyPendingPoints</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyPendingPoints</code>.
     */
 ...
 * @member {Date} activates_at
 */
LoyaltyPendingPoints.prototype['activates_at'] = undefined;

/**
 * @member {module:model/LoyaltyPendingPointsDetails} details
 */

...
class VouchersGetResponseBody {
     ...
     * @param {Partial<VouchersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {VouchersGetResponseBody} [obj] Optional instance to populate.
     * @returns {VouchersGetResponseBody} The populated <code>VouchersGetResponseBody</code> instance.
     */
     ...
     * @param {Partial<VouchersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersGetResponseBody</code>.
     */
...
/**
    ...
    * @type {(keyof typeof VouchersGetResponseBody.TypeEnum) | undefined}
    */
...
/**
    * @type {VouchersGetResponseBodyGift | undefined}
    */
VouchersGetResponseBody.prototype['gift'] = undefined;

/**
    * @type {VouchersGetResponseBodyLoyaltyCard | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof VouchersGetResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {VouchersGetResponseBodyPublish | undefined}
    */
VouchersGetResponseBody.prototype['publish'] = undefined;

/**
    * @type {VouchersGetResponseBodyRedemption | undefined}
    */

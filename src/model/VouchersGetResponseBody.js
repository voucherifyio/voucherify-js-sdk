...
import VouchersGetResponseBodyGift from './VouchersGetResponseBodyGift';
import VouchersGetResponseBodyLoyaltyCard from './VouchersGetResponseBodyLoyaltyCard';
import VouchersGetResponseBodyPublish from './VouchersGetResponseBodyPublish';
import VouchersGetResponseBodyRedemption from './VouchersGetResponseBodyRedemption';
...
class VouchersGetResponseBody {
    /**
     * Constructs a new <code>VouchersGetResponseBody</code>.
     * Response body schema for **GET** &#x60;v1/vouchers/{code}&#x60;.
     * @alias module:model/VouchersGetResponseBody
     */
    constructor() { 
        
        VouchersGetResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VouchersGetResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VouchersGetResponseBody} obj Optional instance to populate.
     * @return {module:model/VouchersGetResponseBody} The populated <code>VouchersGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersGetResponseBody();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = VouchersGetResponseBodyGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = VouchersGetResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = VouchersGetResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = VouchersGetResponseBodyRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VouchersGetResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersGetResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          VouchersGetResponseBodyGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          VouchersGetResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          VouchersGetResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          VouchersGetResponseBodyRedemption.validateJSON(data['redemption']);
        }
 ...
 * @member {String} id
 */
VouchersGetResponseBody.prototype['id'] = undefined;
 ...
 * @member {String} code
 */
VouchersGetResponseBody.prototype['code'] = undefined;

/**
 * A unique campaign name, identifies the voucher's parent campaign.
 * @member {String} campaign
 */
VouchersGetResponseBody.prototype['campaign'] = undefined;

/**
 * Assigned by the Voucherify API, identifies the voucher's parent campaign.
 * @member {String} campaign_id
 */
VouchersGetResponseBody.prototype['campaign_id'] = undefined;

/**
 * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
 * @member {String} category
 */
VouchersGetResponseBody.prototype['category'] = undefined;

/**
 * Unique category ID assigned by Voucherify.
 * @member {String} category_id
 */
VouchersGetResponseBody.prototype['category_id'] = undefined;

/**
 * Defines the type of the voucher. 
 * @member {module:model/VouchersGetResponseBody.TypeEnum} type
 */
VouchersGetResponseBody.prototype['type'] = undefined;

/**
 * @member {module:model/Discount} discount
 */
VouchersGetResponseBody.prototype['discount'] = undefined;

/**
 * @member {module:model/VouchersGetResponseBodyGift} gift
 */
VouchersGetResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/VouchersGetResponseBodyLoyaltyCard} loyalty_card
 */
VouchersGetResponseBody.prototype['loyalty_card'] = undefined;

/**
 * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
 * @member {Date} start_date
 */
VouchersGetResponseBody.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
 * @member {Date} expiration_date
 */
VouchersGetResponseBody.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
VouchersGetResponseBody.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/VouchersGetResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
VouchersGetResponseBody.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
VouchersGetResponseBody.prototype['validity_hours'] = undefined;
 ...
 */
VouchersGetResponseBody.prototype['holder_id'] = undefined;

/**
 * Unique identifier of the referring person.
 * @member {String} referrer_id
 */
VouchersGetResponseBody.prototype['referrer_id'] = undefined;
 ...
 * @default 'voucher'
 */
VouchersGetResponseBody.prototype['object'] = 'voucher';

/**
 * @member {module:model/VouchersGetResponseBodyPublish} publish
 */
VouchersGetResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/VouchersGetResponseBodyRedemption} redemption
 */
VouchersGetResponseBody.prototype['redemption'] = undefined;

/**
 * Contains details about the category.
 * @member {Array.<module:model/Category>} categories
 */
VouchersGetResponseBody.prototype['categories'] = undefined;

/**
 * @member {module:model/ValidationRulesAssignmentsList} validation_rules_assignments
 */
VouchersGetResponseBody.prototype['validation_rules_assignments'] = undefined;
 ...
 * @readonly
 */
VouchersGetResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
VouchersGetResponseBody['ValidityDayOfWeekEnum'] = {
...
export default VouchersGetResponseBody;

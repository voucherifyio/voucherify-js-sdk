...
class RedemptionRollbackOrder {
     ...
     * @param {Partial<RedemptionRollbackOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionRollbackOrder} [obj] Optional instance to populate.
     * @returns {RedemptionRollbackOrder} The populated <code>RedemptionRollbackOrder</code> instance.
     */
     ...
     * @param {Partial<RedemptionRollbackOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRollbackOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof RedemptionRollbackOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof RedemptionRollbackOrder.ObjectEnum) | undefined}
    * @default 'order'
    */

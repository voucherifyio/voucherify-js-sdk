...
class RedemptionRollbackOrder {
    /**
     * Constructs a new <code>RedemptionRollbackOrder</code>.
     * @alias module:model/RedemptionRollbackOrder
     */
    constructor() { 
        
        RedemptionRollbackOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionRollbackOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedemptionRollbackOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionRollbackOrder} The populated <code>RedemptionRollbackOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionRollbackOrder();
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionRollbackOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRollbackOrder</code>.
     */
 ...
 * @member {String} id
 */
RedemptionRollbackOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
RedemptionRollbackOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/RedemptionRollbackOrder.StatusEnum} status
 */
RedemptionRollbackOrder.prototype['status'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['initial_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['total_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
RedemptionRollbackOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/RedemptionRollbackOrder.ObjectEnum} object
 * @default 'order'
 */
RedemptionRollbackOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
RedemptionRollbackOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
RedemptionRollbackOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
RedemptionRollbackOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
RedemptionRollbackOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
RedemptionRollbackOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
RedemptionRollbackOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
RedemptionRollbackOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
RedemptionRollbackOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
RedemptionRollbackOrder['StatusEnum'] = {
 ...
 * @readonly
 */
RedemptionRollbackOrder['ObjectEnum'] = {
...
export default RedemptionRollbackOrder;

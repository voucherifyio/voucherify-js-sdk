...
class LoyaltyCardTransactionDetailsEarningRule {
     ...
     * @return {module:model/LoyaltyCardTransactionDetailsEarningRule} The populated <code>LoyaltyCardTransactionDetailsEarningRule</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCardTransactionDetailsEarningRule</code>.
     */
...
/**
 * @member {module:model/LoyaltyCardTransactionDetailsEarningRuleSource} source
 */

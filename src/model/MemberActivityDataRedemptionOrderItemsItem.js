...
class MemberActivityDataRedemptionOrderItemsItem {
     ...
     * @return {module:model/MemberActivityDataRedemptionOrderItemsItem} The populated <code>MemberActivityDataRedemptionOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionOrderItemsItem</code>.
     */
...
/**
 * @member {module:model/MemberActivityDataRedemptionOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionOrderItemsItem.RelatedObjectEnum} related_object
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionOrderItemsItemProduct} product
 */
MemberActivityDataRedemptionOrderItemsItem.prototype['product'] = undefined;

/**
 * @member {module:model/MemberActivityDataRedemptionOrderItemsItemSku} sku
 */

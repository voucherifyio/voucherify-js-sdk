...
class ValidationsValidateResponseBodyRedeemablesItem {
     ...
     * @return {module:model/ValidationsValidateResponseBodyRedeemablesItem} The populated <code>ValidationsValidateResponseBodyRedeemablesItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyRedeemablesItem</code>.
     */
...
/**
 * @member {module:model/ValidationsValidateResponseBodyRedeemablesItem.StatusEnum} status
 */
 ...
 * @member {module:model/ValidationsValidateResponseBodyRedeemablesItem.ObjectEnum} object
 */
ValidationsValidateResponseBodyRedeemablesItem.prototype['object'] = undefined;

/**
 * @member {module:model/ValidationsValidateResponseBodyRedeemablesItemOrder} order
 */
...
/**
 * @member {module:model/ValidationsValidateResponseBodyRedeemablesItemResult} result
 */

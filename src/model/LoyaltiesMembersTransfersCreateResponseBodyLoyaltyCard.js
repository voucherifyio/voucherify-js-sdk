...
class LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard {
    ...
    constructor() { 
        ...
        LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard} The populated <code>LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard</code>.
     */
...
export default LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard;

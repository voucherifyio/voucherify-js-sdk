...
class LoyaltyMember {
     ...
     * @return {module:model/LoyaltyMember} The populated <code>LoyaltyMember</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyMember</code>.
     */
 ...
 * @member {module:model/LoyaltyMember.TypeEnum} type
...
/**
 * @member {module:model/LoyaltyMemberLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/LoyaltyMember.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/LoyaltyMemberPublish} publish
 */
LoyaltyMember.prototype['publish'] = undefined;

/**
 * @member {module:model/LoyaltyMemberRedemption} redemption
 */

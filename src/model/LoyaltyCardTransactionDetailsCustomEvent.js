...
class LoyaltyCardTransactionDetailsCustomEvent {
     ...
     * @return {module:model/LoyaltyCardTransactionDetailsCustomEvent} The populated <code>LoyaltyCardTransactionDetailsCustomEvent</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCardTransactionDetailsCustomEvent</code>.
     */

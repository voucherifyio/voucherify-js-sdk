...
class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount} The populated <code>LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount</code>.
     */
...
export default LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount;

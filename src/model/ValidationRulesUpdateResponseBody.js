...
class ValidationRulesUpdateResponseBody {
     ...
     * @return {module:model/ValidationRulesUpdateResponseBody} The populated <code>ValidationRulesUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesUpdateResponseBody</code>.
     */
...
/**
 * @member {module:model/ValidationRulesUpdateResponseBodyError} error
 */
ValidationRulesUpdateResponseBody.prototype['error'] = undefined;

/**
 * @member {module:model/ValidationRulesUpdateResponseBodyApplicableTo} applicable_to
 */
ValidationRulesUpdateResponseBody.prototype['applicable_to'] = undefined;

/**
 * Type of validation rule.
 * @member {module:model/ValidationRulesUpdateResponseBody.TypeEnum} type
 * @default 'expression'
 */
 ...
 * @member {module:model/ValidationRulesUpdateResponseBody.ContextTypeEnum} context_type
 * @default 'global'
 */

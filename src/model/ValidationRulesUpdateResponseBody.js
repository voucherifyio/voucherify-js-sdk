...
class ValidationRulesUpdateResponseBody {
     ...
     * @alias ValidationRulesUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<ValidationRulesUpdateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationRulesUpdateResponseBody} [obj] Optional instance to populate.
     * @returns {ValidationRulesUpdateResponseBody} The populated <code>ValidationRulesUpdateResponseBody</code> instance.
     */
...
/**
    * @type {ValidationRulesUpdateResponseBodyApplicableTo | undefined}
    */
ValidationRulesUpdateResponseBody.prototype['applicable_to'] = undefined;

/**
    * Type of validation rule.
    * @type {(keyof typeof ValidationRulesUpdateResponseBody.TypeEnum) | undefined}
    * @default 'expression'
    */
...
/**
    ...
    * @type {(keyof typeof ValidationRulesUpdateResponseBody.ContextTypeEnum) | undefined}
    * @default 'global'
    */

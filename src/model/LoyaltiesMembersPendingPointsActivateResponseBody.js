...
class LoyaltiesMembersPendingPointsActivateResponseBody {
     ...
     * @return {module:model/LoyaltiesMembersPendingPointsActivateResponseBody} The populated <code>LoyaltiesMembersPendingPointsActivateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPendingPointsActivateResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsActivateResponseBody.TypeEnum} type
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsActivateResponseBody.ObjectEnum} object
 * @default 'balance'
 */
LoyaltiesMembersPendingPointsActivateResponseBody.prototype['object'] = 'balance';

/**
 * @member {module:model/LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject} related_object
 */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsActivateResponseBody.OperationTypeEnum} operation_type
 * @default 'MANUAL'
 */

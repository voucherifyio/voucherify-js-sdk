...
class VoucherWithCategories {
     ...
     * @param {Partial<VoucherWithCategories>} data The plain JavaScript object bearing properties of interest.
     * @param {VoucherWithCategories} [obj] Optional instance to populate.
     * @returns {VoucherWithCategories} The populated <code>VoucherWithCategories</code> instance.
     */
     ...
     * @param {Partial<VoucherWithCategories>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherWithCategories</code>.
     */
...
/**
    ...
    * @type {(keyof typeof VoucherWithCategories.TypeEnum) | undefined}
    */
...
/**
    * @type {VoucherWithCategoriesGift | undefined}
    */
VoucherWithCategories.prototype['gift'] = undefined;

/**
    * @type {VoucherWithCategoriesLoyaltyCard | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof VoucherWithCategories.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {VoucherWithCategoriesPublish | undefined}
    */
VoucherWithCategories.prototype['publish'] = undefined;

/**
    * @type {VoucherWithCategoriesRedemption | undefined}
    */

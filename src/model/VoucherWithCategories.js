...
import VoucherWithCategoriesGift from './VoucherWithCategoriesGift';
import VoucherWithCategoriesLoyaltyCard from './VoucherWithCategoriesLoyaltyCard';
import VoucherWithCategoriesPublish from './VoucherWithCategoriesPublish';
import VoucherWithCategoriesRedemption from './VoucherWithCategoriesRedemption';
...
class VoucherWithCategories {
    /**
     * Constructs a new <code>VoucherWithCategories</code>.
     * This is an object representing a voucher with categories.
     * @alias module:model/VoucherWithCategories
     */
    constructor() { 
        
        VoucherWithCategories.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VoucherWithCategories</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VoucherWithCategories} obj Optional instance to populate.
     * @return {module:model/VoucherWithCategories} The populated <code>VoucherWithCategories</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherWithCategories();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = VoucherWithCategoriesGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = VoucherWithCategoriesLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = VoucherWithCategoriesPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = VoucherWithCategoriesRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VoucherWithCategories</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherWithCategories</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          VoucherWithCategoriesGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          VoucherWithCategoriesLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          VoucherWithCategoriesPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          VoucherWithCategoriesRedemption.validateJSON(data['redemption']);
        }
 ...
 * @member {String} id
 */
VoucherWithCategories.prototype['id'] = undefined;
 ...
 * @member {String} code
 */
VoucherWithCategories.prototype['code'] = undefined;

/**
 * A unique campaign name, identifies the voucher's parent campaign.
 * @member {String} campaign
 */
VoucherWithCategories.prototype['campaign'] = undefined;

/**
 * Assigned by the Voucherify API, identifies the voucher's parent campaign.
 * @member {String} campaign_id
 */
VoucherWithCategories.prototype['campaign_id'] = undefined;

/**
 * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
 * @member {String} category
 */
VoucherWithCategories.prototype['category'] = undefined;

/**
 * Unique category ID assigned by Voucherify.
 * @member {String} category_id
 */
VoucherWithCategories.prototype['category_id'] = undefined;

/**
 * Defines the type of the voucher. 
 * @member {module:model/VoucherWithCategories.TypeEnum} type
 */
VoucherWithCategories.prototype['type'] = undefined;

/**
 * @member {module:model/Discount} discount
 */
VoucherWithCategories.prototype['discount'] = undefined;

/**
 * @member {module:model/VoucherWithCategoriesGift} gift
 */
VoucherWithCategories.prototype['gift'] = undefined;

/**
 * @member {module:model/VoucherWithCategoriesLoyaltyCard} loyalty_card
 */
VoucherWithCategories.prototype['loyalty_card'] = undefined;

/**
 * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
 * @member {Date} start_date
 */
VoucherWithCategories.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
 * @member {Date} expiration_date
 */
VoucherWithCategories.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
VoucherWithCategories.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/VoucherWithCategories.ValidityDayOfWeekEnum>} validity_day_of_week
 */
VoucherWithCategories.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
VoucherWithCategories.prototype['validity_hours'] = undefined;
 ...
 */
VoucherWithCategories.prototype['holder_id'] = undefined;

/**
 * Unique identifier of the referring person.
 * @member {String} referrer_id
 */
VoucherWithCategories.prototype['referrer_id'] = undefined;
 ...
 * @default 'voucher'
 */
VoucherWithCategories.prototype['object'] = 'voucher';

/**
 * @member {module:model/VoucherWithCategoriesPublish} publish
 */
VoucherWithCategories.prototype['publish'] = undefined;

/**
 * @member {module:model/VoucherWithCategoriesRedemption} redemption
 */
VoucherWithCategories.prototype['redemption'] = undefined;

/**
 * Contains details about the category.
 * @member {Array.<module:model/Category>} categories
 */
VoucherWithCategories.prototype['categories'] = undefined;
 ...
 * @readonly
 */
VoucherWithCategories['TypeEnum'] = {
 ...
 * @readonly
 */
VoucherWithCategories['ValidityDayOfWeekEnum'] = {
...
export default VoucherWithCategories;

...
class RedemptionChannel {
    ...
    constructor() { 
        ...
        RedemptionChannel.initialize(this);
    }
     ...
     * @return {module:model/RedemptionChannel} The populated <code>RedemptionChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionChannel();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionChannel</code>.
     */
 ...
 * @member {module:model/RedemptionChannel.ChannelTypeEnum} channel_type
 */
...
export default RedemptionChannel;

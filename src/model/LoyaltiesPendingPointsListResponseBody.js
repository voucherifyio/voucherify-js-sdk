...
class LoyaltiesPendingPointsListResponseBody {
     ...
     * @return {module:model/LoyaltiesPendingPointsListResponseBody} The populated <code>LoyaltiesPendingPointsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPendingPointsListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesPendingPointsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesPendingPointsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */

...
class ParameterFiltersListCampaignsVoucherTypeConditions {
     ...
     * @return {module:model/ParameterFiltersListCampaignsVoucherTypeConditions} The populated <code>ParameterFiltersListCampaignsVoucherTypeConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsVoucherTypeConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListCampaignsVoucherTypeConditions.InEnum>} $in
 */
ParameterFiltersListCampaignsVoucherTypeConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListCampaignsVoucherTypeConditions.NotInEnum>} $not_in
 */
ParameterFiltersListCampaignsVoucherTypeConditions.prototype['$not_in'] = undefined;

/**
 * Value is exactly this value (single value).
 * @member {module:model/ParameterFiltersListCampaignsVoucherTypeConditions.IsEnum} $is
 */
ParameterFiltersListCampaignsVoucherTypeConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListCampaignsVoucherTypeConditions.IsNotEnum} $is_not
 */

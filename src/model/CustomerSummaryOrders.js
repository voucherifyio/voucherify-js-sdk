...
class CustomerSummaryOrders {
     ...
     * @return {module:model/CustomerSummaryOrders} The populated <code>CustomerSummaryOrders</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerSummaryOrders</code>.
     */
 ...
 * @member {Number} last_order_amount
 */

...
class CustomerReferrals {
     ...
     * @return {module:model/CustomerReferrals} The populated <code>CustomerReferrals</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerReferrals</code>.
     */
 ...
 * @member {Array.<module:model/CustomerReferralsCampaignsItem>} campaigns
 */

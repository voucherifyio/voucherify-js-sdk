...
class PromotionsTiersEnableResponseBodyCampaign {
    /**
     * Constructs a new <code>PromotionsTiersEnableResponseBodyCampaign</code>.
     * Contains details about promotion tier&#39;s parent campaign.
     * @alias PromotionsTiersEnableResponseBodyCampaign
     */
    constructor() { 
        
        PromotionsTiersEnableResponseBodyCampaign.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionsTiersEnableResponseBodyCampaign</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<PromotionsTiersEnableResponseBodyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionsTiersEnableResponseBodyCampaign} [obj] Optional instance to populate.
     * @returns {PromotionsTiersEnableResponseBodyCampaign} The populated <code>PromotionsTiersEnableResponseBodyCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersEnableResponseBodyCampaign();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsTiersEnableResponseBodyCampaign</code>.
     * @param {Partial<PromotionsTiersEnableResponseBodyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersEnableResponseBodyCampaign</code>.
     */
...
/**
    ...
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['id'] = undefined;

/**
    * Activation timestamp defines when the campaign starts to be active in ISO 8601 format. Campaign is *inactive before* this date. 
    * @type {Date | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the campaign expires in ISO 8601 format.  Campaign is *inactive after* this date.
    * @type {Date | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof PromotionsTiersEnableResponseBodyCampaign.ValidityDayOfWeekEnum>) | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['active'] = undefined;

/**
    * Unique category ID that this campaign belongs to.
    * @type {String | undefined}
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['category_id'] = undefined;
...
/**
    ...
    * @default 'campaign'
    */
PromotionsTiersEnableResponseBodyCampaign.prototype['object'] = 'campaign';
 ...
 * @readonly
 */
PromotionsTiersEnableResponseBodyCampaign['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersEnableResponseBodyCampaign;

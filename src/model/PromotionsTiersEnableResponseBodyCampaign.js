...
class PromotionsTiersEnableResponseBodyCampaign {
     ...
     * @alias module:model/PromotionsTiersEnableResponseBodyCampaign
     */
    constructor() { 
     ...
     * @param {module:model/PromotionsTiersEnableResponseBodyCampaign} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersEnableResponseBodyCampaign} The populated <code>PromotionsTiersEnableResponseBodyCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersEnableResponseBodyCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersEnableResponseBodyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

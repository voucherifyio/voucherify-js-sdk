...
class LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem {
    /**
     * Constructs a new <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code>.
     * @alias LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem
     * @implements OrderCalculatedItem
     */
    constructor() { 
        OrderCalculatedItem.initialize(this);
        LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem} [obj] Optional instance to populate.
     * @returns {LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem();
    ...
    /**
     * Validates the JSON data with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code>.
     * @param {Partial<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code>.
     */
...
/**
    ...
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['id'] = undefined;

/**
    * Unique identifier of the SKU. It is assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['sku_id'] = undefined;

/**
    * Unique identifier of the product. It is assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['product_id'] = undefined;

/**
    * Used along with the source_id property, can be set to either sku or product.
    * @type {(keyof typeof LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.RelatedObjectEnum) | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['related_object'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['source_id'] = undefined;

/**
    * The quantity of the particular item in the cart.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['quantity'] = undefined;

/**
    * Number of dicounted items.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['initial_quantity'] = undefined;

/**
    * The total amount of the order item (price * quantity).
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['amount'] = undefined;

/**
    * Sum of all order-item-level discounts applied to the order.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['discount_amount'] = undefined;

/**
    * This field shows the order-level discount applied.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['applied_discount_amount'] = undefined;

/**
    * Number of the discounted items applied in the transaction.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['applied_discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['applied_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['applied_quantity_amount'] = undefined;

/**
    * A positive integer in the smallest currency unit (e.g. 100 cents for $1.00) representing the total amount of the order. This is the sum of the order items' amounts.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['initial_amount'] = undefined;

/**
    * Unit price of an item. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['price'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['subtotal_amount'] = undefined;

/**
    * @type {OrderCalculatedItemProduct | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['product'] = undefined;

/**
    * @type {OrderCalculatedItemSku | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['sku'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['object'] = 'order_item';
...
/**
    ...
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['metadata'] = undefined;
...
/**
    ...
    */
LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.prototype['application_details'] = undefined;
...
OrderCalculatedItem.prototype['metadata'] = undefined;
     ...
     * @readonly
     */
    LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem['RelatedObjectEnum'] = {
     ...
     * @readonly
     */
    LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem['ObjectEnum'] = {
...
export default LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem;

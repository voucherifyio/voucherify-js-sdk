...
class LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem {
     ...
     * @alias module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem
     ...
     * @param {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

...
class ClientValidationsValidateResponseBodyRedeemablesItemOrder {
     ...
     * @alias module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrder
     */
    constructor() { 
     ...
     * @param {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrder} obj Optional instance to populate.
     * @return {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrder} The populated <code>ClientValidationsValidateResponseBodyRedeemablesItemOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyRedeemablesItemOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrder.StatusEnum} status
 */
 ...
 * @member {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer} customer
 */
ClientValidationsValidateResponseBodyRedeemablesItemOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer} referrer
 */
 ...
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */

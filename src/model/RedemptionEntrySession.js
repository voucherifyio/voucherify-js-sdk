...
class RedemptionEntrySession {
    ...
    constructor() { 
        ...
        RedemptionEntrySession.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntrySession} The populated <code>RedemptionEntrySession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntrySession();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntrySession</code>.
     */
...
export default RedemptionEntrySession;

...
class ManagementProjectsTemplatesCampaignsCopyCreateRequestBody {
     ...
     * @return {module:model/ManagementProjectsTemplatesCampaignsCopyCreateRequestBody} The populated <code>ManagementProjectsTemplatesCampaignsCopyCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsTemplatesCampaignsCopyCreateRequestBody</code>.
     */
 ...
 * @member {String} destination_project_id
 */

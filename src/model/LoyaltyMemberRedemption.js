...
class LoyaltyMemberRedemption {
    ...
    constructor() { 
        ...
        LoyaltyMemberRedemption.initialize(this);
    }
     ...
     * @return {module:model/LoyaltyMemberRedemption} The populated <code>LoyaltyMemberRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltyMemberRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyMemberRedemption</code>.
     */
...
export default LoyaltyMemberRedemption;

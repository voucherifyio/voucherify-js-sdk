...
class LoyaltiesEarningRulesCreateRequestBodyItemSource {
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateRequestBodyItemSource} The populated <code>LoyaltiesEarningRulesCreateRequestBodyItemSource</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateRequestBodyItemSource</code>.
     */

...
class ProductsUpdateInBulkRequestBody {
     ...
     * @alias ProductsUpdateInBulkRequestBody
     */
    constructor() { 
     ...
     * @param {Partial<ProductsUpdateInBulkRequestBody>} data The plain JavaScript object bearing properties of interest.
     * @param {ProductsUpdateInBulkRequestBody} [obj] Optional instance to populate.
     * @returns {ProductsUpdateInBulkRequestBody} The populated <code>ProductsUpdateInBulkRequestBody</code> instance.
     */

...
class MetadataSchemaDefinitionDeprecated {
     ...
     * @return {module:model/MetadataSchemaDefinitionDeprecated} The populated <code>MetadataSchemaDefinitionDeprecated</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetadataSchemaDefinitionDeprecated</code>.
     */
...
/**
 * @member {module:model/MetadataSchemaDefinitionDeprecated.TypeEnum} type
 */

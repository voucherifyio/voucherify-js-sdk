...
class CampaignsImportVoucherItem {
     ...
     * @return {module:model/CampaignsImportVoucherItem} The populated <code>CampaignsImportVoucherItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsImportVoucherItem</code>.
     */
...
/**
 * @member {module:model/CampaignsImportVoucherItemRedemption} redemption
 */
 ...
 * @member {Array.<module:model/CampaignsImportVoucherItem.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/CampaignsImportVoucherItem.TypeEnum} type
 */

...
class QualificationsOptionFiltersCampaignType {
     ...
     * @return {module:model/QualificationsOptionFiltersCampaignType} The populated <code>QualificationsOptionFiltersCampaignType</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsOptionFiltersCampaignType</code>.
     */
...
/**
 * @member {module:model/QualificationsOptionFiltersCampaignTypeConditions} conditions
 */

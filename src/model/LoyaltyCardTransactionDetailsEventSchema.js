...
class LoyaltyCardTransactionDetailsEventSchema {
    ...
    constructor() { 
        ...
        LoyaltyCardTransactionDetailsEventSchema.initialize(this);
    }
     ...
     * @return {module:model/LoyaltyCardTransactionDetailsEventSchema} The populated <code>LoyaltyCardTransactionDetailsEventSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltyCardTransactionDetailsEventSchema();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCardTransactionDetailsEventSchema</code>.
     */
...
export default LoyaltyCardTransactionDetailsEventSchema;

...
class CampaignLoyaltyCard {
     ...
     * @return {module:model/CampaignLoyaltyCard} The populated <code>CampaignLoyaltyCard</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignLoyaltyCard</code>.
     */
...
/**
 * @member {module:model/CampaignLoyaltyCardExpirationRules} expiration_rules
 */

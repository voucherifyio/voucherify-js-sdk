...
class RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku {
    ...
    constructor() { 
        ...
        RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku} The populated <code>RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku</code>.
     */
...
export default RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku;

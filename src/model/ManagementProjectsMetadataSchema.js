...
class ManagementProjectsMetadataSchema {
    ...
    constructor() { 
        ...
        ManagementProjectsMetadataSchema.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsMetadataSchema} The populated <code>ManagementProjectsMetadataSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsMetadataSchema();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsMetadataSchema</code>.
     */
...
export default ManagementProjectsMetadataSchema;

...
class LoyaltiesMembersRedemptionRedeemRequestBody {
     ...
     * @return {module:model/LoyaltiesMembersRedemptionRedeemRequestBody} The populated <code>LoyaltiesMembersRedemptionRedeemRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemRequestBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesMembersRedemptionRedeemRequestBodyReward} reward
 */

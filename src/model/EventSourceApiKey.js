...
class EventSourceApiKey {
     ...
     * @return {module:model/EventSourceApiKey} The populated <code>EventSourceApiKey</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventSourceApiKey</code>.
     */

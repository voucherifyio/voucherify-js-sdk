...
class UsageNotifications {
    ...
    constructor() { 
        ...
        UsageNotifications.initialize(this);
    }
     ...
     * @return {module:model/UsageNotifications} The populated <code>UsageNotifications</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsageNotifications();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsageNotifications</code>.
     */

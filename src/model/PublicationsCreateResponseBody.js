...
class PublicationsCreateResponseBody {
    ...
    constructor() { 
        ...
        PublicationsCreateResponseBody.initialize(this);
    }
     ...
     * @return {module:model/PublicationsCreateResponseBody} The populated <code>PublicationsCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicationsCreateResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicationsCreateResponseBody</code>.
     */
 ...
 * @member {module:model/PublicationsCreateResponseBody.ObjectEnum} object
 * @default 'publication'
 */
 ...
 * @member {module:model/PublicationsCreateResponseBody.ChannelEnum} channel
 * @default 'API'
 */
 ...
 * @member {module:model/PublicationsCreateResponseBody.ResultEnum} result
 * @default 'SUCCESS'
 */
...
export default PublicationsCreateResponseBody;

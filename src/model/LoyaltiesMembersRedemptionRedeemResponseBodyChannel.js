...
class LoyaltiesMembersRedemptionRedeemResponseBodyChannel {
     ...
     * @return {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyChannel} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyChannel</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyChannel</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyChannel.ChannelTypeEnum} channel_type
 */

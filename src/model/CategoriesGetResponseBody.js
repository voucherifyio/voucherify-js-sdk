...
class CategoriesGetResponseBody {
     ...
     * @return {module:model/CategoriesGetResponseBody} The populated <code>CategoriesGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesGetResponseBody</code>.
     */
 ...
 * @member {module:model/CategoriesGetResponseBody.ObjectEnum} object
 * @default 'category'
 */

...
class CategoriesCreateRequestBody {
    ...
    constructor() { 
        ...
        CategoriesCreateRequestBody.initialize(this);
    }
     ...
     * @return {module:model/CategoriesCreateRequestBody} The populated <code>CategoriesCreateRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesCreateRequestBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesCreateRequestBody</code>.
     */
...
export default CategoriesCreateRequestBody;

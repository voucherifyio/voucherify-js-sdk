...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier} The populated <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier</code>.
     */
...
export default LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier;

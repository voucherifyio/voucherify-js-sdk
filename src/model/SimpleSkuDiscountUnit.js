...
class SimpleSkuDiscountUnit {
    ...
    constructor() { 
        ...
        SimpleSkuDiscountUnit.initialize(this);
    }
     ...
     * @return {module:model/SimpleSkuDiscountUnit} The populated <code>SimpleSkuDiscountUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleSkuDiscountUnit();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleSkuDiscountUnit</code>.
     */
...
export default SimpleSkuDiscountUnit;

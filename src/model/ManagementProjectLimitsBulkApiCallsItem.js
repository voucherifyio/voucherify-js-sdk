...
class ManagementProjectLimitsBulkApiCallsItem {
    ...
    constructor() { 
        ...
        ManagementProjectLimitsBulkApiCallsItem.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectLimitsBulkApiCallsItem} The populated <code>ManagementProjectLimitsBulkApiCallsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectLimitsBulkApiCallsItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectLimitsBulkApiCallsItem</code>.
     */
...
export default ManagementProjectLimitsBulkApiCallsItem;

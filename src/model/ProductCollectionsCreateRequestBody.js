...
class ProductCollectionsCreateRequestBody {
     ...
     * @return {module:model/ProductCollectionsCreateRequestBody} The populated <code>ProductCollectionsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsCreateRequestBody</code>.
     */
 ...
 * @member {module:model/ProductCollectionsCreateRequestBody.TypeEnum} type
 * @default 'STATIC'
 */
 ...
 * @member {Array.<module:model/ProductCollectionsCreateRequestBodyProductsItem>} products
 */

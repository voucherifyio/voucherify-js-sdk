...
class ManagementProjectsUpdateRequestBodyDefaultCodeConfig {
    ...
    constructor() { 
        ...
        ManagementProjectsUpdateRequestBodyDefaultCodeConfig.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsUpdateRequestBodyDefaultCodeConfig} The populated <code>ManagementProjectsUpdateRequestBodyDefaultCodeConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsUpdateRequestBodyDefaultCodeConfig();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsUpdateRequestBodyDefaultCodeConfig</code>.
     */
...
export default ManagementProjectsUpdateRequestBodyDefaultCodeConfig;

...
class VouchersUpdateResponseBodyRedemption {
    ...
    constructor() { 
        ...
        VouchersUpdateResponseBodyRedemption.initialize(this);
    }
     ...
     * @return {module:model/VouchersUpdateResponseBodyRedemption} The populated <code>VouchersUpdateResponseBodyRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersUpdateResponseBodyRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersUpdateResponseBodyRedemption</code>.
     */
...
export default VouchersUpdateResponseBodyRedemption;

...
class MemberActivityDataRedemptionRewardVoucherRedemption {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionRewardVoucherRedemption.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardVoucherRedemption} The populated <code>MemberActivityDataRedemptionRewardVoucherRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionRewardVoucherRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardVoucherRedemption</code>.
     */
...
export default MemberActivityDataRedemptionRewardVoucherRedemption;

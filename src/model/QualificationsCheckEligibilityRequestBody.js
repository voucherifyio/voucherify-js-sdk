...
class QualificationsCheckEligibilityRequestBody {
     ...
     * @return {module:model/QualificationsCheckEligibilityRequestBody} The populated <code>QualificationsCheckEligibilityRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsCheckEligibilityRequestBody</code>.
     */
 ...
 * @member {module:model/QualificationsCheckEligibilityRequestBody.ScenarioEnum} scenario
 */
...
/**
 * @member {module:model/QualificationsCheckEligibilityRequestBodySession} session
 */

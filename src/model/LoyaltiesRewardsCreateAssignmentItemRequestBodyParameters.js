...
class LoyaltiesRewardsCreateAssignmentItemRequestBodyParameters {
     ...
     * @return {module:model/LoyaltiesRewardsCreateAssignmentItemRequestBodyParameters} The populated <code>LoyaltiesRewardsCreateAssignmentItemRequestBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardsCreateAssignmentItemRequestBodyParameters</code>.
     */
...
/**
 * @member {module:model/LoyaltiesRewardsCreateAssignmentItemRequestBodyParametersLoyalty} loyalty
 */

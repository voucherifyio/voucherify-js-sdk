...
class MemberActivityDataTransactionDetailsOrder {
    ...
    constructor() { 
        ...
        MemberActivityDataTransactionDetailsOrder.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataTransactionDetailsOrder} The populated <code>MemberActivityDataTransactionDetailsOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataTransactionDetailsOrder();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataTransactionDetailsOrder</code>.
     */
...
export default MemberActivityDataTransactionDetailsOrder;

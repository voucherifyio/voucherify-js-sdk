...
class RedemptionEntryOrderReferrer {
     ...
     * @return {module:model/RedemptionEntryOrderReferrer} The populated <code>RedemptionEntryOrderReferrer</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryOrderReferrer</code>.
     */
 ...
 * @member {module:model/RedemptionEntryOrderReferrer.ObjectEnum} object
 * @default 'customer'
 */

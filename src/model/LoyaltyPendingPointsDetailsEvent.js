...
class LoyaltyPendingPointsDetailsEvent {
     ...
     * @return {module:model/LoyaltyPendingPointsDetailsEvent} The populated <code>LoyaltyPendingPointsDetailsEvent</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyPendingPointsDetailsEvent</code>.
     */
 ...
 * @member {module:model/LoyaltyPendingPointsDetailsEvent.TypeEnum} type
...
/**
 * Type of the event.
 * @member {module:model/LoyaltyPendingPointsDetailsEvent.CategoryEnum} category
 */
LoyaltyPendingPointsDetailsEvent.prototype['category'] = undefined;

/**
 * @member {module:model/EventSource} event_source
 */

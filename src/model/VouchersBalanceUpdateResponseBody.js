...
class VouchersBalanceUpdateResponseBody {
     ...
     * @return {module:model/VouchersBalanceUpdateResponseBody} The populated <code>VouchersBalanceUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersBalanceUpdateResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersBalanceUpdateResponseBody.TypeEnum} type
 */
VouchersBalanceUpdateResponseBody.prototype['type'] = undefined;

/**
 * The type of the operation being performed.
 * @member {module:model/VouchersBalanceUpdateResponseBody.OperationTypeEnum} operation_type
 * @default 'MANUAL'
 */
 ...
 * @member {module:model/VouchersBalanceUpdateResponseBody.ObjectEnum} object
 * @default 'balance'
 */
VouchersBalanceUpdateResponseBody.prototype['object'] = 'balance';

/**
 * @member {module:model/VouchersBalanceUpdateResponseBodyRelatedObject} related_object
 */

...
class ClientRedemptionsRedeemRequestBodyOptions {
     ...
     * @alias module:model/ClientRedemptionsRedeemRequestBodyOptions
     */
    constructor() { 
     ...
     * @param {module:model/ClientRedemptionsRedeemRequestBodyOptions} obj Optional instance to populate.
     * @return {module:model/ClientRedemptionsRedeemRequestBodyOptions} The populated <code>ClientRedemptionsRedeemRequestBodyOptions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemRequestBodyOptions</code>.
     */
 ...
 * @member {Array.<module:model/ClientRedemptionsRedeemRequestBodyOptions.ExpandEnum>} expand
 */

...
class LoyaltiesMemberActivityListResponseBody {
     ...
     * @return {module:model/LoyaltiesMemberActivityListResponseBody} The populated <code>LoyaltiesMemberActivityListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMemberActivityListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMemberActivityListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {Array.<module:model/MemberActivity>} data
 */

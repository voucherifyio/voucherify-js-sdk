...
class LoyaltyPointsBucketBucket {
     ...
     * @return {module:model/LoyaltyPointsBucketBucket} The populated <code>LoyaltyPointsBucketBucket</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyPointsBucketBucket</code>.
     */

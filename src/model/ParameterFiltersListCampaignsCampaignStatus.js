...
class ParameterFiltersListCampaignsCampaignStatus {
     ...
     * @return {module:model/ParameterFiltersListCampaignsCampaignStatus} The populated <code>ParameterFiltersListCampaignsCampaignStatus</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsCampaignStatus</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListCampaignsCampaignStatusConditions} conditions
 */

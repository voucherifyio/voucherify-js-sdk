...
class MemberActivityDataTransactionDetailsEarningRuleSource {
    ...
    constructor() { 
        ...
        MemberActivityDataTransactionDetailsEarningRuleSource.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataTransactionDetailsEarningRuleSource} The populated <code>MemberActivityDataTransactionDetailsEarningRuleSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataTransactionDetailsEarningRuleSource();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataTransactionDetailsEarningRuleSource</code>.
     */
...
export default MemberActivityDataTransactionDetailsEarningRuleSource;

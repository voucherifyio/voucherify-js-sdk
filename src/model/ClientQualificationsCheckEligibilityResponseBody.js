...
class ClientQualificationsCheckEligibilityResponseBody {
     ...
     * @return {module:model/ClientQualificationsCheckEligibilityResponseBody} The populated <code>ClientQualificationsCheckEligibilityResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientQualificationsCheckEligibilityResponseBody</code>.
     */
...
/**
 * @member {module:model/ClientQualificationsCheckEligibilityResponseBodyOrder} order
 */

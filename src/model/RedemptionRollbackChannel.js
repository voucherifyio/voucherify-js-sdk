...
class RedemptionRollbackChannel {
     ...
     * @return {module:model/RedemptionRollbackChannel} The populated <code>RedemptionRollbackChannel</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRollbackChannel</code>.
     */
 ...
 * @member {module:model/RedemptionRollbackChannel.ChannelTypeEnum} channel_type
 */

...
class OrderItemSku {
     ...
     * @alias module:model/OrderItemSku
     */
    constructor() { 
     ...
     * @param {module:model/OrderItemSku} obj Optional instance to populate.
     * @returns {module:model/OrderItemSku} The populated <code>OrderItemSku</code> instance.
     */

...
class VouchersBalanceUpdateResponseBodyRelatedObject {
     ...
     * @return {module:model/VouchersBalanceUpdateResponseBodyRelatedObject} The populated <code>VouchersBalanceUpdateResponseBodyRelatedObject</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersBalanceUpdateResponseBodyRelatedObject</code>.
     */
 ...
 * @member {module:model/VouchersBalanceUpdateResponseBodyRelatedObject.TypeEnum} type
 * @default 'voucher'
 */

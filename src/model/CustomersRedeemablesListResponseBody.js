...
class CustomersRedeemablesListResponseBody {
     ...
     * @return {module:model/CustomersRedeemablesListResponseBody} The populated <code>CustomersRedeemablesListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersRedeemablesListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/CustomerRedeemable>} data
 */

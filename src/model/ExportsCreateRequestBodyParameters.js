...
class ExportsCreateRequestBodyParameters {
     ...
     * @alias ExportsCreateRequestBodyParameters
     */
    constructor() { 
     ...
     * @param {Partial<ExportsCreateRequestBodyParameters>} data The plain JavaScript object bearing properties of interest.
     * @param {ExportsCreateRequestBodyParameters} [obj] Optional instance to populate.
     * @returns {ExportsCreateRequestBodyParameters} The populated <code>ExportsCreateRequestBodyParameters</code> instance.
     */
     ...
     * @param {Partial<ExportsCreateRequestBodyParameters>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ExportsCreateRequestBodyParameters</code>.
     */
...
/**
    * @type {(keyof typeof ExportsCreateRequestBodyParameters.OrderEnum) | undefined}
    */

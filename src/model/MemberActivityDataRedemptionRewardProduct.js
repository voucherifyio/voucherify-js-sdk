...
class MemberActivityDataRedemptionRewardProduct {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionRewardProduct.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionRewardProduct} The populated <code>MemberActivityDataRedemptionRewardProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionRewardProduct();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRewardProduct</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionRewardProduct.ObjectEnum} object
 * @default 'product'
 */
...
export default MemberActivityDataRedemptionRewardProduct;

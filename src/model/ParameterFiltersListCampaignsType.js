...
class ParameterFiltersListCampaignsType {
     ...
     * @return {module:model/ParameterFiltersListCampaignsType} The populated <code>ParameterFiltersListCampaignsType</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsType</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListCampaignsTypeConditions} conditions
 */

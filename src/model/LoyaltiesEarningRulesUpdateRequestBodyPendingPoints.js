...
class LoyaltiesEarningRulesUpdateRequestBodyPendingPoints {
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateRequestBodyPendingPoints} The populated <code>LoyaltiesEarningRulesUpdateRequestBodyPendingPoints</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateRequestBodyPendingPoints</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesUpdateRequestBodyPendingPoints.PeriodTypeEnum} period_type
 * @default 'DAY'
 */

...
class RedemptionsGetResponseBodyVoucherPublish {
     ...
     * @return {module:model/RedemptionsGetResponseBodyVoucherPublish} The populated <code>RedemptionsGetResponseBodyVoucherPublish</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyVoucherPublish</code>.
     */

...
class LocationsGetResponseBodyShapeDistance {
     ...
     * @return {module:model/LocationsGetResponseBodyShapeDistance} The populated <code>LocationsGetResponseBodyShapeDistance</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationsGetResponseBodyShapeDistance</code>.
     */

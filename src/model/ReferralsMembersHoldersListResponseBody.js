...
class ReferralsMembersHoldersListResponseBody {
    ...
    constructor() { 
        ...
        ReferralsMembersHoldersListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ReferralsMembersHoldersListResponseBody} The populated <code>ReferralsMembersHoldersListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReferralsMembersHoldersListResponseBody();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [RedeemableHolder]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReferralsMembersHoldersListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/RedeemableHolder>} data
 */
...
export default ReferralsMembersHoldersListResponseBody;

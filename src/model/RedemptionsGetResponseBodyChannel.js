...
class RedemptionsGetResponseBodyChannel {
     ...
     * @return {module:model/RedemptionsGetResponseBodyChannel} The populated <code>RedemptionsGetResponseBodyChannel</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyChannel</code>.
     */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyChannel.ChannelTypeEnum} channel_type
 */

...
class LoyaltyPendingPointsDetailsEarningRule {
     ...
     * @return {module:model/LoyaltyPendingPointsDetailsEarningRule} The populated <code>LoyaltyPendingPointsDetailsEarningRule</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyPendingPointsDetailsEarningRule</code>.
     */
...
/**
 * @member {module:model/LoyaltyPendingPointsDetailsEarningRuleSource} source
 */

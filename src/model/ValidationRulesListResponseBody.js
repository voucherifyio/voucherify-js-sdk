...
class ValidationRulesListResponseBody {
     ...
     * @return {module:model/ValidationRulesListResponseBody} The populated <code>ValidationRulesListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/ValidationRule>} data
 */

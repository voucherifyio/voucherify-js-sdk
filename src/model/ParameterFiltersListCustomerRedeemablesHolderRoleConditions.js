...
class ParameterFiltersListCustomerRedeemablesHolderRoleConditions {
    ...
    constructor() { 
        ...
        ParameterFiltersListCustomerRedeemablesHolderRoleConditions.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions} The populated <code>ParameterFiltersListCustomerRedeemablesHolderRoleConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListCustomerRedeemablesHolderRoleConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCustomerRedeemablesHolderRoleConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions.InEnum>} $in
 */
ParameterFiltersListCustomerRedeemablesHolderRoleConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions.NotInEnum>} $not_in
 */
 ...
 * @member {module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions.IsEnum} $is
 */
ParameterFiltersListCustomerRedeemablesHolderRoleConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions.IsNotEnum} $is_not
 */
 ...
 * @readonly
 */
ParameterFiltersListCustomerRedeemablesHolderRoleConditions['InEnum'] = {
 ...
 * @readonly
 */
ParameterFiltersListCustomerRedeemablesHolderRoleConditions['NotInEnum'] = {
...
export default ParameterFiltersListCustomerRedeemablesHolderRoleConditions;

...
class SegmentsCreateResponseBody {
     ...
     * @alias module:model/SegmentsCreateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/SegmentsCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/SegmentsCreateResponseBody} The populated <code>SegmentsCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentsCreateResponseBody</code>.
     */
 ...
 * @member {module:model/SegmentsCreateResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/SegmentsCreateResponseBody.InitialSyncStatusEnum} initial_sync_status
 */
 ...
 * @member {module:model/SegmentsCreateResponseBody.ObjectEnum} object
 * @default 'segment'
 */

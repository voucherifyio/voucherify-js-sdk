...
class OrdersImportCreateRequestBodyItem {
    ...
    constructor() { 
        ...
        OrdersImportCreateRequestBodyItem.initialize(this);
    }
     ...
     * @return {module:model/OrdersImportCreateRequestBodyItem} The populated <code>OrdersImportCreateRequestBodyItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersImportCreateRequestBodyItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersImportCreateRequestBodyItem</code>.
     */
...
/**
 * The order status.
 * @member {module:model/OrdersImportCreateRequestBodyItem.StatusEnum} status
 */
...
export default OrdersImportCreateRequestBodyItem;

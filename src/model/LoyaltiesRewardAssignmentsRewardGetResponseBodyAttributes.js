...
class LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes {
    ...
    constructor() { 
        ...
        LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes} The populated <code>LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes</code>.
     */
...
export default LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes;

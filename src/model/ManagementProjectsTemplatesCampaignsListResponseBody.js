...
class ManagementProjectsTemplatesCampaignsListResponseBody {
     ...
     * @return {module:model/ManagementProjectsTemplatesCampaignsListResponseBody} The populated <code>ManagementProjectsTemplatesCampaignsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsTemplatesCampaignsListResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsTemplatesCampaignsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsTemplatesCampaignsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */

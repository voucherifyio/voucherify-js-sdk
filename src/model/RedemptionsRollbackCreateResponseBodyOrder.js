...
class RedemptionsRollbackCreateResponseBodyOrder {
    ...
    constructor() { 
        ...
        RedemptionsRollbackCreateResponseBodyOrder.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsRollbackCreateResponseBodyOrder} The populated <code>RedemptionsRollbackCreateResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsRollbackCreateResponseBodyOrder();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRollbackCreateResponseBodyOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/RedemptionsRollbackCreateResponseBodyOrder.StatusEnum} status
 */
 ...
 * @member {module:model/RedemptionsRollbackCreateResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
...
export default RedemptionsRollbackCreateResponseBodyOrder;

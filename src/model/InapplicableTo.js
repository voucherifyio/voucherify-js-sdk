...
class InapplicableTo {
     ...
     * @return {module:model/InapplicableTo} The populated <code>InapplicableTo</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InapplicableTo</code>.
     */
 ...
 * @member {module:model/InapplicableTo.ObjectEnum} object
 */
 ...
 * @member {Array.<module:model/InapplicableToOrderItemUnitsItem>} order_item_units
 */
 ...
 * @member {module:model/InapplicableTo.TargetEnum} target
 */

...
class VoucherTransactionDetailsRollback {
    ...
    constructor() { 
        ...
        VoucherTransactionDetailsRollback.initialize(this);
    }
     ...
     * @return {module:model/VoucherTransactionDetailsRollback} The populated <code>VoucherTransactionDetailsRollback</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherTransactionDetailsRollback();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionDetailsRollback</code>.
     */
...
export default VoucherTransactionDetailsRollback;

...
class CampaignsVouchersCreateCombinedResponseBodyGift {
     ...
     * @return {module:model/CampaignsVouchersCreateCombinedResponseBodyGift} The populated <code>CampaignsVouchersCreateCombinedResponseBodyGift</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateCombinedResponseBodyGift</code>.
     */
 ...
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBodyGift.EffectEnum} effect
 */

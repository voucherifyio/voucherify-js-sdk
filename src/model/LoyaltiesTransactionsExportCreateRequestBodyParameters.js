...
class LoyaltiesTransactionsExportCreateRequestBodyParameters {
    ...
    constructor() { 
        ...
        LoyaltiesTransactionsExportCreateRequestBodyParameters.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesTransactionsExportCreateRequestBodyParameters} The populated <code>LoyaltiesTransactionsExportCreateRequestBodyParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesTransactionsExportCreateRequestBodyParameters();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTransactionsExportCreateRequestBodyParameters</code>.
     */
 ...
 * @member {module:model/LoyaltiesTransactionsExportCreateRequestBodyParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/LoyaltiesTransactionsExportCreateRequestBodyParameters.FieldsEnum>} fields
 */
 ...
 * @readonly
 */
LoyaltiesTransactionsExportCreateRequestBodyParameters['FieldsEnum'] = {
...
export default LoyaltiesTransactionsExportCreateRequestBodyParameters;

...
class VouchersRedemptionGetResponseBody {
     ...
     * @return {module:model/VouchersRedemptionGetResponseBody} The populated <code>VouchersRedemptionGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersRedemptionGetResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/RedemptionEntry>} redemption_entries
 */

...
class RedemptionsRedeemResponseBody {
     ...
     * @alias module:model/RedemptionsRedeemResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionsRedeemResponseBody} obj Optional instance to populate.
     * @return {module:model/RedemptionsRedeemResponseBody} The populated <code>RedemptionsRedeemResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRedeemResponseBody</code>.
     */
...
/**
 * @member {module:model/RedemptionsRedeemResponseBodyOrder} order
 */

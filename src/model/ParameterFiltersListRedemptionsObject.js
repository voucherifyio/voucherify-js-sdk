...
class ParameterFiltersListRedemptionsObject {
    ...
    constructor() { 
        ...
        ParameterFiltersListRedemptionsObject.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListRedemptionsObject} The populated <code>ParameterFiltersListRedemptionsObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListRedemptionsObject();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListRedemptionsObject</code>.
     */
...
export default ParameterFiltersListRedemptionsObject;

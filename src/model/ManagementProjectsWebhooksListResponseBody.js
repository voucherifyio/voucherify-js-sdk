...
class ManagementProjectsWebhooksListResponseBody {
     ...
     * @return {module:model/ManagementProjectsWebhooksListResponseBody} The populated <code>ManagementProjectsWebhooksListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhooksListResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsWebhooksListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsWebhooksListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhook>} data
 */

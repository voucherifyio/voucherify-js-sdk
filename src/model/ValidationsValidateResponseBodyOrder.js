...
class ValidationsValidateResponseBodyOrder {
     ...
     * @alias ValidationsValidateResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<ValidationsValidateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationsValidateResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {ValidationsValidateResponseBodyOrder} The populated <code>ValidationsValidateResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<ValidationsValidateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof ValidationsValidateResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof ValidationsValidateResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
...
/**
    ...
    * @type {Array.<ValidationsValidateResponseBodyOrderItemsItem> | undefined}
    */

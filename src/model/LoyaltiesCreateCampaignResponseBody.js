...
class LoyaltiesCreateCampaignResponseBody {
     ...
     * @return {module:model/LoyaltiesCreateCampaignResponseBody} The populated <code>LoyaltiesCreateCampaignResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesCreateCampaignResponseBody</code>.
     */
...
/**
 * Type of campaign.
 * @member {module:model/LoyaltiesCreateCampaignResponseBody.CampaignTypeEnum} campaign_type
 ...
 * @member {module:model/LoyaltiesCreateCampaignResponseBody.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/LoyaltiesCreateCampaignResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @member {module:model/LoyaltiesCreateCampaignResponseBody.CreationStatusEnum} creation_status
 */
 ...
 * @member {module:model/LoyaltiesCreateCampaignResponseBody.VouchersGenerationStatusEnum} vouchers_generation_status
 */

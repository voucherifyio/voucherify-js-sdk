...
class MemberActivityDataTransaction {
     ...
     * @return {module:model/MemberActivityDataTransaction} The populated <code>MemberActivityDataTransaction</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataTransaction</code>.
     */
...
/**
 * @member {module:model/MemberActivityDataTransactionDetails} details
 */
MemberActivityDataTransaction.prototype['details'] = undefined;

/**
 * @member {module:model/MemberActivityDataTransaction.TypeEnum} type
 */

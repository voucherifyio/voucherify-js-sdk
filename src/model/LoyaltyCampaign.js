...
class LoyaltyCampaign {
     ...
     * @param {Partial<LoyaltyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @param {LoyaltyCampaign} [obj] Optional instance to populate.
     * @returns {LoyaltyCampaign} The populated <code>LoyaltyCampaign</code> instance.
     */
     ...
     * @param {Partial<LoyaltyCampaign>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCampaign</code>.
     */
...
/**
    * Type of campaign.
    * @type {(keyof typeof LoyaltyCampaign.CampaignTypeEnum) | undefined}
...
/**
    ...
    * @type {(keyof typeof LoyaltyCampaign.TypeEnum) | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof LoyaltyCampaign.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof LoyaltyCampaign.CreationStatusEnum) | undefined}
    */
LoyaltyCampaign.prototype['creation_status'] = undefined;

/**
    * Indicates the status of the campaign's voucher generation.
    * @type {(keyof typeof LoyaltyCampaign.VouchersGenerationStatusEnum) | undefined}
    */

...
class LoyaltyCampaign {
    ...
    /**
     * Validates the JSON data with respect to <code>LoyaltyCampaign</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCampaign</code>.
     */
 ...
 * @member {String} id
 */
LoyaltyCampaign.prototype['id'] = undefined;

/**
 * Campaign name.
 * @member {String} name
 */
LoyaltyCampaign.prototype['name'] = undefined;

/**
 * An optional field to keep any extra textual information about the campaign such as a campaign description and details.
 * @member {String} description
 */
LoyaltyCampaign.prototype['description'] = undefined;

/**
 * Type of campaign.
 * @member {module:model/LoyaltyCampaign.CampaignTypeEnum} campaign_type
 * @default 'LOYALTY_PROGRAM'
 */
LoyaltyCampaign.prototype['campaign_type'] = 'LOYALTY_PROGRAM';
 ...
 * @member {module:model/LoyaltyCampaign.TypeEnum} type
 */
LoyaltyCampaign.prototype['type'] = undefined;

/**
 * @member {module:model/LoyaltyCampaignVoucher} voucher
 */
LoyaltyCampaign.prototype['voucher'] = undefined;

/**
 * Indicates whether customers will be able to auto-join a loyalty campaign if any earning rule is fulfilled.
 * @member {Boolean} auto_join
 */
LoyaltyCampaign.prototype['auto_join'] = undefined;
 ...
 */
LoyaltyCampaign.prototype['join_once'] = undefined;
 ...
 */
LoyaltyCampaign.prototype['use_voucher_metadata_schema'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
LoyaltyCampaign.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/LoyaltyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */
LoyaltyCampaign.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
LoyaltyCampaign.prototype['validity_hours'] = undefined;
 ...
 */
LoyaltyCampaign.prototype['activity_duration_after_publishing'] = undefined;

/**
 * Total number of unique vouchers in campaign.
 * @member {Number} vouchers_count
 */
LoyaltyCampaign.prototype['vouchers_count'] = undefined;

/**
 * Activation timestamp defines when the campaign starts to be active in ISO 8601 format. Campaign is *inactive before* this date. 
 * @member {Date} start_date
 */
LoyaltyCampaign.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the campaign expires in ISO 8601 format.  Campaign is *inactive after* this date.
 * @member {Date} expiration_date
 */
LoyaltyCampaign.prototype['expiration_date'] = undefined;
 ...
 */
LoyaltyCampaign.prototype['active'] = undefined;

/**
 * The metadata object stores all custom attributes assigned to the campaign. A set of key/value pairs that you can attach to a campaign object. It can be useful for storing additional information about the campaign in a structured format.
 * @member {Object} metadata
 */
LoyaltyCampaign.prototype['metadata'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
LoyaltyCampaign.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
LoyaltyCampaign.prototype['updated_at'] = undefined;

/**
 * Unique category name.
 * @member {String} category
 */
LoyaltyCampaign.prototype['category'] = undefined;

/**
 * Indicates the status of the campaign creation.
 * @member {module:model/LoyaltyCampaign.CreationStatusEnum} creation_status
 */
LoyaltyCampaign.prototype['creation_status'] = undefined;

/**
 * Indicates the status of the campaign's voucher generation.
 * @member {module:model/LoyaltyCampaign.VouchersGenerationStatusEnum} vouchers_generation_status
 */
LoyaltyCampaign.prototype['vouchers_generation_status'] = undefined;
 ...
 */
LoyaltyCampaign.prototype['readonly'] = undefined;

/**
 * Indicates whether the resource can be deleted.
 * @member {Boolean} protected
 */
LoyaltyCampaign.prototype['protected'] = undefined;

/**
 * Unique category ID that this campaign belongs to.
 * @member {String} category_id
 */
LoyaltyCampaign.prototype['category_id'] = undefined;

/**
 * Contains details about the category.
 * @member {Array.<module:model/Category>} categories
 */
LoyaltyCampaign.prototype['categories'] = undefined;
 ...
 * @readonly
 */
LoyaltyCampaign['CampaignTypeEnum'] = {
 ...
 * @readonly
 */
LoyaltyCampaign['ValidityDayOfWeekEnum'] = {
 ...
 * @readonly
 */
LoyaltyCampaign['CreationStatusEnum'] = {
 ...
 * @readonly
 */
LoyaltyCampaign['VouchersGenerationStatusEnum'] = {

...
class RedemptionsGetResponseBodyOrder {
     ...
     * @alias module:model/RedemptionsGetResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionsGetResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionsGetResponseBodyOrder} The populated <code>RedemptionsGetResponseBodyOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/RedemptionsGetResponseBodyOrder.StatusEnum} status
 */
 ...
 * @member {module:model/RedemptionsGetResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyOrderCustomer} customer
 */
RedemptionsGetResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/RedemptionsGetResponseBodyOrderReferrer} referrer
 */
 ...
 * @member {Array.<module:model/RedemptionsGetResponseBodyOrderItemsItem>} items
 */

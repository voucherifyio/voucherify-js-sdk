...
class RedemptionsListResponseBodyRedemptionsItemOrderReferrer {
    ...
    constructor() { 
        ...
        RedemptionsListResponseBodyRedemptionsItemOrderReferrer.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsListResponseBodyRedemptionsItemOrderReferrer} The populated <code>RedemptionsListResponseBodyRedemptionsItemOrderReferrer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsListResponseBodyRedemptionsItemOrderReferrer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBodyRedemptionsItemOrderReferrer</code>.
     */
 ...
 * @member {module:model/RedemptionsListResponseBodyRedemptionsItemOrderReferrer.ObjectEnum} object
 * @default 'customer'
 */
...
export default RedemptionsListResponseBodyRedemptionsItemOrderReferrer;

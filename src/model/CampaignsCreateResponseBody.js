...
class CampaignsCreateResponseBody {
     ...
     * @alias CampaignsCreateResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<CampaignsCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {CampaignsCreateResponseBody} [obj] Optional instance to populate.
     * @returns {CampaignsCreateResponseBody} The populated <code>CampaignsCreateResponseBody</code> instance.
     */
     ...
     * @param {Partial<CampaignsCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsCreateResponseBody</code>.
     */
...
/**
    * Type of campaign.
    * @type {(keyof typeof CampaignsCreateResponseBody.CampaignTypeEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof CampaignsCreateResponseBody.TypeEnum) | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof CampaignsCreateResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof CampaignsCreateResponseBody.CreationStatusEnum) | undefined}
    */
CampaignsCreateResponseBody.prototype['creation_status'] = undefined;

/**
    * Indicates the status of the campaign's voucher generation.
    * @type {(keyof typeof CampaignsCreateResponseBody.VouchersGenerationStatusEnum) | undefined}
    */

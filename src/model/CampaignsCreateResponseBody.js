...
class CampaignsCreateResponseBody {
    /**
     * Constructs a new <code>CampaignsCreateResponseBody</code>.
     * Response body schema for **POST** &#x60;v1/campaigns/{campaignId}&#x60;.
     * @alias module:model/CampaignsCreateResponseBody
     */
    constructor() { 
        
        CampaignsCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignsCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignsCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/CampaignsCreateResponseBody} The populated <code>CampaignsCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsCreateResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignsCreateResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsCreateResponseBody</code>.
     */
 ...
 * @member {String} id
 */
CampaignsCreateResponseBody.prototype['id'] = undefined;

/**
 * Campaign name.
 * @member {String} name
 */
CampaignsCreateResponseBody.prototype['name'] = undefined;

/**
 * An optional field to keep any extra textual information about the campaign such as a campaign description and details.
 * @member {String} description
 */
CampaignsCreateResponseBody.prototype['description'] = undefined;

/**
 * Type of campaign.
 * @member {module:model/CampaignsCreateResponseBody.CampaignTypeEnum} campaign_type
 */
CampaignsCreateResponseBody.prototype['campaign_type'] = undefined;
 ...
 * @member {module:model/CampaignsCreateResponseBody.TypeEnum} type
 */
CampaignsCreateResponseBody.prototype['type'] = undefined;

/**
 * @member {module:model/CampaignVoucher} voucher
 */
CampaignsCreateResponseBody.prototype['voucher'] = undefined;

/**
 * Indicates whether customers will be able to auto-join a loyalty campaign if any earning rule is fulfilled.
 * @member {Boolean} auto_join
 */
CampaignsCreateResponseBody.prototype['auto_join'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['join_once'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['use_voucher_metadata_schema'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
CampaignsCreateResponseBody.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/CampaignsCreateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
CampaignsCreateResponseBody.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
CampaignsCreateResponseBody.prototype['validity_hours'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['activity_duration_after_publishing'] = undefined;

/**
 * Total number of unique vouchers in campaign.
 * @member {Number} vouchers_count
 */
CampaignsCreateResponseBody.prototype['vouchers_count'] = undefined;

/**
 * Activation timestamp defines when the campaign starts to be active in ISO 8601 format. Campaign is *inactive before* this date. 
 * @member {Date} start_date
 */
CampaignsCreateResponseBody.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the campaign expires in ISO 8601 format.  Campaign is *inactive after* this date.
 * @member {Date} expiration_date
 */
CampaignsCreateResponseBody.prototype['expiration_date'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['active'] = undefined;

/**
 * The metadata object stores all custom attributes assigned to the campaign. A set of key/value pairs that you can attach to a campaign object. It can be useful for storing additional information about the campaign in a structured format.
 * @member {Object} metadata
 */
CampaignsCreateResponseBody.prototype['metadata'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
CampaignsCreateResponseBody.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the campaign was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
CampaignsCreateResponseBody.prototype['updated_at'] = undefined;

/**
 * Unique category name.
 * @member {String} category
 */
CampaignsCreateResponseBody.prototype['category'] = undefined;

/**
 * Indicates the status of the campaign creation.
 * @member {module:model/CampaignsCreateResponseBody.CreationStatusEnum} creation_status
 */
CampaignsCreateResponseBody.prototype['creation_status'] = undefined;

/**
 * Indicates the status of the campaign's voucher generation.
 * @member {module:model/CampaignsCreateResponseBody.VouchersGenerationStatusEnum} vouchers_generation_status
 */
CampaignsCreateResponseBody.prototype['vouchers_generation_status'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['readonly'] = undefined;

/**
 * Indicates whether the resource can be deleted.
 * @member {Boolean} protected
 */
CampaignsCreateResponseBody.prototype['protected'] = undefined;

/**
 * Unique category ID that this campaign belongs to.
 * @member {String} category_id
 */
CampaignsCreateResponseBody.prototype['category_id'] = undefined;
 ...
 */
CampaignsCreateResponseBody.prototype['categories'] = undefined;
 ...
 * @default 'campaign'
 */
CampaignsCreateResponseBody.prototype['object'] = 'campaign';

/**
 * @member {module:model/ReferralProgram} referral_program
 */
CampaignsCreateResponseBody.prototype['referral_program'] = undefined;

/**
 * @member {module:model/LoyaltyTiersExpirationAll} loyalty_tiers_expiration
 */
CampaignsCreateResponseBody.prototype['loyalty_tiers_expiration'] = undefined;

/**
 * @member {module:model/AccessSettingsCampaignAssignmentsList} access_settings_assignments
 */
CampaignsCreateResponseBody.prototype['access_settings_assignments'] = undefined;

/**
 * @member {module:model/PromotionTiersList} promotion
 */
CampaignsCreateResponseBody.prototype['promotion'] = undefined;

/**
 * @member {module:model/ValidationRulesAssignmentsList} validation_rules_assignments
 */
CampaignsCreateResponseBody.prototype['validation_rules_assignments'] = undefined;
 ...
 * @readonly
 */
CampaignsCreateResponseBody['CampaignTypeEnum'] = {
 ...
 * @readonly
 */
CampaignsCreateResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
CampaignsCreateResponseBody['ValidityDayOfWeekEnum'] = {
 ...
 * @readonly
 */
CampaignsCreateResponseBody['CreationStatusEnum'] = {
 ...
 * @readonly
 */
CampaignsCreateResponseBody['VouchersGenerationStatusEnum'] = {
...
export default CampaignsCreateResponseBody;

...
class MemberActivityDataRedemptionRelatedRedemptions {
     ...
     * @return {module:model/MemberActivityDataRedemptionRelatedRedemptions} The populated <code>MemberActivityDataRedemptionRelatedRedemptions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionRelatedRedemptions</code>.
     */
...
/**
 * @member {Array.<module:model/MemberActivityDataRedemptionRelatedRedemptionsRollbacksItem>} rollbacks
 */
MemberActivityDataRedemptionRelatedRedemptions.prototype['rollbacks'] = undefined;

/**
 * @member {Array.<module:model/MemberActivityDataRedemptionRelatedRedemptionsRedemptionsItem>} redemptions
 */

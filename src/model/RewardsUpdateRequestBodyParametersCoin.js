...
class RewardsUpdateRequestBodyParametersCoin {
    ...
    constructor() { 
        ...
        RewardsUpdateRequestBodyParametersCoin.initialize(this);
    }
     ...
     * @return {module:model/RewardsUpdateRequestBodyParametersCoin} The populated <code>RewardsUpdateRequestBodyParametersCoin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RewardsUpdateRequestBodyParametersCoin();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsUpdateRequestBodyParametersCoin</code>.
     */
...
export default RewardsUpdateRequestBodyParametersCoin;

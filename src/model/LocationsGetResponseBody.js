...
class LocationsGetResponseBody {
     ...
     * @return {module:model/LocationsGetResponseBody} The populated <code>LocationsGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationsGetResponseBody</code>.
     */
 ...
 * @member {module:model/LocationsGetResponseBody.ObjectEnum} object
 * @default 'location'
 */
...
/**
 * @member {module:model/LocationsGetResponseBodyShape} shape
 */

...
class ReferralProgramRefereeRewardRelatedObjectParent {
     ...
     * @return {module:model/ReferralProgramRefereeRewardRelatedObjectParent} The populated <code>ReferralProgramRefereeRewardRelatedObjectParent</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReferralProgramRefereeRewardRelatedObjectParent</code>.
     */
 ...
 * @member {module:model/ReferralProgramRefereeRewardRelatedObjectParent.ObjectEnum} object
 * @default 'CAMPAIGN'
 */

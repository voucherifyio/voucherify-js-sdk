...
class OrdersGetResponseBody {
     ...
     * @param {Partial<OrdersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {OrdersGetResponseBody} [obj] Optional instance to populate.
     * @returns {OrdersGetResponseBody} The populated <code>OrdersGetResponseBody</code> instance.
     */
     ...
     * @param {Partial<OrdersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersGetResponseBody</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof OrdersGetResponseBody.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof OrdersGetResponseBody.ObjectEnum) | undefined}
    * @default 'order'
    */

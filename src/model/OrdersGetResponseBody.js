...
class OrdersGetResponseBody {
    /**
     * Constructs a new <code>OrdersGetResponseBody</code>.
     * Response body schema for **GET** &#x60;v1/orders/{orderId}&#x60;.
     * @alias module:model/OrdersGetResponseBody
     */
    constructor() { 
        
        OrdersGetResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrdersGetResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrdersGetResponseBody} obj Optional instance to populate.
     * @return {module:model/OrdersGetResponseBody} The populated <code>OrdersGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersGetResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>OrdersGetResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersGetResponseBody</code>.
     */
 ...
 * @member {String} id
 */
OrdersGetResponseBody.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
OrdersGetResponseBody.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/OrdersGetResponseBody.StatusEnum} status
 */
OrdersGetResponseBody.prototype['status'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['initial_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['items_discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['total_discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['total_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['applied_discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
OrdersGetResponseBody.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/OrdersGetResponseBody.ObjectEnum} object
 * @default 'order'
 */
OrdersGetResponseBody.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
OrdersGetResponseBody.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
OrdersGetResponseBody.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
OrdersGetResponseBody.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
OrdersGetResponseBody.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
OrdersGetResponseBody.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
OrdersGetResponseBody.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
OrdersGetResponseBody.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
OrdersGetResponseBody.prototype['items'] = undefined;
 ...
 * @readonly
 */
OrdersGetResponseBody['StatusEnum'] = {
 ...
 * @readonly
 */
OrdersGetResponseBody['ObjectEnum'] = {
...
export default OrdersGetResponseBody;

...
class ParameterFiltersListCustomerRedeemablesHolderRole {
     ...
     * @return {module:model/ParameterFiltersListCustomerRedeemablesHolderRole} The populated <code>ParameterFiltersListCustomerRedeemablesHolderRole</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCustomerRedeemablesHolderRole</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListCustomerRedeemablesHolderRoleConditions} conditions
 */

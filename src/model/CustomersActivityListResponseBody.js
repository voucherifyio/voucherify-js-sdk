...
class CustomersActivityListResponseBody {
     ...
     * @return {module:model/CustomersActivityListResponseBody} The populated <code>CustomersActivityListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersActivityListResponseBody</code>.
     */
 ...
 * @member {module:model/CustomersActivityListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {Array.<module:model/CustomerActivity>} data
 */

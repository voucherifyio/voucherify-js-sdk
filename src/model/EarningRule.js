...
import EarningRuleCustomEvent from './EarningRuleCustomEvent';
import EarningRuleExpirationRules from './EarningRuleExpirationRules';
import EarningRuleLoyalty from './EarningRuleLoyalty';
import EarningRuleLoyaltyTier from './EarningRuleLoyaltyTier';
import EarningRulePendingPoints from './EarningRulePendingPoints';
import EarningRuleSegment from './EarningRuleSegment';
...
class EarningRule {
     ...
     * @return {module:model/EarningRule} The populated <code>EarningRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRule();
            ...
            if (data.hasOwnProperty('loyalty')) {
                obj['loyalty'] = EarningRuleLoyalty.constructFromObject(data['loyalty']);
            }
            if (data.hasOwnProperty('event')) {
                obj['event'] = ApiClient.convertToType(data['event'], 'String');
            }
            if (data.hasOwnProperty('custom_event')) {
                obj['custom_event'] = EarningRuleCustomEvent.constructFromObject(data['custom_event']);
            }
            if (data.hasOwnProperty('segment')) {
                obj['segment'] = EarningRuleSegment.constructFromObject(data['segment']);
            }
            if (data.hasOwnProperty('loyalty_tier')) {
                obj['loyalty_tier'] = EarningRuleLoyaltyTier.constructFromObject(data['loyalty_tier']);
            }
            if (data.hasOwnProperty('pending_points')) {
                obj['pending_points'] = EarningRulePendingPoints.constructFromObject(data['pending_points']);
            }
            if (data.hasOwnProperty('source')) {
                obj['source'] = EarningRuleSource.constructFromObject(data['source']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRule</code>.
     */
    static validateJSON(data) {
        ...
        if (data['loyalty']) { // data not null
          EarningRuleLoyalty.validateJSON(data['loyalty']);
        }
        // ensure the json data is a string
        ...
        if (data['custom_event']) { // data not null
          EarningRuleCustomEvent.validateJSON(data['custom_event']);
        }
        // validate the optional field `segment`
        if (data['segment']) { // data not null
          EarningRuleSegment.validateJSON(data['segment']);
        }
        // validate the optional field `loyalty_tier`
        if (data['loyalty_tier']) { // data not null
          EarningRuleLoyaltyTier.validateJSON(data['loyalty_tier']);
        }
        // validate the optional field `pending_points`
        if (data['pending_points']) { // data not null
          EarningRulePendingPoints.validateJSON(data['pending_points']);
        }
        // validate the optional field `source`
        if (data['source']) { // data not null
          EarningRuleSource.validateJSON(data['source']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/EarningRuleLoyalty} loyalty
 */
...
/**
 * @member {module:model/EarningRuleCustomEvent} custom_event
 */
EarningRule.prototype['custom_event'] = undefined;

/**
 * @member {module:model/EarningRuleSegment} segment
 */
EarningRule.prototype['segment'] = undefined;

/**
 * @member {module:model/EarningRuleLoyaltyTier} loyalty_tier
 */
EarningRule.prototype['loyalty_tier'] = undefined;

/**
 * @member {module:model/EarningRulePendingPoints} pending_points
 */
EarningRule.prototype['pending_points'] = undefined;

/**
 * @member {module:model/EarningRuleSource} source
 */
EarningRule.prototype['source'] = undefined;

/**
 * The type of the object represented by JSON. Default is earning_rule.
 * @member {module:model/EarningRule.ObjectEnum} object
 ...
 * @member {Array.<module:model/EarningRule.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @readonly
 */
EarningRule['ValidityDayOfWeekEnum'] = {

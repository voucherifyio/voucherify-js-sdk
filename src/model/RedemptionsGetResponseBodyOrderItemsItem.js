...
class RedemptionsGetResponseBodyOrderItemsItem {
    ...
    constructor() { 
        ...
        RedemptionsGetResponseBodyOrderItemsItem.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsGetResponseBodyOrderItemsItem} The populated <code>RedemptionsGetResponseBodyOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsGetResponseBodyOrderItemsItem();
            ...
            if (data.hasOwnProperty('product')) {
                obj['product'] = RedemptionsGetResponseBodyOrderItemsItemProduct.constructFromObject(data['product']);
            }
            if (data.hasOwnProperty('sku')) {
                obj['sku'] = RedemptionsGetResponseBodyOrderItemsItemSku.constructFromObject(data['sku']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyOrderItemsItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['product']) { // data not null
          RedemptionsGetResponseBodyOrderItemsItemProduct.validateJSON(data['product']);
        }
        // validate the optional field `sku`
        if (data['sku']) { // data not null
          RedemptionsGetResponseBodyOrderItemsItemSku.validateJSON(data['sku']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/RedemptionsGetResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyOrderItemsItemProduct} product
 */
RedemptionsGetResponseBodyOrderItemsItem.prototype['product'] = undefined;

/**
 * @member {module:model/RedemptionsGetResponseBodyOrderItemsItemSku} sku
 */
RedemptionsGetResponseBodyOrderItemsItem.prototype['sku'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/RedemptionsGetResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */
...
export default RedemptionsGetResponseBodyOrderItemsItem;

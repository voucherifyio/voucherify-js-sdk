...
class CategoriesUpdateRequestBody {
    ...
    constructor() { 
        ...
        CategoriesUpdateRequestBody.initialize(this);
    }
     ...
     * @return {module:model/CategoriesUpdateRequestBody} The populated <code>CategoriesUpdateRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesUpdateRequestBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesUpdateRequestBody</code>.
     */
...
export default CategoriesUpdateRequestBody;

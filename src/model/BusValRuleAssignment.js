...
class BusValRuleAssignment {
     ...
     * @return {module:model/BusValRuleAssignment} The populated <code>BusValRuleAssignment</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BusValRuleAssignment</code>.
     */
 ...
 * @member {module:model/BusValRuleAssignment.ObjectEnum} object
 ...
 * @member {module:model/BusValRuleAssignment.ValidationStatusEnum} validation_status
 */
BusValRuleAssignment.prototype['validation_status'] = undefined;

/**
 * The list of omitted rules
 * @member {Array.<String>} validation_omitted_rules
 */

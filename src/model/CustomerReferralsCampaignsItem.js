...
class CustomerReferralsCampaignsItem {
     ...
     * @return {module:model/CustomerReferralsCampaignsItem} The populated <code>CustomerReferralsCampaignsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerReferralsCampaignsItem</code>.
     */

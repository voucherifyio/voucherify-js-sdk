...
class CampaignsUpdateResponseBody {
     ...
     * @alias module:model/CampaignsUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/CampaignsUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/CampaignsUpdateResponseBody} The populated <code>CampaignsUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsUpdateResponseBody</code>.
     */
...
/**
 * Type of campaign.
 * @member {module:model/CampaignsUpdateResponseBody.CampaignTypeEnum} campaign_type
 */
 ...
 * @member {module:model/CampaignsUpdateResponseBody.TypeEnum} type
 */
CampaignsUpdateResponseBody.prototype['type'] = undefined;

/**
 * @member {module:model/CampaignVoucher} voucher
 */
 ...
 * @member {Array.<module:model/CampaignsUpdateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @member {module:model/CampaignsUpdateResponseBody.CreationStatusEnum} creation_status
 */
CampaignsUpdateResponseBody.prototype['creation_status'] = undefined;

/**
 * Indicates the status of the campaign's voucher generation.
 * @member {module:model/CampaignsUpdateResponseBody.VouchersGenerationStatusEnum} vouchers_generation_status
 */
...
/**
 * @member {module:model/PromotionTiersList} promotion
 */

...
class ValidationsRedeemableSkippedResultDetails {
     ...
     * @return {module:model/ValidationsRedeemableSkippedResultDetails} The populated <code>ValidationsRedeemableSkippedResultDetails</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsRedeemableSkippedResultDetails</code>.
     */
...
/**
 * @member {module:model/ValidationsRedeemableSkippedResultDetails.KeyEnum} key
 */

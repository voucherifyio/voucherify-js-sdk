...
class LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem {
    ...
    constructor() { 
        ...
        LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem</code>.
     */
...
export default LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptionsRedemptionsItem;

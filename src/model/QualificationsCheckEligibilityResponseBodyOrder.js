...
class QualificationsCheckEligibilityResponseBodyOrder {
     ...
     * @alias QualificationsCheckEligibilityResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<QualificationsCheckEligibilityResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {QualificationsCheckEligibilityResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {QualificationsCheckEligibilityResponseBodyOrder} The populated <code>QualificationsCheckEligibilityResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<QualificationsCheckEligibilityResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsCheckEligibilityResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof QualificationsCheckEligibilityResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof QualificationsCheckEligibilityResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */

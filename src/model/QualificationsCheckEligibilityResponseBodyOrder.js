...
class QualificationsCheckEligibilityResponseBodyOrder {
    /**
     * Constructs a new <code>QualificationsCheckEligibilityResponseBodyOrder</code>.
     * @alias module:model/QualificationsCheckEligibilityResponseBodyOrder
     */
    constructor() { 
        
        QualificationsCheckEligibilityResponseBodyOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QualificationsCheckEligibilityResponseBodyOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QualificationsCheckEligibilityResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/QualificationsCheckEligibilityResponseBodyOrder} The populated <code>QualificationsCheckEligibilityResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QualificationsCheckEligibilityResponseBodyOrder();
    ...
    /**
     * Validates the JSON data with respect to <code>QualificationsCheckEligibilityResponseBodyOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsCheckEligibilityResponseBodyOrder</code>.
     */
 ...
 * @member {String} id
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/QualificationsCheckEligibilityResponseBodyOrder.StatusEnum} status
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['status'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['initial_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['total_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/QualificationsCheckEligibilityResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
QualificationsCheckEligibilityResponseBodyOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
QualificationsCheckEligibilityResponseBodyOrder['StatusEnum'] = {
 ...
 * @readonly
 */
QualificationsCheckEligibilityResponseBodyOrder['ObjectEnum'] = {
...
export default QualificationsCheckEligibilityResponseBodyOrder;

...
class CategoriesCreateResponseBody {
     ...
     * @return {module:model/CategoriesCreateResponseBody} The populated <code>CategoriesCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesCreateResponseBody</code>.
     */
...
/**
 * @member {module:model/CategoriesCreateResponseBody.ObjectEnum} object
 * @default 'category'
 */

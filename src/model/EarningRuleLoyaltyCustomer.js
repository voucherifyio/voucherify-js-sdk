...
class EarningRuleLoyaltyCustomer {
    ...
    constructor() { 
        ...
        EarningRuleLoyaltyCustomer.initialize(this);
    }
     ...
     * @return {module:model/EarningRuleLoyaltyCustomer} The populated <code>EarningRuleLoyaltyCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRuleLoyaltyCustomer();

            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = EarningRuleLoyaltyCustomerMetadata.constructFromObject(data['metadata']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleLoyaltyCustomer</code>.
     */
    static validateJSON(data) {
        // validate the optional field `metadata`
        if (data['metadata']) { // data not null
          EarningRuleLoyaltyCustomerMetadata.validateJSON(data['metadata']);
        }
...
/**
 * @member {module:model/EarningRuleLoyaltyCustomerMetadata} metadata
 */
...
export default EarningRuleLoyaltyCustomer;

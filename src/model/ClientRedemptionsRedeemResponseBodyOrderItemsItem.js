...
class ClientRedemptionsRedeemResponseBodyOrderItemsItem {
    /**
     * Constructs a new <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code>.
     * @alias ClientRedemptionsRedeemResponseBodyOrderItemsItem
     * @implements OrderCalculatedItem
     */
    constructor() { 
        OrderCalculatedItem.initialize(this);
        ClientRedemptionsRedeemResponseBodyOrderItemsItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<ClientRedemptionsRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {ClientRedemptionsRedeemResponseBodyOrderItemsItem} [obj] Optional instance to populate.
     * @returns {ClientRedemptionsRedeemResponseBodyOrderItemsItem} The populated <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientRedemptionsRedeemResponseBodyOrderItemsItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code>.
     * @param {Partial<ClientRedemptionsRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code>.
     */
...
/**
    ...
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['id'] = undefined;

/**
    * Unique identifier of the SKU. It is assigned by Voucherify.
    * @type {String | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['sku_id'] = undefined;

/**
    * Unique identifier of the product. It is assigned by Voucherify.
    * @type {String | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['product_id'] = undefined;

/**
    * Used along with the source_id property, can be set to either sku or product.
    * @type {(keyof typeof ClientRedemptionsRedeemResponseBodyOrderItemsItem.RelatedObjectEnum) | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['related_object'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['source_id'] = undefined;

/**
    * The quantity of the particular item in the cart.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['quantity'] = undefined;

/**
    * Number of dicounted items.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['initial_quantity'] = undefined;

/**
    * The total amount of the order item (price * quantity).
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['amount'] = undefined;

/**
    * Sum of all order-item-level discounts applied to the order.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['discount_amount'] = undefined;

/**
    * This field shows the order-level discount applied.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_discount_amount'] = undefined;

/**
    * Number of the discounted items applied in the transaction.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_quantity_amount'] = undefined;

/**
    * A positive integer in the smallest currency unit (e.g. 100 cents for $1.00) representing the total amount of the order. This is the sum of the order items' amounts.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['initial_amount'] = undefined;

/**
    * Unit price of an item. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['price'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['subtotal_amount'] = undefined;

/**
    * @type {OrderCalculatedItemProduct | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['product'] = undefined;

/**
    * @type {OrderCalculatedItemSku | undefined}
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['sku'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof ClientRedemptionsRedeemResponseBodyOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['object'] = 'order_item';
...
/**
    ...
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['metadata'] = undefined;
...
/**
    ...
    */
ClientRedemptionsRedeemResponseBodyOrderItemsItem.prototype['application_details'] = undefined;
...
OrderCalculatedItem.prototype['metadata'] = undefined;
     ...
     * @readonly
     */
    ClientRedemptionsRedeemResponseBodyOrderItemsItem['RelatedObjectEnum'] = {
     ...
     * @readonly
     */
    ClientRedemptionsRedeemResponseBodyOrderItemsItem['ObjectEnum'] = {
...
export default ClientRedemptionsRedeemResponseBodyOrderItemsItem;

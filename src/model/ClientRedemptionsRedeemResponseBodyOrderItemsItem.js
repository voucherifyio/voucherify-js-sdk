...
class ClientRedemptionsRedeemResponseBodyOrderItemsItem {
     ...
     * @alias module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem
     ...
     * @param {module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem} The populated <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemResponseBodyOrderItemsItem</code>.
     */
 ...
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

...
class CampaignsVouchersCreateCombinedResponseBodyPublish {
    ...
    constructor() { 
        ...
        CampaignsVouchersCreateCombinedResponseBodyPublish.initialize(this);
    }
     ...
     * @return {module:model/CampaignsVouchersCreateCombinedResponseBodyPublish} The populated <code>CampaignsVouchersCreateCombinedResponseBodyPublish</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsVouchersCreateCombinedResponseBodyPublish();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateCombinedResponseBodyPublish</code>.
     */
...
export default CampaignsVouchersCreateCombinedResponseBodyPublish;

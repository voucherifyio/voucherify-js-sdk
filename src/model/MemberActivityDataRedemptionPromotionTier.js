...
import MemberActivityDataRedemptionPromotionTierAction from './MemberActivityDataRedemptionPromotionTierAction';
import MemberActivityDataRedemptionPromotionTierCampaign from './MemberActivityDataRedemptionPromotionTierCampaign';
import MemberActivityDataRedemptionPromotionTierSummary from './MemberActivityDataRedemptionPromotionTierSummary';
...
class MemberActivityDataRedemptionPromotionTier {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionPromotionTier.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionPromotionTier} The populated <code>MemberActivityDataRedemptionPromotionTier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionPromotionTier();
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = MemberActivityDataRedemptionPromotionTierCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = MemberActivityDataRedemptionPromotionTierAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = MemberActivityDataRedemptionPromotionTierSummary.constructFromObject(data['summary']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionPromotionTier</code>.
     */
    static validateJSON(data) {
        ...
        if (data['campaign']) { // data not null
          MemberActivityDataRedemptionPromotionTierCampaign.validateJSON(data['campaign']);
        }
        // validate the optional field `action`
        if (data['action']) { // data not null
          MemberActivityDataRedemptionPromotionTierAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          MemberActivityDataRedemptionPromotionTierSummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/MemberActivityDataRedemptionPromotionTierCampaign} campaign
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionPromotionTierAction} action
 */
 ...
 * @member {Array.<module:model/MemberActivityDataRedemptionPromotionTier.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionPromotionTierSummary} summary
 */
 ...
 * @readonly
 */
MemberActivityDataRedemptionPromotionTier['ValidityDayOfWeekEnum'] = {
...
export default MemberActivityDataRedemptionPromotionTier;

...
class SkusGetResponseBody {
     ...
     * @param {Partial<SkusGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {SkusGetResponseBody} [obj] Optional instance to populate.
     * @returns {SkusGetResponseBody} The populated <code>SkusGetResponseBody</code> instance.
     */
...
/**
    ...
    * @type {(keyof typeof SkusGetResponseBody.ObjectEnum) | undefined}
    * @default 'sku'
    */

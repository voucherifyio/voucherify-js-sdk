...
class SkusGetResponseBody {
     ...
     * @return {module:model/SkusGetResponseBody} The populated <code>SkusGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SkusGetResponseBody</code>.
     */
 ...
 * @member {module:model/SkusGetResponseBody.ObjectEnum} object
 * @default 'sku'
 */

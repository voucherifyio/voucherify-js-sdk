...
class ParameterCampaignsAccessSetttings {
    ...
    constructor() { 
        ...
        ParameterCampaignsAccessSetttings.initialize(this);
    }
     ...
     * @return {module:model/ParameterCampaignsAccessSetttings} The populated <code>ParameterCampaignsAccessSetttings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterCampaignsAccessSetttings();

            if (data.hasOwnProperty('filter')) {
                obj['filter'] = ParameterCampaignsAccessSetttingsFilter.constructFromObject(data['filter']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterCampaignsAccessSetttings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `filter`
        if (data['filter']) { // data not null
          ParameterCampaignsAccessSetttingsFilter.validateJSON(data['filter']);
        }
...
/**
 * @member {module:model/ParameterCampaignsAccessSetttingsFilter} filter
 */
...
export default ParameterCampaignsAccessSetttings;

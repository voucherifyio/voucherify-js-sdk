...
class ParameterFiltersListBinId {
     ...
     * @return {module:model/ParameterFiltersListBinId} The populated <code>ParameterFiltersListBinId</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListBinId</code>.
     */

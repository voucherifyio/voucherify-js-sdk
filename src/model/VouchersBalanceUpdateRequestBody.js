...
class VouchersBalanceUpdateRequestBody {
     ...
     * @return {module:model/VouchersBalanceUpdateRequestBody} The populated <code>VouchersBalanceUpdateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersBalanceUpdateRequestBody</code>.
     */

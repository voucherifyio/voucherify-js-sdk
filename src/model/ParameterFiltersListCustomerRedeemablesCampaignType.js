...
class ParameterFiltersListCustomerRedeemablesCampaignType {
     ...
     * @return {module:model/ParameterFiltersListCustomerRedeemablesCampaignType} The populated <code>ParameterFiltersListCustomerRedeemablesCampaignType</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCustomerRedeemablesCampaignType</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions} conditions
 */

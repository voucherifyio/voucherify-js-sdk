...
class LoyaltiesRewardsUpdateAssignmentRequestBody {
     ...
     * @return {module:model/LoyaltiesRewardsUpdateAssignmentRequestBody} The populated <code>LoyaltiesRewardsUpdateAssignmentRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardsUpdateAssignmentRequestBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesRewardsUpdateAssignmentRequestBodyParameters} parameters
 */

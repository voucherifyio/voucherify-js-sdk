...
class TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem {
    ...
    constructor() { 
        ...
        TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem.initialize(this);
    }
     ...
     * @return {module:model/TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem} The populated <code>TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem</code>.
     */
 ...
 * @member {module:model/TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem.ObjectEnum} object
 */
...
export default TemplatesCampaignsTierSetupCreateResponseBodyCreatedResourcesItem;

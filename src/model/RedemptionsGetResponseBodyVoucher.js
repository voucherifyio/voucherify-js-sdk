...
class RedemptionsGetResponseBodyVoucher {
     ...
     * @alias module:model/RedemptionsGetResponseBodyVoucher
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionsGetResponseBodyVoucher} obj Optional instance to populate.
     * @return {module:model/RedemptionsGetResponseBodyVoucher} The populated <code>RedemptionsGetResponseBodyVoucher</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyVoucher</code>.
     */
 ...
 * @member {module:model/RedemptionsGetResponseBodyVoucher.TypeEnum} type
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyVoucherGift} gift
 */
RedemptionsGetResponseBodyVoucher.prototype['gift'] = undefined;

/**
 * @member {module:model/RedemptionsGetResponseBodyVoucherLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/RedemptionsGetResponseBodyVoucher.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/RedemptionsGetResponseBodyVoucherPublish} publish
 */
RedemptionsGetResponseBodyVoucher.prototype['publish'] = undefined;

/**
 * @member {module:model/RedemptionsGetResponseBodyVoucherRedemption} redemption
 */

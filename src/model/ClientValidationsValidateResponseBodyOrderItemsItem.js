...
class ClientValidationsValidateResponseBodyOrderItemsItem {
     ...
     * @alias module:model/ClientValidationsValidateResponseBodyOrderItemsItem
     ...
     * @param {module:model/ClientValidationsValidateResponseBodyOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/ClientValidationsValidateResponseBodyOrderItemsItem} The populated <code>ClientValidationsValidateResponseBodyOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyOrderItemsItem</code>.
     */
 ...
 * @member {module:model/ClientValidationsValidateResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/ClientValidationsValidateResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

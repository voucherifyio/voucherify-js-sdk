...
class ClientValidationsValidateResponseBodyOrderItemsItem {
    /**
     * Constructs a new <code>ClientValidationsValidateResponseBodyOrderItemsItem</code>.
     * @alias ClientValidationsValidateResponseBodyOrderItemsItem
     * @implements OrderCalculatedItem
     */
    constructor() { 
        OrderCalculatedItem.initialize(this);
        ClientValidationsValidateResponseBodyOrderItemsItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientValidationsValidateResponseBodyOrderItemsItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<ClientValidationsValidateResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {ClientValidationsValidateResponseBodyOrderItemsItem} [obj] Optional instance to populate.
     * @returns {ClientValidationsValidateResponseBodyOrderItemsItem} The populated <code>ClientValidationsValidateResponseBodyOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientValidationsValidateResponseBodyOrderItemsItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientValidationsValidateResponseBodyOrderItemsItem</code>.
     * @param {Partial<ClientValidationsValidateResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyOrderItemsItem</code>.
     */
...
/**
    ...
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['id'] = undefined;

/**
    * Unique identifier of the SKU. It is assigned by Voucherify.
    * @type {String | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['sku_id'] = undefined;

/**
    * Unique identifier of the product. It is assigned by Voucherify.
    * @type {String | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['product_id'] = undefined;

/**
    * Used along with the source_id property, can be set to either sku or product.
    * @type {(keyof typeof ClientValidationsValidateResponseBodyOrderItemsItem.RelatedObjectEnum) | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['related_object'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['source_id'] = undefined;

/**
    * The quantity of the particular item in the cart.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['quantity'] = undefined;

/**
    * Number of dicounted items.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['initial_quantity'] = undefined;

/**
    * The total amount of the order item (price * quantity).
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['amount'] = undefined;

/**
    * Sum of all order-item-level discounts applied to the order.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['discount_amount'] = undefined;

/**
    * This field shows the order-level discount applied.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['applied_discount_amount'] = undefined;

/**
    * Number of the discounted items applied in the transaction.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['applied_discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['applied_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['applied_quantity_amount'] = undefined;

/**
    * A positive integer in the smallest currency unit (e.g. 100 cents for $1.00) representing the total amount of the order. This is the sum of the order items' amounts.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['initial_amount'] = undefined;

/**
    * Unit price of an item. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['price'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['subtotal_amount'] = undefined;

/**
    * @type {OrderCalculatedItemProduct | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['product'] = undefined;

/**
    * @type {OrderCalculatedItemSku | undefined}
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['sku'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof ClientValidationsValidateResponseBodyOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['object'] = 'order_item';
...
/**
    ...
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['metadata'] = undefined;
...
/**
    ...
    */
ClientValidationsValidateResponseBodyOrderItemsItem.prototype['application_details'] = undefined;
...
OrderCalculatedItem.prototype['metadata'] = undefined;
     ...
     * @readonly
     */
    ClientValidationsValidateResponseBodyOrderItemsItem['RelatedObjectEnum'] = {
     ...
     * @readonly
     */
    ClientValidationsValidateResponseBodyOrderItemsItem['ObjectEnum'] = {
...
export default ClientValidationsValidateResponseBodyOrderItemsItem;

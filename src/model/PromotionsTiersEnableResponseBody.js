...
import PromotionsTiersEnableResponseBodyAction from './PromotionsTiersEnableResponseBodyAction';
import PromotionsTiersEnableResponseBodyCampaign from './PromotionsTiersEnableResponseBodyCampaign';
import PromotionsTiersEnableResponseBodySummary from './PromotionsTiersEnableResponseBodySummary';
...
class PromotionsTiersEnableResponseBody {
    /**
     * Constructs a new <code>PromotionsTiersEnableResponseBody</code>.
     * Response body schema for **POST** &#x60;v1/promotions/tiers/{promotionTierId}/enable&#x60;.
     * @alias module:model/PromotionsTiersEnableResponseBody
     */
    constructor() { 
        
        PromotionsTiersEnableResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionsTiersEnableResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsTiersEnableResponseBody} obj Optional instance to populate.
     * @return {module:model/PromotionsTiersEnableResponseBody} The populated <code>PromotionsTiersEnableResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersEnableResponseBody();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = PromotionsTiersEnableResponseBodyAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = PromotionsTiersEnableResponseBodyCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = PromotionsTiersEnableResponseBodySummary.constructFromObject(data['summary']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsTiersEnableResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersEnableResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          PromotionsTiersEnableResponseBodyAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['campaign']) { // data not null
          PromotionsTiersEnableResponseBodyCampaign.validateJSON(data['campaign']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          PromotionsTiersEnableResponseBodySummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
PromotionsTiersEnableResponseBody.prototype['id'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['created_at'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['updated_at'] = undefined;

/**
 * Name of the promotion tier.
 * @member {String} name
 */
PromotionsTiersEnableResponseBody.prototype['name'] = undefined;

/**
 * Text to be displayed to your customers on your website.
 * @member {String} banner
 */
PromotionsTiersEnableResponseBody.prototype['banner'] = undefined;

/**
 * @member {module:model/PromotionsTiersEnableResponseBodyAction} action
 */
PromotionsTiersEnableResponseBody.prototype['action'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['metadata'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['hierarchy'] = undefined;

/**
 * Promotion unique ID.
 * @member {String} promotion_id
 */
PromotionsTiersEnableResponseBody.prototype['promotion_id'] = undefined;

/**
 * @member {module:model/PromotionsTiersEnableResponseBodyCampaign} campaign
 */
PromotionsTiersEnableResponseBody.prototype['campaign'] = undefined;

/**
 * Promotion tier's parent campaign's unique ID.
 * @member {String} campaign_id
 */
PromotionsTiersEnableResponseBody.prototype['campaign_id'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['active'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['start_date'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
PromotionsTiersEnableResponseBody.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/PromotionsTiersEnableResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
PromotionsTiersEnableResponseBody.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
PromotionsTiersEnableResponseBody.prototype['validity_hours'] = undefined;

/**
 * @member {module:model/PromotionsTiersEnableResponseBodySummary} summary
 */
PromotionsTiersEnableResponseBody.prototype['summary'] = undefined;
 ...
 */
PromotionsTiersEnableResponseBody.prototype['object'] = 'promotion_tier';

/**
 * @member {module:model/ValidationRuleAssignmentsList} validation_rule_assignments
 */
PromotionsTiersEnableResponseBody.prototype['validation_rule_assignments'] = undefined;

/**
 * Promotion tier category ID.
 * @member {String} category_id
 */
PromotionsTiersEnableResponseBody.prototype['category_id'] = undefined;

/**
 * @member {Array.<module:model/Category>} categories
 */
PromotionsTiersEnableResponseBody.prototype['categories'] = undefined;
 ...
 * @readonly
 */
PromotionsTiersEnableResponseBody['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersEnableResponseBody;

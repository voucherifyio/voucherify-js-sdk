...
class PromotionsTiersEnableResponseBody {
     ...
     * @alias PromotionsTiersEnableResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<PromotionsTiersEnableResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionsTiersEnableResponseBody} [obj] Optional instance to populate.
     * @returns {PromotionsTiersEnableResponseBody} The populated <code>PromotionsTiersEnableResponseBody</code> instance.
     */
     ...
     * @param {Partial<PromotionsTiersEnableResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersEnableResponseBody</code>.
     */
...
/**
    * @type {PromotionsTiersEnableResponseBodyAction | undefined}
    */
...
/**
    * @type {PromotionsTiersEnableResponseBodyCampaign | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof PromotionsTiersEnableResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {PromotionsTiersEnableResponseBodySummary | undefined}
    */

...
class ValidationsValidateResponseBodyRedeemablesItemResultDetails {
    ...
    constructor() { 
        ...
        ValidationsValidateResponseBodyRedeemablesItemResultDetails.initialize(this);
    }
     ...
     * @return {module:model/ValidationsValidateResponseBodyRedeemablesItemResultDetails} The populated <code>ValidationsValidateResponseBodyRedeemablesItemResultDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationsValidateResponseBodyRedeemablesItemResultDetails();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyRedeemablesItemResultDetails</code>.
     */
...
export default ValidationsValidateResponseBodyRedeemablesItemResultDetails;

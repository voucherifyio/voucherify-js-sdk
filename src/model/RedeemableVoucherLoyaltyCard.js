...
class RedeemableVoucherLoyaltyCard {
     ...
     * @alias RedeemableVoucherLoyaltyCard
     */
    constructor() { 
     ...
     * @param {Partial<RedeemableVoucherLoyaltyCard>} data The plain JavaScript object bearing properties of interest.
     * @param {RedeemableVoucherLoyaltyCard} [obj] Optional instance to populate.
     * @returns {RedeemableVoucherLoyaltyCard} The populated <code>RedeemableVoucherLoyaltyCard</code> instance.
     */
     ...
     * @param {Partial<RedeemableVoucherLoyaltyCard>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedeemableVoucherLoyaltyCard</code>.
     */

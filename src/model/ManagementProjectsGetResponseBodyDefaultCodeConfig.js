...
class ManagementProjectsGetResponseBodyDefaultCodeConfig {
    ...
    constructor() { 
        ...
        ManagementProjectsGetResponseBodyDefaultCodeConfig.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsGetResponseBodyDefaultCodeConfig} The populated <code>ManagementProjectsGetResponseBodyDefaultCodeConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsGetResponseBodyDefaultCodeConfig();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsGetResponseBodyDefaultCodeConfig</code>.
     */
...
export default ManagementProjectsGetResponseBodyDefaultCodeConfig;

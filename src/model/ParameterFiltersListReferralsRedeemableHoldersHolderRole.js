...
class ParameterFiltersListReferralsRedeemableHoldersHolderRole {
     ...
     * @return {module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRole} The populated <code>ParameterFiltersListReferralsRedeemableHoldersHolderRole</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListReferralsRedeemableHoldersHolderRole</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions} conditions
 */

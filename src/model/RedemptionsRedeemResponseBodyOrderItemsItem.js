...
class RedemptionsRedeemResponseBodyOrderItemsItem {
    /**
     * Constructs a new <code>RedemptionsRedeemResponseBodyOrderItemsItem</code>.
     * @alias RedemptionsRedeemResponseBodyOrderItemsItem
     * @implements OrderCalculatedItem
     */
    constructor() { 
        OrderCalculatedItem.initialize(this);
        RedemptionsRedeemResponseBodyOrderItemsItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionsRedeemResponseBodyOrderItemsItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<RedemptionsRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionsRedeemResponseBodyOrderItemsItem} [obj] Optional instance to populate.
     * @returns {RedemptionsRedeemResponseBodyOrderItemsItem} The populated <code>RedemptionsRedeemResponseBodyOrderItemsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsRedeemResponseBodyOrderItemsItem();
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionsRedeemResponseBodyOrderItemsItem</code>.
     * @param {Partial<RedemptionsRedeemResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRedeemResponseBodyOrderItemsItem</code>.
     */
...
/**
    ...
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['id'] = undefined;

/**
    * Unique identifier of the SKU. It is assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['sku_id'] = undefined;

/**
    * Unique identifier of the product. It is assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['product_id'] = undefined;

/**
    * Used along with the source_id property, can be set to either sku or product.
    * @type {(keyof typeof RedemptionsRedeemResponseBodyOrderItemsItem.RelatedObjectEnum) | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['related_object'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['source_id'] = undefined;

/**
    * The quantity of the particular item in the cart.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['quantity'] = undefined;

/**
    * Number of dicounted items.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['initial_quantity'] = undefined;

/**
    * The total amount of the order item (price * quantity).
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['amount'] = undefined;

/**
    * Sum of all order-item-level discounts applied to the order.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['discount_amount'] = undefined;

/**
    * This field shows the order-level discount applied.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_discount_amount'] = undefined;

/**
    * Number of the discounted items applied in the transaction.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_discount_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_quantity'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['applied_quantity_amount'] = undefined;

/**
    * A positive integer in the smallest currency unit (e.g. 100 cents for $1.00) representing the total amount of the order. This is the sum of the order items' amounts.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['initial_amount'] = undefined;

/**
    * Unit price of an item. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['price'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['subtotal_amount'] = undefined;

/**
    * @type {OrderCalculatedItemProduct | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['product'] = undefined;

/**
    * @type {OrderCalculatedItemSku | undefined}
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['sku'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof RedemptionsRedeemResponseBodyOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['object'] = 'order_item';
...
/**
    ...
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['metadata'] = undefined;
...
/**
    ...
    */
RedemptionsRedeemResponseBodyOrderItemsItem.prototype['application_details'] = undefined;
...
OrderCalculatedItem.prototype['metadata'] = undefined;
     ...
     * @readonly
     */
    RedemptionsRedeemResponseBodyOrderItemsItem['RelatedObjectEnum'] = {
     ...
     * @readonly
     */
    RedemptionsRedeemResponseBodyOrderItemsItem['ObjectEnum'] = {
...
export default RedemptionsRedeemResponseBodyOrderItemsItem;

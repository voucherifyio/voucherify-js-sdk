...
class RedemptionsRedeemResponseBodyOrderItemsItem {
     ...
     * @alias module:model/RedemptionsRedeemResponseBodyOrderItemsItem
     ...
     * @param {module:model/RedemptionsRedeemResponseBodyOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/RedemptionsRedeemResponseBodyOrderItemsItem} The populated <code>RedemptionsRedeemResponseBodyOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsRedeemResponseBodyOrderItemsItem</code>.
     */
 ...
 * @member {module:model/RedemptionsRedeemResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/RedemptionsRedeemResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

...
class ManagementProjectsUsersListResponseBody {
     ...
     * @return {module:model/ManagementProjectsUsersListResponseBody} The populated <code>ManagementProjectsUsersListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsUsersListResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsUsersListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsUsersListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */

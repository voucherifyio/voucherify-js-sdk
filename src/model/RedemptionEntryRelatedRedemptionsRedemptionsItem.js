...
class RedemptionEntryRelatedRedemptionsRedemptionsItem {
    ...
    constructor() { 
        ...
        RedemptionEntryRelatedRedemptionsRedemptionsItem.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntryRelatedRedemptionsRedemptionsItem} The populated <code>RedemptionEntryRelatedRedemptionsRedemptionsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryRelatedRedemptionsRedemptionsItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryRelatedRedemptionsRedemptionsItem</code>.
     */
...
export default RedemptionEntryRelatedRedemptionsRedemptionsItem;

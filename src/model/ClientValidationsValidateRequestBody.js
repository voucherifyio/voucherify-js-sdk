...
import ClientValidationsValidateRequestBodyOptions from './ClientValidationsValidateRequestBodyOptions';
import ClientValidationsValidateRequestBodyRedeemablesItem from './ClientValidationsValidateRequestBodyRedeemablesItem';
...
class ClientValidationsValidateRequestBody {
    ...
    constructor() { 
        ...
        ClientValidationsValidateRequestBody.initialize(this);
    }
     ...
     * @return {module:model/ClientValidationsValidateRequestBody} The populated <code>ClientValidationsValidateRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientValidationsValidateRequestBody();

            if (data.hasOwnProperty('options')) {
                obj['options'] = ClientValidationsValidateRequestBodyOptions.constructFromObject(data['options']);
            }
            if (data.hasOwnProperty('redeemables')) {
                obj['redeemables'] = ApiClient.convertToType(data['redeemables'], [ClientValidationsValidateRequestBodyRedeemablesItem]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateRequestBody</code>.
     */
    static validateJSON(data) {
        // validate the optional field `options`
        if (data['options']) { // data not null
          ClientValidationsValidateRequestBodyOptions.validateJSON(data['options']);
        }
        if (data['redeemables']) { // data not null
            ...
            for (const item of data['redeemables']) {
                ClientValidationsValidateRequestBodyRedeemablesItem.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/ClientValidationsValidateRequestBodyOptions} options
 */
ClientValidationsValidateRequestBody.prototype['options'] = undefined;

/**
 * @member {Array.<module:model/ClientValidationsValidateRequestBodyRedeemablesItem>} redeemables
 */
...
export default ClientValidationsValidateRequestBody;

...
class TemplatesCampaignsUpdateRequestBody {
     ...
     * @return {module:model/TemplatesCampaignsUpdateRequestBody} The populated <code>TemplatesCampaignsUpdateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsUpdateRequestBody</code>.
     */

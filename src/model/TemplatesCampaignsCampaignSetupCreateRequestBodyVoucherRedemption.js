...
class TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption {
    ...
    constructor() { 
        ...
        TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption.initialize(this);
    }
     ...
     * @return {module:model/TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption} The populated <code>TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption</code>.
     */
...
export default TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption;

...
class ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions {
    ...
    constructor() { 
        ...
        ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions} The populated <code>ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.InEnum>} $in
 */
ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.NotInEnum>} $not_in
 */
 ...
 * @member {module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.IsEnum} $is
 */
 ...
 * @member {module:model/ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions.IsNotEnum} $is_not
 */
 ...
 * @readonly
 */
ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions['InEnum'] = {
 ...
 * @readonly
 */
ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions['NotInEnum'] = {
...
export default ParameterFiltersListReferralsRedeemableHoldersHolderRoleConditions;

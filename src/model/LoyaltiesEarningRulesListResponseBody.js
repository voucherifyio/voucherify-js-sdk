...
class LoyaltiesEarningRulesListResponseBody {
     ...
     * @return {module:model/LoyaltiesEarningRulesListResponseBody} The populated <code>LoyaltiesEarningRulesListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesListResponseBody.ObjectEnum} object
 * @default 'list'
 */

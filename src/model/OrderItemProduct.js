...
class OrderItemProduct {
     ...
     * @param {Partial<OrderItemProduct>} data The plain JavaScript object bearing properties of interest.
     * @param {OrderItemProduct} [obj] Optional instance to populate.
     * @returns {OrderItemProduct} The populated <code>OrderItemProduct</code> instance.
     */
     ...
     * @param {Partial<OrderItemProduct>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>OrderItemProduct</code>.
     */
...
/**
    ...
    * @type {String | undefined}
    */
OrderItemProduct.prototype['source_id'] = undefined;
...
/**
    ...
    */
OrderItemProduct.prototype['override'] = undefined;

...
class OrderItemProduct {
     ...
     * @alias module:model/OrderItemProduct
     */
    constructor() { 
     ...
     * @param {module:model/OrderItemProduct} obj Optional instance to populate.
     * @returns {module:model/OrderItemProduct} The populated <code>OrderItemProduct</code> instance.
     */

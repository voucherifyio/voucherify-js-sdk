...
class ParameterFiltersListCampaignsCampaignStatusConditions {
    ...
    constructor() { 
        ...
        ParameterFiltersListCampaignsCampaignStatusConditions.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListCampaignsCampaignStatusConditions} The populated <code>ParameterFiltersListCampaignsCampaignStatusConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListCampaignsCampaignStatusConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsCampaignStatusConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListCampaignsCampaignStatusConditions.InEnum>} $in
 */
ParameterFiltersListCampaignsCampaignStatusConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListCampaignsCampaignStatusConditions.NotInEnum>} $not_in
 */
ParameterFiltersListCampaignsCampaignStatusConditions.prototype['$not_in'] = undefined;

/**
 * Value is exactly this value (single value).
 * @member {module:model/ParameterFiltersListCampaignsCampaignStatusConditions.IsEnum} $is
 */
ParameterFiltersListCampaignsCampaignStatusConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListCampaignsCampaignStatusConditions.IsNotEnum} $is_not
 */
 ...
 * @readonly
 */
ParameterFiltersListCampaignsCampaignStatusConditions['InEnum'] = {
 ...
 * @readonly
 */
ParameterFiltersListCampaignsCampaignStatusConditions['NotInEnum'] = {
...
export default ParameterFiltersListCampaignsCampaignStatusConditions;

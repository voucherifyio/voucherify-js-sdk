...
class RedemptionEntryVoucher {
     ...
     * @param {Partial<RedemptionEntryVoucher>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionEntryVoucher} [obj] Optional instance to populate.
     * @returns {RedemptionEntryVoucher} The populated <code>RedemptionEntryVoucher</code> instance.
     */
     ...
     * @param {Partial<RedemptionEntryVoucher>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryVoucher</code>.
     */
...
/**
    ...
    * @type {(keyof typeof RedemptionEntryVoucher.TypeEnum) | undefined}
    */
...
/**
    * @type {RedemptionEntryVoucherGift | undefined}
    */
RedemptionEntryVoucher.prototype['gift'] = undefined;

/**
    * @type {RedemptionEntryVoucherLoyaltyCard | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof RedemptionEntryVoucher.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {RedemptionEntryVoucherPublish | undefined}
    */
RedemptionEntryVoucher.prototype['publish'] = undefined;

/**
    * @type {RedemptionEntryVoucherRedemption | undefined}
    */

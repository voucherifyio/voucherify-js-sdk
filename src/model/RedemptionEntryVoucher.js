...
import RedemptionEntryVoucherGift from './RedemptionEntryVoucherGift';
import RedemptionEntryVoucherLoyaltyCard from './RedemptionEntryVoucherLoyaltyCard';
import RedemptionEntryVoucherPublish from './RedemptionEntryVoucherPublish';
import RedemptionEntryVoucherRedemption from './RedemptionEntryVoucherRedemption';
...
class RedemptionEntryVoucher {
    /**
     * Constructs a new <code>RedemptionEntryVoucher</code>.
     * @alias module:model/RedemptionEntryVoucher
     */
    constructor() { 
        
        RedemptionEntryVoucher.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionEntryVoucher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedemptionEntryVoucher} obj Optional instance to populate.
     * @return {module:model/RedemptionEntryVoucher} The populated <code>RedemptionEntryVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryVoucher();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = RedemptionEntryVoucherGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = RedemptionEntryVoucherLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = RedemptionEntryVoucherPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = RedemptionEntryVoucherRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionEntryVoucher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryVoucher</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          RedemptionEntryVoucherGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          RedemptionEntryVoucherLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          RedemptionEntryVoucherPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          RedemptionEntryVoucherRedemption.validateJSON(data['redemption']);
        }
 ...
 * @member {String} id
 */
RedemptionEntryVoucher.prototype['id'] = undefined;
 ...
 * @member {String} code
 */
RedemptionEntryVoucher.prototype['code'] = undefined;

/**
 * A unique campaign name, identifies the voucher's parent campaign.
 * @member {String} campaign
 */
RedemptionEntryVoucher.prototype['campaign'] = undefined;

/**
 * Assigned by the Voucherify API, identifies the voucher's parent campaign.
 * @member {String} campaign_id
 */
RedemptionEntryVoucher.prototype['campaign_id'] = undefined;

/**
 * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
 * @member {String} category
 */
RedemptionEntryVoucher.prototype['category'] = undefined;

/**
 * Unique category ID assigned by Voucherify.
 * @member {String} category_id
 */
RedemptionEntryVoucher.prototype['category_id'] = undefined;

/**
 * Defines the type of the voucher. 
 * @member {module:model/RedemptionEntryVoucher.TypeEnum} type
 */
RedemptionEntryVoucher.prototype['type'] = undefined;

/**
 * @member {module:model/Discount} discount
 */
RedemptionEntryVoucher.prototype['discount'] = undefined;

/**
 * @member {module:model/RedemptionEntryVoucherGift} gift
 */
RedemptionEntryVoucher.prototype['gift'] = undefined;

/**
 * @member {module:model/RedemptionEntryVoucherLoyaltyCard} loyalty_card
 */
RedemptionEntryVoucher.prototype['loyalty_card'] = undefined;

/**
 * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
 * @member {Date} start_date
 */
RedemptionEntryVoucher.prototype['start_date'] = undefined;

/**
 * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
 * @member {Date} expiration_date
 */
RedemptionEntryVoucher.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
RedemptionEntryVoucher.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/RedemptionEntryVoucher.ValidityDayOfWeekEnum>} validity_day_of_week
 */
RedemptionEntryVoucher.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
RedemptionEntryVoucher.prototype['validity_hours'] = undefined;
 ...
 */
RedemptionEntryVoucher.prototype['holder_id'] = undefined;

/**
 * Unique identifier of the referring person.
 * @member {String} referrer_id
 */
RedemptionEntryVoucher.prototype['referrer_id'] = undefined;
 ...
 * @default 'voucher'
 */
RedemptionEntryVoucher.prototype['object'] = 'voucher';

/**
 * @member {module:model/RedemptionEntryVoucherPublish} publish
 */
RedemptionEntryVoucher.prototype['publish'] = undefined;

/**
 * @member {module:model/RedemptionEntryVoucherRedemption} redemption
 */
RedemptionEntryVoucher.prototype['redemption'] = undefined;

/**
 * Contains details about the category.
 * @member {Array.<module:model/Category>} categories
 */
RedemptionEntryVoucher.prototype['categories'] = undefined;

/**
 * @member {module:model/ValidationRulesAssignmentsList} validation_rules_assignments
 */
RedemptionEntryVoucher.prototype['validation_rules_assignments'] = undefined;

/**
 * @member {module:model/SimpleCustomer} holder
 */
RedemptionEntryVoucher.prototype['holder'] = undefined;
 ...
 * @readonly
 */
RedemptionEntryVoucher['TypeEnum'] = {
 ...
 * @readonly
 */
RedemptionEntryVoucher['ValidityDayOfWeekEnum'] = {
...
export default RedemptionEntryVoucher;

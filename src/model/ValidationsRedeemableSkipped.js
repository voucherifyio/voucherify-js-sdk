...
class ValidationsRedeemableSkipped {
    ...
    constructor() { 
        ...
        ValidationsRedeemableSkipped.initialize(this);
    }
     ...
     * @return {module:model/ValidationsRedeemableSkipped} The populated <code>ValidationsRedeemableSkipped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationsRedeemableSkipped();
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = ValidationsRedeemableSkippedResult.constructFromObject(data['result']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsRedeemableSkipped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['result']) { // data not null
          ValidationsRedeemableSkippedResult.validateJSON(data['result']);
        }
 ...
 * @member {module:model/ValidationsRedeemableSkipped.StatusEnum} status
 * @default 'SKIPPED'
 */
 ...
 * @member {module:model/ValidationsRedeemableSkipped.ObjectEnum} object
 */
ValidationsRedeemableSkipped.prototype['object'] = undefined;

/**
 * @member {module:model/ValidationsRedeemableSkippedResult} result
 */
...
export default ValidationsRedeemableSkipped;

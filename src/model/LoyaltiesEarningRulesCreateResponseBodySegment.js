...
class LoyaltiesEarningRulesCreateResponseBodySegment {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesCreateResponseBodySegment.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateResponseBodySegment} The populated <code>LoyaltiesEarningRulesCreateResponseBodySegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesCreateResponseBodySegment();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateResponseBodySegment</code>.
     */
...
export default LoyaltiesEarningRulesCreateResponseBodySegment;

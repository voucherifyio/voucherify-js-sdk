...
class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata} The populated <code>LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata</code>.
     */
...
export default LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata;

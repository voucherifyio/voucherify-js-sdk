...
class RedemptionsGetResponseBodyVoucherGift {
    ...
    constructor() { 
        ...
        RedemptionsGetResponseBodyVoucherGift.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsGetResponseBodyVoucherGift} The populated <code>RedemptionsGetResponseBodyVoucherGift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsGetResponseBodyVoucherGift();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyVoucherGift</code>.
     */
 ...
 * @member {module:model/RedemptionsGetResponseBodyVoucherGift.EffectEnum} effect
 */
...
export default RedemptionsGetResponseBodyVoucherGift;

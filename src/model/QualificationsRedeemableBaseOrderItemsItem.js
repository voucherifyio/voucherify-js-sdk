...
class QualificationsRedeemableBaseOrderItemsItem {
     ...
     * @alias module:model/QualificationsRedeemableBaseOrderItemsItem
     ...
     * @param {module:model/QualificationsRedeemableBaseOrderItemsItem} obj Optional instance to populate.
     * @return {module:model/QualificationsRedeemableBaseOrderItemsItem} The populated <code>QualificationsRedeemableBaseOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsRedeemableBaseOrderItemsItem</code>.
     */
 ...
 * @member {module:model/QualificationsRedeemableBaseOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/QualificationsRedeemableBaseOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

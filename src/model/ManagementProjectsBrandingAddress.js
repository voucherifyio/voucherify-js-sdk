...
class ManagementProjectsBrandingAddress {
    ...
    constructor() { 
        ...
        ManagementProjectsBrandingAddress.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsBrandingAddress} The populated <code>ManagementProjectsBrandingAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsBrandingAddress();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsBrandingAddress</code>.
     */
...
export default ManagementProjectsBrandingAddress;

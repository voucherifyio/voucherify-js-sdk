...
class ApplicableToOrderItemUnitsItem {
     ...
     * @return {module:model/ApplicableToOrderItemUnitsItem} The populated <code>ApplicableToOrderItemUnitsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicableToOrderItemUnitsItem</code>.
     */

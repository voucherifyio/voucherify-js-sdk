...
class ManagementProjectsWebhook {
    ...
    constructor() { 
        ...
        ManagementProjectsWebhook.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsWebhook} The populated <code>ManagementProjectsWebhook</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsWebhook();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhook</code>.
     */
 ...
 * @member {module:model/ManagementProjectsWebhook.ObjectEnum} object
 * @default 'webhook'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhook.EventsEnum>} events
 */
 ...
 * @readonly
 */
ManagementProjectsWebhook['EventsEnum'] = {
...
export default ManagementProjectsWebhook;

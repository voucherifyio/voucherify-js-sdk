...
class CampaignsTransactionsExportCreateRequestBody {
     ...
     * @return {module:model/CampaignsTransactionsExportCreateRequestBody} The populated <code>CampaignsTransactionsExportCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsTransactionsExportCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/CampaignsTransactionsExportCreateRequestBodyParameters} parameters
 */

...
class ManagementProjectsMetadataSchemasGetResponseBody {
     ...
     * @alias module:model/ManagementProjectsMetadataSchemasGetResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ManagementProjectsMetadataSchemasGetResponseBody} obj Optional instance to populate.
     * @return {module:model/ManagementProjectsMetadataSchemasGetResponseBody} The populated <code>ManagementProjectsMetadataSchemasGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsMetadataSchemasGetResponseBody</code>.
     */

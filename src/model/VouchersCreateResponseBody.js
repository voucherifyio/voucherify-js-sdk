...
class VouchersCreateResponseBody {
     ...
     * @alias module:model/VouchersCreateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/VouchersCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/VouchersCreateResponseBody} The populated <code>VouchersCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersCreateResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersCreateResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/VouchersCreateResponseBodyGift} gift
 */
VouchersCreateResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/VouchersCreateResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/VouchersCreateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersCreateResponseBodyPublish} publish
 */
VouchersCreateResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/VouchersCreateResponseBodyRedemption} redemption
 */

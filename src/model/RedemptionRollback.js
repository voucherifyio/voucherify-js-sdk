...
class RedemptionRollback {
     ...
     * @return {module:model/RedemptionRollback} The populated <code>RedemptionRollback</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRollback</code>.
     */
 ...
 * @member {module:model/RedemptionRollback.ObjectEnum} object
...
/**
 * Redemption result.
 * @member {module:model/RedemptionRollback.ResultEnum} result
 */
RedemptionRollback.prototype['result'] = undefined;

/**
 * Redemption status.
 * @member {module:model/RedemptionRollback.StatusEnum} status
 */
...
/**
 * @member {module:model/RedemptionRollbackOrder} order
 */
RedemptionRollback.prototype['order'] = undefined;

/**
 * @member {module:model/RedemptionRollbackChannel} channel
 */
 ...
 * @member {module:model/RedemptionRollback.RelatedObjectTypeEnum} related_object_type
 */
...
/**
 * @member {module:model/RedemptionRollbackGift} gift
 */
RedemptionRollback.prototype['gift'] = undefined;

/**
 * @member {module:model/RedemptionRollbackLoyaltyCard} loyalty_card
 */

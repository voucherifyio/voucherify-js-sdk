...
class EarningRuleSource {
     ...
     * @alias module:model/EarningRuleSource
     */
    constructor() { 
     ...
     * @param {module:model/EarningRuleSource} obj Optional instance to populate.
     * @return {module:model/EarningRuleSource} The populated <code>EarningRuleSource</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleSource</code>.
     */
 ...
 * @member {module:model/EarningRuleSource.ObjectTypeEnum} object_type
 * @default 'campaign'
 */

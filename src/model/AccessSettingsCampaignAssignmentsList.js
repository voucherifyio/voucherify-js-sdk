...
class AccessSettingsCampaignAssignmentsList {
     ...
     * @return {module:model/AccessSettingsCampaignAssignmentsList} The populated <code>AccessSettingsCampaignAssignmentsList</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessSettingsCampaignAssignmentsList</code>.
     */
 ...
 * @member {module:model/AccessSettingsCampaignAssignmentsList.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/AccessSettingsCampaignAssignmentsList.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/AreaStoreCampaignAssignment>} data
 */

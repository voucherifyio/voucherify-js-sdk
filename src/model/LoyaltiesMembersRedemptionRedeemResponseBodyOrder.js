...
class LoyaltiesMembersRedemptionRedeemResponseBodyOrder {
     ...
     * @alias module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrder} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrder.StatusEnum} status
 */
 ...
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer} customer
 */
LoyaltiesMembersRedemptionRedeemResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer} referrer
 */
 ...
 * @member {Array.<module:model/LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem>} items
 */

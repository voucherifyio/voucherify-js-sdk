...
class SimpleVoucherRedemption {
    ...
    constructor() { 
        ...
        SimpleVoucherRedemption.initialize(this);
    }
     ...
     * @return {module:model/SimpleVoucherRedemption} The populated <code>SimpleVoucherRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleVoucherRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleVoucherRedemption</code>.
     */
...
export default SimpleVoucherRedemption;

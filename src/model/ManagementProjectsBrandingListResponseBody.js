...
class ManagementProjectsBrandingListResponseBody {
     ...
     * @return {module:model/ManagementProjectsBrandingListResponseBody} The populated <code>ManagementProjectsBrandingListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsBrandingListResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsBrandingListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsBrandingListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsBranding>} data
 */

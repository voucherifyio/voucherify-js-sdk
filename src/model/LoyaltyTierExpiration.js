...
class LoyaltyTierExpiration {
     ...
     * @return {module:model/LoyaltyTierExpiration} The populated <code>LoyaltyTierExpiration</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTierExpiration</code>.
     */

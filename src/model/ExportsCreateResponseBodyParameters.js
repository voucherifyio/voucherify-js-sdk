...
class ExportsCreateResponseBodyParameters {
     ...
     * @return {module:model/ExportsCreateResponseBodyParameters} The populated <code>ExportsCreateResponseBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportsCreateResponseBodyParameters</code>.
     */
...
/**
 * @member {module:model/ExportsCreateResponseBodyParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/ExportsCreateResponseBodyParameters.FieldsEnum>} fields
 */

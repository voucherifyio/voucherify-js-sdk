...
class ManagementProjectsCreateResponseBodyServerSideKey {
    ...
    constructor() { 
        ...
        ManagementProjectsCreateResponseBodyServerSideKey.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsCreateResponseBodyServerSideKey} The populated <code>ManagementProjectsCreateResponseBodyServerSideKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsCreateResponseBodyServerSideKey();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCreateResponseBodyServerSideKey</code>.
     */
...
export default ManagementProjectsCreateResponseBodyServerSideKey;

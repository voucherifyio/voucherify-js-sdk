...
class ManagementProjectsWebhooksGetResponseBody {
     ...
     * @alias module:model/ManagementProjectsWebhooksGetResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ManagementProjectsWebhooksGetResponseBody} obj Optional instance to populate.
     * @return {module:model/ManagementProjectsWebhooksGetResponseBody} The populated <code>ManagementProjectsWebhooksGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhooksGetResponseBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsWebhooksGetResponseBody.ObjectEnum} object
 * @default 'webhook'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhooksGetResponseBody.EventsEnum>} events
 */

...
class MetadataSchemaDeprecated {
     ...
     * @alias module:model/MetadataSchemaDeprecated
     */
    constructor() { 
     ...
     * @param {module:model/MetadataSchemaDeprecated} obj Optional instance to populate.
     * @return {module:model/MetadataSchemaDeprecated} The populated <code>MetadataSchemaDeprecated</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetadataSchemaDeprecated</code>.
     */

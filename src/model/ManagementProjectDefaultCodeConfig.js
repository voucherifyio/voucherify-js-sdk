...
class ManagementProjectDefaultCodeConfig {
     ...
     * @return {module:model/ManagementProjectDefaultCodeConfig} The populated <code>ManagementProjectDefaultCodeConfig</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectDefaultCodeConfig</code>.
     */

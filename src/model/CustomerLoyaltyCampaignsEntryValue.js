...
class CustomerLoyaltyCampaignsEntryValue {
     ...
     * @return {module:model/CustomerLoyaltyCampaignsEntryValue} The populated <code>CustomerLoyaltyCampaignsEntryValue</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerLoyaltyCampaignsEntryValue</code>.
     */

...
class RewardTypeCoin {
     ...
     * @return {module:model/RewardTypeCoin} The populated <code>RewardTypeCoin</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardTypeCoin</code>.
     */

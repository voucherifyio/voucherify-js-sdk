...
class ValidationRulesCreateResponseBodyError {
     ...
     * @return {module:model/ValidationRulesCreateResponseBodyError} The populated <code>ValidationRulesCreateResponseBodyError</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesCreateResponseBodyError</code>.
     */

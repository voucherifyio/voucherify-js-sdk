...
class LoyaltiesTiersRewardsListResponseBody {
     ...
     * @return {module:model/LoyaltiesTiersRewardsListResponseBody} The populated <code>LoyaltiesTiersRewardsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTiersRewardsListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/LoyaltiesLoyaltyTierReward>} data
 */

...
class RewardsUpdateRequestBody {
     ...
     * @return {module:model/RewardsUpdateRequestBody} The populated <code>RewardsUpdateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsUpdateRequestBody</code>.
     */
...
/**
 * @member {module:model/RewardsUpdateRequestBodyParameters} parameters
 */
...
/**
 * @member {module:model/RewardsUpdateRequestBodyAttributes} attributes
 */

...
class ManagementProjectsCustomEventSchema {
     ...
     * @return {module:model/ManagementProjectsCustomEventSchema} The populated <code>ManagementProjectsCustomEventSchema</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchema</code>.
     */
...
/**
 * @member {module:model/ManagementProjectsCustomEventSchemaSchema} schema
 */
 ...
 * @member {module:model/ManagementProjectsCustomEventSchema.ObjectEnum} object

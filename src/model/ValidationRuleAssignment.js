...
class ValidationRuleAssignment {
     ...
     * @return {module:model/ValidationRuleAssignment} The populated <code>ValidationRuleAssignment</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRuleAssignment</code>.
     */
 ...
 * @member {module:model/ValidationRuleAssignment.RelatedObjectTypeEnum} related_object_type
 */
 ...
 * @member {module:model/ValidationRuleAssignment.ObjectEnum} object

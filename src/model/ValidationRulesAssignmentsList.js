...
class ValidationRulesAssignmentsList {
    ...
    constructor() { 
        ...
        ValidationRulesAssignmentsList.initialize(this);
    }
     ...
     * @return {module:model/ValidationRulesAssignmentsList} The populated <code>ValidationRulesAssignmentsList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationRulesAssignmentsList();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BusValRuleAssignment]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesAssignmentsList</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                BusValRuleAssignment.validateJSON(item);
            };
        }
 ...
 * @member {module:model/ValidationRulesAssignmentsList.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ValidationRulesAssignmentsList.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/BusValRuleAssignment>} data
 */
...
export default ValidationRulesAssignmentsList;

...
class RedemptionEntryVoucherPublish {
    ...
    constructor() { 
        ...
        RedemptionEntryVoucherPublish.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntryVoucherPublish} The populated <code>RedemptionEntryVoucherPublish</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryVoucherPublish();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryVoucherPublish</code>.
     */
...
export default RedemptionEntryVoucherPublish;

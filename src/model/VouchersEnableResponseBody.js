...
class VouchersEnableResponseBody {
     ...
     * @alias module:model/VouchersEnableResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/VouchersEnableResponseBody} obj Optional instance to populate.
     * @return {module:model/VouchersEnableResponseBody} The populated <code>VouchersEnableResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersEnableResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersEnableResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/VouchersEnableResponseBodyGift} gift
 */
VouchersEnableResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/VouchersEnableResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/VouchersEnableResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersEnableResponseBodyPublish} publish
 */
VouchersEnableResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/VouchersEnableResponseBodyRedemption} redemption
 */

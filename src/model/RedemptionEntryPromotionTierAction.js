...
class RedemptionEntryPromotionTierAction {
     ...
     * @return {module:model/RedemptionEntryPromotionTierAction} The populated <code>RedemptionEntryPromotionTierAction</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryPromotionTierAction</code>.
     */

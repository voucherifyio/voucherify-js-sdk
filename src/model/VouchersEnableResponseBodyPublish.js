...
class VouchersEnableResponseBodyPublish {
    ...
    constructor() { 
        ...
        VouchersEnableResponseBodyPublish.initialize(this);
    }
     ...
     * @return {module:model/VouchersEnableResponseBodyPublish} The populated <code>VouchersEnableResponseBodyPublish</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersEnableResponseBodyPublish();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersEnableResponseBodyPublish</code>.
     */
...
export default VouchersEnableResponseBodyPublish;

...
class CustomerWithSummaryLoyaltyReferrals {
    ...
    constructor() { 
        ...
        CustomerWithSummaryLoyaltyReferrals.initialize(this);
    }
     ...
     * @return {module:model/CustomerWithSummaryLoyaltyReferrals} The populated <code>CustomerWithSummaryLoyaltyReferrals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerWithSummaryLoyaltyReferrals();
            ...
            if (data.hasOwnProperty('assets')) {
                obj['assets'] = CustomerWithSummaryLoyaltyReferralsAssets.constructFromObject(data['assets']);
            }
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = CustomerWithSummaryLoyaltyReferralsAddress.constructFromObject(data['address']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerWithSummaryLoyaltyReferrals</code>.
     */
    static validateJSON(data) {
        ...
        if (data['assets']) { // data not null
          CustomerWithSummaryLoyaltyReferralsAssets.validateJSON(data['assets']);
        }
        // ensure the json data is a string
        ...
        if (data['address']) { // data not null
          CustomerWithSummaryLoyaltyReferralsAddress.validateJSON(data['address']);
        }
...
/**
 * @member {module:model/CustomerWithSummaryLoyaltyReferralsAssets} assets
 */
CustomerWithSummaryLoyaltyReferrals.prototype['assets'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/CustomerWithSummaryLoyaltyReferrals.ObjectEnum} object
 * @default 'customer'
 */
...
/**
 * @member {module:model/CustomerWithSummaryLoyaltyReferralsAddress} address
 */
...
export default CustomerWithSummaryLoyaltyReferrals;

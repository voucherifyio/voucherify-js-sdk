...
class MemberActivityDataTransactionDetailsRedemption {
    ...
    constructor() { 
        ...
        MemberActivityDataTransactionDetailsRedemption.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataTransactionDetailsRedemption} The populated <code>MemberActivityDataTransactionDetailsRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataTransactionDetailsRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataTransactionDetailsRedemption</code>.
     */
...
export default MemberActivityDataTransactionDetailsRedemption;

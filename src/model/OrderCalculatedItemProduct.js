...
class OrderCalculatedItemProduct {
    ...
    constructor() { 
        ...
        OrderCalculatedItemProduct.initialize(this);
    }
     ...
     * @return {module:model/OrderCalculatedItemProduct} The populated <code>OrderCalculatedItemProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCalculatedItemProduct();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCalculatedItemProduct</code>.
     */
...
export default OrderCalculatedItemProduct;

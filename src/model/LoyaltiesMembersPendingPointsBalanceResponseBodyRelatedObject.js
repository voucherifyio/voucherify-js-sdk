...
class LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject {
     ...
     * @return {module:model/LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject} The populated <code>LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject.TypeEnum} type
 * @default 'voucher'
 */

...
class EarningRuleLoyaltyOrderItemsQuantityApplicableToItem {
    ...
    constructor() { 
        ...
        EarningRuleLoyaltyOrderItemsQuantityApplicableToItem.initialize(this);
    }
     ...
     * @return {module:model/EarningRuleLoyaltyOrderItemsQuantityApplicableToItem} The populated <code>EarningRuleLoyaltyOrderItemsQuantityApplicableToItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRuleLoyaltyOrderItemsQuantityApplicableToItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleLoyaltyOrderItemsQuantityApplicableToItem</code>.
     */
 ...
 * @member {module:model/EarningRuleLoyaltyOrderItemsQuantityApplicableToItem.ObjectEnum} object
 */
...
export default EarningRuleLoyaltyOrderItemsQuantityApplicableToItem;

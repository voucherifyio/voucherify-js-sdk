...
class PromotionsTiersEnableResponseBodySummaryOrders {
     ...
     * @return {module:model/PromotionsTiersEnableResponseBodySummaryOrders} The populated <code>PromotionsTiersEnableResponseBodySummaryOrders</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersEnableResponseBodySummaryOrders</code>.
     */

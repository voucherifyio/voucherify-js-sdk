...
class CustomersMetadataUpdateInBulkRequestBody {
    ...
    constructor() { 
        ...
        CustomersMetadataUpdateInBulkRequestBody.initialize(this);
    }
     ...
     * @return {module:model/CustomersMetadataUpdateInBulkRequestBody} The populated <code>CustomersMetadataUpdateInBulkRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomersMetadataUpdateInBulkRequestBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersMetadataUpdateInBulkRequestBody</code>.
     */
...
export default CustomersMetadataUpdateInBulkRequestBody;

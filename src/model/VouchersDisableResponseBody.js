...
class VouchersDisableResponseBody {
     ...
     * @alias module:model/VouchersDisableResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/VouchersDisableResponseBody} obj Optional instance to populate.
     * @return {module:model/VouchersDisableResponseBody} The populated <code>VouchersDisableResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersDisableResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersDisableResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/VouchersDisableResponseBodyGift} gift
 */
VouchersDisableResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/VouchersDisableResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/VouchersDisableResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersDisableResponseBodyPublish} publish
 */
VouchersDisableResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/VouchersDisableResponseBodyRedemption} redemption
 */

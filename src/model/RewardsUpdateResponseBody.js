...
class RewardsUpdateResponseBody {
     ...
     * @return {module:model/RewardsUpdateResponseBody} The populated <code>RewardsUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsUpdateResponseBody</code>.
     */
...
/**
 * @member {module:model/RewardsUpdateResponseBodyAttributes} attributes
 */
...
/**
 * Reward type.
 * @member {module:model/RewardsUpdateResponseBody.TypeEnum} type
 */
 ...
 * @member {module:model/RewardsUpdateResponseBody.ObjectEnum} object
 * @default 'reward'
 */

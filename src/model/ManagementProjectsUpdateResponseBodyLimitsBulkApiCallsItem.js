...
class ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem {
    ...
    constructor() { 
        ...
        ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem} The populated <code>ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem</code>.
     */
...
export default ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem;

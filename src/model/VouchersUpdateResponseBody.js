...
import VouchersUpdateResponseBodyGift from './VouchersUpdateResponseBodyGift';
import VouchersUpdateResponseBodyLoyaltyCard from './VouchersUpdateResponseBodyLoyaltyCard';
import VouchersUpdateResponseBodyPublish from './VouchersUpdateResponseBodyPublish';
import VouchersUpdateResponseBodyRedemption from './VouchersUpdateResponseBodyRedemption';
/**
...
class VouchersUpdateResponseBody {
    /**
     * Constructs a new <code>VouchersUpdateResponseBody</code>.
     * Response body schema for **PUT** &#x60;v1/vouchers/{code}&#x60;.
     * @alias VouchersUpdateResponseBody
     */
    constructor() { 
        
        VouchersUpdateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VouchersUpdateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<VouchersUpdateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {VouchersUpdateResponseBody} [obj] Optional instance to populate.
     * @returns {VouchersUpdateResponseBody} The populated <code>VouchersUpdateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersUpdateResponseBody();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = VouchersUpdateResponseBodyGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = VouchersUpdateResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = VouchersUpdateResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = VouchersUpdateResponseBodyRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VouchersUpdateResponseBody</code>.
     * @param {Partial<VouchersUpdateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersUpdateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          VouchersUpdateResponseBodyGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          VouchersUpdateResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          VouchersUpdateResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          VouchersUpdateResponseBodyRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
VouchersUpdateResponseBody.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof VouchersUpdateResponseBody.TypeEnum) | undefined}
    */
VouchersUpdateResponseBody.prototype['type'] = undefined;

/**
    * @type {Discount | undefined}
    */
VouchersUpdateResponseBody.prototype['discount'] = undefined;

/**
    * @type {VouchersUpdateResponseBodyGift | undefined}
    */
VouchersUpdateResponseBody.prototype['gift'] = undefined;

/**
    * @type {VouchersUpdateResponseBodyLoyaltyCard | undefined}
    */
VouchersUpdateResponseBody.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
VouchersUpdateResponseBody.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
VouchersUpdateResponseBody.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
VouchersUpdateResponseBody.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof VouchersUpdateResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
VouchersUpdateResponseBody.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
VouchersUpdateResponseBody.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
VouchersUpdateResponseBody.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
VouchersUpdateResponseBody.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
VouchersUpdateResponseBody.prototype['assets'] = undefined;

/**
    * Flag indicating whether this voucher is a referral code; `true` for campaign type `REFERRAL_PROGRAM`.
    * @type {Boolean | undefined}
    */
VouchersUpdateResponseBody.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
VouchersUpdateResponseBody.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
VouchersUpdateResponseBody.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the redeemable holder. It equals to the customer ID assigned by Voucherify.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['holder_id'] = undefined;

/**
    * Unique identifier of the referring person.
    * @type {String | undefined}
    */
VouchersUpdateResponseBody.prototype['referrer_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
VouchersUpdateResponseBody.prototype['object'] = 'voucher';

/**
    * @type {VouchersUpdateResponseBodyPublish | undefined}
    */
VouchersUpdateResponseBody.prototype['publish'] = undefined;

/**
    * @type {VouchersUpdateResponseBodyRedemption | undefined}
    */
VouchersUpdateResponseBody.prototype['redemption'] = undefined;

/**
    * Contains details about the category.
    * @type {Array.<Category> | undefined}
    */
VouchersUpdateResponseBody.prototype['categories'] = undefined;

/**
    * @type {ValidationRulesAssignmentsList | undefined}
    */
VouchersUpdateResponseBody.prototype['validation_rules_assignments'] = undefined;
     ...
     * @readonly
     */
    VouchersUpdateResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
VouchersUpdateResponseBody['ValidityDayOfWeekEnum'] = {
...
export default VouchersUpdateResponseBody;

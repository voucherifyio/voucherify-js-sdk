...
class VouchersUpdateResponseBody {
     ...
     * @alias module:model/VouchersUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/VouchersUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/VouchersUpdateResponseBody} The populated <code>VouchersUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersUpdateResponseBody</code>.
     */
 ...
 * @member {module:model/VouchersUpdateResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/VouchersUpdateResponseBodyGift} gift
 */
VouchersUpdateResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/VouchersUpdateResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/VouchersUpdateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/VouchersUpdateResponseBodyPublish} publish
 */
VouchersUpdateResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/VouchersUpdateResponseBodyRedemption} redemption
 */

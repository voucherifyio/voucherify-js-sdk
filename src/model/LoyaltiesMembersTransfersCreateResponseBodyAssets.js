...
class LoyaltiesMembersTransfersCreateResponseBodyAssets {
    ...
    constructor() { 
        ...
        LoyaltiesMembersTransfersCreateResponseBodyAssets.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersTransfersCreateResponseBodyAssets} The populated <code>LoyaltiesMembersTransfersCreateResponseBodyAssets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersTransfersCreateResponseBodyAssets();

            if (data.hasOwnProperty('qr')) {
                obj['qr'] = LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.constructFromObject(data['qr']);
            }
            if (data.hasOwnProperty('barcode')) {
                obj['barcode'] = LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode.constructFromObject(data['barcode']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransfersCreateResponseBodyAssets</code>.
     */
    static validateJSON(data) {
        // validate the optional field `qr`
        if (data['qr']) { // data not null
          LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.validateJSON(data['qr']);
        }
        // validate the optional field `barcode`
        if (data['barcode']) { // data not null
          LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode.validateJSON(data['barcode']);
        }
...
/**
 * @member {module:model/LoyaltiesMembersTransfersCreateResponseBodyAssetsQr} qr
 */
LoyaltiesMembersTransfersCreateResponseBodyAssets.prototype['qr'] = undefined;

/**
 * @member {module:model/LoyaltiesMembersTransfersCreateResponseBodyAssetsBarcode} barcode
 */
...
export default LoyaltiesMembersTransfersCreateResponseBodyAssets;

...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata} The populated <code>LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata</code>.
     */
...
export default LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata;

...
class LoyaltiesMembersGetResponseBody {
     ...
     * @alias module:model/LoyaltiesMembersGetResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/LoyaltiesMembersGetResponseBody} obj Optional instance to populate.
     * @return {module:model/LoyaltiesMembersGetResponseBody} The populated <code>LoyaltiesMembersGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersGetResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersGetResponseBody.TypeEnum} type
...
/**
 * @member {module:model/LoyaltiesMembersGetResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/LoyaltiesMembersGetResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/LoyaltiesMembersGetResponseBodyPublish} publish
 */
LoyaltiesMembersGetResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/LoyaltiesMembersGetResponseBodyRedemption} redemption
 */

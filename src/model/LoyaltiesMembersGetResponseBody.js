...
import LoyaltiesMembersGetResponseBodyLoyaltyCard from './LoyaltiesMembersGetResponseBodyLoyaltyCard';
import LoyaltiesMembersGetResponseBodyPublish from './LoyaltiesMembersGetResponseBodyPublish';
import LoyaltiesMembersGetResponseBodyRedemption from './LoyaltiesMembersGetResponseBodyRedemption';
...
class LoyaltiesMembersGetResponseBody {
    /**
     * Constructs a new <code>LoyaltiesMembersGetResponseBody</code>.
     * Response body schema for **GET** &#x60;/loyalties/{campaignId}/members/{memberId}&#x60; and **GET** &#x60;/loyalties/members/{memberId}&#x60;.
     * @alias LoyaltiesMembersGetResponseBody
     */
    constructor() { 
        
        LoyaltiesMembersGetResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoyaltiesMembersGetResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<LoyaltiesMembersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {LoyaltiesMembersGetResponseBody} [obj] Optional instance to populate.
     * @returns {LoyaltiesMembersGetResponseBody} The populated <code>LoyaltiesMembersGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersGetResponseBody();
            ...
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = LoyaltiesMembersGetResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = LoyaltiesMembersGetResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = LoyaltiesMembersGetResponseBodyRedemption.constructFromObject(data['redemption']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LoyaltiesMembersGetResponseBody</code>.
     * @param {Partial<LoyaltiesMembersGetResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersGetResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['loyalty_card']) { // data not null
          LoyaltiesMembersGetResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          LoyaltiesMembersGetResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          LoyaltiesMembersGetResponseBodyRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
LoyaltiesMembersGetResponseBody.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof LoyaltiesMembersGetResponseBody.TypeEnum) | undefined}
    * @default 'LOYALTY_CARD'
    */
LoyaltiesMembersGetResponseBody.prototype['type'] = 'LOYALTY_CARD';

/**
    * @type {Object | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['discount'] = undefined;

/**
    * @type {Object | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['gift'] = undefined;

/**
    * @type {LoyaltiesMembersGetResponseBodyLoyaltyCard | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof LoyaltiesMembersGetResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
LoyaltiesMembersGetResponseBody.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['assets'] = undefined;

/**
    * This is always false for loyalty members.
    * @type {Boolean | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['updated_at'] = undefined;

/**
    * Unique identifier of the customer who owns the voucher.
    * @type {String | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['holder_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
LoyaltiesMembersGetResponseBody.prototype['object'] = 'voucher';

/**
    * @type {LoyaltiesMembersGetResponseBodyPublish | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['publish'] = undefined;

/**
    * @type {LoyaltiesMembersGetResponseBodyRedemption | undefined}
    */
LoyaltiesMembersGetResponseBody.prototype['redemption'] = undefined;
     ...
     * @readonly
     */
    LoyaltiesMembersGetResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
LoyaltiesMembersGetResponseBody['ValidityDayOfWeekEnum'] = {
...
export default LoyaltiesMembersGetResponseBody;

...
class RedemptionsGetResponseBodyRelatedRedemptionsRollbacksItem {
     ...
     * @return {module:model/RedemptionsGetResponseBodyRelatedRedemptionsRollbacksItem} The populated <code>RedemptionsGetResponseBodyRelatedRedemptionsRollbacksItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyRelatedRedemptionsRollbacksItem</code>.
     */
 ...
 * @member {module:model/RedemptionsGetResponseBodyRelatedRedemptionsRollbacksItem.RollbackOrderModeEnum} rollback_order_mode
 */

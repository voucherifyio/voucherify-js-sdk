...
class ClientQualificationsCheckEligibilityResponseBodyOrder {
     ...
     * @alias module:model/ClientQualificationsCheckEligibilityResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {module:model/ClientQualificationsCheckEligibilityResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/ClientQualificationsCheckEligibilityResponseBodyOrder} The populated <code>ClientQualificationsCheckEligibilityResponseBodyOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientQualificationsCheckEligibilityResponseBodyOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/ClientQualificationsCheckEligibilityResponseBodyOrder.StatusEnum} status
 */
 ...
 * @member {module:model/ClientQualificationsCheckEligibilityResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
 ...
 * @member {Array.<module:model/ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem>} items
 */

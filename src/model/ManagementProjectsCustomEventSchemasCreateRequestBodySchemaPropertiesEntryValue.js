...
class ManagementProjectsCustomEventSchemasCreateRequestBodySchemaPropertiesEntryValue {
     ...
     * @return {module:model/ManagementProjectsCustomEventSchemasCreateRequestBodySchemaPropertiesEntryValue} The populated <code>ManagementProjectsCustomEventSchemasCreateRequestBodySchemaPropertiesEntryValue</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchemasCreateRequestBodySchemaPropertiesEntryValue</code>.
     */
 ...
 * @member {module:model/ManagementProjectsCustomEventSchemasCreateRequestBodySchemaPropertiesEntryValue.TypeEnum} type
 */

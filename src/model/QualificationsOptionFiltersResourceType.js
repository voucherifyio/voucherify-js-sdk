...
class QualificationsOptionFiltersResourceType {
     ...
     * @return {module:model/QualificationsOptionFiltersResourceType} The populated <code>QualificationsOptionFiltersResourceType</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsOptionFiltersResourceType</code>.
     */
...
/**
 * @member {module:model/QualificationsOptionFiltersResourceTypeConditions} conditions
 */

...
import RedemptionsListResponseBodyRedemptionsItemVoucherGift from './RedemptionsListResponseBodyRedemptionsItemVoucherGift';
import RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard from './RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard';
import RedemptionsListResponseBodyRedemptionsItemVoucherPublish from './RedemptionsListResponseBodyRedemptionsItemVoucherPublish';
import RedemptionsListResponseBodyRedemptionsItemVoucherRedemption from './RedemptionsListResponseBodyRedemptionsItemVoucherRedemption';
...
class RedemptionsListResponseBodyRedemptionsItemVoucher {
    /**
     * Constructs a new <code>RedemptionsListResponseBodyRedemptionsItemVoucher</code>.
     * @alias RedemptionsListResponseBodyRedemptionsItemVoucher
     */
    constructor() { 
        
        RedemptionsListResponseBodyRedemptionsItemVoucher.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionsListResponseBodyRedemptionsItemVoucher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<RedemptionsListResponseBodyRedemptionsItemVoucher>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionsListResponseBodyRedemptionsItemVoucher} [obj] Optional instance to populate.
     * @returns {RedemptionsListResponseBodyRedemptionsItemVoucher} The populated <code>RedemptionsListResponseBodyRedemptionsItemVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsListResponseBodyRedemptionsItemVoucher();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = RedemptionsListResponseBodyRedemptionsItemVoucherGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = RedemptionsListResponseBodyRedemptionsItemVoucherPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionsListResponseBodyRedemptionsItemVoucher</code>.
     * @param {Partial<RedemptionsListResponseBodyRedemptionsItemVoucher>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBodyRedemptionsItemVoucher</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          RedemptionsListResponseBodyRedemptionsItemVoucherGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          RedemptionsListResponseBodyRedemptionsItemVoucherPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof RedemptionsListResponseBodyRedemptionsItemVoucher.TypeEnum) | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['type'] = undefined;

/**
    * @type {Discount | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['discount'] = undefined;

/**
    * @type {RedemptionsListResponseBodyRedemptionsItemVoucherGift | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['gift'] = undefined;

/**
    * @type {RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof RedemptionsListResponseBodyRedemptionsItemVoucher.ValidityDayOfWeekEnum>) | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['assets'] = undefined;

/**
    * Flag indicating whether this voucher is a referral code; `true` for campaign type `REFERRAL_PROGRAM`.
    * @type {Boolean | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the redeemable holder. It equals to the customer ID assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['holder_id'] = undefined;

/**
    * Unique identifier of the referring person.
    * @type {String | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['referrer_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['object'] = 'voucher';

/**
    * @type {RedemptionsListResponseBodyRedemptionsItemVoucherPublish | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['publish'] = undefined;

/**
    * @type {RedemptionsListResponseBodyRedemptionsItemVoucherRedemption | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['redemption'] = undefined;

/**
    * Contains details about the category.
    * @type {Array.<Category> | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['categories'] = undefined;

/**
    * @type {ValidationRulesAssignmentsList | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['validation_rules_assignments'] = undefined;

/**
    * @type {SimpleCustomer | undefined}
    */
RedemptionsListResponseBodyRedemptionsItemVoucher.prototype['holder'] = undefined;
     ...
     * @readonly
     */
    RedemptionsListResponseBodyRedemptionsItemVoucher['TypeEnum'] = {
 ...
 * @readonly
 */
RedemptionsListResponseBodyRedemptionsItemVoucher['ValidityDayOfWeekEnum'] = {
...
export default RedemptionsListResponseBodyRedemptionsItemVoucher;

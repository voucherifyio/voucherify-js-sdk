...
class SimpleVoucher {
     ...
     * @return {module:model/SimpleVoucher} The populated <code>SimpleVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleVoucher();
            ...
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = SimpleVoucherRedemption.constructFromObject(data['redemption']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleVoucher</code>.
     */
    static validateJSON(data) {
        ...
        if (data['redemption']) { // data not null
          SimpleVoucherRedemption.validateJSON(data['redemption']);
        }
        // ensure the json data is a string
...
/**
 * Type of the voucher.
 * @member {module:model/SimpleVoucher.TypeEnum} type
 */
...
/**
 * @member {module:model/SimpleVoucherRedemption} redemption
 */
 ...
 * @member {module:model/SimpleVoucher.ObjectEnum} object
 * @default 'voucher'
 */

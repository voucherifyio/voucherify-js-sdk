...
class ValidationRulesCreateRequestBodyApplicableTo {
     ...
     * @return {module:model/ValidationRulesCreateRequestBodyApplicableTo} The populated <code>ValidationRulesCreateRequestBodyApplicableTo</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesCreateRequestBodyApplicableTo</code>.
     */

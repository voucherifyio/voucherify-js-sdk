...
class RedemptionRewardResultParametersCampaign {
    ...
    constructor() { 
        ...
        RedemptionRewardResultParametersCampaign.initialize(this);
    }
     ...
     * @return {module:model/RedemptionRewardResultParametersCampaign} The populated <code>RedemptionRewardResultParametersCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionRewardResultParametersCampaign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRewardResultParametersCampaign</code>.
     */
...
export default RedemptionRewardResultParametersCampaign;

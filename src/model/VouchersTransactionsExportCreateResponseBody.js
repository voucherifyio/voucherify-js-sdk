...
class VouchersTransactionsExportCreateResponseBody {
    ...
    constructor(parameters) { 
        ...
        VouchersTransactionsExportCreateResponseBody.initialize(this, parameters);
    }
     ...
     * @return {module:model/VouchersTransactionsExportCreateResponseBody} The populated <code>VouchersTransactionsExportCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VouchersTransactionsExportCreateResponseBody();
            ...
            if (data.hasOwnProperty('parameters')) {
                obj['parameters'] = VoucherTransactionsFilters.constructFromObject(data['parameters']);
            }
            if (data.hasOwnProperty('result')) {
                obj['result'] = VouchersTransactionsExportCreateResponseBodyResult.constructFromObject(data['result']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersTransactionsExportCreateResponseBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VouchersTransactionsExportCreateResponseBody.RequiredProperties) {
        ...
        if (data['parameters']) { // data not null
          VoucherTransactionsFilters.validateJSON(data['parameters']);
        }
        // validate the optional field `result`
        if (data['result']) { // data not null
          VouchersTransactionsExportCreateResponseBodyResult.validateJSON(data['result']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/VouchersTransactionsExportCreateResponseBody.ObjectEnum} object
 * @default 'export'
 */
 ...
 * @member {module:model/VouchersTransactionsExportCreateResponseBody.StatusEnum} status
 * @default 'SCHEDULED'
 */
 ...
 * @member {module:model/VouchersTransactionsExportCreateResponseBody.ExportedObjectEnum} exported_object
 * @default 'voucher_transactions'
 */
VouchersTransactionsExportCreateResponseBody.prototype['exported_object'] = 'voucher_transactions';

/**
 * @member {module:model/VoucherTransactionsFilters} parameters
 */
VouchersTransactionsExportCreateResponseBody.prototype['parameters'] = undefined;

/**
 * @member {module:model/VouchersTransactionsExportCreateResponseBodyResult} result
 */
...
export default VouchersTransactionsExportCreateResponseBody;

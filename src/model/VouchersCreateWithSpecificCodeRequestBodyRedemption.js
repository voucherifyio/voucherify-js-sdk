...
class VouchersCreateWithSpecificCodeRequestBodyRedemption {
     ...
     * @return {module:model/VouchersCreateWithSpecificCodeRequestBodyRedemption} The populated <code>VouchersCreateWithSpecificCodeRequestBodyRedemption</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersCreateWithSpecificCodeRequestBodyRedemption</code>.
     */

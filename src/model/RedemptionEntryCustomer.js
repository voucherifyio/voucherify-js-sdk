...
class RedemptionEntryCustomer {
    ...
    constructor() { 
        ...
        RedemptionEntryCustomer.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntryCustomer} The populated <code>RedemptionEntryCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryCustomer</code>.
     */
 ...
 * @member {module:model/RedemptionEntryCustomer.ObjectEnum} object
 * @default 'customer'
 */
...
export default RedemptionEntryCustomer;

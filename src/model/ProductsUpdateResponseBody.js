...
class ProductsUpdateResponseBody {
     ...
     * @alias module:model/ProductsUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ProductsUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/ProductsUpdateResponseBody} The populated <code>ProductsUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsUpdateResponseBody</code>.
     */
 ...
 * @member {module:model/ProductsUpdateResponseBody.ObjectEnum} object
 * @default 'product'
 */

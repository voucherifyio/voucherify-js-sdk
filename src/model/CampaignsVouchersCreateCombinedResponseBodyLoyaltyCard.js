...
class CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard {
    ...
    constructor() { 
        ...
        CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.initialize(this);
    }
     ...
     * @return {module:model/CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard} The populated <code>CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard</code>.
     */
...
export default CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard;

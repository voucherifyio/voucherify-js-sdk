...
class ProductsCreateRequestBody {
     ...
     * @alias module:model/ProductsCreateRequestBody
     */
    constructor() { 
     ...
     * @param {module:model/ProductsCreateRequestBody} obj Optional instance to populate.
     * @returns {module:model/ProductsCreateRequestBody} The populated <code>ProductsCreateRequestBody</code> instance.
     */

...
class CampaignVoucher {
     ...
     * @return {module:model/CampaignVoucher} The populated <code>CampaignVoucher</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignVoucher</code>.
     */
...
/**
 * @member {module:model/CampaignVoucherRedemption} redemption
 */
 ...
 * @member {Array.<module:model/CampaignVoucher.ValidityDayOfWeekEnum>} validity_day_of_week
 */

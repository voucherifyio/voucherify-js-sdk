...
class ParameterFiltersListReferralsRedeemableHoldersCustomerId {
     ...
     * @return {module:model/ParameterFiltersListReferralsRedeemableHoldersCustomerId} The populated <code>ParameterFiltersListReferralsRedeemableHoldersCustomerId</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListReferralsRedeemableHoldersCustomerId</code>.
     */

...
class LoyaltiesPointsExpirationExportCreateRequestBody {
     ...
     * @return {module:model/LoyaltiesPointsExpirationExportCreateRequestBody} The populated <code>LoyaltiesPointsExpirationExportCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPointsExpirationExportCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParameters} parameters
 */

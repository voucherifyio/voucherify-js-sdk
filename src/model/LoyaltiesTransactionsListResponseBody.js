...
class LoyaltiesTransactionsListResponseBody {
     ...
     * @alias module:model/LoyaltiesTransactionsListResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/LoyaltiesTransactionsListResponseBody} obj Optional instance to populate.
     * @return {module:model/LoyaltiesTransactionsListResponseBody} The populated <code>LoyaltiesTransactionsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTransactionsListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesTransactionsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesTransactionsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/LoyaltyCardTransaction>} data
 */

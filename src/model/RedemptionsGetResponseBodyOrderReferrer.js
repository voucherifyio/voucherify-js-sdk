...
class RedemptionsGetResponseBodyOrderReferrer {
    ...
    constructor() { 
        ...
        RedemptionsGetResponseBodyOrderReferrer.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsGetResponseBodyOrderReferrer} The populated <code>RedemptionsGetResponseBodyOrderReferrer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsGetResponseBodyOrderReferrer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyOrderReferrer</code>.
     */
 ...
 * @member {module:model/RedemptionsGetResponseBodyOrderReferrer.ObjectEnum} object
 * @default 'customer'
 */
...
export default RedemptionsGetResponseBodyOrderReferrer;

...
class ManagementProjectsWebhooksCreateRequestBody {
     ...
     * @return {module:model/ManagementProjectsWebhooksCreateRequestBody} The populated <code>ManagementProjectsWebhooksCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhooksCreateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhooksCreateRequestBody.EventsEnum>} events
 */

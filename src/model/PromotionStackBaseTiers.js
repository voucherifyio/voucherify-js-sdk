...
class PromotionStackBaseTiers {
     ...
     * @return {module:model/PromotionStackBaseTiers} The populated <code>PromotionStackBaseTiers</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionStackBaseTiers</code>.
     */
...
/**
 * @member {module:model/PromotionStackBaseTiers.HierarchyModeEnum} hierarchy_mode
 * @default 'MANUAL'
 */

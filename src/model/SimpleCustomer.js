...
class SimpleCustomer {
    ...
    constructor() { 
        ...
        SimpleCustomer.initialize(this);
    }
     ...
     * @return {module:model/SimpleCustomer} The populated <code>SimpleCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleCustomer</code>.
     */
 ...
 * @member {module:model/SimpleCustomer.ObjectEnum} object
 * @default 'customer'
 */

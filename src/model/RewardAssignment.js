...
class RewardAssignment {
     ...
     * @return {module:model/RewardAssignment} The populated <code>RewardAssignment</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardAssignment</code>.
     */
 ...
 * @member {module:model/RewardAssignment.ObjectEnum} object
 ...
 * @member {module:model/RewardAssignment.RelatedObjectTypeEnum} related_object_type
 * @default 'campaign'
 */
RewardAssignment.prototype['related_object_type'] = 'campaign';

/**
 * @member {module:model/RewardAssignmentParameters} parameters
 */

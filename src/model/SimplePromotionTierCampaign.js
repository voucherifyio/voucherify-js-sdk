...
class SimplePromotionTierCampaign {
     ...
     * @return {module:model/SimplePromotionTierCampaign} The populated <code>SimplePromotionTierCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePromotionTierCampaign</code>.
     */

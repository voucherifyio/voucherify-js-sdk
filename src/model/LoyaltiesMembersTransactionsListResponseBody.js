...
class LoyaltiesMembersTransactionsListResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesMembersTransactionsListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersTransactionsListResponseBody} The populated <code>LoyaltiesMembersTransactionsListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersTransactionsListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransactionsListResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersTransactionsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/LoyaltiesMembersTransactionsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
...
export default LoyaltiesMembersTransactionsListResponseBody;

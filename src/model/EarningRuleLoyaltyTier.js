...
class EarningRuleLoyaltyTier {
    ...
    constructor() { 
        ...
        EarningRuleLoyaltyTier.initialize(this);
    }
     ...
     * @return {module:model/EarningRuleLoyaltyTier} The populated <code>EarningRuleLoyaltyTier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EarningRuleLoyaltyTier();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleLoyaltyTier</code>.
     */
...
export default EarningRuleLoyaltyTier;

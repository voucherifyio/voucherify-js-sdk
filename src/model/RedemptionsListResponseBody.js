...
class RedemptionsListResponseBody {
     ...
     * @return {module:model/RedemptionsListResponseBody} The populated <code>RedemptionsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBody</code>.
     */
...
/**
 * @member {Array.<module:model/RedemptionsListResponseBodyRedemptionsItem>} redemptions
 */

...
class LoyaltiesMembersTransactionsExportCreateResponseBodyParameters {
     ...
     * @return {module:model/LoyaltiesMembersTransactionsExportCreateResponseBodyParameters} The populated <code>LoyaltiesMembersTransactionsExportCreateResponseBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransactionsExportCreateResponseBodyParameters</code>.
     */
...
/**
 * @member {module:model/ExportVoucherTransactionsOrder} order
 */
 ...
 * @member {Array.<module:model/ExportVoucherTransactionsFields>} fields
 */
LoyaltiesMembersTransactionsExportCreateResponseBodyParameters.prototype['fields'] = undefined;

/**
 * @member {module:model/ExportVoucherTransactionsFilters} filters
 */

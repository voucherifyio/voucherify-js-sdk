...
class CategoriesListResponseBody {
    ...
    constructor() { 
        ...
        CategoriesListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/CategoriesListResponseBody} The populated <code>CategoriesListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesListResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesListResponseBody</code>.
     */
 ...
 * @member {module:model/CategoriesListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/CategoriesListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
...
export default CategoriesListResponseBody;

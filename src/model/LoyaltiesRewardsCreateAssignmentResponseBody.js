...
class LoyaltiesRewardsCreateAssignmentResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesRewardsCreateAssignmentResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesRewardsCreateAssignmentResponseBody} The populated <code>LoyaltiesRewardsCreateAssignmentResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesRewardsCreateAssignmentResponseBody();
            ...
            if (data.hasOwnProperty('parameters')) {
                obj['parameters'] = LoyaltiesRewardsCreateAssignmentResponseBodyParameters.constructFromObject(data['parameters']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardsCreateAssignmentResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['parameters']) { // data not null
          LoyaltiesRewardsCreateAssignmentResponseBodyParameters.validateJSON(data['parameters']);
        }
 ...
 * @member {module:model/LoyaltiesRewardsCreateAssignmentResponseBody.ObjectEnum} object
 ...
 * @member {module:model/LoyaltiesRewardsCreateAssignmentResponseBody.RelatedObjectTypeEnum} related_object_type
 * @default 'campaign'
 */
LoyaltiesRewardsCreateAssignmentResponseBody.prototype['related_object_type'] = 'campaign';

/**
 * @member {module:model/LoyaltiesRewardsCreateAssignmentResponseBodyParameters} parameters
 */
...
export default LoyaltiesRewardsCreateAssignmentResponseBody;

...
class RedemptionEntryOrder {
     ...
     * @alias module:model/RedemptionEntryOrder
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionEntryOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionEntryOrder} The populated <code>RedemptionEntryOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/RedemptionEntryOrder.StatusEnum} status
 */
 ...
 * @member {module:model/RedemptionEntryOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/RedemptionEntryOrderCustomer} customer
 */
RedemptionEntryOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/RedemptionEntryOrderReferrer} referrer
 */
 ...
 * @member {Array.<module:model/RedemptionEntryOrderItemsItem>} items
 */

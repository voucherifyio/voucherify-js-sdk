...
class LoyaltiesEarningRulesUpdateResponseBody {
     ...
     * @return {module:model/LoyaltiesEarningRulesUpdateResponseBody} The populated <code>LoyaltiesEarningRulesUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesUpdateResponseBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyalty} loyalty
 */
...
/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyCustomEvent} custom_event
 */
LoyaltiesEarningRulesUpdateResponseBody.prototype['custom_event'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodySegment} segment
 */
LoyaltiesEarningRulesUpdateResponseBody.prototype['segment'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier} loyalty_tier
 */
LoyaltiesEarningRulesUpdateResponseBody.prototype['loyalty_tier'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodyPendingPoints} pending_points
 */
LoyaltiesEarningRulesUpdateResponseBody.prototype['pending_points'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBodySource} source
 */
 ...
 * @member {module:model/LoyaltiesEarningRulesUpdateResponseBody.ObjectEnum} object
 ...
 * @member {Array.<module:model/LoyaltiesEarningRulesUpdateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */

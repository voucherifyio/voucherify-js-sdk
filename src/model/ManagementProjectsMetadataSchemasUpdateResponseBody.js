...
class ManagementProjectsMetadataSchemasUpdateResponseBody {
     ...
     * @alias module:model/ManagementProjectsMetadataSchemasUpdateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/ManagementProjectsMetadataSchemasUpdateResponseBody} obj Optional instance to populate.
     * @return {module:model/ManagementProjectsMetadataSchemasUpdateResponseBody} The populated <code>ManagementProjectsMetadataSchemasUpdateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsMetadataSchemasUpdateResponseBody</code>.
     */

...
class RewardsAssignmentsGetResponseBody {
     ...
     * @alias module:model/RewardsAssignmentsGetResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/RewardsAssignmentsGetResponseBody} obj Optional instance to populate.
     * @return {module:model/RewardsAssignmentsGetResponseBody} The populated <code>RewardsAssignmentsGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsAssignmentsGetResponseBody</code>.
     */
 ...
 * @member {module:model/RewardsAssignmentsGetResponseBody.ObjectEnum} object
 ...
 * @member {module:model/RewardsAssignmentsGetResponseBody.RelatedObjectTypeEnum} related_object_type
 * @default 'campaign'
 */
RewardsAssignmentsGetResponseBody.prototype['related_object_type'] = 'campaign';

/**
 * @member {module:model/RewardsAssignmentsGetResponseBodyParameters} parameters
 */

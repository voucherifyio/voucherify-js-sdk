...
class ExportsGetResponseBodyParameters {
     ...
     * @alias module:model/ExportsGetResponseBodyParameters
     */
    constructor() { 
     ...
     * @param {module:model/ExportsGetResponseBodyParameters} obj Optional instance to populate.
     * @return {module:model/ExportsGetResponseBodyParameters} The populated <code>ExportsGetResponseBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportsGetResponseBodyParameters</code>.
     */
...
/**
 * @member {module:model/ExportsGetResponseBodyParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/ExportsGetResponseBodyParameters.FieldsEnum>} fields
 */

...
import ClientValidationsValidateResponseBodyOrderItemsItem from './ClientValidationsValidateResponseBodyOrderItemsItem';
...
class ClientValidationsValidateResponseBodyOrder {
    /**
     * Constructs a new <code>ClientValidationsValidateResponseBodyOrder</code>.
     * @alias module:model/ClientValidationsValidateResponseBodyOrder
     */
    constructor() { 
        
        ClientValidationsValidateResponseBodyOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientValidationsValidateResponseBodyOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientValidationsValidateResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/ClientValidationsValidateResponseBodyOrder} The populated <code>ClientValidationsValidateResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientValidationsValidateResponseBodyOrder();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ClientValidationsValidateResponseBodyOrderItemsItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClientValidationsValidateResponseBodyOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ClientValidationsValidateResponseBodyOrderItemsItem.validateJSON(item);
            };
        }
 ...
 * @member {String} id
 */
ClientValidationsValidateResponseBodyOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
ClientValidationsValidateResponseBodyOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/ClientValidationsValidateResponseBodyOrder.StatusEnum} status
 */
ClientValidationsValidateResponseBodyOrder.prototype['status'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['initial_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['total_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
ClientValidationsValidateResponseBodyOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/ClientValidationsValidateResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
ClientValidationsValidateResponseBodyOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
ClientValidationsValidateResponseBodyOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
ClientValidationsValidateResponseBodyOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
ClientValidationsValidateResponseBodyOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
ClientValidationsValidateResponseBodyOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
ClientValidationsValidateResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
ClientValidationsValidateResponseBodyOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
ClientValidationsValidateResponseBodyOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/ClientValidationsValidateResponseBodyOrderItemsItem>} items
 */
ClientValidationsValidateResponseBodyOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
ClientValidationsValidateResponseBodyOrder['StatusEnum'] = {
 ...
 * @readonly
 */
ClientValidationsValidateResponseBodyOrder['ObjectEnum'] = {
...
export default ClientValidationsValidateResponseBodyOrder;

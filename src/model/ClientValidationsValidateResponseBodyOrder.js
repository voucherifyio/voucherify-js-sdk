...
class ClientValidationsValidateResponseBodyOrder {
     ...
     * @returns {module:model/ClientValidationsValidateResponseBodyOrder} The populated <code>ClientValidationsValidateResponseBodyOrder</code> instance.
     */
...
/**
 * The order status.
 * @member {module:model/ClientValidationsValidateResponseBodyOrder.StatusEnum} 
 */
 ...
 * @member {module:model/ClientValidationsValidateResponseBodyOrder.ObjectEnum} 
 * @default 'order'
 */
 ...
 * @member {Array.<module:model/ClientValidationsValidateResponseBodyOrderItemsItem>} 
 */

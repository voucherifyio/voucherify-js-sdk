...
class ClientValidationsValidateResponseBodyOrder {
     ...
     * @alias ClientValidationsValidateResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<ClientValidationsValidateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {ClientValidationsValidateResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {ClientValidationsValidateResponseBodyOrder} The populated <code>ClientValidationsValidateResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<ClientValidationsValidateResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof ClientValidationsValidateResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof ClientValidationsValidateResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
...
/**
    ...
    * @type {Array.<ClientValidationsValidateResponseBodyOrderItemsItem> | undefined}
    */

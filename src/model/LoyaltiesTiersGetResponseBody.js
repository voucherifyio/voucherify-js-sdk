...
class LoyaltiesTiersGetResponseBody {
     ...
     * @return {module:model/LoyaltiesTiersGetResponseBody} The populated <code>LoyaltiesTiersGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTiersGetResponseBody</code>.
     */
...
/**
 * @member {module:model/LoyaltiesTiersGetResponseBodyPoints} points
 */
...
/**
 * @member {module:model/LoyaltiesTiersGetResponseBodyConfig} config
 */
LoyaltiesTiersGetResponseBody.prototype['config'] = undefined;

/**
 * @member {module:model/LoyaltyTierExpiration} expiration
 */
 ...
 * @member {module:model/LoyaltiesTiersGetResponseBody.ObjectEnum} object

...
class PromotionsTiersCreateResponseBodyAction {
    ...
    constructor() { 
        ...
        PromotionsTiersCreateResponseBodyAction.initialize(this);
    }
     ...
     * @return {module:model/PromotionsTiersCreateResponseBodyAction} The populated <code>PromotionsTiersCreateResponseBodyAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersCreateResponseBodyAction();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersCreateResponseBodyAction</code>.
     */
...
export default PromotionsTiersCreateResponseBodyAction;

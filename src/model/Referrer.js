...
class Referrer {
     ...
     * @return {module:model/Referrer} The populated <code>Referrer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Referrer();
            ...
            if (data.hasOwnProperty('address')) {
                obj['address'] = ReferrerAddress.constructFromObject(data['address']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Referrer</code>.
     */
    static validateJSON(data) {
        ...
        if (data['address']) { // data not null
          ReferrerAddress.validateJSON(data['address']);
        }
...
/**
 * @member {module:model/ReferrerAddress} address
 */

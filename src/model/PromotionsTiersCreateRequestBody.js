...
class PromotionsTiersCreateRequestBody {
     ...
     * @alias PromotionsTiersCreateRequestBody
     */
    constructor() { 
     ...
     * @param {Partial<PromotionsTiersCreateRequestBody>} data The plain JavaScript object bearing properties of interest.
     * @param {PromotionsTiersCreateRequestBody} [obj] Optional instance to populate.
     * @returns {PromotionsTiersCreateRequestBody} The populated <code>PromotionsTiersCreateRequestBody</code> instance.
     */
...
/**
    ...
    * @type {(Array<keyof typeof PromotionsTiersCreateRequestBody.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {PromotionsTiersCreateRequestBodyAction | undefined}
    */

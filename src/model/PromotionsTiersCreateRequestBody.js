...
class PromotionsTiersCreateRequestBody {
     ...
     * @return {module:model/PromotionsTiersCreateRequestBody} The populated <code>PromotionsTiersCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersCreateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersCreateRequestBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/PromotionsTiersCreateRequestBodyAction} action
 */

...
class LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions {
    ...
    constructor() { 
        ...
        LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions} The populated <code>LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions</code>.
     */
...
export default LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignIdConditions;

...
class RewardsUpdateRequestBodyAttributes {
     ...
     * @return {module:model/RewardsUpdateRequestBodyAttributes} The populated <code>RewardsUpdateRequestBodyAttributes</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsUpdateRequestBodyAttributes</code>.
     */

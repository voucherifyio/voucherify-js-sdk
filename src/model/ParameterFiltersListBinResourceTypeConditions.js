...
class ParameterFiltersListBinResourceTypeConditions {
    ...
    constructor() { 
        ...
        ParameterFiltersListBinResourceTypeConditions.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListBinResourceTypeConditions} The populated <code>ParameterFiltersListBinResourceTypeConditions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListBinResourceTypeConditions();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListBinResourceTypeConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListBinResourceTypeConditions.InEnum>} $in
 */
ParameterFiltersListBinResourceTypeConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListBinResourceTypeConditions.NotInEnum>} $not_in
 */
ParameterFiltersListBinResourceTypeConditions.prototype['$not_in'] = undefined;

/**
 * Value is exactly this value (single value).
 * @member {module:model/ParameterFiltersListBinResourceTypeConditions.IsEnum} $is
 */
ParameterFiltersListBinResourceTypeConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListBinResourceTypeConditions.IsNotEnum} $is_not
 */
 ...
 * @readonly
 */
ParameterFiltersListBinResourceTypeConditions['InEnum'] = {
 ...
 * @readonly
 */
ParameterFiltersListBinResourceTypeConditions['NotInEnum'] = {
...
export default ParameterFiltersListBinResourceTypeConditions;

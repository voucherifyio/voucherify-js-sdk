...
class LoyaltiesMembersTransfersCreateResponseBodyPublish {
     ...
     * @return {module:model/LoyaltiesMembersTransfersCreateResponseBodyPublish} The populated <code>LoyaltiesMembersTransfersCreateResponseBodyPublish</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransfersCreateResponseBodyPublish</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersTransfersCreateResponseBodyPublish.ObjectEnum} object
 * @default 'list'
 */

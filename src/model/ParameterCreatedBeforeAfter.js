...
class ParameterCreatedBeforeAfter {
     ...
     * @return {module:model/ParameterCreatedBeforeAfter} The populated <code>ParameterCreatedBeforeAfter</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterCreatedBeforeAfter</code>.
     */

...
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem} The populated <code>LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem</code>.
     */
 ...
 * @member {module:model/LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem.ObjectEnum} object
 */
...
export default LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem;

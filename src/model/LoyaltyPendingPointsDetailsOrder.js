...
class LoyaltyPendingPointsDetailsOrder {
     ...
     * @return {module:model/LoyaltyPendingPointsDetailsOrder} The populated <code>LoyaltyPendingPointsDetailsOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyPendingPointsDetailsOrder</code>.
     */

...
class CustomersUpdateInBulkRequestBodyAddress {
    ...
    constructor() { 
        ...
        CustomersUpdateInBulkRequestBodyAddress.initialize(this);
    }
     ...
     * @return {module:model/CustomersUpdateInBulkRequestBodyAddress} The populated <code>CustomersUpdateInBulkRequestBodyAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomersUpdateInBulkRequestBodyAddress();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersUpdateInBulkRequestBodyAddress</code>.
     */
...
export default CustomersUpdateInBulkRequestBodyAddress;

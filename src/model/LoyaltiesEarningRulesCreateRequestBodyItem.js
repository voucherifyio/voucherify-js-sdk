...
import LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent from './LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent';
import LoyaltiesEarningRulesCreateRequestBodyItemLoyalty from './LoyaltiesEarningRulesCreateRequestBodyItemLoyalty';
import LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier from './LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier';
import LoyaltiesEarningRulesCreateRequestBodyItemPendingPoints from './LoyaltiesEarningRulesCreateRequestBodyItemPendingPoints';
import LoyaltiesEarningRulesCreateRequestBodyItemSegment from './LoyaltiesEarningRulesCreateRequestBodyItemSegment';
...
class LoyaltiesEarningRulesCreateRequestBodyItem {
    ...
    constructor() { 
        ...
        LoyaltiesEarningRulesCreateRequestBodyItem.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesEarningRulesCreateRequestBodyItem} The populated <code>LoyaltiesEarningRulesCreateRequestBodyItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesEarningRulesCreateRequestBodyItem();
            ...
            if (data.hasOwnProperty('loyalty')) {
                obj['loyalty'] = LoyaltiesEarningRulesCreateRequestBodyItemLoyalty.constructFromObject(data['loyalty']);
            }
            if (data.hasOwnProperty('event')) {
                obj['event'] = ApiClient.convertToType(data['event'], 'String');
            }
            if (data.hasOwnProperty('source')) {
                obj['source'] = LoyaltiesEarningRulesCreateRequestBodyItemSource.constructFromObject(data['source']);
            }
            ...
            if (data.hasOwnProperty('pending_points')) {
                obj['pending_points'] = LoyaltiesEarningRulesCreateRequestBodyItemPendingPoints.constructFromObject(data['pending_points']);
            }
            ...
            if (data.hasOwnProperty('segment')) {
                obj['segment'] = LoyaltiesEarningRulesCreateRequestBodyItemSegment.constructFromObject(data['segment']);
            }
            if (data.hasOwnProperty('custom_event')) {
                obj['custom_event'] = LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent.constructFromObject(data['custom_event']);
            }
            if (data.hasOwnProperty('loyalty_tier')) {
                obj['loyalty_tier'] = LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier.constructFromObject(data['loyalty_tier']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesCreateRequestBodyItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['loyalty']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemLoyalty.validateJSON(data['loyalty']);
        }
        // ensure the json data is a string
        ...
        if (data['source']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemSource.validateJSON(data['source']);
        }
        // validate the optional field `pending_points`
        if (data['pending_points']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemPendingPoints.validateJSON(data['pending_points']);
        }
        ...
        if (data['segment']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemSegment.validateJSON(data['segment']);
        }
        // validate the optional field `custom_event`
        if (data['custom_event']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent.validateJSON(data['custom_event']);
        }
        // validate the optional field `loyalty_tier`
        if (data['loyalty_tier']) { // data not null
          LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier.validateJSON(data['loyalty_tier']);
        }
...
/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyalty} loyalty
 */
...
/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemSource} source
 */
...
/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemPendingPoints} pending_points
 */
 ...
 * @member {Array.<module:model/LoyaltiesEarningRulesCreateRequestBodyItem.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemSegment} segment
 */
LoyaltiesEarningRulesCreateRequestBodyItem.prototype['segment'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemCustomEvent} custom_event
 */
LoyaltiesEarningRulesCreateRequestBodyItem.prototype['custom_event'] = undefined;

/**
 * @member {module:model/LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyTier} loyalty_tier
 */
 ...
 * @readonly
 */
LoyaltiesEarningRulesCreateRequestBodyItem['ValidityDayOfWeekEnum'] = {
...
export default LoyaltiesEarningRulesCreateRequestBodyItem;

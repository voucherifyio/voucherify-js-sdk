...
class RedemptionsGetResponseBodyVoucherRedemption {
    ...
    constructor() { 
        ...
        RedemptionsGetResponseBodyVoucherRedemption.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsGetResponseBodyVoucherRedemption} The populated <code>RedemptionsGetResponseBodyVoucherRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsGetResponseBodyVoucherRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyVoucherRedemption</code>.
     */
...
export default RedemptionsGetResponseBodyVoucherRedemption;

...
class ProductCollectionsGetResponseBody {
    ...
    constructor() { 
        ...
        ProductCollectionsGetResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ProductCollectionsGetResponseBody} The populated <code>ProductCollectionsGetResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductCollectionsGetResponseBody();
            ...
            if (data.hasOwnProperty('products')) {
                obj['products'] = ApiClient.convertToType(data['products'], [ProductCollectionsGetResponseBodyProductsItem]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsGetResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['products']) { // data not null
            ...
            for (const item of data['products']) {
                ProductCollectionsGetResponseBodyProductsItem.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {module:model/ProductCollectionsGetResponseBody.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/ProductCollectionsGetResponseBodyProductsItem>} products
 */
 ...
 * @member {module:model/ProductCollectionsGetResponseBody.ObjectEnum} object
...
export default ProductCollectionsGetResponseBody;

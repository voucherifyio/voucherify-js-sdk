...
class MemberActivityDataRedemptionVoucherGift {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionVoucherGift.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionVoucherGift} The populated <code>MemberActivityDataRedemptionVoucherGift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionVoucherGift();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionVoucherGift</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionVoucherGift.EffectEnum} effect
 */
...
export default MemberActivityDataRedemptionVoucherGift;

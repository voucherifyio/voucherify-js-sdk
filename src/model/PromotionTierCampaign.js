...
class PromotionTierCampaign {
     ...
     * @return {module:model/PromotionTierCampaign} The populated <code>PromotionTierCampaign</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionTierCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionTierCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */

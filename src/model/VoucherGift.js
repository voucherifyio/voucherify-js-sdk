...
class VoucherGift {
     ...
     * @alias module:model/VoucherGift
     */
    constructor() { 
     ...
     * @param {module:model/VoucherGift} obj Optional instance to populate.
     * @return {module:model/VoucherGift} The populated <code>VoucherGift</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherGift</code>.
     */
 ...
 * @member {module:model/VoucherGift.EffectEnum} effect
 */

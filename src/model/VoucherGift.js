...
class VoucherGift {
    ...
    /**
     * Constructs a <code>VoucherGift</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<VoucherGift>} data The plain JavaScript object bearing properties of interest.
     * @param {VoucherGift} [obj] Optional instance to populate.
     * @returns {VoucherGift} The populated <code>VoucherGift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherGift();
    ...
    /**
     * Validates the JSON data with respect to <code>VoucherGift</code>.
     * @param {Partial<VoucherGift>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherGift</code>.
     */
...
/**
    ...
    */
VoucherGift.prototype['amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
VoucherGift.prototype['subtracted_amount'] = undefined;

/**
    * Available funds. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
    * @type {Number | undefined}
    */
VoucherGift.prototype['balance'] = undefined;

/**
    * Defines how the credits are applied to the customer's order.
    * @type {(keyof typeof VoucherGift.EffectEnum) | undefined}
    */
VoucherGift.prototype['effect'] = undefined;

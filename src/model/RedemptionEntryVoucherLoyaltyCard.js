...
class RedemptionEntryVoucherLoyaltyCard {
    ...
    constructor() { 
        ...
        RedemptionEntryVoucherLoyaltyCard.initialize(this);
    }
     ...
     * @return {module:model/RedemptionEntryVoucherLoyaltyCard} The populated <code>RedemptionEntryVoucherLoyaltyCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryVoucherLoyaltyCard();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryVoucherLoyaltyCard</code>.
     */
...
export default RedemptionEntryVoucherLoyaltyCard;

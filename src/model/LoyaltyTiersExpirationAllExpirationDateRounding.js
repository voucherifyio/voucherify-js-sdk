...
class LoyaltyTiersExpirationAllExpirationDateRounding {
     ...
     * @return {module:model/LoyaltyTiersExpirationAllExpirationDateRounding} The populated <code>LoyaltyTiersExpirationAllExpirationDateRounding</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTiersExpirationAllExpirationDateRounding</code>.
     */
 ...
 * @member {module:model/LoyaltyTiersExpirationAllExpirationDateRounding.TypeEnum} type
 */
 ...
 * @member {module:model/LoyaltyTiersExpirationAllExpirationDateRounding.StrategyEnum} strategy
 */
 ...
 * @member {module:model/LoyaltyTiersExpirationAllExpirationDateRounding.UnitEnum} unit
 * @default 'MONTH'
 */

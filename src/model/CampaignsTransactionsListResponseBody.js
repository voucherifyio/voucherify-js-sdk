...
class CampaignsTransactionsListResponseBody {
     ...
     * @alias module:model/CampaignsTransactionsListResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/CampaignsTransactionsListResponseBody} obj Optional instance to populate.
     * @return {module:model/CampaignsTransactionsListResponseBody} The populated <code>CampaignsTransactionsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsTransactionsListResponseBody</code>.
     */
 ...
 * @member {module:model/CampaignsTransactionsListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/CampaignsTransactionsListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/VoucherTransaction>} data
 */

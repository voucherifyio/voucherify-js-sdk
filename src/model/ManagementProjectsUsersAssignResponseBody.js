...
class ManagementProjectsUsersAssignResponseBody {
    ...
    constructor() { 
        ...
        ManagementProjectsUsersAssignResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsUsersAssignResponseBody} The populated <code>ManagementProjectsUsersAssignResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsUsersAssignResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsUsersAssignResponseBody</code>.
     */
...
export default ManagementProjectsUsersAssignResponseBody;

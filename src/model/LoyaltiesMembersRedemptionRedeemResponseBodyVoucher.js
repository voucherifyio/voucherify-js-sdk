...
import LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift from './LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift';
import LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard from './LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard';
import LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish from './LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish';
import LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption from './LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption';
...
class LoyaltiesMembersRedemptionRedeemResponseBodyVoucher {
    /**
     * Constructs a new <code>LoyaltiesMembersRedemptionRedeemResponseBodyVoucher</code>.
     * Defines the details of the voucher being redeemed.
     * @alias LoyaltiesMembersRedemptionRedeemResponseBodyVoucher
     */
    constructor() { 
        
        LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LoyaltiesMembersRedemptionRedeemResponseBodyVoucher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<LoyaltiesMembersRedemptionRedeemResponseBodyVoucher>} data The plain JavaScript object bearing properties of interest.
     * @param {LoyaltiesMembersRedemptionRedeemResponseBodyVoucher} [obj] Optional instance to populate.
     * @returns {LoyaltiesMembersRedemptionRedeemResponseBodyVoucher} The populated <code>LoyaltiesMembersRedemptionRedeemResponseBodyVoucher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersRedemptionRedeemResponseBodyVoucher();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyVoucher</code>.
     * @param {Partial<LoyaltiesMembersRedemptionRedeemResponseBodyVoucher>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersRedemptionRedeemResponseBodyVoucher</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption.validateJSON(data['redemption']);
        }
        // ensure the json data is an array
...
/**
    ...
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.TypeEnum) | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['type'] = undefined;

/**
    * @type {Discount | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['discount'] = undefined;

/**
    * @type {LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['gift'] = undefined;

/**
    * @type {LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.ValidityDayOfWeekEnum>) | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['assets'] = undefined;

/**
    * Flag indicating whether this voucher is a referral code; `true` for campaign type `REFERRAL_PROGRAM`.
    * @type {Boolean | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the redeemable holder. It equals to the customer ID assigned by Voucherify.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['holder_id'] = undefined;

/**
    * Unique identifier of the referring person.
    * @type {String | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['referrer_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['object'] = 'voucher';

/**
    * @type {LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['publish'] = undefined;

/**
    * @type {LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['redemption'] = undefined;

/**
    * Always returns an empty array.
    * @type {Array.<Object> | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['categories'] = undefined;

/**
    * @type {ValidationRulesAssignmentsList | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['validation_rules_assignments'] = undefined;

/**
    * @type {SimpleCustomer | undefined}
    */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.prototype['holder'] = undefined;
     ...
     * @readonly
     */
    LoyaltiesMembersRedemptionRedeemResponseBodyVoucher['TypeEnum'] = {
 ...
 * @readonly
 */
LoyaltiesMembersRedemptionRedeemResponseBodyVoucher['ValidityDayOfWeekEnum'] = {
...
export default LoyaltiesMembersRedemptionRedeemResponseBodyVoucher;

...
class VoucherTransactionsExportParameters {
     ...
     * @alias module:model/VoucherTransactionsExportParameters
     */
    constructor() { 
     ...
     * @param {module:model/VoucherTransactionsExportParameters} obj Optional instance to populate.
     * @return {module:model/VoucherTransactionsExportParameters} The populated <code>VoucherTransactionsExportParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionsExportParameters</code>.
     */
 ...
 * @member {module:model/VoucherTransactionsExportParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/VoucherTransactionsExportParameters.FieldsEnum>} fields
 */

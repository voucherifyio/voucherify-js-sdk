...
class ClientEventsCreateRequestBodyLoyalty {
     ...
     * @return {module:model/ClientEventsCreateRequestBodyLoyalty} The populated <code>ClientEventsCreateRequestBodyLoyalty</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientEventsCreateRequestBodyLoyalty</code>.
     */

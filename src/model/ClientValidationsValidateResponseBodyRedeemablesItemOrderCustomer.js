...
class ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer {
    ...
    constructor() { 
        ...
        ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer.initialize(this);
    }
     ...
     * @return {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer} The populated <code>ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer</code>.
     */
 ...
 * @member {module:model/ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer.ObjectEnum} object
 * @default 'customer'
 */
...
export default ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer;

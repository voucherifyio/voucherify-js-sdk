...
class ProductCollectionsGetResponseBodyProductsItem {
    ...
    constructor(id, object) { 
        ...
        ProductCollectionsGetResponseBodyProductsItem.initialize(this, id, object);
    }
     ...
     * @return {module:model/ProductCollectionsGetResponseBodyProductsItem} The populated <code>ProductCollectionsGetResponseBodyProductsItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductCollectionsGetResponseBodyProductsItem();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsGetResponseBodyProductsItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProductCollectionsGetResponseBodyProductsItem.RequiredProperties) {
 ...
 * @member {module:model/ProductCollectionsGetResponseBodyProductsItem.ObjectEnum} object
 */
...
export default ProductCollectionsGetResponseBodyProductsItem;

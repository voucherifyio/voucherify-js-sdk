...
class VoucherTransactionsExportFilterConditionsVoucherId {
     ...
     * @return {module:model/VoucherTransactionsExportFilterConditionsVoucherId} The populated <code>VoucherTransactionsExportFilterConditionsVoucherId</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionsExportFilterConditionsVoucherId</code>.
     */
...
/**
 * @member {module:model/VoucherTransactionsExportFilterConditionsVoucherIdConditions} conditions
 */

...
class ParameterFiltersListCampaignsActive {
     ...
     * @return {module:model/ParameterFiltersListCampaignsActive} The populated <code>ParameterFiltersListCampaignsActive</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsActive</code>.
     */

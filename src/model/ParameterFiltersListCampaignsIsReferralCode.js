...
class ParameterFiltersListCampaignsIsReferralCode {
    ...
    constructor() { 
        ...
        ParameterFiltersListCampaignsIsReferralCode.initialize(this);
    }
     ...
     * @return {module:model/ParameterFiltersListCampaignsIsReferralCode} The populated <code>ParameterFiltersListCampaignsIsReferralCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterFiltersListCampaignsIsReferralCode();

            if (data.hasOwnProperty('conditions')) {
                obj['conditions'] = ParameterFiltersListCampaignsIsReferralCodeConditions.constructFromObject(data['conditions']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsIsReferralCode</code>.
     */
    static validateJSON(data) {
        // validate the optional field `conditions`
        if (data['conditions']) { // data not null
          ParameterFiltersListCampaignsIsReferralCodeConditions.validateJSON(data['conditions']);
        }
...
/**
 * @member {module:model/ParameterFiltersListCampaignsIsReferralCodeConditions} conditions
 */
...
export default ParameterFiltersListCampaignsIsReferralCode;

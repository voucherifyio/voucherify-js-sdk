...
class AsyncActionGetResponseBody {
     ...
     * @return {module:model/AsyncActionGetResponseBody} The populated <code>AsyncActionGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AsyncActionGetResponseBody</code>.
     */
 ...
 * @member {module:model/AsyncActionGetResponseBody.StatusEnum} status
 */
 ...
 * @member {module:model/AsyncActionGetResponseBody.OperationStatusEnum} operation_status
 */
 ...
 * @member {module:model/AsyncActionGetResponseBody.ObjectEnum} object

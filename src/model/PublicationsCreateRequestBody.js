...
class PublicationsCreateRequestBody {
     ...
     * @return {module:model/PublicationsCreateRequestBody} The populated <code>PublicationsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicationsCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/CreatePublicationCampaign} campaign
 */

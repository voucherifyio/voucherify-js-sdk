...
class ValidationRulesCreateResponseBody {
    /**
     * Constructs a new <code>ValidationRulesCreateResponseBody</code>.
     * Response body schema for **POST** &#x60;v1/validation-rules&#x60;.
     * @alias module:model/ValidationRulesCreateResponseBody
     */
    constructor() { 
        
        ValidationRulesCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidationRulesCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidationRulesCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/ValidationRulesCreateResponseBody} The populated <code>ValidationRulesCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationRulesCreateResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidationRulesCreateResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesCreateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['applicable_to']) { // data not null
          ValidationRulesCreateResponseBodyApplicableTo.validateJSON(data['applicable_to']);
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
ValidationRulesCreateResponseBody.prototype['name'] = undefined;
 ...
 * @member {Object} rules
 */
ValidationRulesCreateResponseBody.prototype['rules'] = undefined;
 ...
 * @member {Object} bundle_rules
 */
ValidationRulesCreateResponseBody.prototype['bundle_rules'] = undefined;

/**
 * @member {module:model/ValidationRulesCreateResponseBodyError} error
 */
ValidationRulesCreateResponseBody.prototype['error'] = undefined;

/**
 * @member {module:model/ValidationRulesCreateResponseBodyApplicableTo} applicable_to
 */
ValidationRulesCreateResponseBody.prototype['applicable_to'] = undefined;

/**
 * Type of validation rule.
 * @member {module:model/ValidationRulesCreateResponseBody.TypeEnum} type
 * @default 'expression'
 */
ValidationRulesCreateResponseBody.prototype['type'] = 'expression';
 ...
 * @member {module:model/ValidationRulesCreateResponseBody.ContextTypeEnum} context_type
 * @default 'global'
 */
ValidationRulesCreateResponseBody.prototype['context_type'] = 'global';

/**
 * Unique validation rule ID.
 * @member {String} id
 */
ValidationRulesCreateResponseBody.prototype['id'] = undefined;
 ...
 */
ValidationRulesCreateResponseBody.prototype['created_at'] = undefined;
 ...
 */
ValidationRulesCreateResponseBody.prototype['updated_at'] = undefined;

/**
 * The number of instances the validation rule has been assigned to different types of redeemables.
 * @member {Number} assignments_count
 */
ValidationRulesCreateResponseBody.prototype['assignments_count'] = undefined;
 ...
 */
ValidationRulesCreateResponseBody.prototype['object'] = 'validation_rules';
 ...
 * @readonly
 */
ValidationRulesCreateResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
ValidationRulesCreateResponseBody['ContextTypeEnum'] = {
...
export default ValidationRulesCreateResponseBody;

...
class ValidationRulesCreateResponseBody {
     ...
     * @alias ValidationRulesCreateResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<ValidationRulesCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationRulesCreateResponseBody} [obj] Optional instance to populate.
     * @returns {ValidationRulesCreateResponseBody} The populated <code>ValidationRulesCreateResponseBody</code> instance.
     */
     ...
     * @param {Partial<ValidationRulesCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRulesCreateResponseBody</code>.
     */
...
/**
    * @type {ValidationRulesCreateResponseBodyApplicableTo | undefined}
    */
ValidationRulesCreateResponseBody.prototype['applicable_to'] = undefined;

/**
    * Type of validation rule.
    * @type {(keyof typeof ValidationRulesCreateResponseBody.TypeEnum) | undefined}
    * @default 'expression'
    */
...
/**
    ...
    * @type {(keyof typeof ValidationRulesCreateResponseBody.ContextTypeEnum) | undefined}
    * @default 'global'
    */

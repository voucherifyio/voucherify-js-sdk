...
class LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject {
     ...
     * @return {module:model/LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject} The populated <code>LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsActivateResponseBodyRelatedObject.TypeEnum} type
 * @default 'voucher'
 */

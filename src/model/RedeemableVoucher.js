...
class RedeemableVoucher {
     ...
     * @alias module:model/RedeemableVoucher
     */
    constructor() { 
     ...
     * @param {module:model/RedeemableVoucher} obj Optional instance to populate.
     * @return {module:model/RedeemableVoucher} The populated <code>RedeemableVoucher</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedeemableVoucher</code>.
     */
 ...
 * @member {module:model/RedeemableVoucher.TypeEnum} type
 */
...
/**
 * @member {module:model/RedeemableVoucherGift} gift
 */
RedeemableVoucher.prototype['gift'] = undefined;

/**
 * @member {module:model/RedeemableVoucherLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/RedeemableVoucher.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/RedeemableVoucherPublish} publish
 */
RedeemableVoucher.prototype['publish'] = undefined;

/**
 * @member {module:model/RedeemableVoucherRedemption} redemption
 */

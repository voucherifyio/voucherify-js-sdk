...
class CampaignsVouchersCreateRequestBody {
     ...
     * @return {module:model/CampaignsVouchersCreateRequestBody} The populated <code>CampaignsVouchersCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/CampaignsVouchersCreateRequestBodyRedemption} redemption
 */

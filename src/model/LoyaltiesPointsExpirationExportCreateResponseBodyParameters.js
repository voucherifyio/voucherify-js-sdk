...
class LoyaltiesPointsExpirationExportCreateResponseBodyParameters {
     ...
     * @return {module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParameters} The populated <code>LoyaltiesPointsExpirationExportCreateResponseBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesPointsExpirationExportCreateResponseBodyParameters</code>.
     */
 ...
 * @member {module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParameters.OrderEnum} order
 */
 ...
 * @member {Array.<module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParameters.FieldsEnum>} fields
 */
LoyaltiesPointsExpirationExportCreateResponseBodyParameters.prototype['fields'] = undefined;

/**
 * @member {module:model/LoyaltiesPointsExpirationExportCreateResponseBodyParametersFilters} filters
 */

...
class LocationShapeGeojson {
     ...
     * @return {module:model/LocationShapeGeojson} The populated <code>LocationShapeGeojson</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationShapeGeojson</code>.
     */
...
/**
 * @member {module:model/LocationShapeGeojson.TypeEnum} type
 */

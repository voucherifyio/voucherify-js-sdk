...
class MemberActivityDataRedemptionPreviousOrderReferrer {
    ...
    constructor() { 
        ...
        MemberActivityDataRedemptionPreviousOrderReferrer.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataRedemptionPreviousOrderReferrer} The populated <code>MemberActivityDataRedemptionPreviousOrderReferrer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataRedemptionPreviousOrderReferrer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionPreviousOrderReferrer</code>.
     */
 ...
 * @member {module:model/MemberActivityDataRedemptionPreviousOrderReferrer.ObjectEnum} object
 * @default 'customer'
 */
...
export default MemberActivityDataRedemptionPreviousOrderReferrer;

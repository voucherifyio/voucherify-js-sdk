...
class CustomersListResponseBody {
     ...
     * @return {module:model/CustomersListResponseBody} The populated <code>CustomersListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/CustomerWithSummaryLoyaltyReferrals>} customers
 */

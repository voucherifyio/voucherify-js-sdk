...
class RedemptionOrder {
     ...
     * @alias module:model/RedemptionOrder
     */
    constructor() { 
     ...
     * @param {module:model/RedemptionOrder} obj Optional instance to populate.
     * @return {module:model/RedemptionOrder} The populated <code>RedemptionOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/RedemptionOrder.StatusEnum} status
 */
 ...
 * @member {module:model/RedemptionOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/RedemptionOrderCustomer} customer
 */
RedemptionOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/RedemptionOrderReferrer} referrer
 */
 ...
 * @member {Array.<module:model/RedemptionOrderItemsItem>} items
 */

...
import RedemptionOrderCustomer from './RedemptionOrderCustomer';
import RedemptionOrderItemsItem from './RedemptionOrderItemsItem';
import RedemptionOrderReferrer from './RedemptionOrderReferrer';
/**
...
class RedemptionOrder {
    /**
     * Constructs a new <code>RedemptionOrder</code>.
     * @alias RedemptionOrder
     */
    constructor() { 
        
        RedemptionOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<RedemptionOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionOrder} [obj] Optional instance to populate.
     * @returns {RedemptionOrder} The populated <code>RedemptionOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionOrder();
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = RedemptionOrderCustomer.constructFromObject(data['customer']);
            }
            if (data.hasOwnProperty('referrer')) {
                obj['referrer'] = RedemptionOrderReferrer.constructFromObject(data['referrer']);
            }
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [RedemptionOrderItemsItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionOrder</code>.
     * @param {Partial<RedemptionOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['customer']) { // data not null
          RedemptionOrderCustomer.validateJSON(data['customer']);
        }
        // validate the optional field `referrer`
        if (data['referrer']) { // data not null
          RedemptionOrderReferrer.validateJSON(data['referrer']);
        }
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                RedemptionOrderItemsItem.validateJSON(item);
            };
        }
...
/**
    ...
    */
RedemptionOrder.prototype['id'] = undefined;

/**
    * Unique source ID of an existing order that will be linked to the redemption of this request.
    * @type {String | undefined}
    */
RedemptionOrder.prototype['source_id'] = undefined;

/**
    * The order status.
    * @type {(keyof typeof RedemptionOrder.StatusEnum) | undefined}
    */
RedemptionOrder.prototype['status'] = undefined;
...
/**
    ...
    */
RedemptionOrder.prototype['amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['initial_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['items_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['total_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['total_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['items_applied_discount_amount'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionOrder.prototype['total_applied_discount_amount'] = undefined;
...
/**
    ...
    */
RedemptionOrder.prototype['metadata'] = undefined;

/**
    * The type of the object represented by JSON.
    * @type {(keyof typeof RedemptionOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
RedemptionOrder.prototype['object'] = 'order';

/**
    * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
RedemptionOrder.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
RedemptionOrder.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
    * @type {String | undefined}
    */
RedemptionOrder.prototype['customer_id'] = undefined;

/**
    * Unique referrer ID.
    * @type {String | undefined}
    */
RedemptionOrder.prototype['referrer_id'] = undefined;

/**
    * @type {RedemptionOrderCustomer | undefined}
    */
RedemptionOrder.prototype['customer'] = undefined;

/**
    * @type {RedemptionOrderReferrer | undefined}
    */
RedemptionOrder.prototype['referrer'] = undefined;

/**
    * @type {Object.<String, OrderRedemptionsEntry> | undefined}
    */
RedemptionOrder.prototype['redemptions'] = undefined;

/**
    * Array of items applied to the order. It can include up to 500 items.
    * @type {Array.<RedemptionOrderItemsItem> | undefined}
    */
RedemptionOrder.prototype['items'] = undefined;

...
import QualificationsRedeemableOrderItemsItem from './QualificationsRedeemableOrderItemsItem';
...
class QualificationsRedeemableOrder {
    /**
     * Constructs a new <code>QualificationsRedeemableOrder</code>.
     * @alias module:model/QualificationsRedeemableOrder
     */
    constructor() { 
        
        QualificationsRedeemableOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QualificationsRedeemableOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QualificationsRedeemableOrder} obj Optional instance to populate.
     * @return {module:model/QualificationsRedeemableOrder} The populated <code>QualificationsRedeemableOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QualificationsRedeemableOrder();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [QualificationsRedeemableOrderItemsItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>QualificationsRedeemableOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsRedeemableOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                QualificationsRedeemableOrderItemsItem.validateJSON(item);
            };
        }
 ...
 * @member {String} id
 */
QualificationsRedeemableOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
QualificationsRedeemableOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/QualificationsRedeemableOrder.StatusEnum} status
 */
QualificationsRedeemableOrder.prototype['status'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['initial_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['total_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
QualificationsRedeemableOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/QualificationsRedeemableOrder.ObjectEnum} object
 * @default 'order'
 */
QualificationsRedeemableOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
QualificationsRedeemableOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
QualificationsRedeemableOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
QualificationsRedeemableOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
QualificationsRedeemableOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
QualificationsRedeemableOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
QualificationsRedeemableOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
QualificationsRedeemableOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/QualificationsRedeemableOrderItemsItem>} items
 */
QualificationsRedeemableOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
QualificationsRedeemableOrder['StatusEnum'] = {
 ...
 * @readonly
 */
QualificationsRedeemableOrder['ObjectEnum'] = {
...
export default QualificationsRedeemableOrder;

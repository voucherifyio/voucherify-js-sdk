...
class QualificationsRedeemableOrder {
     ...
     * @alias QualificationsRedeemableOrder
     */
    constructor() { 
     ...
     * @param {Partial<QualificationsRedeemableOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {QualificationsRedeemableOrder} [obj] Optional instance to populate.
     * @returns {QualificationsRedeemableOrder} The populated <code>QualificationsRedeemableOrder</code> instance.
     */
     ...
     * @param {Partial<QualificationsRedeemableOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsRedeemableOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof QualificationsRedeemableOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof QualificationsRedeemableOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
...
/**
    ...
    * @type {Array.<QualificationsRedeemableOrderItemsItem> | undefined}
    */

...
class VoucherTransactionDetails {
     ...
     * @return {module:model/VoucherTransactionDetails} The populated <code>VoucherTransactionDetails</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionDetails</code>.
     */
...
/**
 * @member {module:model/VoucherTransactionDetailsOrder} order
 */
VoucherTransactionDetails.prototype['order'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsEvent} event
 */
VoucherTransactionDetails.prototype['event'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsEarningRule} earning_rule
 */
VoucherTransactionDetails.prototype['earning_rule'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsSegment} segment
 */
VoucherTransactionDetails.prototype['segment'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsLoyaltyTier} loyalty_tier
 */
VoucherTransactionDetails.prototype['loyalty_tier'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsRedemption} redemption
 */
VoucherTransactionDetails.prototype['redemption'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsRollback} rollback
 */
VoucherTransactionDetails.prototype['rollback'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsCustomEvent} custom_event
 */
VoucherTransactionDetails.prototype['custom_event'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsEventSchema} event_schema
 */
VoucherTransactionDetails.prototype['event_schema'] = undefined;

/**
 * @member {module:model/VoucherTransactionDetailsHolderLoyaltyTier} holder_loyalty_tier
 */
...
/**
 * @member {module:model/VoucherTransactionDetailsReward} reward
 */

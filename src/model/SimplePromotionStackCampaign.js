...
class SimplePromotionStackCampaign {
    ...
    constructor() { 
        ...
        SimplePromotionStackCampaign.initialize(this);
    }
     ...
     * @return {module:model/SimplePromotionStackCampaign} The populated <code>SimplePromotionStackCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplePromotionStackCampaign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePromotionStackCampaign</code>.
     */
...
export default SimplePromotionStackCampaign;

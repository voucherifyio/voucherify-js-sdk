...
class LoyaltiesMembersCreateResponseBodyRedemption {
    ...
    constructor() { 
        ...
        LoyaltiesMembersCreateResponseBodyRedemption.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesMembersCreateResponseBodyRedemption} The populated <code>LoyaltiesMembersCreateResponseBodyRedemption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesMembersCreateResponseBodyRedemption();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersCreateResponseBodyRedemption</code>.
     */
...
export default LoyaltiesMembersCreateResponseBodyRedemption;

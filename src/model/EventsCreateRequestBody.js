...
class EventsCreateRequestBody {
     ...
     * @return {module:model/EventsCreateRequestBody} The populated <code>EventsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCreateRequestBody</code>.
     */
...
/**
 * @member {module:model/EventsCreateRequestBodyReferral} referral
 */
EventsCreateRequestBody.prototype['referral'] = undefined;

/**
 * @member {module:model/EventsCreateRequestBodyLoyalty} loyalty
 */

...
class MemberActivityDataRedemptionPreviousOrder {
     ...
     * @returns {module:model/MemberActivityDataRedemptionPreviousOrder} The populated <code>MemberActivityDataRedemptionPreviousOrder</code> instance.
     */
...
/**
 * The order status.
 * @member {module:model/MemberActivityDataRedemptionPreviousOrder.StatusEnum} 
 */
 ...
 * @member {module:model/MemberActivityDataRedemptionPreviousOrder.ObjectEnum} 
 * @default 'order'
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionPreviousOrderCustomer} 
 */
MemberActivityDataRedemptionPreviousOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/MemberActivityDataRedemptionPreviousOrderReferrer} 
 */

...
class MemberActivityDataRedemptionPreviousOrder {
     ...
     * @alias module:model/MemberActivityDataRedemptionPreviousOrder
     */
    constructor() { 
     ...
     * @param {module:model/MemberActivityDataRedemptionPreviousOrder} obj Optional instance to populate.
     * @return {module:model/MemberActivityDataRedemptionPreviousOrder} The populated <code>MemberActivityDataRedemptionPreviousOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataRedemptionPreviousOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/MemberActivityDataRedemptionPreviousOrder.StatusEnum} status
 */
 ...
 * @member {module:model/MemberActivityDataRedemptionPreviousOrder.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/MemberActivityDataRedemptionPreviousOrderCustomer} customer
 */
MemberActivityDataRedemptionPreviousOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/MemberActivityDataRedemptionPreviousOrderReferrer} referrer
 */

...
class ParameterFiltersListCustomerRedeemablesCampaignTypeConditions {
     ...
     * @return {module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions} The populated <code>ParameterFiltersListCustomerRedeemablesCampaignTypeConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCustomerRedeemablesCampaignTypeConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.InEnum>} $in
 */
ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.NotInEnum>} $not_in
 */
 ...
 * @member {module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.IsEnum} $is
 */
ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.prototype['$is'] = undefined;

/**
 * Results omit this value (single value).
 * @member {module:model/ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.IsNotEnum} $is_not
 */

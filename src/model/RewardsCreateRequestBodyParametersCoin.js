...
class RewardsCreateRequestBodyParametersCoin {
     ...
     * @alias module:model/RewardsCreateRequestBodyParametersCoin
     */
    constructor() { 
     ...
     * @param {module:model/RewardsCreateRequestBodyParametersCoin} obj Optional instance to populate.
     * @return {module:model/RewardsCreateRequestBodyParametersCoin} The populated <code>RewardsCreateRequestBodyParametersCoin</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsCreateRequestBodyParametersCoin</code>.
     */

...
class RewardsCreateResponseBodyAttributes {
    ...
    constructor() { 
        ...
        RewardsCreateResponseBodyAttributes.initialize(this);
    }
     ...
     * @return {module:model/RewardsCreateResponseBodyAttributes} The populated <code>RewardsCreateResponseBodyAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RewardsCreateResponseBodyAttributes();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardsCreateResponseBodyAttributes</code>.
     */
...
export default RewardsCreateResponseBodyAttributes;

...
class EarningRuleLoyaltyCustomEvent {
     ...
     * @return {module:model/EarningRuleLoyaltyCustomEvent} The populated <code>EarningRuleLoyaltyCustomEvent</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EarningRuleLoyaltyCustomEvent</code>.
     */
...
/**
 * @member {module:model/EarningRuleLoyaltyCustomEventMetadata} metadata
 */

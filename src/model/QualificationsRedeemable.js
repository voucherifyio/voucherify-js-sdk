...
import QualificationsRedeemableBase from './QualificationsRedeemableBase';
...
class QualificationsRedeemable {
    ...
    constructor() { 
        ...
        QualificationsRedeemable.initialize(this);
    }
     ...
     * @return {module:model/QualificationsRedeemable} The populated <code>QualificationsRedeemable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QualificationsRedeemable();
            ...
            if (data.hasOwnProperty('order')) {
                obj['order'] = QualificationsRedeemableOrder.constructFromObject(data['order']);
            }
            ...
            if (data.hasOwnProperty('redeemables')) {
                obj['redeemables'] = ApiClient.convertToType(data['redeemables'], [QualificationsRedeemableBase]);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsRedeemable</code>.
     */
    static validateJSON(data) {
        ...
        if (data['order']) { // data not null
          QualificationsRedeemableOrder.validateJSON(data['order']);
        }
        // ensure the json data is a string
        ...
        if (data['redeemables']) { // data not null
            ...
            for (const item of data['redeemables']) {
                QualificationsRedeemableBase.validateJSON(item);
            };
        }
 ...
 * @member {module:model/QualificationsRedeemable.ObjectEnum} object
 */
...
/**
 * @member {module:model/QualificationsRedeemableOrder} order
 */
...
/**
 * @member {Array.<module:model/QualificationsRedeemableBase>} redeemables
 */
...
export default QualificationsRedeemable;

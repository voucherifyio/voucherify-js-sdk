...
class TemplatesCampaignsCreateTemplateResponseBody {
     ...
     * @return {module:model/TemplatesCampaignsCreateTemplateResponseBody} The populated <code>TemplatesCampaignsCreateTemplateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsCreateTemplateResponseBody</code>.
     */
 ...
 * @member {module:model/TemplatesCampaignsCreateTemplateResponseBody.CampaignTypeEnum} campaign_type
 */
 ...
 * @member {module:model/TemplatesCampaignsCreateTemplateResponseBody.ObjectEnum} object

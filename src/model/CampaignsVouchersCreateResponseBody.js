...
class CampaignsVouchersCreateResponseBody {
     ...
     * @alias module:model/CampaignsVouchersCreateResponseBody
     */
    constructor() { 
     ...
     * @param {module:model/CampaignsVouchersCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/CampaignsVouchersCreateResponseBody} The populated <code>CampaignsVouchersCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateResponseBody</code>.
     */
 ...
 * @member {module:model/CampaignsVouchersCreateResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/CampaignsVouchersCreateResponseBodyGift} gift
 */
CampaignsVouchersCreateResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/CampaignsVouchersCreateResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/CampaignsVouchersCreateResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/CampaignsVouchersCreateResponseBodyPublish} publish
 */
CampaignsVouchersCreateResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/CampaignsVouchersCreateResponseBodyRedemption} redemption
 */

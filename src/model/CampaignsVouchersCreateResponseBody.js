...
import CampaignsVouchersCreateResponseBodyGift from './CampaignsVouchersCreateResponseBodyGift';
import CampaignsVouchersCreateResponseBodyLoyaltyCard from './CampaignsVouchersCreateResponseBodyLoyaltyCard';
import CampaignsVouchersCreateResponseBodyPublish from './CampaignsVouchersCreateResponseBodyPublish';
import CampaignsVouchersCreateResponseBodyRedemption from './CampaignsVouchersCreateResponseBodyRedemption';
...
class CampaignsVouchersCreateResponseBody {
    /**
     * Constructs a new <code>CampaignsVouchersCreateResponseBody</code>.
     * Response body schema for **POST** &#x60;v1/campaigns/{campaignId}/vouchers/{code}&#x60; and **POST** &#x60;v1/campaigns/{campaignId}/vouchers&#x60;.
     * @alias CampaignsVouchersCreateResponseBody
     */
    constructor() { 
        
        CampaignsVouchersCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignsVouchersCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<CampaignsVouchersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {CampaignsVouchersCreateResponseBody} [obj] Optional instance to populate.
     * @returns {CampaignsVouchersCreateResponseBody} The populated <code>CampaignsVouchersCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsVouchersCreateResponseBody();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = CampaignsVouchersCreateResponseBodyGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = CampaignsVouchersCreateResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = CampaignsVouchersCreateResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = CampaignsVouchersCreateResponseBodyRedemption.constructFromObject(data['redemption']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignsVouchersCreateResponseBody</code>.
     * @param {Partial<CampaignsVouchersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          CampaignsVouchersCreateResponseBodyGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          CampaignsVouchersCreateResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          CampaignsVouchersCreateResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          CampaignsVouchersCreateResponseBodyRedemption.validateJSON(data['redemption']);
        }
...
/**
    ...
    */
CampaignsVouchersCreateResponseBody.prototype['id'] = undefined;
...
/**
    ...
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['code'] = undefined;

/**
    * A unique campaign name, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['campaign'] = undefined;

/**
    * Assigned by the Voucherify API, identifies the voucher's parent campaign.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['campaign_id'] = undefined;

/**
    * Tag defining the category that this voucher belongs to. Useful when listing vouchers using the List Vouchers endpoint.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['category'] = undefined;

/**
    * Unique category ID assigned by Voucherify.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['category_id'] = undefined;

/**
    * Defines the type of the voucher. 
    * @type {(keyof typeof CampaignsVouchersCreateResponseBody.TypeEnum) | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['type'] = undefined;

/**
    * @type {Discount | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['discount'] = undefined;

/**
    * @type {CampaignsVouchersCreateResponseBodyGift | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['gift'] = undefined;

/**
    * @type {CampaignsVouchersCreateResponseBodyLoyaltyCard | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['loyalty_card'] = undefined;

/**
    * Activation timestamp defines when the code starts to be active in ISO 8601 format. Voucher is *inactive before* this date. 
    * @type {Date | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['start_date'] = undefined;

/**
    * Expiration timestamp defines when the code expires in ISO 8601 format.  Voucher is *inactive after* this date.
    * @type {Date | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['expiration_date'] = undefined;

/**
    * @type {ValidityTimeframe | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['validity_timeframe'] = undefined;

/**
    * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
    * @type {(Array<keyof typeof CampaignsVouchersCreateResponseBody.ValidityDayOfWeekEnum>) | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['validity_day_of_week'] = undefined;

/**
    * @type {ValidityHours | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['validity_hours'] = undefined;
...
/**
    ...
    */
CampaignsVouchersCreateResponseBody.prototype['active'] = undefined;

/**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['additional_info'] = undefined;

/**
    * The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.
    * @type {Object | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['metadata'] = undefined;

/**
    * @type {VoucherAssets | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['assets'] = undefined;

/**
    * Flag indicating whether this voucher is a referral code; `true` for campaign type `REFERRAL_PROGRAM`.
    * @type {Boolean | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['is_referral_code'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was created. The value is shown in the ISO 8601 format.
    * @type {Date | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['created_at'] = undefined;

/**
    * Timestamp representing the date and time when the voucher was last updated in ISO 8601 format.
    * @type {Date | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['updated_at'] = undefined;

/**
    * Unique customer identifier of the redeemable holder. It equals to the customer ID assigned by Voucherify.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['holder_id'] = undefined;

/**
    * Unique identifier of the referring person.
    * @type {String | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['referrer_id'] = undefined;
...
/**
    ...
    * @default 'voucher'
    */
CampaignsVouchersCreateResponseBody.prototype['object'] = 'voucher';

/**
    * @type {CampaignsVouchersCreateResponseBodyPublish | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['publish'] = undefined;

/**
    * @type {CampaignsVouchersCreateResponseBodyRedemption | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['redemption'] = undefined;

/**
    * Contains details about the category.
    * @type {Array.<Category> | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['categories'] = undefined;

/**
    * @type {ValidationRulesAssignmentsList | undefined}
    */
CampaignsVouchersCreateResponseBody.prototype['validation_rules_assignments'] = undefined;
     ...
     * @readonly
     */
    CampaignsVouchersCreateResponseBody['TypeEnum'] = {
 ...
 * @readonly
 */
CampaignsVouchersCreateResponseBody['ValidityDayOfWeekEnum'] = {
...
export default CampaignsVouchersCreateResponseBody;

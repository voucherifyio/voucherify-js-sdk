...
class DiscountProduct {
    ...
    constructor() { 
        ...
        DiscountProduct.initialize(this);
    }
     ...
     * @return {module:model/DiscountProduct} The populated <code>DiscountProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiscountProduct();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiscountProduct</code>.
     */

...
class ProductCollectionsCreateResponseBody {
     ...
     * @return {module:model/ProductCollectionsCreateResponseBody} The populated <code>ProductCollectionsCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollectionsCreateResponseBody</code>.
     */
 ...
 * @member {module:model/ProductCollectionsCreateResponseBody.TypeEnum} type
 */
 ...
 * @member {Array.<module:model/ProductCollectionsCreateResponseBodyProductsItem>} products
 */
 ...
 * @member {module:model/ProductCollectionsCreateResponseBody.ObjectEnum} object

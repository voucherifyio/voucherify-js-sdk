...
class LoyaltiesMembersTransfersCreateResponseBodyRedemption {
     ...
     * @return {module:model/LoyaltiesMembersTransfersCreateResponseBodyRedemption} The populated <code>LoyaltiesMembersTransfersCreateResponseBodyRedemption</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersTransfersCreateResponseBodyRedemption</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersTransfersCreateResponseBodyRedemption.ObjectEnum} object
 * @default 'list'
 */

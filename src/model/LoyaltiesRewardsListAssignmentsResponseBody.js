...
class LoyaltiesRewardsListAssignmentsResponseBody {
    ...
    constructor() { 
        ...
        LoyaltiesRewardsListAssignmentsResponseBody.initialize(this);
    }
     ...
     * @return {module:model/LoyaltiesRewardsListAssignmentsResponseBody} The populated <code>LoyaltiesRewardsListAssignmentsResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltiesRewardsListAssignmentsResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesRewardsListAssignmentsResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesRewardsListAssignmentsResponseBody.ObjectEnum} object
 * @default 'list'
 */
...
export default LoyaltiesRewardsListAssignmentsResponseBody;

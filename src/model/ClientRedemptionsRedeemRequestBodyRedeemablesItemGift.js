...
class ClientRedemptionsRedeemRequestBodyRedeemablesItemGift {
    ...
    constructor() { 
        ...
        ClientRedemptionsRedeemRequestBodyRedeemablesItemGift.initialize(this);
    }
     ...
     * @return {module:model/ClientRedemptionsRedeemRequestBodyRedeemablesItemGift} The populated <code>ClientRedemptionsRedeemRequestBodyRedeemablesItemGift</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientRedemptionsRedeemRequestBodyRedeemablesItemGift();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemRequestBodyRedeemablesItemGift</code>.
     */
...
export default ClientRedemptionsRedeemRequestBodyRedeemablesItemGift;

...
class RedemptionRewardResultParametersCoin {
     ...
     * @return {module:model/RedemptionRewardResultParametersCoin} The populated <code>RedemptionRewardResultParametersCoin</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionRewardResultParametersCoin</code>.
     */

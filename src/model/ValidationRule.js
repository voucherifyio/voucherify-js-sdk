...
class ValidationRule {
     ...
     * @param {Partial<ValidationRule>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationRule} [obj] Optional instance to populate.
     * @returns {ValidationRule} The populated <code>ValidationRule</code> instance.
     */
     ...
     * @param {Partial<ValidationRule>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationRule</code>.
     */
...
/**
    * @type {ValidationRuleApplicableTo | undefined}
    */
ValidationRule.prototype['applicable_to'] = undefined;

/**
    * Type of validation rule.
    * @type {(keyof typeof ValidationRule.TypeEnum) | undefined}
    * @default 'expression'
    */
...
/**
    ...
    * @type {(keyof typeof ValidationRule.ContextTypeEnum) | undefined}
    * @default 'global'
    */

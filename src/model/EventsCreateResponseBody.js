...
class EventsCreateResponseBody {
     ...
     * @return {module:model/EventsCreateResponseBody} The populated <code>EventsCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCreateResponseBody</code>.
     */
 ...
 * @member {module:model/EventsCreateResponseBody.ObjectEnum} object
 * @default 'event'
 */

...
class ManagementProjectsCustomEventSchemasUpdateResponseBodySchema {
    ...
    constructor() { 
        ...
        ManagementProjectsCustomEventSchemasUpdateResponseBodySchema.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsCustomEventSchemasUpdateResponseBodySchema} The populated <code>ManagementProjectsCustomEventSchemasUpdateResponseBodySchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsCustomEventSchemasUpdateResponseBodySchema();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchemasUpdateResponseBodySchema</code>.
     */
...
export default ManagementProjectsCustomEventSchemasUpdateResponseBodySchema;

...
class ManagementProjectsCustomEventSchemasListResponseBody {
    ...
    constructor() { 
        ...
        ManagementProjectsCustomEventSchemasListResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsCustomEventSchemasListResponseBody} The populated <code>ManagementProjectsCustomEventSchemasListResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsCustomEventSchemasListResponseBody();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ManagementProjectsCustomEventSchema]);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCustomEventSchemasListResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ManagementProjectsCustomEventSchema.validateJSON(item);
            };
        }
 ...
 * @member {module:model/ManagementProjectsCustomEventSchemasListResponseBody.ObjectEnum} object
 * @default 'list'
 */
 ...
 * @member {module:model/ManagementProjectsCustomEventSchemasListResponseBody.DataRefEnum} data_ref
 * @default 'data'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsCustomEventSchema>} data
 */
...
export default ManagementProjectsCustomEventSchemasListResponseBody;

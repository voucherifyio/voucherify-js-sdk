...
class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions {
     ...
     * @return {module:model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions} The populated <code>ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions</code>.
     */
 ...
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.InEnum>} $in
 */
ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.prototype['$in'] = undefined;

/**
 * Array of resource values that should be included in the results (multiple values).
 * @member {Array.<module:model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.NotInEnum>} $not_in
 */
 ...
 * @member {module:model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.IsEnum} $is
 * @default 'voucher'
 */
 ...
 * @member {module:model/ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.IsNotEnum} $is_not
 * @default 'voucher'
 */

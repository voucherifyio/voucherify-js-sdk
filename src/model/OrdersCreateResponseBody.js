...
class OrdersCreateResponseBody {
     ...
     * @alias OrdersCreateResponseBody
     */
    constructor() { 
     ...
     * @param {Partial<OrdersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @param {OrdersCreateResponseBody} [obj] Optional instance to populate.
     * @returns {OrdersCreateResponseBody} The populated <code>OrdersCreateResponseBody</code> instance.
     */
     ...
     * @param {Partial<OrdersCreateResponseBody>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersCreateResponseBody</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof OrdersCreateResponseBody.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof OrdersCreateResponseBody.ObjectEnum) | undefined}
    * @default 'order'
    */

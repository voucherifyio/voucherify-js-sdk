...
class OrdersCreateResponseBody {
    /**
     * Constructs a new <code>OrdersCreateResponseBody</code>.
     * Response body schema for **POST** &#x60;v1/orders&#x60;.
     * @alias module:model/OrdersCreateResponseBody
     */
    constructor() { 
        
        OrdersCreateResponseBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrdersCreateResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrdersCreateResponseBody} obj Optional instance to populate.
     * @return {module:model/OrdersCreateResponseBody} The populated <code>OrdersCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersCreateResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>OrdersCreateResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersCreateResponseBody</code>.
     */
 ...
 * @member {String} id
 */
OrdersCreateResponseBody.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
OrdersCreateResponseBody.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/OrdersCreateResponseBody.StatusEnum} status
 */
OrdersCreateResponseBody.prototype['status'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['initial_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['items_discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['total_discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['total_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['applied_discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
OrdersCreateResponseBody.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/OrdersCreateResponseBody.ObjectEnum} object
 * @default 'order'
 */
OrdersCreateResponseBody.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
OrdersCreateResponseBody.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
OrdersCreateResponseBody.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
OrdersCreateResponseBody.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
OrdersCreateResponseBody.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
OrdersCreateResponseBody.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
OrdersCreateResponseBody.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
OrdersCreateResponseBody.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/OrderCalculatedItem>} items
 */
OrdersCreateResponseBody.prototype['items'] = undefined;
 ...
 * @readonly
 */
OrdersCreateResponseBody['StatusEnum'] = {
 ...
 * @readonly
 */
OrdersCreateResponseBody['ObjectEnum'] = {
...
export default OrdersCreateResponseBody;

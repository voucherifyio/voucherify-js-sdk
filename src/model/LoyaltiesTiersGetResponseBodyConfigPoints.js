...
class LoyaltiesTiersGetResponseBodyConfigPoints {
     ...
     * @return {module:model/LoyaltiesTiersGetResponseBodyConfigPoints} The populated <code>LoyaltiesTiersGetResponseBodyConfigPoints</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesTiersGetResponseBodyConfigPoints</code>.
     */

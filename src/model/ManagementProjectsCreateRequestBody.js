...
class ManagementProjectsCreateRequestBody {
     ...
     * @return {module:model/ManagementProjectsCreateRequestBody} The populated <code>ManagementProjectsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsCreateRequestBody</code>.
     */
 ...
 * @member {module:model/ManagementProjectsCreateRequestBody.WebhookVersionEnum} webhook_version
 * @default 'v2024-01-01'
 */
...
/**
 * @member {module:model/ManagementProjectsCreateRequestBodyWebhooksCalloutNotifications} webhooks_callout_notifications
 */
ManagementProjectsCreateRequestBody.prototype['webhooks_callout_notifications'] = undefined;

/**
 * @member {module:model/ManagementProjectsCreateRequestBodyApiUsageNotifications} api_usage_notifications
 */
 ...
 * @member {module:model/ManagementProjectsCreateRequestBody.ApiVersionEnum} api_version
 * @default 'v2018-08-01'
 */
 ...
 * @member {Array.<module:model/ManagementProjectsCreateRequestBodyUsersItem>} users
 */

...
class QualificationsFieldConditions {
     ...
     * @return {module:model/QualificationsFieldConditions} The populated <code>QualificationsFieldConditions</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsFieldConditions</code>.
     */
...
/**
 * @member {module:model/QualificationsFiltersCondition} conditions
 */

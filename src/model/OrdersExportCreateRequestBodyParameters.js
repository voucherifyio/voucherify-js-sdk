...
class OrdersExportCreateRequestBodyParameters {
     ...
     * @return {module:model/OrdersExportCreateRequestBodyParameters} The populated <code>OrdersExportCreateRequestBodyParameters</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersExportCreateRequestBodyParameters</code>.
     */

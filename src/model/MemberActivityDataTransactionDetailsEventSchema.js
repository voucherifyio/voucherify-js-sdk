...
class MemberActivityDataTransactionDetailsEventSchema {
    ...
    constructor() { 
        ...
        MemberActivityDataTransactionDetailsEventSchema.initialize(this);
    }
     ...
     * @return {module:model/MemberActivityDataTransactionDetailsEventSchema} The populated <code>MemberActivityDataTransactionDetailsEventSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberActivityDataTransactionDetailsEventSchema();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberActivityDataTransactionDetailsEventSchema</code>.
     */
...
export default MemberActivityDataTransactionDetailsEventSchema;

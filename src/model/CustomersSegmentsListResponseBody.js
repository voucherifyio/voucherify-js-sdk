...
class CustomersSegmentsListResponseBody {
     ...
     * @return {module:model/CustomersSegmentsListResponseBody} The populated <code>CustomersSegmentsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomersSegmentsListResponseBody</code>.
     */
 ...
 * @member {Array.<module:model/SimpleSegment>} data
 */

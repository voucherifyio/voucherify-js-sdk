...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer {
     ...
     * @return {module:model/LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer} The populated <code>LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer</code>.
     */
...
/**
 * @member {module:model/LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomerMetadata} metadata
 */

...
class OrdersListResponseBodyOrdersItem {
     ...
     * @alias module:model/OrdersListResponseBodyOrdersItem
     * @implements module:model/OrderCalculated
     */
    constructor() { 
     ...
     * @param {module:model/OrdersListResponseBodyOrdersItem} obj Optional instance to populate.
     * @return {module:model/OrdersListResponseBodyOrdersItem} The populated <code>OrdersListResponseBodyOrdersItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersListResponseBodyOrdersItem</code>.
     */
...
/**
 * The order status.
 * @member {module:model/OrdersListResponseBodyOrdersItem.StatusEnum} status
 */
 ...
 * @member {module:model/OrdersListResponseBodyOrdersItem.ObjectEnum} object
 * @default 'order'
 */
...
/**
 * @member {module:model/CustomerId} customer
 */
OrdersListResponseBodyOrdersItem.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
...
/**
 * The order status.
 * @member {module:model/OrderCalculated.StatusEnum} status
 */
...
/**
 * The type of the object represented by JSON.
 * @member {module:model/OrderCalculated.ObjectEnum} object
 * @default 'order'
 */

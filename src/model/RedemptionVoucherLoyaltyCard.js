...
class RedemptionVoucherLoyaltyCard {
    /**
     * Constructs a new <code>RedemptionVoucherLoyaltyCard</code>.
     * Object representing loyalty card parameters. Child attributes are present only if &#x60;type&#x60; is &#x60;LOYALTY_CARD&#x60;. Defaults to &#x60;null&#x60;.
     * @alias RedemptionVoucherLoyaltyCard
     */
    constructor() { 
        
        RedemptionVoucherLoyaltyCard.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionVoucherLoyaltyCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Partial<RedemptionVoucherLoyaltyCard>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionVoucherLoyaltyCard} [obj] Optional instance to populate.
     * @returns {RedemptionVoucherLoyaltyCard} The populated <code>RedemptionVoucherLoyaltyCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionVoucherLoyaltyCard();
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionVoucherLoyaltyCard</code>.
     * @param {Partial<RedemptionVoucherLoyaltyCard>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionVoucherLoyaltyCard</code>.
     */
...
/**
    ...
    */
RedemptionVoucherLoyaltyCard.prototype['points'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['balance'] = undefined;

/**
    * The next closest date when the next set of points are due to expire.
    * @type {Date | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['next_expiration_date'] = undefined;

/**
    * The amount of points that are set to expire next.
    * @type {Number | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['next_expiration_points'] = undefined;
...
/**
    ...
    * @type {Number | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['pending_points'] = undefined;

/**
    * Shows the total number of expired points over the lifetime of the loyalty card.
    * @type {Number | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['expired_points'] = undefined;

/**
    * Shows the total number of subtracted points over the lifetime of the loyalty card.
    * @type {Number | undefined}
    */
RedemptionVoucherLoyaltyCard.prototype['subtracted_points'] = undefined;
...
export default RedemptionVoucherLoyaltyCard;

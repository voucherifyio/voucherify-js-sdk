...
class ProductsCreateResponseBody {
    ...
    constructor() { 
        ...
        ProductsCreateResponseBody.initialize(this);
    }
     ...
     * @return {module:model/ProductsCreateResponseBody} The populated <code>ProductsCreateResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductsCreateResponseBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsCreateResponseBody</code>.
     */
 ...
 * @member {module:model/ProductsCreateResponseBody.ObjectEnum} object
 * @default 'product'
 */
...
export default ProductsCreateResponseBody;

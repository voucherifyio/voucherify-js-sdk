...
class TemplatesCampaignsCreateRequestBody {
     ...
     * @return {module:model/TemplatesCampaignsCreateRequestBody} The populated <code>TemplatesCampaignsCreateRequestBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplatesCampaignsCreateRequestBody</code>.
     */
 ...
 * @member {String} promotion_tier_id
 */

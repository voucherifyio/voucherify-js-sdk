...
class ExportsGetResponseBody {
     ...
     * @return {module:model/ExportsGetResponseBody} The populated <code>ExportsGetResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExportsGetResponseBody</code>.
     */
 ...
 * @member {module:model/ExportsGetResponseBody.ObjectEnum} object
 * @default 'export'
 */
 ...
 * @member {module:model/ExportsGetResponseBody.StatusEnum} status
 */
...
/**
 * @member {module:model/ExportsGetResponseBodyResult} result
 */
...
/**
 * @member {module:model/ExportsGetResponseBody.ExportedObjectEnum} exported_object
 */
ExportsGetResponseBody.prototype['exported_object'] = undefined;

/**
 * @member {module:model/ExportsGetResponseBodyParameters} parameters
 */

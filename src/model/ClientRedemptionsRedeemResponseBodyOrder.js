...
class ClientRedemptionsRedeemResponseBodyOrder {
     ...
     * @returns {module:model/ClientRedemptionsRedeemResponseBodyOrder} The populated <code>ClientRedemptionsRedeemResponseBodyOrder</code> instance.
     */
...
/**
 * The order status.
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrder.StatusEnum} 
 */
 ...
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrder.ObjectEnum} 
 * @default 'order'
 */
 ...
 * @member {Array.<module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem>} 
 */

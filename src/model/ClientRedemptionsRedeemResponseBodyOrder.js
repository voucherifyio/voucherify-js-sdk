...
class ClientRedemptionsRedeemResponseBodyOrder {
     ...
     * @alias ClientRedemptionsRedeemResponseBodyOrder
     */
    constructor() { 
     ...
     * @param {Partial<ClientRedemptionsRedeemResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @param {ClientRedemptionsRedeemResponseBodyOrder} [obj] Optional instance to populate.
     * @returns {ClientRedemptionsRedeemResponseBodyOrder} The populated <code>ClientRedemptionsRedeemResponseBodyOrder</code> instance.
     */
     ...
     * @param {Partial<ClientRedemptionsRedeemResponseBodyOrder>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemResponseBodyOrder</code>.
     */
...
/**
    * The order status.
    * @type {(keyof typeof ClientRedemptionsRedeemResponseBodyOrder.StatusEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof ClientRedemptionsRedeemResponseBodyOrder.ObjectEnum) | undefined}
    * @default 'order'
    */
...
/**
    ...
    * @type {Array.<ClientRedemptionsRedeemResponseBodyOrderItemsItem> | undefined}
    */

...
import ClientRedemptionsRedeemResponseBodyOrderItemsItem from './ClientRedemptionsRedeemResponseBodyOrderItemsItem';
import CustomerId from './CustomerId';
import OrderRedemptionsEntry from './OrderRedemptionsEntry';
import ReferrerId from './ReferrerId';

/**
 * The ClientRedemptionsRedeemResponseBodyOrder model module.
 * @module model/ClientRedemptionsRedeemResponseBodyOrder
 * @version v2018-08-01
 */
class ClientRedemptionsRedeemResponseBodyOrder {
    /**
     * Constructs a new <code>ClientRedemptionsRedeemResponseBodyOrder</code>.
     * Contains the order details associated with the redemption.
     * @alias module:model/ClientRedemptionsRedeemResponseBodyOrder
     */
    constructor() { 
        
        ClientRedemptionsRedeemResponseBodyOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientRedemptionsRedeemResponseBodyOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientRedemptionsRedeemResponseBodyOrder} obj Optional instance to populate.
     * @return {module:model/ClientRedemptionsRedeemResponseBodyOrder} The populated <code>ClientRedemptionsRedeemResponseBodyOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientRedemptionsRedeemResponseBodyOrder();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ClientRedemptionsRedeemResponseBodyOrderItemsItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClientRedemptionsRedeemResponseBodyOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientRedemptionsRedeemResponseBodyOrder</code>.
     */
    static validateJSON(data) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ClientRedemptionsRedeemResponseBodyOrderItemsItem.validateJSON(item);
            };
        }
 ...
 * @member {String} id
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['id'] = undefined;

/**
 * Unique source ID of an existing order that will be linked to the redemption of this request.
 * @member {String} source_id
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['source_id'] = undefined;

/**
 * The order status.
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrder.StatusEnum} status
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['status'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['initial_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['items_discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['total_discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['total_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['applied_discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['items_applied_discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['total_applied_discount_amount'] = undefined;
 ...
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['metadata'] = undefined;

/**
 * The type of the object represented by JSON.
 * @member {module:model/ClientRedemptionsRedeemResponseBodyOrder.ObjectEnum} object
 * @default 'order'
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['object'] = 'order';

/**
 * Timestamp representing the date and time when the order was created. The value is shown in the ISO 8601 format.
 * @member {Date} created_at
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['created_at'] = undefined;

/**
 * Timestamp representing the date and time when the order was last updated in ISO 8601 format.
 * @member {Date} updated_at
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['updated_at'] = undefined;

/**
 * Unique customer identifier of the customer making the purchase. The ID is assigned by Voucherify.
 * @member {String} customer_id
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['customer_id'] = undefined;

/**
 * Unique referrer ID.
 * @member {String} referrer_id
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['referrer_id'] = undefined;

/**
 * @member {module:model/CustomerId} customer
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['customer'] = undefined;

/**
 * @member {module:model/ReferrerId} referrer
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['referrer'] = undefined;

/**
 * @member {Object.<String, module:model/OrderRedemptionsEntry>} redemptions
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['redemptions'] = undefined;

/**
 * Array of items applied to the order. It can include up to 500 items.
 * @member {Array.<module:model/ClientRedemptionsRedeemResponseBodyOrderItemsItem>} items
 */
ClientRedemptionsRedeemResponseBodyOrder.prototype['items'] = undefined;
 ...
 * @readonly
 */
ClientRedemptionsRedeemResponseBodyOrder['StatusEnum'] = {
 ...
 * @readonly
 */
ClientRedemptionsRedeemResponseBodyOrder['ObjectEnum'] = {
...
export default ClientRedemptionsRedeemResponseBodyOrder;

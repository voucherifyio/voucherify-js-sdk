...
class QualificationsRedeemableBaseOrder {
     ...
     * @return {module:model/QualificationsRedeemableBaseOrder} The populated <code>QualificationsRedeemableBaseOrder</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QualificationsRedeemableBaseOrder</code>.
     */
...
/**
 * The order status.
 * @member {module:model/QualificationsRedeemableBaseOrder.StatusEnum} status
 */
 ...
 * @member {module:model/QualificationsRedeemableBaseOrder.ObjectEnum} object
 * @default 'order'
 */
 ...
 * @member {Array.<module:model/QualificationsRedeemableBaseOrderItemsItem>} items
 */

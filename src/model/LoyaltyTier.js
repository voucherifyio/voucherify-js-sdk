...
class LoyaltyTier {
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTier</code>.
     */
...
/**
 * @member {module:model/LoyaltyTierPoints} points
 */
...
/**
 * @member {module:model/LoyaltyTierConfig} config
 */
 ...
 * @member {module:model/LoyaltyTier.ObjectEnum} object

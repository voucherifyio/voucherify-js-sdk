...
class VoucherBalance {
     ...
     * @return {module:model/VoucherBalance} The populated <code>VoucherBalance</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherBalance</code>.
     */
 ...
 * @member {module:model/VoucherBalance.TypeEnum} type
 */
 ...
 * @member {module:model/VoucherBalance.ObjectEnum} object
 * @default 'balance'
 */
 ...
 * @member {module:model/VoucherBalance.OperationTypeEnum} operation_type
 */
VoucherBalance.prototype['operation_type'] = undefined;

/**
 * @member {module:model/VoucherBalanceRelatedObject} related_object
 */

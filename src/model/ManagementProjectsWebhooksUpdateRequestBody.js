...
class ManagementProjectsWebhooksUpdateRequestBody {
    ...
    constructor() { 
        ...
        ManagementProjectsWebhooksUpdateRequestBody.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsWebhooksUpdateRequestBody} The populated <code>ManagementProjectsWebhooksUpdateRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsWebhooksUpdateRequestBody();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsWebhooksUpdateRequestBody</code>.
     */
 ...
 * @member {Array.<module:model/ManagementProjectsWebhooksUpdateRequestBody.EventsEnum>} events
 */
 ...
 * @readonly
 */
ManagementProjectsWebhooksUpdateRequestBody['EventsEnum'] = {
...
export default ManagementProjectsWebhooksUpdateRequestBody;

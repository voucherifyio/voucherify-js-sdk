...
class LocationsGetResponseBodyShape {
    ...
    constructor() { 
        ...
        LocationsGetResponseBodyShape.initialize(this);
    }
     ...
     * @return {module:model/LocationsGetResponseBodyShape} The populated <code>LocationsGetResponseBodyShape</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationsGetResponseBodyShape();
            ...
            if (data.hasOwnProperty('distance')) {
                obj['distance'] = LocationsGetResponseBodyShapeDistance.constructFromObject(data['distance']);
            }
            if (data.hasOwnProperty('geojson')) {
                obj['geojson'] = LocationsGetResponseBodyShapeGeojson.constructFromObject(data['geojson']);
            }
        }
        return obj;
    }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationsGetResponseBodyShape</code>.
     */
    static validateJSON(data) {
        ...
        if (data['distance']) { // data not null
          LocationsGetResponseBodyShapeDistance.validateJSON(data['distance']);
        }
        // validate the optional field `geojson`
        if (data['geojson']) { // data not null
          LocationsGetResponseBodyShapeGeojson.validateJSON(data['geojson']);
        }
...
/**
 * @member {module:model/LocationsGetResponseBodyShape.TypeEnum} type
 */
LocationsGetResponseBodyShape.prototype['type'] = undefined;

/**
 * @member {module:model/LocationsGetResponseBodyShape.FormatEnum} format
 */
LocationsGetResponseBodyShape.prototype['format'] = undefined;

/**
 * @member {module:model/LocationsGetResponseBodyShapeDistance} distance
 */
LocationsGetResponseBodyShape.prototype['distance'] = undefined;

/**
 * @member {module:model/LocationsGetResponseBodyShapeGeojson} geojson
 */
...
export default LocationsGetResponseBodyShape;

...
class VouchersEnableResponseBodyLoyaltyCard {
     ...
     * @return {module:model/VouchersEnableResponseBodyLoyaltyCard} The populated <code>VouchersEnableResponseBodyLoyaltyCard</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VouchersEnableResponseBodyLoyaltyCard</code>.
     */

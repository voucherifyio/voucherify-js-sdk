...
class RedemptionEntryPromotionTier {
     ...
     * @alias RedemptionEntryPromotionTier
     */
    constructor() { 
     ...
     * @param {Partial<RedemptionEntryPromotionTier>} data The plain JavaScript object bearing properties of interest.
     * @param {RedemptionEntryPromotionTier} [obj] Optional instance to populate.
     * @returns {RedemptionEntryPromotionTier} The populated <code>RedemptionEntryPromotionTier</code> instance.
     */
     ...
     * @param {Partial<RedemptionEntryPromotionTier>} data The plain JavaScript object bearing properties of interest.
     * @returns {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryPromotionTier</code>.
     */
...
/**
    * @type {RedemptionEntryPromotionTierAction | undefined}
    */
...
/**
    * @type {RedemptionEntryPromotionTierCampaign | undefined}
    */
...
/**
    ...
    * @type {(Array<keyof typeof RedemptionEntryPromotionTier.ValidityDayOfWeekEnum>) | undefined}
    */
...
/**
    * @type {RedemptionEntryPromotionTierSummary | undefined}
    */

...
import RedemptionEntryPromotionTierAction from './RedemptionEntryPromotionTierAction';
import RedemptionEntryPromotionTierCampaign from './RedemptionEntryPromotionTierCampaign';
import RedemptionEntryPromotionTierSummary from './RedemptionEntryPromotionTierSummary';
...
class RedemptionEntryPromotionTier {
    /**
     * Constructs a new <code>RedemptionEntryPromotionTier</code>.
     * @alias module:model/RedemptionEntryPromotionTier
     */
    constructor() { 
        
        RedemptionEntryPromotionTier.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedemptionEntryPromotionTier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedemptionEntryPromotionTier} obj Optional instance to populate.
     * @return {module:model/RedemptionEntryPromotionTier} The populated <code>RedemptionEntryPromotionTier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionEntryPromotionTier();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = RedemptionEntryPromotionTierAction.constructFromObject(data['action']);
            }
            ...
            if (data.hasOwnProperty('campaign')) {
                obj['campaign'] = RedemptionEntryPromotionTierCampaign.constructFromObject(data['campaign']);
            }
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = RedemptionEntryPromotionTierSummary.constructFromObject(data['summary']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RedemptionEntryPromotionTier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionEntryPromotionTier</code>.
     */
    static validateJSON(data) {
        ...
        if (data['action']) { // data not null
          RedemptionEntryPromotionTierAction.validateJSON(data['action']);
        }
        // ensure the json data is a string
        ...
        if (data['campaign']) { // data not null
          RedemptionEntryPromotionTierCampaign.validateJSON(data['campaign']);
        }
        // ensure the json data is a string
        ...
        if (data['summary']) { // data not null
          RedemptionEntryPromotionTierSummary.validateJSON(data['summary']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
RedemptionEntryPromotionTier.prototype['id'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['created_at'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['updated_at'] = undefined;

/**
 * Name of the promotion tier.
 * @member {String} name
 */
RedemptionEntryPromotionTier.prototype['name'] = undefined;

/**
 * Text to be displayed to your customers on your website.
 * @member {String} banner
 */
RedemptionEntryPromotionTier.prototype['banner'] = undefined;

/**
 * @member {module:model/RedemptionEntryPromotionTierAction} action
 */
RedemptionEntryPromotionTier.prototype['action'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['metadata'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['hierarchy'] = undefined;

/**
 * Promotion unique ID.
 * @member {String} promotion_id
 */
RedemptionEntryPromotionTier.prototype['promotion_id'] = undefined;

/**
 * @member {module:model/RedemptionEntryPromotionTierCampaign} campaign
 */
RedemptionEntryPromotionTier.prototype['campaign'] = undefined;

/**
 * Promotion tier's parent campaign's unique ID.
 * @member {String} campaign_id
 */
RedemptionEntryPromotionTier.prototype['campaign_id'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['active'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['start_date'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['expiration_date'] = undefined;

/**
 * @member {module:model/ValidityTimeframe} validity_timeframe
 */
RedemptionEntryPromotionTier.prototype['validity_timeframe'] = undefined;

/**
 * Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday
 * @member {Array.<module:model/RedemptionEntryPromotionTier.ValidityDayOfWeekEnum>} validity_day_of_week
 */
RedemptionEntryPromotionTier.prototype['validity_day_of_week'] = undefined;

/**
 * @member {module:model/ValidityHours} validity_hours
 */
RedemptionEntryPromotionTier.prototype['validity_hours'] = undefined;

/**
 * @member {module:model/RedemptionEntryPromotionTierSummary} summary
 */
RedemptionEntryPromotionTier.prototype['summary'] = undefined;
 ...
 */
RedemptionEntryPromotionTier.prototype['object'] = 'promotion_tier';

/**
 * @member {module:model/ValidationRuleAssignmentsList} validation_rule_assignments
 */
RedemptionEntryPromotionTier.prototype['validation_rule_assignments'] = undefined;

/**
 * Promotion tier category ID.
 * @member {String} category_id
 */
RedemptionEntryPromotionTier.prototype['category_id'] = undefined;

/**
 * @member {Array.<module:model/Category>} categories
 */
RedemptionEntryPromotionTier.prototype['categories'] = undefined;
 ...
 * @readonly
 */
RedemptionEntryPromotionTier['ValidityDayOfWeekEnum'] = {
...
export default RedemptionEntryPromotionTier;

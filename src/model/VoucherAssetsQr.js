...
class VoucherAssetsQr {
    ...
    constructor() { 
        ...
        VoucherAssetsQr.initialize(this);
    }
     ...
     * @return {module:model/VoucherAssetsQr} The populated <code>VoucherAssetsQr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoucherAssetsQr();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherAssetsQr</code>.
     */
...
export default VoucherAssetsQr;

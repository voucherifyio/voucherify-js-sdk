...
class ManagementProjectsBrandingGetResponseBodyCockpits {
    ...
    constructor() { 
        ...
        ManagementProjectsBrandingGetResponseBodyCockpits.initialize(this);
    }
     ...
     * @return {module:model/ManagementProjectsBrandingGetResponseBodyCockpits} The populated <code>ManagementProjectsBrandingGetResponseBodyCockpits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ManagementProjectsBrandingGetResponseBodyCockpits();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ManagementProjectsBrandingGetResponseBodyCockpits</code>.
     */
 ...
 * @member {module:model/ManagementProjectsBrandingGetResponseBodyCockpits.ThemeEnum} theme
 */
...
export default ManagementProjectsBrandingGetResponseBodyCockpits;

...
class ValidationsValidateResponseBodyOrderItemsItem {
     ...
     * @alias ValidationsValidateResponseBodyOrderItemsItem
     ...
     * @param {Partial<ValidationsValidateResponseBodyOrderItemsItem>} data The plain JavaScript object bearing properties of interest.
     * @param {ValidationsValidateResponseBodyOrderItemsItem} [obj] Optional instance to populate.
     * @returns {ValidationsValidateResponseBodyOrderItemsItem} The populated <code>ValidationsValidateResponseBodyOrderItemsItem</code> instance.
     */
...
/**
    ...
    * @type {(keyof typeof ValidationsValidateResponseBodyOrderItemsItem.RelatedObjectEnum) | undefined}
    */
...
/**
    ...
    * @type {(keyof typeof ValidationsValidateResponseBodyOrderItemsItem.ObjectEnum) | undefined}
    * @default 'order_item'
    */

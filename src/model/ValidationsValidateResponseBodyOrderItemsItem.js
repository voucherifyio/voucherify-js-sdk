...
class ValidationsValidateResponseBodyOrderItemsItem {
     ...
     * @return {module:model/ValidationsValidateResponseBodyOrderItemsItem} The populated <code>ValidationsValidateResponseBodyOrderItemsItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsValidateResponseBodyOrderItemsItem</code>.
     */
 ...
 * @member {module:model/ValidationsValidateResponseBodyOrderItemsItem.RelatedObjectEnum} related_object
 */
 ...
 * @member {module:model/ValidationsValidateResponseBodyOrderItemsItem.ObjectEnum} object
 * @default 'order_item'
 */

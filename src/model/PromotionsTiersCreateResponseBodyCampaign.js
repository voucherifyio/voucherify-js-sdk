...
class PromotionsTiersCreateResponseBodyCampaign {
    ...
    constructor() { 
        ...
        PromotionsTiersCreateResponseBodyCampaign.initialize(this);
    }
     ...
     * @return {module:model/PromotionsTiersCreateResponseBodyCampaign} The populated <code>PromotionsTiersCreateResponseBodyCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsTiersCreateResponseBodyCampaign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsTiersCreateResponseBodyCampaign</code>.
     */
 ...
 * @member {Array.<module:model/PromotionsTiersCreateResponseBodyCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @readonly
 */
PromotionsTiersCreateResponseBodyCampaign['ValidityDayOfWeekEnum'] = {
...
export default PromotionsTiersCreateResponseBodyCampaign;

...
class LoyaltyCardTransactionDetailsOrder {
    ...
    constructor() { 
        ...
        LoyaltyCardTransactionDetailsOrder.initialize(this);
    }
     ...
     * @return {module:model/LoyaltyCardTransactionDetailsOrder} The populated <code>LoyaltyCardTransactionDetailsOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltyCardTransactionDetailsOrder();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyCardTransactionDetailsOrder</code>.
     */
...
export default LoyaltyCardTransactionDetailsOrder;

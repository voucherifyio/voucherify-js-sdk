...
class RedemptionsGetResponseBodyPromotionTierCampaign {
    ...
    constructor() { 
        ...
        RedemptionsGetResponseBodyPromotionTierCampaign.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsGetResponseBodyPromotionTierCampaign} The populated <code>RedemptionsGetResponseBodyPromotionTierCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsGetResponseBodyPromotionTierCampaign();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsGetResponseBodyPromotionTierCampaign</code>.
     */
 ...
 * @member {Array.<module:model/RedemptionsGetResponseBodyPromotionTierCampaign.ValidityDayOfWeekEnum>} validity_day_of_week
 */
 ...
 * @readonly
 */
RedemptionsGetResponseBodyPromotionTierCampaign['ValidityDayOfWeekEnum'] = {
...
export default RedemptionsGetResponseBodyPromotionTierCampaign;

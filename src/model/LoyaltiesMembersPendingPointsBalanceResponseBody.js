...
class LoyaltiesMembersPendingPointsBalanceResponseBody {
     ...
     * @return {module:model/LoyaltiesMembersPendingPointsBalanceResponseBody} The populated <code>LoyaltiesMembersPendingPointsBalanceResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltiesMembersPendingPointsBalanceResponseBody</code>.
     */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsBalanceResponseBody.ObjectEnum} object
 * @default 'balance'
 */
LoyaltiesMembersPendingPointsBalanceResponseBody.prototype['object'] = 'balance';

/**
 * @member {module:model/LoyaltiesMembersPendingPointsBalanceResponseBodyRelatedObject} related_object
 */
 ...
 * @member {module:model/LoyaltiesMembersPendingPointsBalanceResponseBody.OperationTypeEnum} operation_type
 * @default 'MANUAL'
 */

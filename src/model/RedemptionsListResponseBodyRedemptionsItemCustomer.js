...
class RedemptionsListResponseBodyRedemptionsItemCustomer {
    ...
    constructor() { 
        ...
        RedemptionsListResponseBodyRedemptionsItemCustomer.initialize(this);
    }
     ...
     * @return {module:model/RedemptionsListResponseBodyRedemptionsItemCustomer} The populated <code>RedemptionsListResponseBodyRedemptionsItemCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedemptionsListResponseBodyRedemptionsItemCustomer();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedemptionsListResponseBodyRedemptionsItemCustomer</code>.
     */
 ...
 * @member {module:model/RedemptionsListResponseBodyRedemptionsItemCustomer.ObjectEnum} object
 * @default 'customer'
 */
...
export default RedemptionsListResponseBodyRedemptionsItemCustomer;

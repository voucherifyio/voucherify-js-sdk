...
class VoucherTransactionDetailsEarningRule {
     ...
     * @return {module:model/VoucherTransactionDetailsEarningRule} The populated <code>VoucherTransactionDetailsEarningRule</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoucherTransactionDetailsEarningRule</code>.
     */
...
/**
 * @member {module:model/VoucherTransactionDetailsEarningRuleSource} source
 */

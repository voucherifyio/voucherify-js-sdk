...
class ParameterFiltersListCampaignsValidityDayOfWeek {
     ...
     * @return {module:model/ParameterFiltersListCampaignsValidityDayOfWeek} The populated <code>ParameterFiltersListCampaignsValidityDayOfWeek</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterFiltersListCampaignsValidityDayOfWeek</code>.
     */
...
/**
 * @member {module:model/ParameterFiltersListCampaignsValidityDayOfWeekConditions} conditions
 */

...
class LoyaltyTierBasePoints {
    ...
    constructor() { 
        ...
        LoyaltyTierBasePoints.initialize(this);
    }
     ...
     * @return {module:model/LoyaltyTierBasePoints} The populated <code>LoyaltyTierBasePoints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LoyaltyTierBasePoints();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LoyaltyTierBasePoints</code>.
     */
...
export default LoyaltyTierBasePoints;

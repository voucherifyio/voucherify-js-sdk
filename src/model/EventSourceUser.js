...
class EventSourceUser {
    ...
    constructor() { 
        ...
        EventSourceUser.initialize(this);
    }
     ...
     * @return {module:model/EventSourceUser} The populated <code>EventSourceUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventSourceUser();
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventSourceUser</code>.
     */
...
export default EventSourceUser;

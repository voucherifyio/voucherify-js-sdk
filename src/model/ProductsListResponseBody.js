...
class ProductsListResponseBody {
     ...
     * @return {module:model/ProductsListResponseBody} The populated <code>ProductsListResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductsListResponseBody</code>.
     */

...
class SimpleOrderItem {
     ...
     * @return {module:model/SimpleOrderItem} The populated <code>SimpleOrderItem</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleOrderItem</code>.
     */
 ...
 * @member {module:model/SimpleOrderItem.ObjectEnum} object
 * @default 'order_item'
 */
 ...
 * @member {module:model/SimpleOrderItem.RelatedObjectEnum} related_object
 */

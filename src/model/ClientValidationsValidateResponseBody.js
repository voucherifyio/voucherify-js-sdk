...
class ClientValidationsValidateResponseBody {
     ...
     * @alias module:model/ClientValidationsValidateResponseBody
     ...
     * @param {module:model/ClientValidationsValidateResponseBody} obj Optional instance to populate.
     * @return {module:model/ClientValidationsValidateResponseBody} The populated <code>ClientValidationsValidateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientValidationsValidateResponseBody</code>.
     */
...
/**
 * @member {Array.<module:model/ClientValidationsValidateResponseBodyRedeemablesItem>} redeemables
 */
...
/**
 * @member {module:model/ClientValidationsValidateResponseBodyOrder} order
 */

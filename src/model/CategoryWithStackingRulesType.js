...
class CategoryWithStackingRulesType {
     ...
     * @return {module:model/CategoryWithStackingRulesType} The populated <code>CategoryWithStackingRulesType</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoryWithStackingRulesType</code>.
     */
 ...
 * @member {module:model/CategoryWithStackingRulesType.ObjectEnum} object
 * @default 'category'
 */
 ...
 * @member {module:model/CategoryWithStackingRulesType.StackingRulesTypeEnum} stacking_rules_type
 */

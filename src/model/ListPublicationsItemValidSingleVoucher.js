...
class ListPublicationsItemValidSingleVoucher {
     ...
     * @return {module:model/ListPublicationsItemValidSingleVoucher} The populated <code>ListPublicationsItemValidSingleVoucher</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPublicationsItemValidSingleVoucher</code>.
     */
 ...
 * @member {module:model/ListPublicationsItemValidSingleVoucher.ObjectEnum} object
 * @default 'publication'
 */
...
/**
 * @member {module:model/ListPublicationsItemValidSingleVoucherMetadata} metadata
 */
 ...
 * @member {module:model/ListPublicationsItemValidSingleVoucher.ResultEnum} result
 * @default 'SUCCESS'
 */

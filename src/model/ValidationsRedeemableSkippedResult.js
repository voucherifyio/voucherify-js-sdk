...
class ValidationsRedeemableSkippedResult {
     ...
     * @return {module:model/ValidationsRedeemableSkippedResult} The populated <code>ValidationsRedeemableSkippedResult</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationsRedeemableSkippedResult</code>.
     */
...
/**
 * @member {module:model/ValidationsRedeemableSkippedResultDetails} details
 */

...
class SimpleRedemptionRewardResult {
     ...
     * @return {module:model/SimpleRedemptionRewardResult} The populated <code>SimpleRedemptionRewardResult</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleRedemptionRewardResult</code>.
     */
...
/**
 * @member {module:model/SimpleSku} sku
 */
 ...
 * @member {module:model/SimpleRedemptionRewardResult.ObjectEnum} object
 * @default 'reward'
 */
...
/**
 * Reward type.
 * @member {module:model/SimpleRedemptionRewardResult.TypeEnum} type
 */

...
class OrdersExportCreateResponseBody {
     ...
     * @return {module:model/OrdersExportCreateResponseBody} The populated <code>OrdersExportCreateResponseBody</code> instance.
     */
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersExportCreateResponseBody</code>.
     */
 ...
 * @member {module:model/OrdersExportCreateResponseBody.ObjectEnum} object
 * @default 'export'
 */
 ...
 * @member {module:model/OrdersExportCreateResponseBody.StatusEnum} status
 * @default 'SCHEDULED'
 */
 ...
 * @member {module:model/OrdersExportCreateResponseBody.ExportedObjectEnum} exported_object
 * @default 'order'
 */
OrdersExportCreateResponseBody.prototype['exported_object'] = 'order';

/**
 * @member {module:model/OrdersExportCreateResponseBodyParameters} parameters
 */

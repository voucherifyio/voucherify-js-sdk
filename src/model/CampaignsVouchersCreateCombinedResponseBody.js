...
import CampaignsVouchersCreateCombinedResponseBodyGift from './CampaignsVouchersCreateCombinedResponseBodyGift';
import CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard from './CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard';
import CampaignsVouchersCreateCombinedResponseBodyPublish from './CampaignsVouchersCreateCombinedResponseBodyPublish';
import CampaignsVouchersCreateCombinedResponseBodyRedemption from './CampaignsVouchersCreateCombinedResponseBodyRedemption';
...
class CampaignsVouchersCreateCombinedResponseBody {
    ...
    constructor() { 
        ...
        CampaignsVouchersCreateCombinedResponseBody.initialize(this);
    }
     ...
     * @return {module:model/CampaignsVouchersCreateCombinedResponseBody} The populated <code>CampaignsVouchersCreateCombinedResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsVouchersCreateCombinedResponseBody();
            ...
            if (data.hasOwnProperty('gift')) {
                obj['gift'] = CampaignsVouchersCreateCombinedResponseBodyGift.constructFromObject(data['gift']);
            }
            if (data.hasOwnProperty('loyalty_card')) {
                obj['loyalty_card'] = CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.constructFromObject(data['loyalty_card']);
            }
            ...
            if (data.hasOwnProperty('publish')) {
                obj['publish'] = CampaignsVouchersCreateCombinedResponseBodyPublish.constructFromObject(data['publish']);
            }
            if (data.hasOwnProperty('redemption')) {
                obj['redemption'] = CampaignsVouchersCreateCombinedResponseBodyRedemption.constructFromObject(data['redemption']);
            }
     ...
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsVouchersCreateCombinedResponseBody</code>.
     */
    static validateJSON(data) {
        ...
        if (data['gift']) { // data not null
          CampaignsVouchersCreateCombinedResponseBodyGift.validateJSON(data['gift']);
        }
        // validate the optional field `loyalty_card`
        if (data['loyalty_card']) { // data not null
          CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.validateJSON(data['loyalty_card']);
        }
        ...
        if (data['publish']) { // data not null
          CampaignsVouchersCreateCombinedResponseBodyPublish.validateJSON(data['publish']);
        }
        // validate the optional field `redemption`
        if (data['redemption']) { // data not null
          CampaignsVouchersCreateCombinedResponseBodyRedemption.validateJSON(data['redemption']);
        }
 ...
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBody.TypeEnum} type
 */
...
/**
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBodyGift} gift
 */
CampaignsVouchersCreateCombinedResponseBody.prototype['gift'] = undefined;

/**
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard} loyalty_card
 */
 ...
 * @member {Array.<module:model/CampaignsVouchersCreateCombinedResponseBody.ValidityDayOfWeekEnum>} validity_day_of_week
 */
...
/**
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBodyPublish} publish
 */
CampaignsVouchersCreateCombinedResponseBody.prototype['publish'] = undefined;

/**
 * @member {module:model/CampaignsVouchersCreateCombinedResponseBodyRedemption} redemption
 */
 ...
 * @readonly
 */
CampaignsVouchersCreateCombinedResponseBody['ValidityDayOfWeekEnum'] = {
...
export default CampaignsVouchersCreateCombinedResponseBody;

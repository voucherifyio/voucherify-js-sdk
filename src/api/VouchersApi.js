...
export default class VouchersApi {
    ...
    */
     ...
     * @param {String} code A unique **code** that identifies the voucher.
     * @param {Object} opts Optional parameters
     * @param {Boolean} [force] If this flag is set to true, the voucher will be removed permanently. If it is set to false or not set at all, the voucher will be moved to the bin. Going forward, the user will be able to create another voucher with exactly the same code.
     ...
     * @param {Boolean} [webhooksEnable] Triggers a webhook sendout for new and updated vouchers if the voucher created and voucher updated webhooks are configured in Project settings.
     ...
     * @param {String} [category] Limit search results to vouchers within the specified category.
     * @param {String} [campaignId] Limit search results to vouchers within the specified campaign
     ...
     * @param {String} [campaign] A unique campaign name, identifies the parent campaign.

...
export default class RedemptionsApi {
    ...
    */
     ...
     * @param {String} [result] A filter on the list based on the redemption result. Available options are: SUCCESS, FAILURE. You can provide multiple values by repeating the param.
     * @param {String} [campaign] A filter by the campaign **name** that the redemption resources originate from.
     * @param {String} [customer] Return redemptions performed by the customer with given id or source_id.
     * @param {module:model/ParameterOrderListRedemptions} [order] Sorts the results using one of the filtering options, where the dash - preceding a sorting option means sorting in a descending order.
     ...
     * @param {module:model/ParameterFiltersListRedemptions} [filters] Filters for listing responses.
     ...
     * @param {String} [trackingId] Customers source_id.

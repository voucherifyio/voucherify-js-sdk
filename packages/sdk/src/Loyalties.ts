...
export class Loyalties {
	...
	public create(campaign: T.LoyaltiesCreateCampaign) {
		return this.client.post<T.LoyaltiesResponse>('/loyalties', campaign)
	}
	public get(campaignId: string) {
		return this.client.get<T.LoyaltiesResponse>(`/loyalties/${encode(campaignId)}`)
	}
	public update(campaign: T.LoyaltiesUpdateCampaign) {
		return this.client.put<T.LoyaltiesResponse>(`/loyalties/${encode(campaign.id)}`, omit(campaign, ['id']))
	}
	 ...
	 */
	public createRewardAssignments(campaignId: string, assignment: T.LoyaltiesRewardAssigmentCreate) {
		return this.client.post<T.LoyaltiesRewardAssigmentResponse>(`/loyalties/${encode(campaignId)}/rewards`, assignment)
	}
	/**
	 * @see https://docs.voucherify.io/reference?utm_source=github&utm_medium=sdk&utm_campaign=acq#update-reward-assignment-1
	 */
	public updateRewardAssignment(campaignId: string, assignment: T.LoyaltiesRewardAssigmentUpdate) {
		return this.client.put<T.LoyaltiesRewardAssigmentResponse>(
	 ...
	 */
	public listEarningRules(campaignId: string, params: T.LoyaltiesListEarningRules) {
	...
	public updateEarningRule(campaignId: string, earningRule: T.LoyaltiesUpdateEarningRule) {
		return this.client.put<T.LoyaltiesCreateEarningRuleResponse>(
	 ...
	 */
	public listMembers(campaignId: string, params?: T.LoyaltiesListMembers) {
	...
	public createMember(campaignId: string, member: T.LoyaltiesCreateMember) {
		return this.client.post<T.LoyaltiesMemberResponse>(`/loyalties/${encode(campaignId)}/members`, member)
	}
	/**
	...
	public getMember(campaignId: string, memberId: string) {
		return this.client.get<T.LoyaltiesMemberResponse>(`/loyalties/${encode(campaignId)}/members/${memberId}`)
	}
	/**

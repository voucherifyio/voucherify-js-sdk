...
export class VoucherTransactionsFilters {
    ...
    */
    'fields'?: Array<VoucherTransactionsFiltersFieldsEnum> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "order",
            "baseName": "order",
            "type": "VoucherTransactionsFiltersOrderEnum",
            "format": ""
        },
        {
            "name": "fields",
            "baseName": "fields",
            "type": "Array<VoucherTransactionsFiltersFieldsEnum>",
            "format": ""
        },
        {
            "name": "filters",
    ...
    static getAttributeTypeMap() {
        return VoucherTransactionsFilters.attributeTypeMap;
    }
...
export enum VoucherTransactionsFiltersOrderEnum {
    CreatedAt = '-created_at',
    CreatedAt2 = 'created_at'
}
export enum VoucherTransactionsFiltersFieldsEnum {
    Id = 'id',
    Type = 'type',
    SourceId = 'source_id',
    Reason = 'reason',

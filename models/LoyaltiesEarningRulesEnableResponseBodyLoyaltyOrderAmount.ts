...
*/
export class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderAmount {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderAmount.attributeTypeMap;
    }

...
*/
export class VoucherWithCategoriesGift {
    /**
    ...
    */
    'effect'?: VoucherWithCategoriesGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VoucherWithCategoriesGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VoucherWithCategoriesGift.attributeTypeMap;
    }
...
export enum VoucherWithCategoriesGiftEffectEnum {

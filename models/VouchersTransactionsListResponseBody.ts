...
*/
export class VouchersTransactionsListResponseBody {
    /**
    * The type of the object represented by JSON.
    */
    'object'?: VouchersTransactionsListResponseBodyObjectEnum | null;
    /**
    * Identifies the name of the attribute that contains the array of transaction objects.
    */
    'dataRef'?: VouchersTransactionsListResponseBodyDataRefEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "VouchersTransactionsListResponseBodyObjectEnum",
            "format": ""
        },
        {
            "name": "dataRef",
            "baseName": "data_ref",
            "type": "VouchersTransactionsListResponseBodyDataRefEnum",
            "format": ""
        },
        {
            "name": "data",
    ...
    static getAttributeTypeMap() {
        return VouchersTransactionsListResponseBody.attributeTypeMap;
    }
...
export enum VouchersTransactionsListResponseBodyObjectEnum {
    List = 'list'
}
export enum VouchersTransactionsListResponseBodyDataRefEnum {
    Data = 'data'
}

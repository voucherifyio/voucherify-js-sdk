...
export class RedemptionsGetResponseBodyCustomer {
    /**
    ...
    */
    'object'?: RedemptionsGetResponseBodyCustomerObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionsGetResponseBodyCustomerObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionsGetResponseBodyCustomer.attributeTypeMap;
    }
...
export enum RedemptionsGetResponseBodyCustomerObjectEnum {
    Customer = 'customer'
}

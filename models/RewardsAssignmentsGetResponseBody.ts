...
*/
export class RewardsAssignmentsGetResponseBody {
    /**
    ...
    */
    'object'?: RewardsAssignmentsGetResponseBodyObjectEnum | null;
    /**
    ...
    */
    'relatedObjectType'?: RewardsAssignmentsGetResponseBodyRelatedObjectTypeEnum | null;
    'parameters'?: RewardsAssignmentsGetResponseBodyParameters | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RewardsAssignmentsGetResponseBodyObjectEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "RewardsAssignmentsGetResponseBodyRelatedObjectTypeEnum",
            "format": ""
        },
        {
            "name": "parameters",
            "baseName": "parameters",
            "type": "RewardsAssignmentsGetResponseBodyParameters",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RewardsAssignmentsGetResponseBody.attributeTypeMap;
    }
...
export enum RewardsAssignmentsGetResponseBodyObjectEnum {
    RewardAssignment = 'reward_assignment'
}
export enum RewardsAssignmentsGetResponseBodyRelatedObjectTypeEnum {
    Campaign = 'campaign'
}

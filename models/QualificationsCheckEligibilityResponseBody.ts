...
*/
export class QualificationsCheckEligibilityResponseBody {
    ...
    */
    ...
    'order'?: QualificationsCheckEligibilityResponseBodyOrder | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "order",
            "baseName": "order",
            "type": "QualificationsCheckEligibilityResponseBodyOrder",
            "format": ""
        },
        {
            "name": "stackingRules",
    ...
    static getAttributeTypeMap() {
        return QualificationsCheckEligibilityResponseBody.attributeTypeMap;
    }

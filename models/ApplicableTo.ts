...
export class ApplicableTo {
    ...
    */
    'object'?: ApplicableToObjectEnum | null;
    /**
    ...
    */
    'orderItemUnits'?: Array<ApplicableToOrderItemUnitsItem> | null;
    /**
    ...
    */
    'target'?: ApplicableToTargetEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ApplicableToOrderItemUnitsItem>",
            "format": ""
        },
        {
            "name": "repeat",
        ...
        },
        {
            "name": "target",
            "baseName": "target",
            "type": "ApplicableToTargetEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApplicableTo.attributeTypeMap;
    }
...
export enum ApplicableToObjectEnum {
    Product = 'product',
    Sku = 'sku',
    ProductsCollection = 'products_collection'
}
export enum ApplicableToTargetEnum {
    Item = 'ITEM',
    Unit = 'UNIT'
}

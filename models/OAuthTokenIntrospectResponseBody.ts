...
*/
export class OAuthTokenIntrospectResponseBody {
    /**
    ...
    */
    'tokenType'?: OAuthTokenIntrospectResponseBodyTokenTypeEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "tokenType",
            "baseName": "token_type",
            "type": "OAuthTokenIntrospectResponseBodyTokenTypeEnum",
            "format": ""
        },
        {
            "name": "active",
    ...
    static getAttributeTypeMap() {
        return OAuthTokenIntrospectResponseBody.attributeTypeMap;
    }
...
export enum OAuthTokenIntrospectResponseBodyTokenTypeEnum {
    Bearer = 'Bearer'
}

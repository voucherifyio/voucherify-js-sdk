...
*/
export class LoyaltiesMembersTransfersCreateResponseBodyRedemption {
    /**
    ...
    */
    'object'?: LoyaltiesMembersTransfersCreateResponseBodyRedemptionObjectEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesMembersTransfersCreateResponseBodyRedemptionObjectEnum",
            "format": ""
        },
        {
            "name": "url",
    ...
    static getAttributeTypeMap() {
        return LoyaltiesMembersTransfersCreateResponseBodyRedemption.attributeTypeMap;
    }
...
export enum LoyaltiesMembersTransfersCreateResponseBodyRedemptionObjectEnum {
    List = 'list'
}

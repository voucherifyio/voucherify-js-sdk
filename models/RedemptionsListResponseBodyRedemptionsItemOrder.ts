...
export class RedemptionsListResponseBodyRedemptionsItemOrder {
    /**
    ...
    * The order status.
    */
    'status'?: RedemptionsListResponseBodyRedemptionsItemOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: RedemptionsListResponseBodyRedemptionsItemOrderObjectEnum | null;
    /**
    ...
    */
    'items'?: Array<RedemptionsListResponseBodyRedemptionsItemOrderItemsItem>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "RedemptionsListResponseBodyRedemptionsItemOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionsListResponseBodyRedemptionsItemOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "RedemptionsListResponseBodyRedemptionsItemOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "RedemptionsListResponseBodyRedemptionsItemOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<RedemptionsListResponseBodyRedemptionsItemOrderItemsItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionsListResponseBodyRedemptionsItemOrder.attributeTypeMap;
    }
...
export enum RedemptionsListResponseBodyRedemptionsItemOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum RedemptionsListResponseBodyRedemptionsItemOrderObjectEnum {
    Order = 'order'
}

...
*/
export class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmountObjectEnum {

...
export class MemberActivityDataRedemptionPromotionTierCampaign {
    /**
    * Unique campaign ID.
    */
    'id'?: string | null;
    ...
    */
    'validityDayOfWeek'?: Array<MemberActivityDataRedemptionPromotionTierCampaignValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<MemberActivityDataRedemptionPromotionTierCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionPromotionTierCampaign.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionPromotionTierCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

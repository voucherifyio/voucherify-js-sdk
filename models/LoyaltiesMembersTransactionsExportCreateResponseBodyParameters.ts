...
*/
export class LoyaltiesMembersTransactionsExportCreateResponseBodyParameters {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesMembersTransactionsExportCreateResponseBodyParameters.attributeTypeMap;
    }

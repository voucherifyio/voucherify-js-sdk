...
*/
export class LoyaltiesRewardsUpdateAssignmentResponseBody {
    /**
    ...
    */
    'object'?: LoyaltiesRewardsUpdateAssignmentResponseBodyObjectEnum | null;
    /**
    ...
    */
    'relatedObjectType'?: LoyaltiesRewardsUpdateAssignmentResponseBodyRelatedObjectTypeEnum | null;
    'parameters'?: LoyaltiesRewardsUpdateAssignmentResponseBodyParameters | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesRewardsUpdateAssignmentResponseBodyObjectEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "LoyaltiesRewardsUpdateAssignmentResponseBodyRelatedObjectTypeEnum",
            "format": ""
        },
        {
            "name": "parameters",
            "baseName": "parameters",
            "type": "LoyaltiesRewardsUpdateAssignmentResponseBodyParameters",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesRewardsUpdateAssignmentResponseBody.attributeTypeMap;
    }
...
export enum LoyaltiesRewardsUpdateAssignmentResponseBodyObjectEnum {
    RewardAssignment = 'reward_assignment'
}
export enum LoyaltiesRewardsUpdateAssignmentResponseBodyRelatedObjectTypeEnum {
    Campaign = 'campaign'
}

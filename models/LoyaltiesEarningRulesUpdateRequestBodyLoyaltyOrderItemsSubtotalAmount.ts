...
*/
export class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountObjectEnum {

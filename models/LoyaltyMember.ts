...
export class LoyaltyMember {
    ...
    */
    'type'?: LoyaltyMemberTypeEnum | null;
    'discount'?: any | null;
    'gift'?: any | null;
    'loyaltyCard'?: LoyaltyMemberLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<LoyaltyMemberValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: LoyaltyMemberPublish | null;
    'redemption'?: LoyaltyMemberRedemption | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<LoyaltyMemberValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "LoyaltyMemberPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "LoyaltyMemberRedemption",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltyMember.attributeTypeMap;
    }
...
export enum LoyaltyMemberTypeEnum {
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum LoyaltyMemberValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class VouchersDisableResponseBodyGift {
    /**
    ...
    */
    'effect'?: VouchersDisableResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VouchersDisableResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VouchersDisableResponseBodyGift.attributeTypeMap;
    }
...
export enum VouchersDisableResponseBodyGiftEffectEnum {

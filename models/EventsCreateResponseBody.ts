...
*/
export class EventsCreateResponseBody {
    /**
    * The object represented is an `event`.
    */
    'object'?: EventsCreateResponseBodyObjectEnum | null;
    /**
    * The event name.
    */
    'type'?: string | null;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "EventsCreateResponseBodyObjectEnum",
            "format": ""
        },
        {
            "name": "type",
    ...
    static getAttributeTypeMap() {
        return EventsCreateResponseBody.attributeTypeMap;
    }
...
export enum EventsCreateResponseBodyObjectEnum {
    Event = 'event'
}

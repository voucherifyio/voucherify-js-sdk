...
*/
export class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountObjectEnum {

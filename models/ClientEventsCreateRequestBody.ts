...
*/
export class ClientEventsCreateRequestBody {
    /**
    * Event name. This is the same name that you used to define a custom event in the **Dashboard** > **Project Settings** > **Event Schema**.
    */
    'event'?: string | null;
    'customer': Customer;
    'referral'?: ClientEventsCreateRequestBodyReferral | null;
    'loyalty'?: ClientEventsCreateRequestBodyLoyalty | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "referral",
            "baseName": "referral",
            "type": "ClientEventsCreateRequestBodyReferral",
            "format": ""
        },
        {
            "name": "loyalty",
            "baseName": "loyalty",
            "type": "ClientEventsCreateRequestBodyLoyalty",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return ClientEventsCreateRequestBody.attributeTypeMap;
    }

...
export class MemberActivityDataTransactionDetailsSourceVoucherGift {
    /**
    ...
    */
    'effect'?: MemberActivityDataTransactionDetailsSourceVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "MemberActivityDataTransactionDetailsSourceVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return MemberActivityDataTransactionDetailsSourceVoucherGift.attributeTypeMap;
    }
...
export enum MemberActivityDataTransactionDetailsSourceVoucherGiftEffectEnum {

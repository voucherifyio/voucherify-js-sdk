...
*/
export class LoyaltiesTiersGetResponseBody {
    /**
    * Loyalty Tier name.
    */
    'name'?: string | null;
    ...
    */
    ...
    'points'?: LoyaltiesTiersGetResponseBodyPoints | null;
    /**
    ...
    */
    'updatedAt'?: Date | null;
    'config'?: LoyaltiesTiersGetResponseBodyConfig | null;
    ...
    */
    'object'?: LoyaltiesTiersGetResponseBodyObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "points",
            "baseName": "points",
            "type": "LoyaltiesTiersGetResponseBodyPoints",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            "name": "config",
            "baseName": "config",
            "type": "LoyaltiesTiersGetResponseBodyConfig",
            "format": ""
        },
        {
            "name": "expiration",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesTiersGetResponseBodyObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesTiersGetResponseBody.attributeTypeMap;
    }
...
export enum LoyaltiesTiersGetResponseBodyObjectEnum {

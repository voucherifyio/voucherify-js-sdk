...
export class RedemptionsListResponseBodyRedemptionsItemVoucher {
    /**
    ...
    */
    'type'?: RedemptionsListResponseBodyRedemptionsItemVoucherTypeEnum | null;
    'discount'?: Discount;
    'gift'?: RedemptionsListResponseBodyRedemptionsItemVoucherGift;
    'loyaltyCard'?: RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<RedemptionsListResponseBodyRedemptionsItemVoucherValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: RedemptionsListResponseBodyRedemptionsItemVoucherPublish;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<RedemptionsListResponseBodyRedemptionsItemVoucherValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return RedemptionsListResponseBodyRedemptionsItemVoucher.attributeTypeMap;
    }
...
export enum RedemptionsListResponseBodyRedemptionsItemVoucherTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum RedemptionsListResponseBodyRedemptionsItemVoucherValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

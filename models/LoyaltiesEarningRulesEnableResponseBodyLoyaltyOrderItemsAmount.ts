...
*/
export class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountObjectEnum {

...
*/
export class LoyaltyCardTransactionDetailsEarningRule {
    /**
    * Unique identifier of an earning rule, assigned by Voucherify.
    */
    'id'?: string | null;
    'source'?: LoyaltyCardTransactionDetailsEarningRuleSource | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "source",
            "baseName": "source",
            "type": "LoyaltyCardTransactionDetailsEarningRuleSource",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltyCardTransactionDetailsEarningRule.attributeTypeMap;
    }

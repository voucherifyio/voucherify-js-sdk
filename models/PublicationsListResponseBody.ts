...
*/
export class PublicationsListResponseBody {
    /**
    ...
    */
    'publications'?: Array<PublicationsListResponseBodyPublicationsItem> | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<PublicationsListResponseBodyPublicationsItem>",
            "format": ""
        },
        {
            "name": "total",
    ...
    static getAttributeTypeMap() {
        return PublicationsListResponseBody.attributeTypeMap;
    }

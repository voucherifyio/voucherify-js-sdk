...
*/
export class ClientRedemptionsRedeemRequestBodyOptions {
    /**
    ...
    */
    'expand'?: Array<ClientRedemptionsRedeemRequestBodyOptionsExpandEnum> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "expand",
            "baseName": "expand",
            "type": "Array<ClientRedemptionsRedeemRequestBodyOptionsExpandEnum>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ClientRedemptionsRedeemRequestBodyOptions.attributeTypeMap;
    }
...
export enum ClientRedemptionsRedeemRequestBodyOptionsExpandEnum {
    Order = 'order',

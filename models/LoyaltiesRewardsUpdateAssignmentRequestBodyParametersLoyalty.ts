...
*/
export class LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty.attributeTypeMap;
    }

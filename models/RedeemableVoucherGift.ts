...
*/
export class RedeemableVoucherGift {
    /**
    ...
    */
    'effect'?: RedeemableVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "RedeemableVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedeemableVoucherGift.attributeTypeMap;
    }
...
export enum RedeemableVoucherGiftEffectEnum {

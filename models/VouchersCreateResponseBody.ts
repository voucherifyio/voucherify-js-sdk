...
*/
export class VouchersCreateResponseBody {
    /**
    ...
    */
    'type'?: VouchersCreateResponseBodyTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VouchersCreateResponseBodyGift | null;
    'loyaltyCard'?: VouchersCreateResponseBodyLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VouchersCreateResponseBodyValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VouchersCreateResponseBodyPublish | null;
    'redemption'?: VouchersCreateResponseBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VouchersCreateResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VouchersCreateResponseBodyGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VouchersCreateResponseBodyLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VouchersCreateResponseBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VouchersCreateResponseBodyPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VouchersCreateResponseBodyRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VouchersCreateResponseBody.attributeTypeMap;
    }
...
export enum VouchersCreateResponseBodyTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VouchersCreateResponseBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

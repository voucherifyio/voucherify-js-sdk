...
*/
export class ClientRedemptionsRedeemRequestBody {
    'options'?: ClientRedemptionsRedeemRequestBodyOptions | null;
    'redeemables'?: Array<ClientRedemptionsRedeemRequestBodyRedeemablesItem> | null;
    'order'?: Order;
    'customer'?: Customer;
    'session'?: Session;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "options",
            "baseName": "options",
            "type": "ClientRedemptionsRedeemRequestBodyOptions",
            "format": ""
        },
        {
            "name": "redeemables",
            "baseName": "redeemables",
            "type": "Array<ClientRedemptionsRedeemRequestBodyRedeemablesItem>",
            "format": ""
        },
        {
            "name": "order",
    ...
    static getAttributeTypeMap() {
        return ClientRedemptionsRedeemRequestBody.attributeTypeMap;
    }

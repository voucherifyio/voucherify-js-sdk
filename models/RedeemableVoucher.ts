...
*/
export class RedeemableVoucher {
    /**
    ...
    */
    'type'?: RedeemableVoucherTypeEnum | null;
    'discount'?: Discount;
    'gift'?: RedeemableVoucherGift | null;
    'loyaltyCard'?: RedeemableVoucherLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<RedeemableVoucherValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: RedeemableVoucherPublish | null;
    'redemption'?: RedeemableVoucherRedemption | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "RedeemableVoucherTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "RedeemableVoucherGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "RedeemableVoucherLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<RedeemableVoucherValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "RedeemableVoucherPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "RedeemableVoucherRedemption",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedeemableVoucher.attributeTypeMap;
    }
...
export enum RedeemableVoucherTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum RedeemableVoucherValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

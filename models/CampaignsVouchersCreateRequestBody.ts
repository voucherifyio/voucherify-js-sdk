...
*/
export class CampaignsVouchersCreateRequestBody {
    /**
    ...
    */
    'metadata'?: any | null;
    'redemption'?: CampaignsVouchersCreateRequestBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "CampaignsVouchersCreateRequestBodyRedemption",
            "format": ""
        },
        {
            "name": "additionalInfo",
    ...
    static getAttributeTypeMap() {
        return CampaignsVouchersCreateRequestBody.attributeTypeMap;
    }

...
*/
export class OrdersUpdateRequestBody {
    /**
    ...
    * The order status.
    */
    'status'?: OrdersUpdateRequestBodyStatusEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OrdersUpdateRequestBodyStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
    ...
    static getAttributeTypeMap() {
        return OrdersUpdateRequestBody.attributeTypeMap;
    }
...
export enum OrdersUpdateRequestBodyStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'

...
export class MemberActivityDataOrder {
    'id'?: string | null;
    'sourceId'?: string | null;
    /**
    * The order status.
    */
    'status'?: MemberActivityDataOrderStatusEnum | null;
    /**
    ...
    */
    'items'?: Array<MemberActivityDataOrderItemsItem> | null;
    /**
    ...
    */
    'object'?: MemberActivityDataOrderObjectEnum | null;
    /**
    ...
    */
    'updatedAt'?: Date | null;
    'customer'?: MemberActivityDataOrderCustomer | null;
    'referrer'?: MemberActivityDataOrderReferrer | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "MemberActivityDataOrderStatusEnum",
            "format": ""
        },
        {
            "name": "customerId",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<MemberActivityDataOrderItemsItem>",
            "format": ""
        },
        {
            "name": "metadata",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "MemberActivityDataOrderObjectEnum",
            "format": ""
        },
        {
            "name": "initialAmount",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "MemberActivityDataOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "MemberActivityDataOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataOrder.attributeTypeMap;
    }
...
export enum MemberActivityDataOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum MemberActivityDataOrderObjectEnum {
    Order = 'order'
}

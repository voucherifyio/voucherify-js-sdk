...
export class ExportsGetResponseBodyParameters {
    'order'?: ExportsGetResponseBodyParametersOrderEnum | null;
    /**
    * Array of strings containing the data in the export. These fields define the headers in the CSV file.
    */
    'fields'?: Array<ExportsGetResponseBodyParametersFieldsEnum> | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "order",
            "baseName": "order",
            "type": "ExportsGetResponseBodyParametersOrderEnum",
            "format": ""
        },
        {
            "name": "fields",
            "baseName": "fields",
            "type": "Array<ExportsGetResponseBodyParametersFieldsEnum>",
            "format": ""
        },
        {
            "name": "filters",
    ...
    static getAttributeTypeMap() {
        return ExportsGetResponseBodyParameters.attributeTypeMap;
    }
...
export enum ExportsGetResponseBodyParametersOrderEnum {
...
export enum ExportsGetResponseBodyParametersFieldsEnum {
    Code = 'code',

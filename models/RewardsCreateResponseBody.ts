...
*/
export class RewardsCreateResponseBody {
    /**
    ...
    */
    ...
    'attributes'?: RewardsCreateResponseBodyAttributes | null;
    /**
    ...
    * Reward type.
    */
    'type'?: RewardsCreateResponseBodyTypeEnum | null;
    ...
    */
    'object': RewardsCreateResponseBodyObjectEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "attributes",
            "baseName": "attributes",
            "type": "RewardsCreateResponseBodyAttributes",
            "format": ""
        },
        {
            "name": "metadata",
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "RewardsCreateResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "parameters",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RewardsCreateResponseBodyObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RewardsCreateResponseBody.attributeTypeMap;
    }
...
export enum RewardsCreateResponseBodyTypeEnum {
    Campaign = 'CAMPAIGN',
    Coin = 'COIN',
    Material = 'MATERIAL'
}
export enum RewardsCreateResponseBodyObjectEnum {
    Reward = 'reward'
}

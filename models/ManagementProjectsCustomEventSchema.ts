...
*/
export class ManagementProjectsCustomEventSchema {
    /**
    ...
    */
    'name'?: string | null;
    'schema'?: ManagementProjectsCustomEventSchemaSchema | null;
    /**
    ...
    */
    'object'?: ManagementProjectsCustomEventSchemaObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "schema",
            "baseName": "schema",
            "type": "ManagementProjectsCustomEventSchemaSchema",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "ManagementProjectsCustomEventSchemaObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementProjectsCustomEventSchema.attributeTypeMap;
    }
...
export enum ManagementProjectsCustomEventSchemaObjectEnum {

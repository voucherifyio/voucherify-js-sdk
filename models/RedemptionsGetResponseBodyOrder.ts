...
export class RedemptionsGetResponseBodyOrder {
    /**
    ...
    * The order status.
    */
    'status'?: RedemptionsGetResponseBodyOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: RedemptionsGetResponseBodyOrderObjectEnum | null;
    /**
    ...
    */
    ...
    'customer'?: RedemptionsGetResponseBodyOrderCustomer | null;
    'referrer'?: RedemptionsGetResponseBodyOrderReferrer | null;
    'redemptions'?: { [key: string]: OrderRedemptionsEntry; } | null;
    /**
    * Array of items applied to the order. It can include up to 500 items.
    */
    'items'?: Array<RedemptionsGetResponseBodyOrderItemsItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "RedemptionsGetResponseBodyOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionsGetResponseBodyOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "RedemptionsGetResponseBodyOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "RedemptionsGetResponseBodyOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<RedemptionsGetResponseBodyOrderItemsItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionsGetResponseBodyOrder.attributeTypeMap;
    }
...
export enum RedemptionsGetResponseBodyOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum RedemptionsGetResponseBodyOrderObjectEnum {
    Order = 'order'
}

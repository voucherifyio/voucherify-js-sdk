...
export class LoyaltyCampaign {
    ...
    * Type of campaign.
    */
    'campaignType'?: LoyaltyCampaignCampaignTypeEnum | null;
    /**
    ...
    */
    'type'?: LoyaltyCampaignTypeEnum | null;
    ...
    */
    'validityDayOfWeek'?: Array<LoyaltyCampaignValidityDayOfWeekEnum>;
    ...
    */
    'creationStatus'?: LoyaltyCampaignCreationStatusEnum | null;
    /**
    * Indicates the status of the campaign\'s voucher generation.
    */
    'vouchersGenerationStatus'?: LoyaltyCampaignVouchersGenerationStatusEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "LoyaltyCampaignCampaignTypeEnum",
            "format": ""
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "LoyaltyCampaignTypeEnum",
            "format": ""
        },
        {
            "name": "voucher",
        ...
        },
        {
            ...
            "type": "Array<LoyaltyCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            ...
            "type": "LoyaltyCampaignCreationStatusEnum",
            "format": ""
        },
        {
            "name": "vouchersGenerationStatus",
            "baseName": "vouchers_generation_status",
            "type": "LoyaltyCampaignVouchersGenerationStatusEnum",
            "format": ""
        },
        {
            "name": "readonly",
...
export enum LoyaltyCampaignCampaignTypeEnum {
    LoyaltyProgram = 'LOYALTY_PROGRAM'
}
export enum LoyaltyCampaignTypeEnum {
    AutoUpdate = 'AUTO_UPDATE',
    Static = 'STATIC'
}
export enum LoyaltyCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,
...
export enum LoyaltyCampaignCreationStatusEnum {
    Done = 'DONE',
...
export enum LoyaltyCampaignVouchersGenerationStatusEnum {
    Done = 'DONE',
    InProgress = 'IN_PROGRESS',
    Failed = 'FAILED',
    Draft = 'DRAFT',

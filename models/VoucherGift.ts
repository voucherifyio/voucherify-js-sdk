...
export class VoucherGift {
    ...
    */
    'effect'?: VoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VoucherGift.attributeTypeMap;
    }
...
export enum VoucherGiftEffectEnum {

...
export class MemberActivityDataRedemptionVoucher {
    'id'?: string | null;
    'code'?: string | null;
    'gift'?: MemberActivityDataRedemptionVoucherGift | null;
    'discount'?: Discount;
    'loyaltyCard'?: MemberActivityDataRedemptionVoucherLoyaltyCard | null;
    'type'?: MemberActivityDataRedemptionVoucherTypeEnum | null;
    ...
    */
    ...
    'redemption'?: MemberActivityDataRedemptionVoucherRedemption | null;
    ...
    */
    'validityDayOfWeek'?: Array<MemberActivityDataRedemptionVoucherValidityDayOfWeekEnum>;
    ...
    */
    ...
    'publish'?: MemberActivityDataRedemptionVoucherPublish | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "MemberActivityDataRedemptionVoucherGift",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            ...
            "type": "MemberActivityDataRedemptionVoucherLoyaltyCard",
            "format": ""
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "MemberActivityDataRedemptionVoucherTypeEnum",
            "format": ""
        },
        {
            "name": "campaign",
        ...
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "MemberActivityDataRedemptionVoucherRedemption",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<MemberActivityDataRedemptionVoucherValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "MemberActivityDataRedemptionVoucherPublish",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionVoucher.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionVoucherTypeEnum {
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD',
    GiftVoucher = 'GIFT_VOUCHER'
}
export enum MemberActivityDataRedemptionVoucherValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityObjectEnum {

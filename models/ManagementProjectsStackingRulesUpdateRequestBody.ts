...
*/
export class ManagementProjectsStackingRulesUpdateRequestBody {
    /**
    ...
    */
    'discountCalculationMode'?: ManagementProjectsStackingRulesUpdateRequestBodyDiscountCalculationModeEnum | null;
    /**
    ...
    */
    'redeemablesApplicationMode'?: ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesApplicationModeEnum | null;
    /**
    ...
    */
    'redeemablesSortingRule'?: ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesSortingRuleEnum | null;
    /**
    ...
    */
    'redeemablesProductsApplicationMode'?: ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesProductsApplicationModeEnum | null;
    /**
    ...
    */
    'redeemablesNoEffectRule'?: ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesNoEffectRuleEnum | null;
    /**
    ...
    */
    'redeemablesRollbackOrderMode'?: ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesRollbackOrderModeEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyDiscountCalculationModeEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesApplicationModeEnum",
            "format": ""
        },
        {
            "name": "redeemablesSortingRule",
            "baseName": "redeemables_sorting_rule",
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesSortingRuleEnum",
            "format": ""
        },
        {
            "name": "redeemablesProductsApplicationMode",
            "baseName": "redeemables_products_application_mode",
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesProductsApplicationModeEnum",
            "format": ""
        },
        {
            "name": "redeemablesNoEffectRule",
            "baseName": "redeemables_no_effect_rule",
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesNoEffectRuleEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesRollbackOrderModeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementProjectsStackingRulesUpdateRequestBody.attributeTypeMap;
    }
...
export enum ManagementProjectsStackingRulesUpdateRequestBodyDiscountCalculationModeEnum {
    InitialAmount = 'INITIAL_AMOUNT',
    DiscountedAmount = 'DISCOUNTED_AMOUNT'
}
export enum ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesApplicationModeEnum {
    All = 'ALL',
    Partial = 'PARTIAL'
}
export enum ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesSortingRuleEnum {
    CategoryHierarchy = 'CATEGORY_HIERARCHY',
    RequestedOrder = 'REQUESTED_ORDER'
}
export enum ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesProductsApplicationModeEnum {
    Stack = 'STACK',
    Once = 'ONCE'
}
export enum ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesNoEffectRuleEnum {
    RedeemAnyway = 'REDEEM_ANYWAY',
    Skip = 'SKIP'
}
export enum ManagementProjectsStackingRulesUpdateRequestBodyRedeemablesRollbackOrderModeEnum {

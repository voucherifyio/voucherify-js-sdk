...
*/
export class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount.attributeTypeMap;
    }

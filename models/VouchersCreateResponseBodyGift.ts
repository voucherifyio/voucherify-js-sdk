...
*/
export class VouchersCreateResponseBodyGift {
    /**
    ...
    */
    'effect'?: VouchersCreateResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VouchersCreateResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VouchersCreateResponseBodyGift.attributeTypeMap;
    }
...
export enum VouchersCreateResponseBodyGiftEffectEnum {

...
export class MemberActivityDataRedemptionRewardVoucherGift {
    /**
    ...
    */
    'effect'?: MemberActivityDataRedemptionRewardVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "MemberActivityDataRedemptionRewardVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionRewardVoucherGift.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionRewardVoucherGiftEffectEnum {

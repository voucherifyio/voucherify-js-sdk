...
*/
export class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantityObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantityObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantityObjectEnum {

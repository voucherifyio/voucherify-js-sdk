...
export class RedemptionVoucher {
    ...
    */
    'type'?: RedemptionVoucherTypeEnum | null;
    'discount'?: Discount;
    'gift'?: RedemptionVoucherGift | null;
    'loyaltyCard'?: RedemptionVoucherLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<RedemptionVoucherValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: RedemptionVoucherPublish | null;
    'redemption'?: RedemptionVoucherRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "RedemptionVoucherTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "RedemptionVoucherGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "RedemptionVoucherLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<RedemptionVoucherValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "RedemptionVoucherPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "RedemptionVoucherRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return RedemptionVoucher.attributeTypeMap;
    }
...
export enum RedemptionVoucherTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum RedemptionVoucherValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class TemplatesCampaignsCreateTemplateResponseBody {
    /**
    ...
    */
    'campaignType'?: TemplatesCampaignsCreateTemplateResponseBodyCampaignTypeEnum | null;
    /**
    ...
    */
    'object'?: TemplatesCampaignsCreateTemplateResponseBodyObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "TemplatesCampaignsCreateTemplateResponseBodyCampaignTypeEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "TemplatesCampaignsCreateTemplateResponseBodyObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TemplatesCampaignsCreateTemplateResponseBody.attributeTypeMap;
    }
...
export enum TemplatesCampaignsCreateTemplateResponseBodyCampaignTypeEnum {
    DiscountCoupons = 'DISCOUNT_COUPONS',
    GiftVouchers = 'GIFT_VOUCHERS'
}
export enum TemplatesCampaignsCreateTemplateResponseBodyObjectEnum {

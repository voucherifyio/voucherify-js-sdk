...
*/
export class ValidationsValidateRequestBody {
    'options'?: ValidationsValidateRequestBodyOptions | null;
    'redeemables'?: Array<ValidationsValidateRequestBodyRedeemablesItem> | null;
    'order'?: Order;
    'customer'?: Customer;
    'session'?: Session;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "options",
            "baseName": "options",
            "type": "ValidationsValidateRequestBodyOptions",
            "format": ""
        },
        {
            "name": "redeemables",
            "baseName": "redeemables",
            "type": "Array<ValidationsValidateRequestBodyRedeemablesItem>",
            "format": ""
        },
        {
            "name": "order",
    ...
    static getAttributeTypeMap() {
        return ValidationsValidateRequestBody.attributeTypeMap;
    }

...
export class RedemptionsListResponseBodyRedemptionsItemVoucherGift {
    /**
    ...
    */
    'effect'?: RedemptionsListResponseBodyRedemptionsItemVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "RedemptionsListResponseBodyRedemptionsItemVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionsListResponseBodyRedemptionsItemVoucherGift.attributeTypeMap;
    }
...
export enum RedemptionsListResponseBodyRedemptionsItemVoucherGiftEffectEnum {

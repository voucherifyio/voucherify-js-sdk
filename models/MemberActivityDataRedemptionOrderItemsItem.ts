...
export class MemberActivityDataRedemptionOrderItemsItem {
    /**
    * Unique identifier of the order line item.
    */
    'id'?: string | null;
    'object'?: MemberActivityDataRedemptionOrderItemsItemObjectEnum;
    /**
    ...
    */
    ...
    'relatedObject'?: MemberActivityDataRedemptionOrderItemsItemRelatedObjectEnum;
    /**
    ...
    */
    ...
    'product'?: MemberActivityDataRedemptionOrderItemsItemProduct | null;
    'sku'?: MemberActivityDataRedemptionOrderItemsItemSku | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "MemberActivityDataRedemptionOrderItemsItemObjectEnum",
            "format": ""
        },
        {
            "name": "sourceId",
        ...
        },
        {
            ...
            "type": "MemberActivityDataRedemptionOrderItemsItemRelatedObjectEnum",
            "format": ""
        },
        {
            "name": "productId",
        ...
        },
        {
            "name": "product",
            "baseName": "product",
            "type": "MemberActivityDataRedemptionOrderItemsItemProduct",
            "format": ""
        },
        {
            "name": "sku",
            "baseName": "sku",
            "type": "MemberActivityDataRedemptionOrderItemsItemSku",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionOrderItemsItem.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionOrderItemsItemObjectEnum {
    OrderItem = 'order_item'
}
export enum MemberActivityDataRedemptionOrderItemsItemRelatedObjectEnum {
    Product = 'product',
    Sku = 'sku'
}

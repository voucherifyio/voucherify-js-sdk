...
export class EarningRule {
    ...
    */
    'createdAt'?: Date | null;
    'loyalty'?: EarningRuleLoyalty | null;
    'event'?: string;
    'customEvent'?: EarningRuleCustomEvent | null;
    'segment'?: EarningRuleSegment | null;
    'loyaltyTier'?: EarningRuleLoyaltyTier | null;
    'pendingPoints'?: EarningRulePendingPoints | null;
    'source'?: EarningRuleSource | null;
    /**
    * The type of the object represented by JSON. Default is earning_rule.
    */
    'object'?: EarningRuleObjectEnum | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<EarningRuleValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "EarningRuleCustomEvent",
            "format": ""
        },
        {
            "name": "segment",
            "baseName": "segment",
            "type": "EarningRuleSegment",
            "format": ""
        },
        {
            "name": "loyaltyTier",
            "baseName": "loyalty_tier",
            "type": "EarningRuleLoyaltyTier",
            "format": ""
        },
        {
            "name": "pendingPoints",
            "baseName": "pending_points",
            "type": "EarningRulePendingPoints",
            "format": ""
        },
        {
            "name": "source",
            "baseName": "source",
            "type": "EarningRuleSource",
            "format": ""
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "EarningRuleObjectEnum",
            "format": ""
        },
        {
            "name": "automationId",
        ...
        },
        {
            ...
            "type": "Array<EarningRuleValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return EarningRule.attributeTypeMap;
    }
...
export enum EarningRuleObjectEnum {
    EarningRule = 'earning_rule'
}
export enum EarningRuleValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

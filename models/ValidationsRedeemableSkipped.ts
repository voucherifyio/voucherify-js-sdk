...
export class ValidationsRedeemableSkipped {
    ...
    */
    'object'?: ValidationsRedeemableSkippedObjectEnum | null;
    'result'?: ValidationsRedeemableSkippedResult | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "ValidationsRedeemableSkippedStatusEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "ValidationsRedeemableSkippedObjectEnum",
            "format": ""
        },
        {
            "name": "result",
            "baseName": "result",
            "type": "ValidationsRedeemableSkippedResult",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return ValidationsRedeemableSkipped.attributeTypeMap;
    }
...
export enum ValidationsRedeemableSkippedStatusEnum {
    Skipped = 'SKIPPED'
}
export enum ValidationsRedeemableSkippedObjectEnum {
    Voucher = 'voucher',

...
*/
export class VouchersEnableResponseBodyGift {
    /**
    ...
    */
    'effect'?: VouchersEnableResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VouchersEnableResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VouchersEnableResponseBodyGift.attributeTypeMap;
    }
...
export enum VouchersEnableResponseBodyGiftEffectEnum {

...
*/
export class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderAmount {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderAmount.attributeTypeMap;
    }

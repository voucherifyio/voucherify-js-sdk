...
export class RedemptionsGetResponseBodyPromotionTierCampaign {
    /**
    * Unique campaign ID.
    */
    'id'?: string | null;
    ...
    */
    'validityDayOfWeek'?: Array<RedemptionsGetResponseBodyPromotionTierCampaignValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<RedemptionsGetResponseBodyPromotionTierCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return RedemptionsGetResponseBodyPromotionTierCampaign.attributeTypeMap;
    }
...
export enum RedemptionsGetResponseBodyPromotionTierCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

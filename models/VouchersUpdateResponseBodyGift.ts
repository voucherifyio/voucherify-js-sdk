...
*/
export class VouchersUpdateResponseBodyGift {
    /**
    ...
    */
    'effect'?: VouchersUpdateResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VouchersUpdateResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VouchersUpdateResponseBodyGift.attributeTypeMap;
    }
...
export enum VouchersUpdateResponseBodyGiftEffectEnum {

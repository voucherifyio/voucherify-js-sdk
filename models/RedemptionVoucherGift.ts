...
*/
export class RedemptionVoucherGift {
    /**
    ...
    */
    'effect'?: RedemptionVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "RedemptionVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionVoucherGift.attributeTypeMap;
    }
...
export enum RedemptionVoucherGiftEffectEnum {

...
*/
export class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountObjectEnum {

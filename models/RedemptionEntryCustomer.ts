...
export class RedemptionEntryCustomer {
    /**
    ...
    */
    'object'?: RedemptionEntryCustomerObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionEntryCustomerObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionEntryCustomer.attributeTypeMap;
    }
...
export enum RedemptionEntryCustomerObjectEnum {
    Customer = 'customer'
}

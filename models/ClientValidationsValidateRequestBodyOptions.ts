...
*/
export class ClientValidationsValidateRequestBodyOptions {
    /**
    ...
    */
    'expand'?: Array<ClientValidationsValidateRequestBodyOptionsExpandEnum> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "expand",
            "baseName": "expand",
            "type": "Array<ClientValidationsValidateRequestBodyOptionsExpandEnum>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ClientValidationsValidateRequestBodyOptions.attributeTypeMap;
    }
...
export enum ClientValidationsValidateRequestBodyOptionsExpandEnum {
    Order = 'order',

...
*/
export class LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata.attributeTypeMap;
    }

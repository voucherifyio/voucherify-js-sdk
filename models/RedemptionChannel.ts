...
*/
export class RedemptionChannel {
    /**
    ...
    */
    'channelType'?: RedemptionChannelChannelTypeEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "RedemptionChannelChannelTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionChannel.attributeTypeMap;
    }
...
export enum RedemptionChannelChannelTypeEnum {
    User = 'USER',
    Api = 'API',

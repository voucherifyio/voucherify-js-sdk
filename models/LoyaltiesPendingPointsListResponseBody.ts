...
*/
export class LoyaltiesPendingPointsListResponseBody {
    /**
    * The type of the object represented by JSON.
    */
    'object'?: LoyaltiesPendingPointsListResponseBodyObjectEnum | null;
    /**
    * Identifies the name of the attribute that contains the array of pending point objects.
    */
    'dataRef'?: LoyaltiesPendingPointsListResponseBodyDataRefEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesPendingPointsListResponseBodyObjectEnum",
            "format": ""
        },
        {
            "name": "dataRef",
            "baseName": "data_ref",
            "type": "LoyaltiesPendingPointsListResponseBodyDataRefEnum",
            "format": ""
        },
        {
            "name": "data",
    ...
    static getAttributeTypeMap() {
        return LoyaltiesPendingPointsListResponseBody.attributeTypeMap;
    }
...
export enum LoyaltiesPendingPointsListResponseBodyObjectEnum {
    List = 'list'
}
export enum LoyaltiesPendingPointsListResponseBodyDataRefEnum {
    Data = 'data'
}

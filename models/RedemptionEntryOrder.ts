...
export class RedemptionEntryOrder {
    /**
    ...
    * The order status.
    */
    'status'?: RedemptionEntryOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: RedemptionEntryOrderObjectEnum | null;
    /**
    ...
    */
    ...
    'customer'?: RedemptionEntryOrderCustomer | null;
    'referrer'?: RedemptionEntryOrderReferrer | null;
    'redemptions'?: { [key: string]: OrderRedemptionsEntry; } | null;
    /**
    * Array of items applied to the order. It can include up to 500 items.
    */
    'items'?: Array<RedemptionEntryOrderItemsItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "RedemptionEntryOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionEntryOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "RedemptionEntryOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "RedemptionEntryOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<RedemptionEntryOrderItemsItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionEntryOrder.attributeTypeMap;
    }
...
export enum RedemptionEntryOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum RedemptionEntryOrderObjectEnum {
    Order = 'order'
}

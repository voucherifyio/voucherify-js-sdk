...
*/
export class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish.attributeTypeMap;
    }

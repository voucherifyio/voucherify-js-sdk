...
*/
export class CampaignsVouchersCreateResponseBodyGift {
    /**
    ...
    */
    'effect'?: CampaignsVouchersCreateResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "CampaignsVouchersCreateResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CampaignsVouchersCreateResponseBodyGift.attributeTypeMap;
    }
...
export enum CampaignsVouchersCreateResponseBodyGiftEffectEnum {

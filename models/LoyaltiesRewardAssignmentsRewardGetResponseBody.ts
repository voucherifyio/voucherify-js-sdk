...
*/
export class LoyaltiesRewardAssignmentsRewardGetResponseBody {
    /**
    ...
    */
    ...
    'attributes'?: LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes | null;
    /**
    ...
    * Reward type.
    */
    'type'?: LoyaltiesRewardAssignmentsRewardGetResponseBodyTypeEnum | null;
    ...
    */
    'object': LoyaltiesRewardAssignmentsRewardGetResponseBodyObjectEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "attributes",
            "baseName": "attributes",
            "type": "LoyaltiesRewardAssignmentsRewardGetResponseBodyAttributes",
            "format": ""
        },
        {
            "name": "metadata",
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "LoyaltiesRewardAssignmentsRewardGetResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "parameters",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesRewardAssignmentsRewardGetResponseBodyObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesRewardAssignmentsRewardGetResponseBody.attributeTypeMap;
    }
...
export enum LoyaltiesRewardAssignmentsRewardGetResponseBodyTypeEnum {
    Campaign = 'CAMPAIGN',
    Coin = 'COIN',
    Material = 'MATERIAL'
}
export enum LoyaltiesRewardAssignmentsRewardGetResponseBodyObjectEnum {
    Reward = 'reward'
}

...
export class MemberActivityDataRedemptionOrder {
    'id'?: string | null;
    'sourceId'?: string | null;
    /**
    * The order status.
    */
    'status'?: MemberActivityDataRedemptionOrderStatusEnum | null;
    /**
    ...
    */
    'items'?: Array<MemberActivityDataRedemptionOrderItemsItem> | null;
    /**
    ...
    */
    'object'?: MemberActivityDataRedemptionOrderObjectEnum | null;
    /**
    ...
    */
    'updatedAt'?: Date | null;
    'customer'?: MemberActivityDataRedemptionOrderCustomer | null;
    'referrer'?: MemberActivityDataRedemptionOrderReferrer | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "MemberActivityDataRedemptionOrderStatusEnum",
            "format": ""
        },
        {
            "name": "customerId",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<MemberActivityDataRedemptionOrderItemsItem>",
            "format": ""
        },
        {
            "name": "metadata",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "MemberActivityDataRedemptionOrderObjectEnum",
            "format": ""
        },
        {
            "name": "initialAmount",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "MemberActivityDataRedemptionOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "MemberActivityDataRedemptionOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionOrder.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum MemberActivityDataRedemptionOrderObjectEnum {
    Order = 'order'
}

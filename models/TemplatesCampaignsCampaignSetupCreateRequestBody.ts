...
*/
export class TemplatesCampaignsCampaignSetupCreateRequestBody {
    /**
    * Campaign name.
    */
    'name'?: string | null;
    ...
    */
    'type'?: TemplatesCampaignsCampaignSetupCreateRequestBodyTypeEnum | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<TemplatesCampaignsCampaignSetupCreateRequestBodyValidityDayOfWeekEnum>;
    ...
    */
    ...
    'voucher'?: TemplatesCampaignsCampaignSetupCreateRequestBodyVoucher | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "TemplatesCampaignsCampaignSetupCreateRequestBodyTypeEnum",
            "format": ""
        },
        {
            "name": "joinOnce",
        ...
        },
        {
            ...
            "type": "Array<TemplatesCampaignsCampaignSetupCreateRequestBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "voucher",
            "baseName": "voucher",
            "type": "TemplatesCampaignsCampaignSetupCreateRequestBodyVoucher",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TemplatesCampaignsCampaignSetupCreateRequestBody.attributeTypeMap;
    }
...
export enum TemplatesCampaignsCampaignSetupCreateRequestBodyTypeEnum {
    AutoUpdate = 'AUTO_UPDATE',
    Static = 'STATIC'
}
export enum TemplatesCampaignsCampaignSetupCreateRequestBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

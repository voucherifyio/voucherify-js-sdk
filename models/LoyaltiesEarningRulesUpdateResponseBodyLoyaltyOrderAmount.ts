...
*/
export class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderAmount.attributeTypeMap;
    }

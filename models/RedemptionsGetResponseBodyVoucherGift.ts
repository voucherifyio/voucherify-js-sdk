...
export class RedemptionsGetResponseBodyVoucherGift {
    /**
    ...
    */
    'effect'?: RedemptionsGetResponseBodyVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "RedemptionsGetResponseBodyVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionsGetResponseBodyVoucherGift.attributeTypeMap;
    }
...
export enum RedemptionsGetResponseBodyVoucherGiftEffectEnum {

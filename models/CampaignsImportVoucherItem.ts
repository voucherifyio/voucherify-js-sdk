...
export class CampaignsImportVoucherItem {
    /**
    * Value representing the imported code.
    */
    'code'?: string | null;
    'redemption'?: CampaignsImportVoucherItemRedemption | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<CampaignsImportVoucherItemValidityDayOfWeekEnum>;
    /**
    * An optional field to keep any extra textual information about the code such as a code description and details.
    */
    'additionalInfo'?: string | null;
    'type'?: CampaignsImportVoucherItemTypeEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "CampaignsImportVoucherItemRedemption",
            "format": ""
        },
        {
            "name": "active",
        ...
        },
        {
            ...
            "type": "Array<CampaignsImportVoucherItemValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "additionalInfo",
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "CampaignsImportVoucherItemTypeEnum",
            "format": ""
        },
        {
            "name": "loyaltyCard",
    ...
    static getAttributeTypeMap() {
        return CampaignsImportVoucherItem.attributeTypeMap;
    }
...
export enum CampaignsImportVoucherItemValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,
...
export enum CampaignsImportVoucherItemTypeEnum {

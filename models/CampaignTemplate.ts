...
export class CampaignTemplate {
    ...
    */
    'campaignType'?: CampaignTemplateCampaignTypeEnum | null;
    /**
    ...
    */
    'object'?: CampaignTemplateObjectEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "CampaignTemplateObjectEnum",
            "format": ""
        },
        {
            "name": "updatedAt",
    ...
    static getAttributeTypeMap() {
        return CampaignTemplate.attributeTypeMap;
    }
...
export enum CampaignTemplateCampaignTypeEnum {
    DiscountCoupons = 'DISCOUNT_COUPONS',
    GiftVouchers = 'GIFT_VOUCHERS'
}
export enum CampaignTemplateObjectEnum {

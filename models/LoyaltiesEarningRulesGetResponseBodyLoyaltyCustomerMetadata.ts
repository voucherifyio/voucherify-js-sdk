...
*/
export class LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomerMetadata {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomerMetadata.attributeTypeMap;
    }

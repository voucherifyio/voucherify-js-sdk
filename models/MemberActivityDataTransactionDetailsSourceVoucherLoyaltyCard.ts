...
export class MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.attributeTypeMap;
    }

...
*/
export class VouchersEnableResponseBody {
    /**
    ...
    */
    'type'?: VouchersEnableResponseBodyTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VouchersEnableResponseBodyGift | null;
    'loyaltyCard'?: VouchersEnableResponseBodyLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VouchersEnableResponseBodyValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VouchersEnableResponseBodyPublish | null;
    'redemption'?: VouchersEnableResponseBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VouchersEnableResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VouchersEnableResponseBodyGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VouchersEnableResponseBodyLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VouchersEnableResponseBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VouchersEnableResponseBodyPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VouchersEnableResponseBodyRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VouchersEnableResponseBody.attributeTypeMap;
    }
...
export enum VouchersEnableResponseBodyTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VouchersEnableResponseBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

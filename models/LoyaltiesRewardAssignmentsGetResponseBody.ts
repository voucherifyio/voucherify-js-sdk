...
*/
export class LoyaltiesRewardAssignmentsGetResponseBody {
    /**
    ...
    */
    'object'?: LoyaltiesRewardAssignmentsGetResponseBodyObjectEnum | null;
    /**
    ...
    */
    'relatedObjectType'?: LoyaltiesRewardAssignmentsGetResponseBodyRelatedObjectTypeEnum | null;
    'parameters'?: LoyaltiesRewardAssignmentsGetResponseBodyParameters | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesRewardAssignmentsGetResponseBodyObjectEnum",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "type": "LoyaltiesRewardAssignmentsGetResponseBodyRelatedObjectTypeEnum",
            "format": ""
        },
        {
            "name": "parameters",
            "baseName": "parameters",
            "type": "LoyaltiesRewardAssignmentsGetResponseBodyParameters",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesRewardAssignmentsGetResponseBody.attributeTypeMap;
    }
...
export enum LoyaltiesRewardAssignmentsGetResponseBodyObjectEnum {
    RewardAssignment = 'reward_assignment'
}
export enum LoyaltiesRewardAssignmentsGetResponseBodyRelatedObjectTypeEnum {
    Campaign = 'campaign'
}

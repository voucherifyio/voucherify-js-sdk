...
export class ExportsCreateRequestBodyParameters {
    'order'?: ExportsCreateRequestBodyParametersOrderEnum | null;
    /**
    * Array of strings containing the data in the export. These fields define the headers in the CSV file.
    */
    'fields'?: Array<ExportsCreateRequestBodyParametersFieldsEnum> | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "order",
            "baseName": "order",
            "type": "ExportsCreateRequestBodyParametersOrderEnum",
            "format": ""
        },
        {
            "name": "fields",
            "baseName": "fields",
            "type": "Array<ExportsCreateRequestBodyParametersFieldsEnum>",
            "format": ""
        },
        {
            "name": "filters",
    ...
    static getAttributeTypeMap() {
        return ExportsCreateRequestBodyParameters.attributeTypeMap;
    }
...
export enum ExportsCreateRequestBodyParametersOrderEnum {
...
export enum ExportsCreateRequestBodyParametersFieldsEnum {
    Code = 'code',

...
*/
export class SkusGetResponseBody {
    /**
    ...
    */
    'object'?: SkusGetResponseBodyObjectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "SkusGetResponseBodyObjectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SkusGetResponseBody.attributeTypeMap;
    }
...
export enum SkusGetResponseBodyObjectEnum {
    Sku = 'sku'
}

...
*/
export class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityObjectEnum {

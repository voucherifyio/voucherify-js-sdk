...
*/
export class ClientValidationsValidateRequestBody {
    'options'?: ClientValidationsValidateRequestBodyOptions | null;
    'redeemables'?: Array<ClientValidationsValidateRequestBodyRedeemablesItem> | null;
    'order'?: Order;
    'customer'?: Customer;
    'session'?: Session;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "options",
            "baseName": "options",
            "type": "ClientValidationsValidateRequestBodyOptions",
            "format": ""
        },
        {
            "name": "redeemables",
            "baseName": "redeemables",
            "type": "Array<ClientValidationsValidateRequestBodyRedeemablesItem>",
            "format": ""
        },
        {
            "name": "order",
    ...
    static getAttributeTypeMap() {
        return ClientValidationsValidateRequestBody.attributeTypeMap;
    }

...
*/
export class PromotionTierCampaign {
    /**
    * Unique campaign ID.
    */
    'id'?: string | null;
    ...
    */
    'validityDayOfWeek'?: Array<PromotionTierCampaignValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<PromotionTierCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return PromotionTierCampaign.attributeTypeMap;
    }
...
export enum PromotionTierCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

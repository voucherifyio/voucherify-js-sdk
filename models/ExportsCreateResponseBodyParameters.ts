...
export class ExportsCreateResponseBodyParameters {
    'order'?: ExportsCreateResponseBodyParametersOrderEnum | null;
    /**
    * Array of strings containing the data in the export. These fields define the headers in the CSV file.
    */
    'fields'?: Array<ExportsCreateResponseBodyParametersFieldsEnum> | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "order",
            "baseName": "order",
            "type": "ExportsCreateResponseBodyParametersOrderEnum",
            "format": ""
        },
        {
            "name": "fields",
            "baseName": "fields",
            "type": "Array<ExportsCreateResponseBodyParametersFieldsEnum>",
            "format": ""
        },
        {
            "name": "filters",
    ...
    static getAttributeTypeMap() {
        return ExportsCreateResponseBodyParameters.attributeTypeMap;
    }
...
export enum ExportsCreateResponseBodyParametersOrderEnum {
...
export enum ExportsCreateResponseBodyParametersFieldsEnum {
    Code = 'code',

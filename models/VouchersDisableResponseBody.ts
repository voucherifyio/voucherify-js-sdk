...
*/
export class VouchersDisableResponseBody {
    /**
    ...
    */
    'type'?: VouchersDisableResponseBodyTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VouchersDisableResponseBodyGift | null;
    'loyaltyCard'?: VouchersDisableResponseBodyLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VouchersDisableResponseBodyValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VouchersDisableResponseBodyPublish | null;
    'redemption'?: VouchersDisableResponseBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VouchersDisableResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VouchersDisableResponseBodyGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VouchersDisableResponseBodyLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VouchersDisableResponseBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VouchersDisableResponseBodyPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VouchersDisableResponseBodyRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VouchersDisableResponseBody.attributeTypeMap;
    }
...
export enum VouchersDisableResponseBodyTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VouchersDisableResponseBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmountObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmountApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmountObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmountApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmountObjectEnum {

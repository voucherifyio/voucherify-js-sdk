...
export class RedemptionEntryPromotionTierCampaign {
    /**
    * Unique campaign ID.
    */
    'id'?: string | null;
    ...
    */
    'validityDayOfWeek'?: Array<RedemptionEntryPromotionTierCampaignValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<RedemptionEntryPromotionTierCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return RedemptionEntryPromotionTierCampaign.attributeTypeMap;
    }
...
export enum RedemptionEntryPromotionTierCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderTotalAmount {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderTotalAmount.attributeTypeMap;
    }

...
*/
export class VouchersGetResponseBody {
    /**
    ...
    */
    'type'?: VouchersGetResponseBodyTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VouchersGetResponseBodyGift | null;
    'loyaltyCard'?: VouchersGetResponseBodyLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VouchersGetResponseBodyValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VouchersGetResponseBodyPublish | null;
    'redemption'?: VouchersGetResponseBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VouchersGetResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VouchersGetResponseBodyGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VouchersGetResponseBodyLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VouchersGetResponseBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VouchersGetResponseBodyPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VouchersGetResponseBodyRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VouchersGetResponseBody.attributeTypeMap;
    }
...
export enum VouchersGetResponseBodyTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VouchersGetResponseBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

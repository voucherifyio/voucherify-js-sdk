...
export class OrdersImportCreateRequestBodyItem {
    /**
    ...
    * The order status.
    */
    'status'?: OrdersImportCreateRequestBodyItemStatusEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OrdersImportCreateRequestBodyItemStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
    ...
    static getAttributeTypeMap() {
        return OrdersImportCreateRequestBodyItem.attributeTypeMap;
    }
...
export enum OrdersImportCreateRequestBodyItemStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'

...
export class RedemptionOrder {
    ...
    * The order status.
    */
    'status'?: RedemptionOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: RedemptionOrderObjectEnum | null;
    /**
    ...
    */
    ...
    'customer'?: RedemptionOrderCustomer | null;
    'referrer'?: RedemptionOrderReferrer | null;
    'redemptions'?: { [key: string]: OrderRedemptionsEntry; } | null;
    /**
    * Array of items applied to the order. It can include up to 500 items.
    */
    'items'?: Array<RedemptionOrderItemsItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "RedemptionOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "RedemptionOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "RedemptionOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "RedemptionOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<RedemptionOrderItemsItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RedemptionOrder.attributeTypeMap;
    }
...
export enum RedemptionOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum RedemptionOrderObjectEnum {
    Order = 'order'
}

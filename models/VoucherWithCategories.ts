...
*/
export class VoucherWithCategories {
    /**
    ...
    */
    'type'?: VoucherWithCategoriesTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VoucherWithCategoriesGift | null;
    'loyaltyCard'?: VoucherWithCategoriesLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VoucherWithCategoriesValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VoucherWithCategoriesPublish | null;
    'redemption'?: VoucherWithCategoriesRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VoucherWithCategoriesTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VoucherWithCategoriesGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VoucherWithCategoriesLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VoucherWithCategoriesValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VoucherWithCategoriesPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VoucherWithCategoriesRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VoucherWithCategories.attributeTypeMap;
    }
...
export enum VoucherWithCategoriesTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VoucherWithCategoriesValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

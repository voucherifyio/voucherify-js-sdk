...
export class MemberActivityDataRedemptionVoucherGift {
    /**
    ...
    */
    'effect'?: MemberActivityDataRedemptionVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "MemberActivityDataRedemptionVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionVoucherGift.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionVoucherGiftEffectEnum {

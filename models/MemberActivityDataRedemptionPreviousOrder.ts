...
export class MemberActivityDataRedemptionPreviousOrder {
    /**
    ...
    * The order status.
    */
    'status'?: MemberActivityDataRedemptionPreviousOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: MemberActivityDataRedemptionPreviousOrderObjectEnum | null;
    /**
    ...
    */
    ...
    'customer'?: MemberActivityDataRedemptionPreviousOrderCustomer | null;
    'referrer'?: MemberActivityDataRedemptionPreviousOrderReferrer | null;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "MemberActivityDataRedemptionPreviousOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "MemberActivityDataRedemptionPreviousOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "MemberActivityDataRedemptionPreviousOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "MemberActivityDataRedemptionPreviousOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
    ...
    static getAttributeTypeMap() {
        return MemberActivityDataRedemptionPreviousOrder.attributeTypeMap;
    }
...
export enum MemberActivityDataRedemptionPreviousOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum MemberActivityDataRedemptionPreviousOrderObjectEnum {
    Order = 'order'
}

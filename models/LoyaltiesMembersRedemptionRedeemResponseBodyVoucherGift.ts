...
*/
export class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift {
    /**
    ...
    */
    'effect'?: LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.attributeTypeMap;
    }
...
export enum LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGiftEffectEnum {

...
*/
export class CategoriesGetResponseBody {
    /**
    ...
    */
    'object'?: CategoriesGetResponseBodyObjectEnum | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "CategoriesGetResponseBodyObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
    ...
    static getAttributeTypeMap() {
        return CategoriesGetResponseBody.attributeTypeMap;
    }
...
export enum CategoriesGetResponseBodyObjectEnum {
    Category = 'category'
}

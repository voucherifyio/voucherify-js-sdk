...
*/
export class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity {
    /**
    ...
    */
    'object'?: LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityObjectEnum | null;
    /**
    ...
    */
    'applicableTo'?: Array<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityObjectEnum",
            "format": ""
        },
        {
            "name": "id",
        ...
        },
        {
            ...
            "type": "Array<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity.attributeTypeMap;
    }
...
export enum LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityObjectEnum {

...
*/
export class VouchersGetResponseBodyGift {
    /**
    ...
    */
    'effect'?: VouchersGetResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "VouchersGetResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VouchersGetResponseBodyGift.attributeTypeMap;
    }
...
export enum VouchersGetResponseBodyGiftEffectEnum {

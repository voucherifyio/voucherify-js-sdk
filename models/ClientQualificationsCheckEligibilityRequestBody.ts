...
*/
export class ClientQualificationsCheckEligibilityRequestBody {
    'customer'?: Customer;
    'order'?: Order;
    /**
    ...
    */
    'scenario'?: ClientQualificationsCheckEligibilityRequestBodyScenarioEnum | null;
    'options'?: QualificationsOption;
    'session'?: ClientQualificationsCheckEligibilityRequestBodySession | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "scenario",
            "baseName": "scenario",
            "type": "ClientQualificationsCheckEligibilityRequestBodyScenarioEnum",
            "format": ""
        },
        {
            "name": "options",
        ...
        },
        {
            "name": "session",
            "baseName": "session",
            "type": "ClientQualificationsCheckEligibilityRequestBodySession",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return ClientQualificationsCheckEligibilityRequestBody.attributeTypeMap;
    }
...
export enum ClientQualificationsCheckEligibilityRequestBodyScenarioEnum {
    All = 'ALL',

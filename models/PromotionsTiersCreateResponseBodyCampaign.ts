...
*/
export class PromotionsTiersCreateResponseBodyCampaign {
    /**
    * Unique campaign ID.
    */
    'id'?: string | null;
    ...
    */
    'validityDayOfWeek'?: Array<PromotionsTiersCreateResponseBodyCampaignValidityDayOfWeekEnum>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<PromotionsTiersCreateResponseBodyCampaignValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
    ...
    static getAttributeTypeMap() {
        return PromotionsTiersCreateResponseBodyCampaign.attributeTypeMap;
    }
...
export enum PromotionsTiersCreateResponseBodyCampaignValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

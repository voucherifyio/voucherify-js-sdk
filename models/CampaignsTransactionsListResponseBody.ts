...
*/
export class CampaignsTransactionsListResponseBody {
    /**
    * The type of the object represented by JSON.
    */
    'object'?: CampaignsTransactionsListResponseBodyObjectEnum | null;
    /**
    * Identifies the name of the attribute that contains the array of transaction objects.
    */
    'dataRef'?: CampaignsTransactionsListResponseBodyDataRefEnum | null;
    /**
    * A dictionary that contains an array of transactions. Each entry in the array is a separate transaction object.
    */
    'data'?: Array<VoucherTransaction> | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "CampaignsTransactionsListResponseBodyObjectEnum",
            "format": ""
        },
        {
            "name": "dataRef",
            "baseName": "data_ref",
            "type": "CampaignsTransactionsListResponseBodyDataRefEnum",
            "format": ""
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<VoucherTransaction>",
            "format": ""
        },
        {
            "name": "hasMore",
    ...
    static getAttributeTypeMap() {
        return CampaignsTransactionsListResponseBody.attributeTypeMap;
    }
...
export enum CampaignsTransactionsListResponseBodyObjectEnum {
    List = 'list'
}
export enum CampaignsTransactionsListResponseBodyDataRefEnum {
    Data = 'data'
}

...
*/
export class EarningRuleSource {
    /**
    ...
    */
    'objectType'?: EarningRuleSourceObjectTypeEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "EarningRuleSourceObjectTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return EarningRuleSource.attributeTypeMap;
    }
...
export enum EarningRuleSourceObjectTypeEnum {
    Campaign = 'campaign'
}

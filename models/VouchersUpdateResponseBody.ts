...
*/
export class VouchersUpdateResponseBody {
    /**
    ...
    */
    'type'?: VouchersUpdateResponseBodyTypeEnum | null;
    'discount'?: Discount;
    'gift'?: VouchersUpdateResponseBodyGift | null;
    'loyaltyCard'?: VouchersUpdateResponseBodyLoyaltyCard | null;
    /**
    ...
    */
    'validityDayOfWeek'?: Array<VouchersUpdateResponseBodyValidityDayOfWeekEnum>;
    ...
    */
    'object'?: string | null;
    'publish'?: VouchersUpdateResponseBodyPublish | null;
    'redemption'?: VouchersUpdateResponseBodyRedemption | null;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "VouchersUpdateResponseBodyTypeEnum",
            "format": ""
        },
        {
            "name": "discount",
        ...
        },
        {
            "name": "gift",
            "baseName": "gift",
            "type": "VouchersUpdateResponseBodyGift",
            "format": ""
        },
        {
            "name": "loyaltyCard",
            "baseName": "loyalty_card",
            "type": "VouchersUpdateResponseBodyLoyaltyCard",
            "format": ""
        },
        {
            "name": "startDate",
        ...
        },
        {
            ...
            "type": "Array<VouchersUpdateResponseBodyValidityDayOfWeekEnum>",
            "format": ""
        },
        {
            "name": "validityHours",
        ...
        },
        {
            "name": "publish",
            "baseName": "publish",
            "type": "VouchersUpdateResponseBodyPublish",
            "format": ""
        },
        {
            "name": "redemption",
            "baseName": "redemption",
            "type": "VouchersUpdateResponseBodyRedemption",
            "format": ""
        },
        {
            "name": "categories",
    ...
    static getAttributeTypeMap() {
        return VouchersUpdateResponseBody.attributeTypeMap;
    }
...
export enum VouchersUpdateResponseBodyTypeEnum {
    GiftVoucher = 'GIFT_VOUCHER',
    DiscountVoucher = 'DISCOUNT_VOUCHER',
    LoyaltyCard = 'LOYALTY_CARD'
}
export enum VouchersUpdateResponseBodyValidityDayOfWeekEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
    NUMBER_2 = 2,
    NUMBER_3 = 3,

...
*/
export class CampaignsVouchersCreateCombinedResponseBodyGift {
    /**
    ...
    */
    'effect'?: CampaignsVouchersCreateCombinedResponseBodyGiftEffectEnum | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "effect",
            "baseName": "effect",
            "type": "CampaignsVouchersCreateCombinedResponseBodyGiftEffectEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CampaignsVouchersCreateCombinedResponseBodyGift.attributeTypeMap;
    }
...
export enum CampaignsVouchersCreateCombinedResponseBodyGiftEffectEnum {

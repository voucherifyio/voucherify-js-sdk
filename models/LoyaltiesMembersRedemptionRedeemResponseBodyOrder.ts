...
export class LoyaltiesMembersRedemptionRedeemResponseBodyOrder {
    /**
    ...
    * The order status.
    */
    'status'?: LoyaltiesMembersRedemptionRedeemResponseBodyOrderStatusEnum | null;
    /**
    ...
    */
    'object'?: LoyaltiesMembersRedemptionRedeemResponseBodyOrderObjectEnum | null;
    /**
    ...
    */
    ...
    'customer'?: LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer | null;
    'referrer'?: LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer | null;
    'redemptions'?: { [key: string]: OrderRedemptionsEntry; } | null;
    /**
    * Array of items applied to the order. It can include up to 500 items.
    */
    'items'?: Array<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem> | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "LoyaltiesMembersRedemptionRedeemResponseBodyOrderStatusEnum",
            "format": ""
        },
        {
            "name": "amount",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "LoyaltiesMembersRedemptionRedeemResponseBodyOrderObjectEnum",
            "format": ""
        },
        {
            "name": "createdAt",
        ...
        },
        {
            "name": "customer",
            "baseName": "customer",
            "type": "LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer",
            "format": ""
        },
        {
            "name": "referrer",
            "baseName": "referrer",
            "type": "LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer",
            "format": ""
        },
        {
            "name": "redemptions",
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return LoyaltiesMembersRedemptionRedeemResponseBodyOrder.attributeTypeMap;
    }
...
export enum LoyaltiesMembersRedemptionRedeemResponseBodyOrderStatusEnum {
    Created = 'CREATED',
    Paid = 'PAID',
    Canceled = 'CANCELED',
    Fulfilled = 'FULFILLED'
}
export enum LoyaltiesMembersRedemptionRedeemResponseBodyOrderObjectEnum {
    Order = 'order'
}

...
> RedemptionsRedeemResponseBody redeemStackedDiscounts()
...
```typescript
import { createConfiguration, RedemptionsApi } from 'voucherify';
import type { RedemptionsApiRedeemStackedDiscountsRequest } from 'voucherify';

const configuration = createConfiguration();
const apiInstance = new RedemptionsApi(configuration);

const request: RedemptionsApiRedeemStackedDiscountsRequest = {

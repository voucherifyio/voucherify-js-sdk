...
> ValidationRulesAssignmentsCreateResponseBody createValidationRuleAssignment(validationRuleId, opts)
...
let opts = {
  ...
  'validationRulesAssignmentsCreateRequestBody': {"voucher":"v_ssR6vhswwh5odSloN2Vc3O60w7aea018"} // ValidationRulesAssignmentsCreateRequestBody | Specify the resource that you would like to assign the validation rule to.
};
apiInstance.createValidationRuleAssignment(validationRuleId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ValidationRulesCreateResponseBody createValidationRules(opts)
...
apiInstance.createValidationRules(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ValidationRulesUpdateResponseBody updateValidationRule(validationRuleId, opts)
...
apiInstance.updateValidationRule(validationRuleId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

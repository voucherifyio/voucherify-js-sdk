# Voucherify.LoyaltiesMembersPendingPointsListResponseBody
...
**data** | [**[LoyaltyPendingPoints]**](LoyaltyPendingPoints.md) | A dictionary that contains an array of pending point entries. Each entry in the array is a separate pending point object. | [optional] 

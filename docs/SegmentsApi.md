...
> SegmentsCreateResponseBody createSegment(opts)
...
let opts = {
  'segmentsCreateRequestBody': {"name":"Customers in a new Segment","type":"static","customers":["cust_iajsExT2QB4sGWzABY85WRqV","cust_sehkNIi8Uq2qQuRqSr7xn4Zi"]} // SegmentsCreateRequestBody | Specify the boundary conditions for the customer segment.
};
apiInstance.createSegment(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {

...
> CategoriesCreateResponseBody createCategory(opts)
...
let opts = {
  'categoriesCreateRequestBody': {"name":"Eighth","hierarchy":8} // CategoriesCreateRequestBody | Specify the details of the category that you would like to create.
};
...
> CategoriesUpdateResponseBody updateCategory(categoryId, opts)
...
let categoryId = "categoryId_example"; // String | Unique category ID assigned by Voucherify.
let opts = {
  'categoriesUpdateRequestBody': {"name":"Summer","hierarchy":1} // CategoriesUpdateRequestBody | Specify the details of the category that you would like to update.
};

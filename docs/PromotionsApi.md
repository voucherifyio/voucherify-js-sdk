...
> PromotionsTiersCreateResponseBody addPromotionTierToCampaign(campaignId, opts)
...
apiInstance.addPromotionTierToCampaign(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PromotionsStacksCreateResponseBody createPromotionStack(campaignId, opts)
...
let opts = {
  'promotionsStacksCreateRequestBody': {"name":"Fifth Stack","tiers":{"ids":["promo_aaAF8mVAzA0PF1igia2OC63d","promo_t9zdL6XMFk7B8fQ23zxELtdE","promo_dJNhAEeV5sR5oPQq1UrUdnMC"],"hierarchy_mode":"MANUAL"}} // PromotionsStacksCreateRequestBody | Specify the order of promotion tiers for the promotion stack.
};
apiInstance.createPromotionStack(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PromotionsStacksUpdateResponseBody updatePromotionStack(campaignId, stackId, opts)
...
let stackId = "stackId_example"; // String | Promotion stack ID.
let opts = {
  'promotionsStacksUpdateRequestBody': {"name":"Fifth Stack Modified","tiers":{"ids":["promo_aaAF8mVAzA0PF1igia2OC63d","promo_t9zdL6XMFk7B8fQ23zxELtdE"],"hierarchy_mode":"MANUAL"}} // PromotionsStacksUpdateRequestBody | Specify the promotion stack parameters that you would like to update.
};
apiInstance.updatePromotionStack(campaignId, stackId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PromotionsTiersUpdateResponseBody updatePromotionTier(promotionTierId, opts)
...
apiInstance.updatePromotionTier(promotionTierId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

...
> LoyaltiesMembersCreateResponseBody addMember(campaignId, opts)
...
let opts = {
  'loyaltiesMembersCreateRequestBody': {"customer":"source_customer_1","metadata":{"year":2022},"channel":"postman","voucher":"KpzbHUY5"} // LoyaltiesMembersCreateRequestBody | Provide details to whom the loyalty card should be assigned.     You can choose to either specify the exact loyalty card code that you want to publish from existin (non-assigned) codes, or choose not to specify a voucher code. If you choose not to specify a code in the request paylaod, then the system will choose the next available voucher code available to be assigned to a customer.   You can also include metadata in the request payload. This metadata will be assigned to the publication object, but will not be returned in the response to this endpoint. To see of publications (assignments of particular codes to customers) and publication metadata, use the [List Publications](/api-reference/publications/list-publications) endpoint.
};
apiInstance.addMember(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersPendingPointsBalanceResponseBody adjustMemberPendingPoints(memberId, pendingPointsId, opts)
...
let pendingPointsId = "pendingPointsId_example"; // String | Unique pending point identifier, assigned by Voucherify.
let opts = {
  'loyaltiesMembersPendingPointsBalanceRequestBody': {"points":10} // LoyaltiesMembersPendingPointsBalanceRequestBody | Define the number of pending points to be added or subtracted.
};
apiInstance.adjustMemberPendingPoints(memberId, pendingPointsId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [LoyaltiesEarningRulesCreateResponseBody] createEarningRule(campaignId, opts)
...
apiInstance.createEarningRule(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [LoyaltyTier] createInBulkLoyaltyTiers(campaignId, opts)
...
let opts = {
  'loyaltiesTiersCreateInBulkRequestBodyItem': [new Voucherify.LoyaltiesTiersCreateInBulkRequestBodyItem()] // [LoyaltiesTiersCreateInBulkRequestBodyItem] | Provide tier definitions you want to add to existing loyalty campaign.
};
apiInstance.createInBulkLoyaltyTiers(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **loyaltiesTiersCreateInBulkRequestBodyItem** | [**[LoyaltiesTiersCreateInBulkRequestBodyItem]**](LoyaltiesTiersCreateInBulkRequestBodyItem.md)| Provide tier definitions you want to add to existing loyalty campaign. | [optional] 
...
> LoyaltiesCreateCampaignResponseBody createLoyaltyProgram(opts)
...
apiInstance.createLoyaltyProgram(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesPointsExpirationExportCreateResponseBody createPointsExpirationExport(campaignId, opts)
...
apiInstance.createPointsExpirationExport(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesRewardsCreateAssignmentResponseBody createRewardAssignment1(campaignId, opts)
...
let opts = {
  'loyaltiesRewardsCreateAssignmentItemRequestBody': [{"reward":"rew_wg2pvCr5LDhCq4uVQZ9LhuZm","parameters":{"loyalty":{"points":2}}},{"reward":"rew_z35ffKoH0tCcck8EL56p6SIs","parameters":{"loyalty":{"points":2}}}] // [LoyaltiesRewardsCreateAssignmentItemRequestBody] | Define the cost of the rewards in loyalty points.
};
apiInstance.createRewardAssignment1(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **loyaltiesRewardsCreateAssignmentItemRequestBody** | [**[LoyaltiesRewardsCreateAssignmentItemRequestBody]**](LoyaltiesRewardsCreateAssignmentItemRequestBody.md)| Define the cost of the rewards in loyalty points. | [optional] 
...
> CampaignsTransactionsExportCreateResponseBody exportLoyaltyCampaignTransactions(campaignId, opts)
...
let opts = {
  'loyaltiesTransactionsExportCreateRequestBody': {"order":"-created_at","parameters":{"fields":["id","type","source_id","created_at"],"filters":{"created_at":{"conditions":{"$after":["2024-10-01T00:00:00.000Z"]}}}}} // LoyaltiesTransactionsExportCreateRequestBody | Specify the parameters for the transaction export.
};
apiInstance.exportLoyaltyCampaignTransactions(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersTransactionsExportCreateResponseBody exportLoyaltyCardTransactions(memberId, opts)
...
apiInstance.exportLoyaltyCardTransactions(memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersTransactionsExportCreateResponseBody exportLoyaltyCardTransactions1(campaignId, memberId, opts)
...
apiInstance.exportLoyaltyCardTransactions1(campaignId, memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersRedemptionRedeemResponseBody redeemReward(memberId, opts)
...
apiInstance.redeemReward(memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersRedemptionRedeemResponseBody redeemReward1(campaignId, memberId, opts)
...
apiInstance.redeemReward1(campaignId, memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersTransfersCreateResponseBody transferPoints(campaignId, memberId, opts)
...
let opts = {
  'loyaltiesTransferPoints': [{"code":"0PmQ7JQI","points":1},{"code":"kCeufB8i","points":1}] // [LoyaltiesTransferPoints] | Provide the loyalty cards you want the points to be transferred from and the number of points to transfer from each card.
};
apiInstance.transferPoints(campaignId, memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **loyaltiesTransferPoints** | [**[LoyaltiesTransferPoints]**](LoyaltiesTransferPoints.md)| Provide the loyalty cards you want the points to be transferred from and the number of points to transfer from each card. | [optional] 
...
> LoyaltiesEarningRulesUpdateResponseBody updateEarningRule(campaignId, earningRuleId, opts)
...
apiInstance.updateEarningRule(campaignId, earningRuleId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersBalanceUpdateResponseBody updateLoyaltyCardBalance(memberId, opts)
...
let memberId = "memberId_example"; // String | Unique loyalty card assigned to a particular customer.
let opts = {
  'loyaltiesMembersBalanceUpdateRequestBody': {"points":-100} // LoyaltiesMembersBalanceUpdateRequestBody | Specify the point adjustment along with the expiration mechanism.
};
apiInstance.updateLoyaltyCardBalance(memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesMembersBalanceUpdateResponseBody updateLoyaltyCardBalance1(campaignId, memberId, opts)
...
let memberId = "memberId_example"; // String | A code that identifies the loyalty card.
let opts = {
  'loyaltiesMembersBalanceUpdateRequestBody': {"points":100,"expiration_type":"CUSTOM_DATE","expiration_date":"2023-05-30"} // LoyaltiesMembersBalanceUpdateRequestBody | Specify the point adjustment along with the expiration mechanism.
};
apiInstance.updateLoyaltyCardBalance1(campaignId, memberId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesUpdateCampaignResponseBody updateLoyaltyProgram(campaignId, opts)
...
apiInstance.updateLoyaltyProgram(campaignId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LoyaltiesRewardsUpdateAssignmentResponseBody updateRewardAssignment1(campaignId, assignmentId, opts)
...
let assignmentId = "assignmentId_example"; // String | A unique reward assignment ID.
let opts = {
  'loyaltiesRewardsUpdateAssignmentRequestBody': {"parameters":{"loyalty":{"points":3}}} // LoyaltiesRewardsUpdateAssignmentRequestBody | Update the points cost for the reward assignment.
};
apiInstance.updateRewardAssignment1(campaignId, assignmentId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);

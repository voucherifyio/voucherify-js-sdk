...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.EarningRuleSource();
  });
  ...
  describe('EarningRuleSource', function() {
    it('should create an instance of EarningRuleSource', function() {
      // uncomment below and update the code to test EarningRuleSource
      //var instance = new Voucherify.EarningRuleSource();
      //expect(instance).to.be.a(Voucherify.EarningRuleSource);
    });

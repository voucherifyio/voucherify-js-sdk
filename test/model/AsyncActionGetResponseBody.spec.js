...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.AsyncActionGetResponseBody();
  });
  ...
  describe('AsyncActionGetResponseBody', function() {
    it('should create an instance of AsyncActionGetResponseBody', function() {
      // uncomment below and update the code to test AsyncActionGetResponseBody
      //var instance = new Voucherify.AsyncActionGetResponseBody();
      //expect(instance).to.be.a(Voucherify.AsyncActionGetResponseBody);
    });
    ...
    it('should have the property operationStatus (base name: "operation_status")', function() {

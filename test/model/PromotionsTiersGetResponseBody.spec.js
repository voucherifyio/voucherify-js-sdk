...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsTiersGetResponseBody();
  });
  ...
  describe('PromotionsTiersGetResponseBody', function() {
    it('should create an instance of PromotionsTiersGetResponseBody', function() {
      // uncomment below and update the code to test PromotionsTiersGetResponseBody
      //var instance = new Voucherify.PromotionsTiersGetResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsTiersGetResponseBody);
    });

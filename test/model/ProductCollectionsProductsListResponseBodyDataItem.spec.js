...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductCollectionsProductsListResponseBodyDataItem();
  });
  ...
  describe('ProductCollectionsProductsListResponseBodyDataItem', function() {
    it('should create an instance of ProductCollectionsProductsListResponseBodyDataItem', function() {
      // uncomment below and update the code to test ProductCollectionsProductsListResponseBodyDataItem
      //var instance = new Voucherify.ProductCollectionsProductsListResponseBodyDataItem();
      //expect(instance).to.be.a(Voucherify.ProductCollectionsProductsListResponseBodyDataItem);
    });

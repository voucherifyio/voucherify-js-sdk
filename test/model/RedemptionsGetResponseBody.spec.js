...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionsGetResponseBody();
  });
  ...
  describe('RedemptionsGetResponseBody', function() {
    it('should create an instance of RedemptionsGetResponseBody', function() {
      // uncomment below and update the code to test RedemptionsGetResponseBody
      //var instance = new Voucherify.RedemptionsGetResponseBody();
      //expect(instance).to.be.a(Voucherify.RedemptionsGetResponseBody);
    });

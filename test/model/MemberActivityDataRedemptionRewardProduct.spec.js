...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.MemberActivityDataRedemptionRewardProduct();
  });
  ...
  describe('MemberActivityDataRedemptionRewardProduct', function() {
    it('should create an instance of MemberActivityDataRedemptionRewardProduct', function() {
      // uncomment below and update the code to test MemberActivityDataRedemptionRewardProduct
      //var instance = new Voucherify.MemberActivityDataRedemptionRewardProduct();
      //expect(instance).to.be.a(Voucherify.MemberActivityDataRedemptionRewardProduct);
    });

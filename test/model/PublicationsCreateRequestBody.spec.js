...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PublicationsCreateRequestBody();
  });
  ...
  describe('PublicationsCreateRequestBody', function() {
    it('should create an instance of PublicationsCreateRequestBody', function() {
      // uncomment below and update the code to test PublicationsCreateRequestBody
      //var instance = new Voucherify.PublicationsCreateRequestBody();
      //expect(instance).to.be.a(Voucherify.PublicationsCreateRequestBody);
    });

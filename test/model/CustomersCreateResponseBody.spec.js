...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CustomersCreateResponseBody();
  });
  ...
  describe('CustomersCreateResponseBody', function() {
    it('should create an instance of CustomersCreateResponseBody', function() {
      // uncomment below and update the code to test CustomersCreateResponseBody
      //var instance = new Voucherify.CustomersCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.CustomersCreateResponseBody);
    });

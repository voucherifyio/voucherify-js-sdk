...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PublicationsCreateResponseBody();
  });
  ...
  describe('PublicationsCreateResponseBody', function() {
    it('should create an instance of PublicationsCreateResponseBody', function() {
      // uncomment below and update the code to test PublicationsCreateResponseBody
      //var instance = new Voucherify.PublicationsCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.PublicationsCreateResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltyTier();
  });
  ...
  describe('LoyaltyTier', function() {
    it('should create an instance of LoyaltyTier', function() {
      // uncomment below and update the code to test LoyaltyTier
      //var instance = new Voucherify.LoyaltyTier();
      //expect(instance).to.be.a(Voucherify.LoyaltyTier);
    });

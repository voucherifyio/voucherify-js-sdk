...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimplePromotionTier();
  });
  ...
  describe('SimplePromotionTier', function() {
    it('should create an instance of SimplePromotionTier', function() {
      // uncomment below and update the code to test SimplePromotionTier
      //var instance = new Voucherify.SimplePromotionTier();
      //expect(instance).to.be.a(Voucherify.SimplePromotionTier);
    });

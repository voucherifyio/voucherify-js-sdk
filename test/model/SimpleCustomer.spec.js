...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimpleCustomer();
  });
  ...
  describe('SimpleCustomer', function() {
    it('should create an instance of SimpleCustomer', function() {
      // uncomment below and update the code to test SimpleCustomer
      //var instance = new Voucherify.SimpleCustomer();
      //expect(instance).to.be.a(Voucherify.SimpleCustomer);
    });

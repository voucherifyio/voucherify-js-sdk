...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionRollback();
  });
  ...
  describe('RedemptionRollback', function() {
    it('should create an instance of RedemptionRollback', function() {
      // uncomment below and update the code to test RedemptionRollback
      //var instance = new Voucherify.RedemptionRollback();
      //expect(instance).to.be.a(Voucherify.RedemptionRollback);
    });

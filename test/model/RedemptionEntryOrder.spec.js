...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionEntryOrder();
  });
  ...
  describe('RedemptionEntryOrder', function() {
    it('should create an instance of RedemptionEntryOrder', function() {
      // uncomment below and update the code to test RedemptionEntryOrder
      //var instance = new Voucherify.RedemptionEntryOrder();
      //expect(instance).to.be.a(Voucherify.RedemptionEntryOrder);
    });

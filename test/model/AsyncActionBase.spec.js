...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.AsyncActionBase();
  });
  ...
  describe('AsyncActionBase', function() {
    it('should create an instance of AsyncActionBase', function() {
      // uncomment below and update the code to test AsyncActionBase
      //var instance = new Voucherify.AsyncActionBase();
      //expect(instance).to.be.a(Voucherify.AsyncActionBase);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrdersGetResponseBody();
  });
  ...
  describe('OrdersGetResponseBody', function() {
    it('should create an instance of OrdersGetResponseBody', function() {
      // uncomment below and update the code to test OrdersGetResponseBody
      //var instance = new Voucherify.OrdersGetResponseBody();
      //expect(instance).to.be.a(Voucherify.OrdersGetResponseBody);
    });

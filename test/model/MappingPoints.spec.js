...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.MappingPoints();
  });
  ...
  describe('MappingPoints', function() {
    it('should create an instance of MappingPoints', function() {
      // uncomment below and update the code to test MappingPoints
      //var instance = new Voucherify.MappingPoints();
      //expect(instance).to.be.a(Voucherify.MappingPoints);
    });

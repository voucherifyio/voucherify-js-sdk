...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrdersUpdateRequestBody();
  });
  ...
  describe('OrdersUpdateRequestBody', function() {
    it('should create an instance of OrdersUpdateRequestBody', function() {
      // uncomment below and update the code to test OrdersUpdateRequestBody
      //var instance = new Voucherify.OrdersUpdateRequestBody();
      //expect(instance).to.be.a(Voucherify.OrdersUpdateRequestBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductsSkusCreateResponseBody();
  });
  ...
  describe('ProductsSkusCreateResponseBody', function() {
    it('should create an instance of ProductsSkusCreateResponseBody', function() {
      // uncomment below and update the code to test ProductsSkusCreateResponseBody
      //var instance = new Voucherify.ProductsSkusCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.ProductsSkusCreateResponseBody);
    });

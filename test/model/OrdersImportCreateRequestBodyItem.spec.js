...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrdersImportCreateRequestBodyItem();
  });
  ...
  describe('OrdersImportCreateRequestBodyItem', function() {
    it('should create an instance of OrdersImportCreateRequestBodyItem', function() {
      // uncomment below and update the code to test OrdersImportCreateRequestBodyItem
      //var instance = new Voucherify.OrdersImportCreateRequestBodyItem();
      //expect(instance).to.be.a(Voucherify.OrdersImportCreateRequestBodyItem);
    });

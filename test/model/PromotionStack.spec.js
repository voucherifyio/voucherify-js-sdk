...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionStack();
  });
  ...
  describe('PromotionStack', function() {
    it('should create an instance of PromotionStack', function() {
      // uncomment below and update the code to test PromotionStack
      //var instance = new Voucherify.PromotionStack();
      //expect(instance).to.be.a(Voucherify.PromotionStack);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimpleRedemptionChannel();
  });
  ...
  describe('SimpleRedemptionChannel', function() {
    it('should create an instance of SimpleRedemptionChannel', function() {
      // uncomment below and update the code to test SimpleRedemptionChannel
      //var instance = new Voucherify.SimpleRedemptionChannel();
      //expect(instance).to.be.a(Voucherify.SimpleRedemptionChannel);
    });

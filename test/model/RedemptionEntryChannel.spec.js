...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionEntryChannel();
  });
  ...
  describe('RedemptionEntryChannel', function() {
    it('should create an instance of RedemptionEntryChannel', function() {
      // uncomment below and update the code to test RedemptionEntryChannel
      //var instance = new Voucherify.RedemptionEntryChannel();
      //expect(instance).to.be.a(Voucherify.RedemptionEntryChannel);
    });

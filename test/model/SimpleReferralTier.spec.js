...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimpleReferralTier();
  });
  ...
  describe('SimpleReferralTier', function() {
    it('should create an instance of SimpleReferralTier', function() {
      // uncomment below and update the code to test SimpleReferralTier
      //var instance = new Voucherify.SimpleReferralTier();
      //expect(instance).to.be.a(Voucherify.SimpleReferralTier);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SkusGetResponseBody();
  });
  ...
  describe('SkusGetResponseBody', function() {
    it('should create an instance of SkusGetResponseBody', function() {
      // uncomment below and update the code to test SkusGetResponseBody
      //var instance = new Voucherify.SkusGetResponseBody();
      //expect(instance).to.be.a(Voucherify.SkusGetResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionTierSummary();
  });
  ...
  describe('PromotionTierSummary', function() {
    it('should create an instance of PromotionTierSummary', function() {
      // uncomment below and update the code to test PromotionTierSummary
      //var instance = new Voucherify.PromotionTierSummary();
      //expect(instance).to.be.a(Voucherify.PromotionTierSummary);
    });

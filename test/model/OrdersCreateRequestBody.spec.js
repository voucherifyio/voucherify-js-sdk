...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrdersCreateRequestBody();
  });
  ...
  describe('OrdersCreateRequestBody', function() {
    it('should create an instance of OrdersCreateRequestBody', function() {
      // uncomment below and update the code to test OrdersCreateRequestBody
      //var instance = new Voucherify.OrdersCreateRequestBody();
      //expect(instance).to.be.a(Voucherify.OrdersCreateRequestBody);
    });

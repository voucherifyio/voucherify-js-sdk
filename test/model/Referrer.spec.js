...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.Referrer();
  });
  ...
  describe('Referrer', function() {
    it('should create an instance of Referrer', function() {
      // uncomment below and update the code to test Referrer
      //var instance = new Voucherify.Referrer();
      //expect(instance).to.be.a(Voucherify.Referrer);
    });

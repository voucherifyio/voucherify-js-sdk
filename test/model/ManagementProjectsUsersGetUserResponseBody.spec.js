...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ManagementProjectsUsersGetUserResponseBody();
  });
  ...
  describe('ManagementProjectsUsersGetUserResponseBody', function() {
    it('should create an instance of ManagementProjectsUsersGetUserResponseBody', function() {
      // uncomment below and update the code to test ManagementProjectsUsersGetUserResponseBody
      //var instance = new Voucherify.ManagementProjectsUsersGetUserResponseBody();
      //expect(instance).to.be.a(Voucherify.ManagementProjectsUsersGetUserResponseBody);
    });

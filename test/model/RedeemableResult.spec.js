...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedeemableResult();
  });
  ...
  describe('RedeemableResult', function() {
    it('should create an instance of RedeemableResult', function() {
      // uncomment below and update the code to test RedeemableResult
      //var instance = new Voucherify.RedeemableResult();
      //expect(instance).to.be.a(Voucherify.RedeemableResult);
    });

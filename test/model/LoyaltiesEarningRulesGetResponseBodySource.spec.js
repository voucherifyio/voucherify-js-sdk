...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltiesEarningRulesGetResponseBodySource();
  });
  ...
  describe('LoyaltiesEarningRulesGetResponseBodySource', function() {
    it('should create an instance of LoyaltiesEarningRulesGetResponseBodySource', function() {
      // uncomment below and update the code to test LoyaltiesEarningRulesGetResponseBodySource
      //var instance = new Voucherify.LoyaltiesEarningRulesGetResponseBodySource();
      //expect(instance).to.be.a(Voucherify.LoyaltiesEarningRulesGetResponseBodySource);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.BundleMissingItem();
  });
  ...
  describe('BundleMissingItem', function() {
    it('should create an instance of BundleMissingItem', function() {
      // uncomment below and update the code to test BundleMissingItem
      //var instance = new Voucherify.BundleMissingItem();
      //expect(instance).to.be.a(Voucherify.BundleMissingItem);
    });

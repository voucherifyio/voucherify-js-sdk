...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltiesLoyaltyTierReward();
  });
  ...
  describe('LoyaltiesLoyaltyTierReward', function() {
    it('should create an instance of LoyaltiesLoyaltyTierReward', function() {
      // uncomment below and update the code to test LoyaltiesLoyaltyTierReward
      //var instance = new Voucherify.LoyaltiesLoyaltyTierReward();
      //expect(instance).to.be.a(Voucherify.LoyaltiesLoyaltyTierReward);
    });

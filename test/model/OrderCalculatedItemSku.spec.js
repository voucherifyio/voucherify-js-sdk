...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrderCalculatedItemSku();
  });
  ...
  describe('OrderCalculatedItemSku', function() {
    it('should create an instance of OrderCalculatedItemSku', function() {
      // uncomment below and update the code to test OrderCalculatedItemSku
      //var instance = new Voucherify.OrderCalculatedItemSku();
      //expect(instance).to.be.a(Voucherify.OrderCalculatedItemSku);
    });

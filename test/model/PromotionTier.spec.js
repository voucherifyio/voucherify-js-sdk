...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionTier();
  });
  ...
  describe('PromotionTier', function() {
    it('should create an instance of PromotionTier', function() {
      // uncomment below and update the code to test PromotionTier
      //var instance = new Voucherify.PromotionTier();
      //expect(instance).to.be.a(Voucherify.PromotionTier);
    });

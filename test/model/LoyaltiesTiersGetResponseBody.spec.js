...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltiesTiersGetResponseBody();
  });
  ...
  describe('LoyaltiesTiersGetResponseBody', function() {
    it('should create an instance of LoyaltiesTiersGetResponseBody', function() {
      // uncomment below and update the code to test LoyaltiesTiersGetResponseBody
      //var instance = new Voucherify.LoyaltiesTiersGetResponseBody();
      //expect(instance).to.be.a(Voucherify.LoyaltiesTiersGetResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CustomersGetResponseBodyAddress();
  });
  ...
  describe('CustomersGetResponseBodyAddress', function() {
    it('should create an instance of CustomersGetResponseBodyAddress', function() {
      // uncomment below and update the code to test CustomersGetResponseBodyAddress
      //var instance = new Voucherify.CustomersGetResponseBodyAddress();
      //expect(instance).to.be.a(Voucherify.CustomersGetResponseBodyAddress);
    });

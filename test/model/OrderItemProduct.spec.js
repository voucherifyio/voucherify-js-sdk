...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrderItemProduct();
  });
  ...
  describe('OrderItemProduct', function() {
    it('should create an instance of OrderItemProduct', function() {
      // uncomment below and update the code to test OrderItemProduct
      //var instance = new Voucherify.OrderItemProduct();
      //expect(instance).to.be.a(Voucherify.OrderItemProduct);
    });

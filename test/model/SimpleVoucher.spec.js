...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimpleVoucher();
  });
  ...
  describe('SimpleVoucher', function() {
    it('should create an instance of SimpleVoucher', function() {
      // uncomment below and update the code to test SimpleVoucher
      //var instance = new Voucherify.SimpleVoucher();
      //expect(instance).to.be.a(Voucherify.SimpleVoucher);
    });

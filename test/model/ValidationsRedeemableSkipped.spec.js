...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ValidationsRedeemableSkipped();
  });
  ...
  describe('ValidationsRedeemableSkipped', function() {
    it('should create an instance of ValidationsRedeemableSkipped', function() {
      // uncomment below and update the code to test ValidationsRedeemableSkipped
      //var instance = new Voucherify.ValidationsRedeemableSkipped();
      //expect(instance).to.be.a(Voucherify.ValidationsRedeemableSkipped);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductsSkusUpdateResponseBody();
  });
  ...
  describe('ProductsSkusUpdateResponseBody', function() {
    it('should create an instance of ProductsSkusUpdateResponseBody', function() {
      // uncomment below and update the code to test ProductsSkusUpdateResponseBody
      //var instance = new Voucherify.ProductsSkusUpdateResponseBody();
      //expect(instance).to.be.a(Voucherify.ProductsSkusUpdateResponseBody);
    });

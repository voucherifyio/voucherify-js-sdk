...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsStacksGetResponseBody();
  });
  ...
  describe('PromotionsStacksGetResponseBody', function() {
    it('should create an instance of PromotionsStacksGetResponseBody', function() {
      // uncomment below and update the code to test PromotionsStacksGetResponseBody
      //var instance = new Voucherify.PromotionsStacksGetResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsStacksGetResponseBody);
    });

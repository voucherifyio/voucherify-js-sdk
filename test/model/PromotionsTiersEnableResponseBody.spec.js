...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsTiersEnableResponseBody();
  });
  ...
  describe('PromotionsTiersEnableResponseBody', function() {
    it('should create an instance of PromotionsTiersEnableResponseBody', function() {
      // uncomment below and update the code to test PromotionsTiersEnableResponseBody
      //var instance = new Voucherify.PromotionsTiersEnableResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsTiersEnableResponseBody);
    });

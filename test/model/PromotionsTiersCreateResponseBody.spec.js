...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsTiersCreateResponseBody();
  });
  ...
  describe('PromotionsTiersCreateResponseBody', function() {
    it('should create an instance of PromotionsTiersCreateResponseBody', function() {
      // uncomment below and update the code to test PromotionsTiersCreateResponseBody
      //var instance = new Voucherify.PromotionsTiersCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsTiersCreateResponseBody);
    });

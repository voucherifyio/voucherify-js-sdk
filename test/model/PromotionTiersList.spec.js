...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionTiersList();
  });
  ...
  describe('PromotionTiersList', function() {
    it('should create an instance of PromotionTiersList', function() {
      // uncomment below and update the code to test PromotionTiersList
      //var instance = new Voucherify.PromotionTiersList();
      //expect(instance).to.be.a(Voucherify.PromotionTiersList);
    });

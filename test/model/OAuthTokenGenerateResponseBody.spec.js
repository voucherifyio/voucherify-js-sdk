...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OAuthTokenGenerateResponseBody();
  });
  ...
  describe('OAuthTokenGenerateResponseBody', function() {
    it('should create an instance of OAuthTokenGenerateResponseBody', function() {
      // uncomment below and update the code to test OAuthTokenGenerateResponseBody
      //var instance = new Voucherify.OAuthTokenGenerateResponseBody();
      //expect(instance).to.be.a(Voucherify.OAuthTokenGenerateResponseBody);
    });

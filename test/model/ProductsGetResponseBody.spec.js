...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductsGetResponseBody();
  });
  ...
  describe('ProductsGetResponseBody', function() {
    it('should create an instance of ProductsGetResponseBody', function() {
      // uncomment below and update the code to test ProductsGetResponseBody
      //var instance = new Voucherify.ProductsGetResponseBody();
      //expect(instance).to.be.a(Voucherify.ProductsGetResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimplePromotionStack();
  });
  ...
  describe('SimplePromotionStack', function() {
    it('should create an instance of SimplePromotionStack', function() {
      // uncomment below and update the code to test SimplePromotionStack
      //var instance = new Voucherify.SimplePromotionStack();
      //expect(instance).to.be.a(Voucherify.SimplePromotionStack);
    });

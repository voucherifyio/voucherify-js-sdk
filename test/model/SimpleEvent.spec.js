...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.SimpleEvent();
  });
  ...
  describe('SimpleEvent', function() {
    it('should create an instance of SimpleEvent', function() {
      // uncomment below and update the code to test SimpleEvent
      //var instance = new Voucherify.SimpleEvent();
      //expect(instance).to.be.a(Voucherify.SimpleEvent);
    });

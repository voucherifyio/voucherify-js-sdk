...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionEntryPromotionTier();
  });
  ...
  describe('RedemptionEntryPromotionTier', function() {
    it('should create an instance of RedemptionEntryPromotionTier', function() {
      // uncomment below and update the code to test RedemptionEntryPromotionTier
      //var instance = new Voucherify.RedemptionEntryPromotionTier();
      //expect(instance).to.be.a(Voucherify.RedemptionEntryPromotionTier);
    });

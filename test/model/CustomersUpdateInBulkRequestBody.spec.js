...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CustomersUpdateInBulkRequestBody();
  });
  ...
  describe('CustomersUpdateInBulkRequestBody', function() {
    it('should create an instance of CustomersUpdateInBulkRequestBody', function() {
      // uncomment below and update the code to test CustomersUpdateInBulkRequestBody
      //var instance = new Voucherify.CustomersUpdateInBulkRequestBody();
      //expect(instance).to.be.a(Voucherify.CustomersUpdateInBulkRequestBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionOrder();
  });
  ...
  describe('RedemptionOrder', function() {
    it('should create an instance of RedemptionOrder', function() {
      // uncomment below and update the code to test RedemptionOrder
      //var instance = new Voucherify.RedemptionOrder();
      //expect(instance).to.be.a(Voucherify.RedemptionOrder);
    });

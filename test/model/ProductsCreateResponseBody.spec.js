...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductsCreateResponseBody();
  });
  ...
  describe('ProductsCreateResponseBody', function() {
    it('should create an instance of ProductsCreateResponseBody', function() {
      // uncomment below and update the code to test ProductsCreateResponseBody
      //var instance = new Voucherify.ProductsCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.ProductsCreateResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CustomersUpdateResponseBody();
  });
  ...
  describe('CustomersUpdateResponseBody', function() {
    it('should create an instance of CustomersUpdateResponseBody', function() {
      // uncomment below and update the code to test CustomersUpdateResponseBody
      //var instance = new Voucherify.CustomersUpdateResponseBody();
      //expect(instance).to.be.a(Voucherify.CustomersUpdateResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionsRollbackCreateResponseBody();
  });
  ...
  describe('RedemptionsRollbackCreateResponseBody', function() {
    it('should create an instance of RedemptionsRollbackCreateResponseBody', function() {
      // uncomment below and update the code to test RedemptionsRollbackCreateResponseBody
      //var instance = new Voucherify.RedemptionsRollbackCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.RedemptionsRollbackCreateResponseBody);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ClientEventsCreateResponseBody();
  });
  ...
  describe('ClientEventsCreateResponseBody', function() {
    it('should create an instance of ClientEventsCreateResponseBody', function() {
      // uncomment below and update the code to test ClientEventsCreateResponseBody
      //var instance = new Voucherify.ClientEventsCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.ClientEventsCreateResponseBody);
    });

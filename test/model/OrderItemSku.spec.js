...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrderItemSku();
  });
  ...
  describe('OrderItemSku', function() {
    it('should create an instance of OrderItemSku', function() {
      // uncomment below and update the code to test OrderItemSku
      //var instance = new Voucherify.OrderItemSku();
      //expect(instance).to.be.a(Voucherify.OrderItemSku);
    });

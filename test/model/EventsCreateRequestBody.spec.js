...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.EventsCreateRequestBody();
  });
  ...
  describe('EventsCreateRequestBody', function() {
    it('should create an instance of EventsCreateRequestBody', function() {
      // uncomment below and update the code to test EventsCreateRequestBody
      //var instance = new Voucherify.EventsCreateRequestBody();
      //expect(instance).to.be.a(Voucherify.EventsCreateRequestBody);
    });

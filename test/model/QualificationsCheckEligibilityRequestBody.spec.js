...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.QualificationsCheckEligibilityRequestBody();
  });
  ...
  describe('QualificationsCheckEligibilityRequestBody', function() {
    it('should create an instance of QualificationsCheckEligibilityRequestBody', function() {
      // uncomment below and update the code to test QualificationsCheckEligibilityRequestBody
      //var instance = new Voucherify.QualificationsCheckEligibilityRequestBody();
      //expect(instance).to.be.a(Voucherify.QualificationsCheckEligibilityRequestBody);
    });

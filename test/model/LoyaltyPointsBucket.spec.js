...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltyPointsBucket();
  });
  ...
  describe('LoyaltyPointsBucket', function() {
    it('should create an instance of LoyaltyPointsBucket', function() {
      // uncomment below and update the code to test LoyaltyPointsBucket
      //var instance = new Voucherify.LoyaltyPointsBucket();
      //expect(instance).to.be.a(Voucherify.LoyaltyPointsBucket);
    });

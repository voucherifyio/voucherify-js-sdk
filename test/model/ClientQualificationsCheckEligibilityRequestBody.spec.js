...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ClientQualificationsCheckEligibilityRequestBody();
  });
  ...
  describe('ClientQualificationsCheckEligibilityRequestBody', function() {
    it('should create an instance of ClientQualificationsCheckEligibilityRequestBody', function() {
      // uncomment below and update the code to test ClientQualificationsCheckEligibilityRequestBody
      //var instance = new Voucherify.ClientQualificationsCheckEligibilityRequestBody();
      //expect(instance).to.be.a(Voucherify.ClientQualificationsCheckEligibilityRequestBody);
    });

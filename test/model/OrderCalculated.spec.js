...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.OrderCalculated();
  });
  ...
  describe('OrderCalculated', function() {
    it('should create an instance of OrderCalculated', function() {
      // uncomment below and update the code to test OrderCalculated
      //var instance = new Voucherify.OrderCalculated();
      //expect(instance).to.be.a(Voucherify.OrderCalculated);
    });

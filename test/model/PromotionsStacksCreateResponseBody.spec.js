...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsStacksCreateResponseBody();
  });
  ...
  describe('PromotionsStacksCreateResponseBody', function() {
    it('should create an instance of PromotionsStacksCreateResponseBody', function() {
      // uncomment below and update the code to test PromotionsStacksCreateResponseBody
      //var instance = new Voucherify.PromotionsStacksCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsStacksCreateResponseBody);
    });

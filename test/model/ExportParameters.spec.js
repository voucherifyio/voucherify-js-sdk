...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ExportParameters();
  });
  ...
  describe('ExportParameters', function() {
    it('should create an instance of ExportParameters', function() {
      // uncomment below and update the code to test ExportParameters
      //var instance = new Voucherify.ExportParameters();
      //expect(instance).to.be.a(Voucherify.ExportParameters);
    });

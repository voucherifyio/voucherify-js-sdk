...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ProductWithoutSkus();
  });
  ...
  describe('ProductWithoutSkus', function() {
    it('should create an instance of ProductWithoutSkus', function() {
      // uncomment below and update the code to test ProductWithoutSkus
      //var instance = new Voucherify.ProductWithoutSkus();
      //expect(instance).to.be.a(Voucherify.ProductWithoutSkus);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionsTiersUpdateResponseBody();
  });
  ...
  describe('PromotionsTiersUpdateResponseBody', function() {
    it('should create an instance of PromotionsTiersUpdateResponseBody', function() {
      // uncomment below and update the code to test PromotionsTiersUpdateResponseBody
      //var instance = new Voucherify.PromotionsTiersUpdateResponseBody();
      //expect(instance).to.be.a(Voucherify.PromotionsTiersUpdateResponseBody);
    });

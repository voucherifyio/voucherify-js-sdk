...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CustomerWithSummaryLoyaltyReferrals();
  });
  ...
  describe('CustomerWithSummaryLoyaltyReferrals', function() {
    it('should create an instance of CustomerWithSummaryLoyaltyReferrals', function() {
      // uncomment below and update the code to test CustomerWithSummaryLoyaltyReferrals
      //var instance = new Voucherify.CustomerWithSummaryLoyaltyReferrals();
      //expect(instance).to.be.a(Voucherify.CustomerWithSummaryLoyaltyReferrals);
    });

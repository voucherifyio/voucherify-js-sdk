...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.PromotionTierSummaryOrders();
  });
  ...
  describe('PromotionTierSummaryOrders', function() {
    it('should create an instance of PromotionTierSummaryOrders', function() {
      // uncomment below and update the code to test PromotionTierSummaryOrders
      //var instance = new Voucherify.PromotionTierSummaryOrders();
      //expect(instance).to.be.a(Voucherify.PromotionTierSummaryOrders);
    });

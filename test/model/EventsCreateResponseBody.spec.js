...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.EventsCreateResponseBody();
  });
  ...
  describe('EventsCreateResponseBody', function() {
    it('should create an instance of EventsCreateResponseBody', function() {
      // uncomment below and update the code to test EventsCreateResponseBody
      //var instance = new Voucherify.EventsCreateResponseBody();
      //expect(instance).to.be.a(Voucherify.EventsCreateResponseBody);
    });

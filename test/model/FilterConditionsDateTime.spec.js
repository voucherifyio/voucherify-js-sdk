...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.FilterConditionsDateTime();
  });
  ...
  describe('FilterConditionsDateTime', function() {
    it('should create an instance of FilterConditionsDateTime', function() {
      // uncomment below and update the code to test FilterConditionsDateTime
      //var instance = new Voucherify.FilterConditionsDateTime();
      //expect(instance).to.be.a(Voucherify.FilterConditionsDateTime);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.LoyaltyMember();
  });
  ...
  describe('LoyaltyMember', function() {
    it('should create an instance of LoyaltyMember', function() {
      // uncomment below and update the code to test LoyaltyMember
      //var instance = new Voucherify.LoyaltyMember();
      //expect(instance).to.be.a(Voucherify.LoyaltyMember);
    });

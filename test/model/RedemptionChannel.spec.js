...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionChannel();
  });
  ...
  describe('RedemptionChannel', function() {
    it('should create an instance of RedemptionChannel', function() {
      // uncomment below and update the code to test RedemptionChannel
      //var instance = new Voucherify.RedemptionChannel();
      //expect(instance).to.be.a(Voucherify.RedemptionChannel);
    });

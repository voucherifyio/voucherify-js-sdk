...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ValidationsRedeemableInapplicable();
  });
  ...
  describe('ValidationsRedeemableInapplicable', function() {
    it('should create an instance of ValidationsRedeemableInapplicable', function() {
      // uncomment below and update the code to test ValidationsRedeemableInapplicable
      //var instance = new Voucherify.ValidationsRedeemableInapplicable();
      //expect(instance).to.be.a(Voucherify.ValidationsRedeemableInapplicable);
    });

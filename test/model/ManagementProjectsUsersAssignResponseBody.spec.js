...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ManagementProjectsUsersAssignResponseBody();
  });
  ...
  describe('ManagementProjectsUsersAssignResponseBody', function() {
    it('should create an instance of ManagementProjectsUsersAssignResponseBody', function() {
      // uncomment below and update the code to test ManagementProjectsUsersAssignResponseBody
      //var instance = new Voucherify.ManagementProjectsUsersAssignResponseBody();
      //expect(instance).to.be.a(Voucherify.ManagementProjectsUsersAssignResponseBody);
    });

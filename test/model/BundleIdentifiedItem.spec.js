...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.BundleIdentifiedItem();
  });
  ...
  describe('BundleIdentifiedItem', function() {
    it('should create an instance of BundleIdentifiedItem', function() {
      // uncomment below and update the code to test BundleIdentifiedItem
      //var instance = new Voucherify.BundleIdentifiedItem();
      //expect(instance).to.be.a(Voucherify.BundleIdentifiedItem);
    });

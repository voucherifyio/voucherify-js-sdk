...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.MemberActivityDataRedemptionRewardSku();
  });
  ...
  describe('MemberActivityDataRedemptionRewardSku', function() {
    it('should create an instance of MemberActivityDataRedemptionRewardSku', function() {
      // uncomment below and update the code to test MemberActivityDataRedemptionRewardSku
      //var instance = new Voucherify.MemberActivityDataRedemptionRewardSku();
      //expect(instance).to.be.a(Voucherify.MemberActivityDataRedemptionRewardSku);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.ReferrerAddress();
  });
  ...
  describe('ReferrerAddress', function() {
    it('should create an instance of ReferrerAddress', function() {
      // uncomment below and update the code to test ReferrerAddress
      //var instance = new Voucherify.ReferrerAddress();
      //expect(instance).to.be.a(Voucherify.ReferrerAddress);
    });

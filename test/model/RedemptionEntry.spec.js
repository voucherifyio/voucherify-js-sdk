...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.RedemptionEntry();
  });
  ...
  describe('RedemptionEntry', function() {
    it('should create an instance of RedemptionEntry', function() {
      // uncomment below and update the code to test RedemptionEntry
      //var instance = new Voucherify.RedemptionEntry();
      //expect(instance).to.be.a(Voucherify.RedemptionEntry);
    });

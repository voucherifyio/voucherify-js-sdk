...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Voucherify.CodeConfig();
  });
  ...
  describe('CodeConfig', function() {
    it('should create an instance of CodeConfig', function() {
      // uncomment below and update the code to test CodeConfig
      //var instance = new Voucherify.CodeConfig();
      //expect(instance).to.be.a(Voucherify.CodeConfig);
    });
    ...
    it('should have the property initialCount (base name: "initial_count")', function() {
